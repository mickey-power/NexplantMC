...
--  Description     : FAMate Core FaTcpDriver Clipboard Object Format Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    internal static class FCbObjectFormat
    {
        ...
        private static string Prefix = "FAMATE_TCP_";

        // --

        public static string TcpDriver = Prefix + FXmlTagTCD.E_TcpDriver;
        // --
        ...
        // --
        public static string TcpLibraryGroup = Prefix + FXmlTagTLG.E_TcpLibraryGroup;
        public static string TcpLibrary = Prefix + FXmlTagTLB.E_TcpLibrary;
        public static string TcpMessageList = Prefix + FXmlTagTML.E_TcpMessageList;
        public static string TcpMessages = Prefix + FXmlTagTMS.E_TcpMessages;
        public static string TcpMessage = Prefix + FXmlTagTMG.E_TcpMessage;       
        public static string TcpItem = Prefix + FXmlTagTIT.E_TcpItem;
        //--
        public static string TcpDevice = Prefix + FXmlTagTDV.E_TcpDevice;
        public static string TcpSession = Prefix + FXmlTagTSN.E_TcpSession;
        // --
        ...
        public static string TcpTrigger = Prefix + FXmlTagTTR.E_TcpTrigger;
        public static string TcpCondition = Prefix + FXmlTagTCN.E_TcpCondition;
        public static string TcpExpression = Prefix + FXmlTagTEP.E_TcpExpression;
        public static string TcpTransmitter = Prefix + FXmlTagTTN.E_TcpTransmitter;
        public static string TcpTransfer = Prefix + FXmlTagTTF.E_TcpTransfer;
