...
--  Description     : FAMate Core FaTcpDriver Pauser Agent Class 
    ...
    internal class FPauserAgent : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                fXmlNodePau = m_fTcdCore.fTcpDriver.fXmlNode.selectSingleNode(string.Format(Query, fPauserData.uniqueId));
                if (fXmlNodePau == null)
                {
                    return;
                }
                ...
                // ***
                fXmlNodeFlow = m_fTcdCore.fTcpDriver.fXmlNode.selectSingleNode(
                ...
                {
                    FScenarioController.executeTcpTransmitter(fScenarioData);
                }
