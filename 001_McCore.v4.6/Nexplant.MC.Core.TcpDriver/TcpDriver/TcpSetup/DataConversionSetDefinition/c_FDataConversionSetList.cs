...
--  Description     : FAMate Core FaTcpDriver Data Conversion Set List Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FDataConversionSetList : FBaseObject<FDataConversionSetList>, FIObject
    {
        ...
        public FDataConversionSetList(
            ...
            : base(fTcdDriver.fTcdCore, FTcpDriverCommon.createXmlNodeDCL(fTcdDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FDataConversionSetList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSetList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSetCollection fChildDataConversionSetCollection
        {
            get
            {
                try
                {
                    return new FDataConversionSetCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagDCS.E_DataConversionSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fDcs.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversionSetList);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.DataConversionSet);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataConversionSet(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
