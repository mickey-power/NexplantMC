...
--  Description     : FAMate Core FaTcpDriver Data Conversion Set Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FDataConversionSet : FBaseObject<FDataConversionSet>, FIObject
    {
        ...
        public FDataConversionSet(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeDCS(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FDataConversionSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionCollection fChildDataConversionCollection
        {
            get
            {
                try
                {
                    return new FDataConversionCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagDCV.E_DataConversion));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    xpath =
                        ...
                        "//" + FXmlTagTIT.E_TcpItem + "[@" + FXmlTagTIT.A_DataConversionSetID + "='" + this.uniqueIdToString + "']" +
                        " | " +
                        ...
                        "//" + FXmlTagTEP.E_TcpExpression + "[@" + FXmlTagTEP.A_DataConversionSetID + "='" + this.uniqueIdToString + "']" +
                        " | " +
                        "../../../../" + FXmlTagEQM.E_EquipmentModeling +
                        "/" + FXmlTagEQP.E_Equipment +
                        "/" + FXmlTagSNG.E_ScenarioGroup +
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fDcv.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversionSet);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.DataConversion);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataConversion(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    if (obj.fObjectType == FObjectType.TcpItem)
                    {
                        ((FTcpItem)obj).dataConversionSetName = this.name;
                        ((FTcpItem)obj).dataConversionSetExpression = expression;
                    }
                    ...
                    else if (obj.fObjectType == FObjectType.TcpExpression)
                    {
                        ((FTcpExpression)obj).dataConversionSetName = this.name;
                        ((FTcpExpression)obj).dataConversionSetExpression = expression;
                    }
