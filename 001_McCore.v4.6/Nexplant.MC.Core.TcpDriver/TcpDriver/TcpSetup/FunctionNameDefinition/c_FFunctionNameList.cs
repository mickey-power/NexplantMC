...
--  Description     : FAMate Core FaTcpDriver Function Name List Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FFunctionNameList : FBaseObject<FFunctionNameList>, FIObject
    {
        ...
        public FFunctionNameList(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeFNL(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FFunctionNameList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionNameList(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionNameList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionNameList(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionNameCollection fChildFunctionNameCollection
        {
            get
            {
                try
                {
                    return new FFunctionNameCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagFNA.E_FunctionName));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fFna.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.FunctionNameList);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.FunctionName);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FFunctionName(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
