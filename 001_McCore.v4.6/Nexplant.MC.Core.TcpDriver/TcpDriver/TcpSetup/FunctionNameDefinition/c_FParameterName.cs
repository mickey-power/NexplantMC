...
--  Description     : FAMate Core FaTcpDriver Parameter Name Class
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FParameterName : FBaseObject<FParameterName>, FIObject
    {
        ...
        public FParameterName(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodePAN(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FFunctionName fParent
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionName(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FParameterName fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FParameterName(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FParameterName fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FParameterName(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FArgumentCollection fChildFArgumentCollection
        {
            get
            {
                try
                {
                    return new FArgumentCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagARG.E_Argument));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fArg.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ParameterName);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Argument);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FArgument(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
