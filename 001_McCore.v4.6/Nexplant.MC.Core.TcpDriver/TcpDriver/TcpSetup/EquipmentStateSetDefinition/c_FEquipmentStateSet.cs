...
--  Description     : FAMate Core FaTcpDriver Equipment State Set Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FEquipmentStateSet : FBaseObject<FEquipmentStateSet>, FIObject
    {
        ...
        public FEquipmentStateSet(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeESS(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSet(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSet(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateCollection fChildEquipmentStateCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagEST.E_EquipmentState));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fEst.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSet);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentState);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentState(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
