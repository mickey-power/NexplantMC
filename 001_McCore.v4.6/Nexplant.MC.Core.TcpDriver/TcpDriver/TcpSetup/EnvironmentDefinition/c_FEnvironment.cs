...
--  Description     : FAMate Core FaTcpDriver Evnironment Class
...
{
    public class FEnvironment : FBaseObject<FEnvironment>, FIObject, FITcpOperand, FIHostOperand
    {
        ...
        public FEnvironment(
           FTcpDriver fTcpDriver
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeENV(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FEnvironmentList(this.fTcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FEnvironment(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch(Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironment fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironment(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironment fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironment(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fTcdCore, fEnl.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fTcdCore, ((FEnvironmentList)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fTcdCore, ((FEnvironment)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fTcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fTcpDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fTcpDriver, ((FEnvironment)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fEnv.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Environment);
