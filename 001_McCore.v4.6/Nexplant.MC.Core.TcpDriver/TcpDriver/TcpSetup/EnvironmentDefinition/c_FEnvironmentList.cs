...
--  Description     : FAMate Core FaTcpDriver Evnironment List Class
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FEnvironmentList : FBaseObject<FEnvironmentList>, FIObject
    {
        ...
        public FEnvironmentList(
            ...
            :base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeENL(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FEnvironmentList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironmentList(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironmentList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironmentList(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironmentCollection fChildEnvironmentCollection
        {
            get
            {
                try
                {
                    return new FEnvironmentCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagENV.E_Environment));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fEvn.fXmlNode);                   
                }
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEnvironment(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                FTcpDriverCommon.validateCutObject(fXmlNode);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EnvironmentList);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Environment);
