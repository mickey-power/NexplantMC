...
--  Description     : FAMate Core FaTcpDriver Column Class
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FColumn : FBaseObject<FColumn>, FIObject
    {
        ...
        public FColumn(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeCOL(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FRepository(this.fTcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FColumn(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumn fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumn(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumn fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumn(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fTcdCore, ((FRepository)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fTcdCore, ((FColumn)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fTcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fTcpDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fTcpDriver, ((FColumn)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Column);
