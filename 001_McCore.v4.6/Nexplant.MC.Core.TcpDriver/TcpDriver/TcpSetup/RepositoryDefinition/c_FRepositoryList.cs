...
--  Description     : FAMate Core FaTcpDriver Repository List Class
    ...
    public class FRepositoryList : FBaseObject<FRepositoryList>, FIObject
    {
        ...
        public FRepositoryList(
          FTcpDriver fTcpDriver
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeRPL(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FRepositoryList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryCollection fChildRepositoryCollection
        {
            get
            {
                try
                {
                    return new FRepositoryCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagRPS.E_Repository));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fRps.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.RepositoryList);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Repository);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FRepository(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
