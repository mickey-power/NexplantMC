...
--  Description     : FAMate Core FaTcpDriver Host Messages Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostMessages : FBaseObject<FHostMessages>, FIObject
    {
        ...
        public FHostMessages(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHMS(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostMessageList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessageList(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessageCollection fChildHostMessageCollection
        {
            get
            {
                try
                {
                    return new FHostMessageCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagHMG.E_HostMessage));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool canAppendChild
        {
            get
            {
                try
                {
                    //if (this.fXmlNode.selectNodes(FXmlTagSMG.E_TcpMessage).count >= 2)
                    //{
                    //    return false;
                    //}
                    return true;
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fHmg.fXmlNode);
                }
           ...
           )
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeHmg in fXmlNodeListHmg)
                {
                    ...
                    {
                        this.fTcdCore.fEventPusher.pushEvent(
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fTcpDriver, this, FTcpDriverCommon.createObject(this.fTcdCore, fXmlNodeHmg))
                            );
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostMessages);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostMessage);
                // --
                if (this.hasChildPrimaryHostMessage)
                {
