...
--  Description     : FAMate Core FaTcpDriver Host Message Transfer Class
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostMessageTransfer : FIObject, FIMessageTransfer, IDisposable
    {
            ...
            )
        {
            ...
            m_fXmlNode = FTcpDriverCommon.createXmlNodeHMT(m_fTcdCore.fXmlDoc);
        }
        ...
        public FHostItemCollection fChildHostItemCollection
        {
            get
            {
                try
                {
                    return new FHostItemCollection(this.m_fTcdCore, this.fXmlNode.selectNodes(FXmlTagHIT.E_HostItem));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                m_fTcdCore.fProtocolAgent.sendHostMessageTransfer(fHostSession, this);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                return (FHostItem)FTcpDriverCommon.createObject(m_fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
