...
--  Description     : FAMate Core FaTcpDriver Host Library Group Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostLibraryGroup : FBaseObject<FHostLibraryGroup>, FIObject
    {
        ...
        public FHostLibraryGroup(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHLG(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostLibraryGroup fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostLibraryGroup(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostLibraryGroup fNextSibling
        {
            get 
            {
                try
                {
                    ...
                    return new FHostLibraryGroup(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostLibraryCollection fChildHostLibraryCollection
        {
            get
            {
                try
                {
                    return new FHostLibraryCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagHLB.E_HostLibrary));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fHlb.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostLibraryGroup);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostLibrary);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostLibrary(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
