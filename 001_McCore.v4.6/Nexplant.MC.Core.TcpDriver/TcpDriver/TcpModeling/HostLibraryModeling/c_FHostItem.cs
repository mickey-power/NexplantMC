...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostItem : FBaseObject<FHostItem>, FIObject, FIHostOperand
    {
        ...
        public FHostItem(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHIT(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostItem(
            ...
            : base(FTcpDriverCommon.createXmlNodeHIT(fTcpDriver.fTcdCore.fXmlDoc, name, fForamt, stringValue))
        {
            ...
            set
            {
                try
                {
                    ...
                    if (value == FPattern.Fixed)
                    {
                        ...
                        //***
                        //Fixed: List나 AsciiList 일 때 ArrayList가 아니어야 한다. (Json - ArrayList Convert)
                        //2020.04.22 Add by Sunghoon.Park
                        //***
                    ...
                    else if (value == FPattern.Variable)
                    {
                        ...
                        //***
                        //Variable: List나 AsciiList 일 때 ArrayList로 설정함. (Json - ArrayList Convert)
                        //2020.04.22 Add by Sunghoon.Park
                        //***
                        if (this.fFormat == FFormat.List || this.fFormat == FFormat.AsciiList)
                        {
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (fXmlNodeParent.name == FXmlTagHMG.E_HostMessage)
                    {
                        ...
                        {
                            return new FHostMessageTransfer(this.fTcdCore, fXmlNodeParent);
                        }
                        else if (messageType == FXmlTagHMG.M_HostDriverDataMessage)
                        {
                            return new FHostDriverDataMessage(this.fTcdCore, fXmlNodeParent);
                        }
                        return null;
                    }
                    return new FHostItem(this.fTcdCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItem fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItem(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItem fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItem(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fTcdCore, fHmg.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                return insertBeforeChildHostItem(
                    new FHostItem(fTcpDriver, name, fFormat, stringValue),
                    fRefChild
                    );
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fTcdCore, ((FHostMessage)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else if (fParent.fObjectType == FObjectType.HostMessageTransfer)
                {
                    this.replace(this.fTcdCore, ((FHostMessageTransfer)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else if (fParent.fObjectType == FObjectType.HostDriverDataMessage)
                {
                    this.replace(this.fTcdCore, ((FHostDriverDataMessage)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fTcdCore, ((FHostItem)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fTcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fTcpDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fTcpDriver, ((FHostItem)fParent).fParent, fParent)
                            });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostItem);
