...
--  Description     : FAMate Core FaTcpDriver Comment Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FComment : FBaseObject<FComment>, FIObject, FIFlow
    {
        ...
        public FComment(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeCMT(fTcpDriver.fTcdCore.fXmlDoc))
        {
