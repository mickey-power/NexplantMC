...
--  Description     : FAMate Core FaTcpDriver FStorage Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FStorage : FBaseObject<FStorage>, FIObject, FIFlow
    {
        ...
        public FStorage(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeSTG(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FRepository fRepository
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FRepository(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
