...
--  Description     : FAMate Core FaTcpDriver Host Trigger Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostTrigger : FBaseObject<FHostTrigger>, FIObject, FIFlow
    {
        ...
        public FHostTrigger(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHTR(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostConditionCollection fChildHostConditionCollection
        {
            get
            {
                try
                {
                    return new FHostConditionCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagHCN.E_HostCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fHcn.fXmlNode);
                }
       ...
       public FIFlow pasteSibling(
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostCondition(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
