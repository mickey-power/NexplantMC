...
--  Description     : FAMate Core FaTcpDriver Scenario Group Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FScenarioGroup : FBaseObject<FScenarioGroup>, FIObject
    {
        ...
        public FScenarioGroup(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeSNG(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FEquipment fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipment(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioGroup fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioGroup fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioCollection fChildScenarioCollection
        {
            get
            {
                try
                {
                    return new FScenarioCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagSNR.E_Scenario));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fSnr.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ScenarioGroup);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Scenario);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FScenario(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // Clone된 개체의 Lock 제거
                // ***
                fScenarioGroup = new FScenarioGroup(this.fTcdCore, this.fXmlNode.clone(true));
                // --
                xpath =
                    ". | " +
