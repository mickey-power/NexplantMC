...
--  Description     : FAMate Core FaTcpDriver Host Transfer Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostTransfer : FBaseObject<FHostTransfer>, FIObject, FITransfer
    {
        ...
        public FHostTransfer(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHTF(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostTransmitter fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransmitter(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTransfer fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransfer(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTransfer fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransfer(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostTransfer);
