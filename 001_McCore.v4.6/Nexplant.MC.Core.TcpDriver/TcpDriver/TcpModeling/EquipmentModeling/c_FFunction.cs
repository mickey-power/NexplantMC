...
--  Description     : FAMate Core FaTcpDriver FFunction Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FFunction : FBaseObject<FFunction>, FIObject
    {
        ...
        public FFunction(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeFUN(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FCallback fParent
        {
            get
            {
                try
                {
                    ...
                    return new FCallback(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunction fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunction(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunction fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunction(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionName fFunctionName
        {
            get
            {
                ...
                try
                {
                    ...
                    fXmlNodeFna = this.fTcpDriver.fXmlNode.selectSingleNode(xpath);
                    if (fXmlNodeFna == null)
                    {
                        return null;
                    }
                    ...
                    return new FFunctionName(this.fTcdCore, fXmlNodeFna);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Function);
