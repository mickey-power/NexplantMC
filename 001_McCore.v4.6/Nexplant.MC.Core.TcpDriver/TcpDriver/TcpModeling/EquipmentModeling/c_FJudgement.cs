...
--  Description     : FAMate Core FaTcpDriver Judgement Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FJudgement : FBaseObject<FJudgement>, FIObject, FIFlow
    {
        ...
        public FJudgement(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeJDM(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FJudgementConditionCollection fChildJudgementConditionCollection
        {
            get
            {
                try
                {
                    return new FJudgementConditionCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagJCN.E_JudgementCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fJdm.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.JudgementCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgementCondition(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
