...
--  Description     : FAMate Core FaTcpDriver FCallback Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FCallback : FBaseObject<FCallback>, FIObject, FIFlow
    {
        ...
        public FCallback(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeCBK(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FFunctionCollection fChildFunctionCollection
        {
            get
            {
                try
                {
                    return new FFunctionCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagFUN.E_Function));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fFun.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Function);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FFunction(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
