...
--  Description     : FAMate Core FaTcpDriver Equipment State Alterer Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FEquipmentStateAlterer : FBaseObject<FEquipmentStateAlterer>, FIObject
    {
        ...
        public FEquipmentStateAlterer(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeEAT(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetAlterer fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetAlterer(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAlterer fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateAlterer(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAlterer fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateAlterer(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateAlterer);
