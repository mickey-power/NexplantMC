...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FEquipmentStateSetAlterer : FBaseObject<FEquipmentStateSetAlterer>, FIObject, FIFlow
    {
        ...
        public FEquipmentStateSetAlterer(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeESA(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSet fEquipmentStateSet
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FEquipmentStateSet(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAltererCollection fChildEquipmentStateAltererCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateAltererCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagEAT.E_EquipmentStateAlterer));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fEat.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentStateAlterer);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateAlterer(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
