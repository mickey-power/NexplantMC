...
--  Description     : FAMate Core FaTcpDriver Host Condition Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostCondition : FBaseObject<FHostCondition>, FIObject
    {
        ...
        public FHostCondition(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHCN(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostDevice fDevice
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostDevice(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fSession
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostSession(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fMessage
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostMessage(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTrigger fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostTrigger(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostCondition fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostCondition(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostCondition fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostCondition(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostExpression(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
