...
--  Description     : FAMate Core FaTcpDriver Host Transmitter Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FHostTransmitter : FBaseObject<FHostTransmitter>, FIObject, FIFlow
    {
        ...
        public FHostTransmitter(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeHTN(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FHostTransferCollection fChildHostTransferCollection
        {
            get
            {
                try
                {
                    return new FHostTransferCollection(this.fTcdCore, this.fXmlNode.selectNodes(FXmlTagHTF.E_HostTransfer));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fHtf.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostTransfer);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostTransfer(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
