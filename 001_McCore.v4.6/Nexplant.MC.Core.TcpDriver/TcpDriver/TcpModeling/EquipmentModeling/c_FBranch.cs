...
--  Description     : FAMate Core FaTcpDriver Branch Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FBranch : FBaseObject<FBranch>, FIObject, FIFlow
    {
        ...
        public FBranch(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeBRN(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FScenario fLocation
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FScenario(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
