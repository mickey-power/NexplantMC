...
--  Description     : FAMate Core FaTcpDriver Scenario Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FScenario : FBaseObject<FScenario>, FIObject
    {
        ...
        public FScenario(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeSNR(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FScenarioGroup fParent
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenario fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenario(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenario fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenario(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFlowCollection fChildFlowCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FFlowCollection(this.fTcdCore, this.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                if (fNewChild.fFlowType == FFlowType.TcpTrigger)
                {
                    ((FTcpTrigger)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.TcpTransmitter)
                {
                    ((FTcpTransmitter)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.HostTrigger)
                {
                    ((FHostTrigger)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.HostTransmitter)
                {
                    ((FHostTransmitter)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.EquipmentStateSetAlterer)
                {
                    ((FEquipmentStateSetAlterer)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Judgement)
                {
                    ((FJudgement)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Mapper)
                {
                    ((FMapper)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Storage)
                {
                    ((FStorage)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Callback)
                {
                    ((FCallback)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Branch)
                {
                    ((FBranch)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Comment)
                {
                    ((FComment)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.Pauser)
                {
                    ((FPauser)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
                else if (fNewChild.fFlowType == FFlowType.EntryPoint)
                {
                    ((FEntryPoint)fNewChild).replace(this.fTcdCore, fXmlNodeNewChild);
                }
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                fXmlNodeNewChild = FTcpDriverCommon.getObjectXmlNode((FIObject)fNewChild);
                FTcpDriverCommon.validateNewChildObject(fXmlNodeNewChild);
                ...
                {
                    FTcpDriverCommon.resetUniqueId(this.fTcdCore.fIdPointer, fXmlNodeNewChild);
                    // --
                    this.fTcdCore.fEventPusher.pushEvent(
                        new FObjectEventArgs(FEventId.ObjectAppendCompleted, this.fTcpDriver, this, (FIObject)fNewChild)
                        );
                }
            ...
            )
        {
            ...
            {
                fXmlNodeNewChild = FTcpDriverCommon.getObjectXmlNode((FIObject)fNewChild);
                fXmlNodeRefChild = FTcpDriverCommon.getObjectXmlNode((FIObject)fRefChild);
                FTcpDriverCommon.validateNewChildObject(fXmlNodeNewChild);                
                FTcpDriverCommon.validateRefChildObject(this.fXmlNode, fXmlNodeRefChild);
                ...
                if (this.isModelingObject)
                {
                    ...
                    // --
                    this.fTcdCore.fEventPusher.pushEvent(
                        new FObjectEventArgs(FEventId.ObjectInsertBeforeCompleted, this.fTcpDriver, this, (FIObject)fNewChild)
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (this.isModelingObject)
                {
                    ...
                    // --
                    this.fTcdCore.fEventPusher.pushEvent(
                        new FObjectEventArgs(FEventId.ObjectInsertAfterCompleted, this.fTcpDriver, this, (FIObject)fNewChild)
                        );
                }
            ...
            )
        {
            try
            {
                if (fChild.fFlowType == FFlowType.TcpTrigger)
                {
                    ((FTcpTrigger)fChild).remove();
                }
                else if (fChild.fFlowType == FFlowType.TcpTransmitter)
                {
                    ((FTcpTransmitter)fChild).remove();
                }
            ...
            )
        {
            ...
            try
            {
                fXmlNodeChild = FTcpDriverCommon.getObjectXmlNode((FIObject)fChild);
                FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fXmlNodeChild);                
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNodeChild = FTcpDriverCommon.getObjectXmlNode((FIObject)fXmlNodeChild);
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fXmlNodeChild);                    
                }
            ...
            )
        {
            try
            {
                ...
                {
                    if (fFlw.fFlowType == FFlowType.TcpTrigger)
                    {
                        ((FTcpTrigger)fFlw).resetRelation();
                    }
                    else if (fFlw.fFlowType == FFlowType.TcpTransmitter)
                    {
                        ((FTcpTransmitter)fFlw).resetRelation();
                    }
            ...
            )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Scenario);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    if (fXmlNodeFlw.name == FXmlTagTTR.E_TcpTrigger)
                    {
                        FTcpTrigger.resetFlowNode(fXmlNodeFlw);
                    }
                    else if (fXmlNodeFlw.name == FXmlTagTTN.E_TcpTransmitter)
                    {
                        FTcpTransmitter.resetFlowNode(fXmlNodeFlw);
                    }
        ...
        public FTcpTrigger selectSingleTcpTriggerByName(
            string name
            )
        {
            const string xpath = FXmlTagTTR.E_TcpTrigger + "[@" + FXmlTagTTR.A_Name + "='{0}']";
            ...
            try
            {
                ...
                return new FTcpTrigger(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public FTcpTransmitter selectSingleTcpTransmitterByName(
            string name
            )
        {
            const string xpath = FXmlTagTTN.E_TcpTransmitter + "[@" + FXmlTagTTN.A_Name + "='{0}']";
            ...
            try
            {
                ...
                return new FTcpTransmitter(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostTrigger(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostTransmitter(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateSetAlterer(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgement(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FMapper(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FStorage(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FCallback(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FBranch(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FPauser(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FComment(this.fTcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // Clone된 개체의 Lock 제거
                // ***
                fScenario = new FScenario(this.fTcdCore, this.fXmlNode.clone(true));
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FIFlow fIFlow in fSourceScenario.fChildFlowCollection)
                {
                    ...
                    if (fIFlow.fFlowType == FFlowType.TcpTransmitter)
                    {
                        fIChildFlow = new FTcpTransmitter(this.fTcdCore, ((FTcpTransmitter)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.TcpTrigger)
                    {
                        fIChildFlow = new FTcpTrigger(this.fTcdCore, ((FTcpTrigger)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.HostTransmitter)
                    {
                        fIChildFlow = new FHostTransmitter(this.fTcdCore, ((FHostTransmitter)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.HostTrigger)
                    {
                        fIChildFlow = new FHostTrigger(this.fTcdCore, ((FHostTrigger)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.EquipmentStateSetAlterer)
                    {
                        fIChildFlow = new FEquipmentStateSetAlterer(this.fTcdCore, ((FEquipmentStateSetAlterer)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Judgement)
                    {
                        fIChildFlow = new FJudgement(this.fTcdCore, ((FJudgement)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Mapper)
                    {
                        fIChildFlow = new FMapper(this.fTcdCore, ((FMapper)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Storage)
                    {
                        fIChildFlow = new FStorage(this.fTcdCore, ((FStorage)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Callback)
                    {
                        fIChildFlow = new FCallback(this.fTcdCore, ((FCallback)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Branch)
                    {
                        fIChildFlow = new FBranch(this.fTcdCore, ((FBranch)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Comment)
                    {
                        fIChildFlow = new FComment(this.fTcdCore, ((FComment)fIFlow).fXmlNode.clone(true));
                    }
                    else if (fIFlow.fFlowType == FFlowType.Pauser)
                    {
                        fIChildFlow = new FPauser(this.fTcdCore, ((FPauser)fIFlow).fXmlNode.clone(true));
                    }
                    // --
