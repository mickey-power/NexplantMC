...
--  Description     : FAMate Core FaTcpDriver JudgementExpression Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FJudgementExpression : FBaseObject<FJudgementExpression>, FIObject
    {
        ...
        public FJudgementExpression(
            ...
            : base(fTcpDriver.fTcdCore, FTcpDriverCommon.createXmlNodeJEP(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FData fOperand
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FData(this.fTcdCore, this.fTcpDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FJudgementCondition(this.fTcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FJudgementExpression(this.fTcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpression fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementExpression(this.fTcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpression fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementExpression(this.fTcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FTcpDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.JudgementExpression);
