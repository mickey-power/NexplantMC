...
--  Description     : FAMate Core FaTcpDriver TID Storage Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    internal class FTidStorage : IDisposable
    {
        ...
        private string makeKey(
            UInt64 deviceUniqueId, 
            UInt64 sessionUniqueId, 
            UInt64 messageUniqueId
            )
        {
            try
            {
                return string.Format(KeyFormat, deviceUniqueId, sessionUniqueId, messageUniqueId);
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                ...
                key = makeKey(deviceUniqueId, sessionUniqueId, messageUniqueId);
                // --        
            ...
            )
        {
            try
            {
                return m_storage.ContainsKey(makeKey(deviceUniqueId, sessionUniqueId, messageUniqueId));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
