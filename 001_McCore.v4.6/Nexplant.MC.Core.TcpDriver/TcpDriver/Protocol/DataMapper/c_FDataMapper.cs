...
--  Description     : FAMate Core FaTcpDriver Data Mapper Class 
    ...
    internal static class FDataMapper
    {
           ...
           )
        {
            try
            {
                ...
                // --
                fScenarioData.fResourceData.setEapName(fScenarioData.fTcdCore.fTcpDriver.eapName);
                fScenarioData.fResourceData.setEquipmentName(fScenarioData.fEquipment.name);
                // --
                if (fScenarioData.fDataMessageReceivedLog != null)
                {
                    if (fScenarioData.fDataMessageReceivedLog.fMessageLogType == FMessageLogType.TcpDeviceDataMessageReceivedLog)
                    {
                        fScenarioData.fResourceData.setTcpDeviceName(((FTcpDeviceDataMessageReceivedLog)fScenarioData.fDataMessageReceivedLog).deviceName);
                        fScenarioData.fResourceData.setTcpSessionName(((FTcpDeviceDataMessageReceivedLog)fScenarioData.fDataMessageReceivedLog).sessionName);
                        fScenarioData.fResourceData.setTcpSessionId(((FTcpDeviceDataMessageReceivedLog)fScenarioData.fDataMessageReceivedLog).sessionId.ToString());
                    }
                ...
                else if (fScenarioData.fIObjectLog != null)
                {
                    ...
                    // Device State Change
                    // ***
                    if (fScenarioData.fIObjectLog.fObjectLogType == FObjectLogType.TcpDeviceStateChangedLog)
                    {
                        fScenarioData.fResourceData.setTcpDeviceName(fScenarioData.fIObjectLog.name);
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                return fScenarioData.fTcdCore.fTcpDriver.fXmlNode.selectSingleNode(xpath);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return fScenarioData.fTcdCore.fTcpDriver.fXmlNode.selectNodes(xpath);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private static FXmlNodeList collectTcpItemLogByGlobalScan(
            FScenarioData fScenarioData,
            string titlName
            )
        {
            const string TcpItemLogQuery =
                ".//" + FXmlTagTITL.E_TcpItem + "[@" + FXmlTagTITL.A_Name + "='{0}']";
            ...
            try
            {
                xpath = string.Format(TcpItemLogQuery, titlName);
                return ((FTcpDeviceDataMessageReceivedLog)fScenarioData.fDataMessageReceivedLog).fXmlNode.selectNodes(xpath);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private static FXmlNodeList collectTcpItemLogByLocalScan(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeParentTitl,
            string titlName
            )
        {
            const string TcpItemLogQuery1 =
                "../" + FXmlTagTITL.E_TcpItem + "[@" + FXmlTagTITL.A_UniqueId + "='{0}' and @" + FXmlTagTITL.A_Name + "='{1}'] | " +
                ".//" + FXmlTagTITL.E_TcpItem + "[@" + FXmlTagTITL.A_Name + "='{1}']";
            // --
            const string TcpItemLogQuery2 =
                ".//" + FXmlTagTITL.E_TcpItem + "[@" + FXmlTagTITL.A_Name + "='{0}']";

            // --

            FXmlNodeList fXmlNodeListTitl = null;
            FXmlNode fXmlNodeParent = null;
            string uniqueId = string.Empty;
            string xpath = string.Empty;
            ...
            {
                // ***
                // Parent가 존재하지 않을 경우 전체 TCP Item Log 목록을 검색한다.
                // ***
                if (fXmlNodeParentTitl == null)
                {
                    return collectTcpItemLogByGlobalScan(fScenarioData, titlName);
                }

                // --

                // ***
                // 부모 TCP Item Log 검색에서 조회되지 않을 경우, 조상 TCP Item Log에서 조회한다.
                // ***
                fXmlNodeParent = fXmlNodeParentTitl;
                if (fXmlNodeParent.name == FXmlTagTITL.E_TcpItem)
                {
                    uniqueId = fXmlNodeParent.get_attrVal(FXmlTagTITL.A_UniqueId, FXmlTagTITL.D_UniqueId);
                }

                // --
                
                while (
                    fXmlNodeParent.name == FXmlTagTMGL.E_TcpMessage ||
                    fXmlNodeParent.name == FXmlTagTITL.E_TcpItem
                    )
                {
                    if (
                        fXmlNodeParent.get_attrVal(FXmlTagTITL.A_UniqueId, FXmlTagTITL.D_UniqueId) == uniqueId &&
                        fXmlNodeParent.get_attrVal(FXmlTagTITL.A_Name, FXmlTagTITL.D_Name) == titlName
                        )
                    {
                        xpath = string.Format(TcpItemLogQuery1, uniqueId, titlName);
                    }
                    else
                    {
                        xpath = string.Format(TcpItemLogQuery2, titlName);
                    }

                    // --

                    fXmlNodeListTitl = fXmlNodeParent.selectNodes(xpath);
                    if (fXmlNodeListTitl.count > 0)
                    {
                        return fXmlNodeListTitl;
                    }
        ...
        private static FXmlNodeList collectTcpItemLogByVariable(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeParentTitl,
            string titlName
            )
        {
            const string TcpItemLogQuery = ".//" + FXmlTagTITL.E_TcpItem + "[@" + FXmlTagTITL.A_Name + "='{0}']";
            ...
            try
            {
                ...
                return fXmlNodeParentTitl.selectNodes(string.Format(TcpItemLogQuery, titlName));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private static int calculateTcpItemLogRawBytes(
            ...
            )
        {
            ...
            try
            {
                ...
                length = int.Parse(fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Length, FXmlTagTITL.D_Length));
                ...
                if (fFormat == FFormat.List || fFormat == FFormat.AsciiList)
                {
                    ...
                    {
                        rawBytes += calculateTcpItemLogRawBytes(x);
                    }
                }
                else
                {
        ...
        private static string getTcpItemLogValueBySourceType(
            ...
            )
        {
            try
            {
                ...
                {
                    return fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_UserTag1, FXmlTagTITL.D_UserTag1);
                }
                else if (fSourceType == FDataSourceType.ItemTag2)
                {
                    return fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_UserTag2, FXmlTagTITL.D_UserTag2);
                }
                else if (fSourceType == FDataSourceType.ItemTag3)
                {
                    return fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_UserTag3, FXmlTagTITL.D_UserTag3);
                }
                else if (fSourceType == FDataSourceType.ItemTag4)
                {
                    return fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_UserTag4, FXmlTagTITL.D_UserTag4);
                }
                else if (fSourceType == FDataSourceType.ItemTag5)
                {
                    return fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_UserTag5, FXmlTagTITL.D_UserTag5);
                }   
                // --
                return string.Empty;
            }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Receive된 TCP 메시지 또는 Host 메시지 Mapping
                // ***
                if (fScenarioData.hasDataMessageReceivedLog)
                {
                    if (fScenarioData.fDataMessageReceivedLog.fMessageLogType == FMessageLogType.TcpDeviceDataMessageReceivedLog)
                    {
                        fXmlNodeDtsl = generateDataSetLogByTcpMessageLog(fScenarioData, fXmlNodeDtsl);
                    }
                    else
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeDatl in fXmlNodeDtsl.selectNodes(xpath))
                {
                    ...
                    else if (fResourceSourceType == FResourceSourceType.TcpDeviceName)
                    {
                        val = fScenarioData.fResourceData.tcpDeviceName;
                    }
                    else if (fResourceSourceType == FResourceSourceType.TcpSessionName)
                    {
                        val = fScenarioData.fResourceData.tcpSessionName;
                    }
                    else if (fResourceSourceType == FResourceSourceType.TcpSessionId)
                    {
                        val = fScenarioData.fResourceData.tcpSessionId;
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeDatl in fXmlNodeDtsl.selectNodes(xpath))
                {
                    ...
                    fEquipmentStateMaterial = fScenarioData.fTcdCore.fEquipmentStateMaterialStorage.getEquipmentStateMaterial(eqpUniqueId, estUniqueId);
        ...
        private static FXmlNode generateDataSetLogByTcpMessageLog(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeDts
            )
        {
            Dictionary<string, int[]> gTitlPositionKey = null;            // TCP Item Log Name, Position (0-Item, 1-Item Tag1, 2-item Tag2, 3-Item Tag3, 4-Item Tag4, 5-Item Tag5)
            Dictionary<string, FXmlNodeList> gTitlPositionData = null;    // TCP Item Log Name, OPC Item Log Node List 
            FXmlNode fXmlNodeDtsl = null;

            try
            {
                gTitlPositionKey = new Dictionary<string, int[]>();
                gTitlPositionData = new Dictionary<string, FXmlNodeList>();

                // --

                fXmlNodeDtsl = fXmlNodeDts.clone(false);
                // --
                generateDataLogByTcpItemLog(
                    fScenarioData,
                    fXmlNodeDtsl,
                    fXmlNodeDts.selectNodes(FXmlTagDAT.E_Data),
                    gTitlPositionKey,
        ...
        private static void generateDataLogByTcpItemLog(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeParent,
            FXmlNodeList fXmlNodeListDat,
            Dictionary<string, int[]> gTitlPositionKey,
            Dictionary<string, FXmlNodeList> gTitlPositionData,
            FXmlNode fXmlNodeParentTitl
            )
        {
            FXmlNode fXmlNodeDat = null;
            ...
            int datCount = 0;
            int index = 0;
            Dictionary<string, int[]> titlPositionKey = null;
            Dictionary<string, FXmlNodeList> titlPositionData = null;
            Dictionary<string, int> varNameCount = null;
            Dictionary<string, int> fixNameCount = null;
            int titlPos = 0;
            FDataSourceType fSourceType;
            string titlName = string.Empty;
            FFormat fFormat;
            FPattern fPattern;
            int fixedLength = 0;
            FDataScanMode fScanMode;
            ...
            {
                // ***
                // 동일한 이름의 TCP Item Log가 사용된 회수를 보관하기 위한 Storage 생성
                // ***
                titlPositionKey = new Dictionary<string, int[]>();
                titlPositionData = new Dictionary<string, FXmlNodeList>();
                datCount = fXmlNodeListDat.count;
                ...
                while (index < datCount)
                {
                    ...
                    if (fPattern == FPattern.Fixed)
                    {
                        ...
                        fScanMode = FEnumConverter.toDataScanMode(fXmlNodeDat.get_attrVal(FXmlTagDAT.A_ScanMode, FXmlTagDAT.D_ScanMode));
                        titlName = fXmlNodeDat.get_attrVal(FXmlTagDAT.A_SourceItem, FXmlTagDAT.D_SourceItem);
                        // --
                        if (fScanMode == FDataScanMode.Local)
                        {
                            if (titlPositionKey.ContainsKey(titlName))
                            {
                                if (fSourceType == FDataSourceType.Item)
                                {
                                    titlPos = titlPositionKey[titlName][0];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag1)
                                {
                                    titlPos = titlPositionKey[titlName][1];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag2)
                                {
                                    titlPos = titlPositionKey[titlName][2];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag3)
                                {
                                    titlPos = titlPositionKey[titlName][3];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag4)
                                {
                                    titlPos = titlPositionKey[titlName][4];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag5)
                                {
                                    titlPos = titlPositionKey[titlName][5];
                                }
                                // --
                                fXmlNodeListTitl = titlPositionData[titlName];
                            }
                            else
                            {
                                titlPos = 0;
                                fXmlNodeListTitl = collectTcpItemLogByLocalScan(fScenarioData, fXmlNodeParentTitl, titlName);
                                // --
                                titlPositionKey.Add(titlName, new int[] { 0, 0, 0, 0, 0, 0 });
                                titlPositionData.Add(titlName, fXmlNodeListTitl);
                            }
                        }
                        else
                        {
                            if (gTitlPositionKey.ContainsKey(titlName))
                            {
                                if (fSourceType == FDataSourceType.Item)
                                {
                                    titlPos = gTitlPositionKey[titlName][0];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag1)
                                {
                                    titlPos = gTitlPositionKey[titlName][1];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag2)
                                {
                                    titlPos = gTitlPositionKey[titlName][2];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag3)
                                {
                                    titlPos = gTitlPositionKey[titlName][3];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag4)
                                {
                                    titlPos = gTitlPositionKey[titlName][4];
                                }
                                else if (fSourceType == FDataSourceType.ItemTag5)
                                {
                                    titlPos = gTitlPositionKey[titlName][5];
                                }
                                // --
                                fXmlNodeListTitl = gTitlPositionData[titlName];
                            }
                            else
                            {
                                titlPos = 0;
                                fXmlNodeListTitl = collectTcpItemLogByGlobalScan(fScenarioData, titlName);
                                // --
                                gTitlPositionKey.Add(titlName, new int[] { 0, 0, 0, 0, 0, 0 });
                                gTitlPositionData.Add(titlName, fXmlNodeListTitl);
                            }
                        }
                        ...
                        for (int i = 0; i < fixedLength; i++)
                        {
                            ...
                            // ***
                            // Fixed일 경우 TCP Item Log Position이 초과할 경우 다시 순환시킨다.
                            // ***
                            if (fXmlNodeListTitl.count == 0)
                            {
                                fXmlNodeTitl = null;
                            ...
                            {
                                if (titlPos >= fXmlNodeListTitl.count)
                                {
                                    titlPos = 0; // 순환
                                }
                                fXmlNodeTitl = fXmlNodeListTitl[titlPos];
                                titlPos++;
                                ...
                                if (fScanMode == FDataScanMode.Local)
                                {
                                    if (fSourceType == FDataSourceType.Item)
                                    {
                                        titlPositionKey[titlName][0] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag1)
                                    {
                                        titlPositionKey[titlName][1] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag2)
                                    {
                                        titlPositionKey[titlName][2] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag3)
                                    {
                                        titlPositionKey[titlName][3] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag4)
                                    {
                                        titlPositionKey[titlName][4] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag5)
                                    {
                                        titlPositionKey[titlName][5] = titlPos;
                                    }
                                }
                                else
                                {
                                    if (fSourceType == FDataSourceType.Item)
                                    {
                                        gTitlPositionKey[titlName][0] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag1)
                                    {
                                        gTitlPositionKey[titlName][1] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag2)
                                    {
                                        gTitlPositionKey[titlName][2] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag3)
                                    {
                                        gTitlPositionKey[titlName][3] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag4)
                                    {
                                        gTitlPositionKey[titlName][4] = titlPos;
                                    }
                                    else if (fSourceType == FDataSourceType.ItemTag5)
                                    {
                                        gTitlPositionKey[titlName][5] = titlPos;
                                    }
                                }
                            }
                            ...
                            else
                            {
                                ...
                                else if (fFormat == FFormat.Unknown)
                                {
                                        ...
                                        )
                                    {
                                        ...
                                        val = getTcpItemLogValueBySourceType(fSourceType, fXmlNodeTitl);
                                        len = 0;
                                        // --
                                        val = FValueConverter.fromStringValue(FFormat.Ascii, val, out len);
                                    ...
                                    {
                                        // ***
                                        // Data Log의 Format를 TCP Item Log Format으로 설정
                                        // ***
                                        // --
                                        // ***
                                        // 2017.03.23 by spike.lee
                                        // fFormat를 fItemFormat으로 변경
                                        // ***
                                        fItemFormat = FEnumConverter.toFormat(fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Format, FXmlTagTITL.D_Format));
                                        fXmlNodeDatl.set_attrVal(FXmlTagDATL.A_Format, FXmlTagDATL.D_Format, FEnumConverter.fromFormat(fItemFormat));
                                        ...
                                        if (fItemFormat == FFormat.List || fItemFormat == FFormat.AsciiList)
                                        {
                                            // ***
                                            // 2017.03.23 by spike.lee
                                            // fXmlNodeTgt를 fXmlNodeDatl에 Append하고 generteDataLogByTcpItemLog에서 또 Append하여 Item이 2배 생성되는 문제 발생
                                            // Unknown Foramt Data인 경우 하위 Child Data에 _(Depth)를 붙여 이름을 Generate
                                            // ***
                                            len = 0;
                                            // genName = fXmlNodeSrc.get_attrVal(FXmlTagDATL.A_Name, FXmlTagDATL.D_Name) + "_";
                                            ...
                                            foreach (FXmlNode x in fXmlNodeTitl.selectNodes(FXmlTagTITL.E_TcpItem))
                                            {
                                                ...
                                                fXmlNodeTgt.set_attrVal(
                                                    ...
                                                    x.get_attrVal(FXmlTagTITL.A_Name, FXmlTagTITL.D_Name)
                                                    );
                                                // ***
                                                // fXmlNodeTgt = fXmlNodeDatl.appendChild(fXmlNodeTgt);
                                                // ***
                                        ...
                                        else if (fItemFormat == FFormat.Raw)
                                        {
                                            fXmlNodeDatl.set_attrVal(
                                                FXmlTagDATL.A_Length,
                                                FXmlTagDATL.D_Length,
                                                fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Length, FXmlTagTITL.D_Length)
                                                );
                                        }
                                        else if (fItemFormat != FFormat.Unknown)
                                        {
                                            ...
                                            // fFormat를 fItemFormat으로 변경
                                            // ***
                                            len = int.Parse(fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Length, FXmlTagTITL.D_Length));
                                            val = FValueConverter.toDataConversionStringValue(
                                                fItemFormat,
                                ...
                                else if (fFormat == FFormat.Raw)
                                {
                                    ...
                                    {
                                        len = calculateTcpItemLogRawBytes(fXmlNodeTitl);
                                    }
                                    // --
                                    fXmlNodeDatl.set_attrVal(FXmlTagDATL.A_Length, FXmlTagDATL.D_Length, len.ToString());
                                }
                                else
                                {
                                    ...
                                    {
                                        val = FValueConverter.toDataConversionStringValue(
                                            FEnumConverter.toFormat(fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Format, FXmlTagTITL.D_Format)),
                                            fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Value, FXmlTagTITL.D_Value),
                                            fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_Transformer, FXmlTagTITL.D_Transformer),
                                            fXmlNodeTitl.get_attrVal(FXmlTagTITL.A_DataConversionSetExpression, FXmlTagTITL.D_DataConversionSetExpression)
                                            );
                    ...
                    else  // Variable
                    {
                        ...
                        for (int i = index; i < datCount; i++)
                        {
                            ...
                            // ***
                            fPattern = FEnumConverter.toPattern(fXmlNodeSrc.get_attrVal(FXmlTagDAT.A_Pattern, FXmlTagDAT.D_Pattern));
                            titlName = fXmlNodeSrc.get_attrVal(FXmlTagDAT.A_SourceItem, FXmlTagDAT.D_SourceItem);
                            // --
                            if (fPattern == FPattern.Variable)
                            {
                                if (varNameCount.ContainsKey(titlName))
                                {
                                    varNameCount[titlName] = varNameCount[titlName] + 1;
                                }
                                else
                                {
                                    varNameCount.Add(titlName, 1);
                                    fixNameCount.Add(titlName, 0);
                                }
                                varLen++;
                                ...
                                {
                                    titlPositionKey.Add(titlName, new int[] { 0, 0, 0, 0, 0, 0 });
                                    titlPositionData.Add(titlName, collectTcpItemLogByVariable(fScenarioData, fXmlNodeParentTitl, titlName));
                                }
                            }
                            else
                            {
                                ...
                                // ***
                                fScanMode = FEnumConverter.toDataScanMode(fXmlNodeSrc.get_attrVal(FXmlTagDAT.A_ScanMode, FXmlTagDAT.D_ScanMode));
                                if (fScanMode == FDataScanMode.Local && fixNameCount.ContainsKey(titlName))
                                {
                                    fixLen = int.Parse(fXmlNodeSrc.get_attrVal(FXmlTagDATL.A_FixedLength, FXmlTagDATL.D_FixedLength));
                                    fixNameCount[titlName] = fixNameCount[titlName] + fixLen;
                                }
                            }
                        }
                        ...
                        foreach (string s in varNameCount.Keys)
                        {
                            if (fSourceType == FDataSourceType.Item)
                            {
                                calVarCnt = titlPositionKey[s][0];
                            }
                            else if (fSourceType == FDataSourceType.ItemTag1)
                            {
                                calVarCnt = titlPositionKey[s][1];
                            }
                            else if (fSourceType == FDataSourceType.ItemTag2)
                            {
                                calVarCnt = titlPositionKey[s][2];
                            }
                            else if (fSourceType == FDataSourceType.ItemTag3)
                            {
                                calVarCnt = titlPositionKey[s][3];
                            }
                            else if (fSourceType == FDataSourceType.ItemTag4)
                            {
                                calVarCnt = titlPositionKey[s][4];
                            }
                            else if (fSourceType == FDataSourceType.ItemTag5)
                            {
                                calVarCnt = titlPositionKey[s][5];
                            }

                            // --

                            calVarCnt = (titlPositionData[s].count - calVarCnt - fixNameCount[s]) / varNameCount[s];
                            if (calVarCnt < 1)
                            {
                                varCnt = 0;
                                break;
                        ...
                        for (int i = 0; i < varCnt; i++)
                        {
                            for (int j = 0; j < varLen; j++)
                            {
                                ...
                                fFormat = FEnumConverter.toFormat(fXmlNodeDat.get_attrVal(FXmlTagDAT.A_Format, FXmlTagDAT.D_Format));
                                // --
                                titlName = fXmlNodeDat.get_attrVal(FXmlTagDATL.A_SourceItem, FXmlTagDATL.D_SourceItem);
                                // --
                                if (fSourceType == FDataSourceType.Item)
                                {
                                    titlPos = titlPositionKey[titlName][0];
                                ...
                                // --
                                fXmlNodeTitl = titlPositionData[titlName][titlPos];
                                titlPos++;
            ...
            finally
            {
                fXmlNodeDat = null;
                fXmlNodeDatl = null;
                fXmlNodeListTitl = null;
                fXmlNodeTitl = null;
                fXmlNodeSrc = null;
                fXmlNodeTgt = null;
                titlPositionKey = null;
                titlPositionData = null;
                varNameCount = null;
                fixNameCount = null;
            }
        }
        ...
        #region TcpMessageTransfer Generation Methods

        public static FXmlNode generateTcpMessageTransfer(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeDtsl,
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeTmt = fXmlNodeTmg.clone(false);
                // --
                generateTcpItemByDataLog(
                    fScenarioData,
                    fXmlNodeTmt,
                    fXmlNodeTmg.selectNodes(FXmlTagTIT.E_TcpItem),
                    gDatlPositionKey,
                    gDatlPositionData,
                    null
                    );
        ...
        private static void generateTcpItemByDataLog(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeParent,
            ...
            )
        {
            ...
            try
            {
                ...
                hitCount = fXmlNodeListTit.count;

                // --

                while (index < hitCount)
                {
                    fXmlNodeTit = fXmlNodeListTit[index];
                    ...
                    if (fPattern == FPattern.Fixed)
                    {
                        ...
                        fScanMode = FEnumConverter.toDataScanMode(fXmlNodeTit.get_attrVal(FXmlTagTIT.A_ScanMode, FXmlTagTIT.D_ScanMode));
                        datlName = fXmlNodeTit.get_attrVal(FXmlTagTIT.A_Name, FXmlTagTIT.D_Name);
                        // --
                        if (fScanMode == FDataScanMode.Local)
                        {
                        ...
                        fixedLength = int.Parse(fXmlNodeTit.get_attrVal(FXmlTagTIT.A_FixedLength, FXmlTagTIT.D_FixedLength));
                        // --
                        for (int i = 0; i < fixedLength; i++)
                        {
                            fXmlNodeTit2 = fXmlNodeParent.appendChild(fXmlNodeTit.clone(false));
                            fXmlNodeTit2.set_attrVal(FXmlTagTIT.A_FixedLength, FXmlTagTIT.D_FixedLength, "1");
                            ...
                            else
                            {
                                ...
                                else if (fFormat == FFormat.Unknown)
                                {
                                    ...
                                    // Unknown TCP Item 복제
                                    // ***
                                    fXmlNodeSrc = fXmlNodeTit.clone(false);

                                    // --

                                    // ***
                                    // TCP Item의 Format를 Data Log Format으로 설정
                                    // ***
                                    // --
                                    // ***
                                    // 2017.03.23 by spike.lee
                                    ...
                                    fXmlNodeTit2.set_attrVal(FXmlTagTIT.A_Format, FXmlTagTIT.D_Format, FEnumConverter.fromFormat(fItemFormat));
                                    ...
                                    if (fItemFormat == FFormat.List || fItemFormat == FFormat.AsciiList)
                                    {
                                        ...
                                        {
                                            fXmlNodeTgt = fXmlNodeSrc.clone(false);
                                            fXmlNodeTgt.set_attrVal(FXmlTagTIT.A_FixedLength, FXmlTagTIT.D_FixedLength, "1");
                                            fXmlNodeTgt.set_attrVal(
                                                FXmlTagTIT.A_Name,
                                                FXmlTagTIT.D_Name,
                                            ...
                                            // ***
                                            // fXmlNodeTgt = fXmlNodeTit2.appendChild(fXmlNodeTgt);
                                            // ***
                                            // --
                                            generateTcpItemByDataLog(
                                                fScenarioData,
                                        ...
                                        // --
                                        fXmlNodeTit2.set_attrVal(FXmlTagTIT.A_Length, FXmlTagTIT.D_Length, len.ToString());
                                    }
                                    else if (fItemFormat == FFormat.Raw)
                                    {
                                        fXmlNodeTit2.set_attrVal(
                                            FXmlTagTIT.A_Length,
                                            FXmlTagTIT.D_Length,
                                    ...
                                    else if (fItemFormat != FFormat.Unknown)
                                    {
                                        ...
                                        // --
                                        fXmlNodeTit2.set_attrVal(FXmlTagTIT.A_Value, FXmlTagTIT.D_Value, val);
                                        fXmlNodeTit2.set_attrVal(FXmlTagTIT.A_Length, FXmlTagTIT.D_Length, len.ToString());
                                    }
                                }
                                else if (fFormat == FFormat.Raw)
                        ...
                        // ***
                        // Parent가 TCP Item일 경우 Length 설정
                        // ***
                        if (fixedLength > 1 || fXmlNodeParent.name == FXmlTagTIT.E_TcpItem)
                        {
                            len = int.Parse(fXmlNodeParent.get_attrVal(FXmlTagTIT.A_Length, FXmlTagTIT.D_Length)) + fixedLength - 1;
                            fXmlNodeParent.set_attrVal(FXmlTagTIT.A_Length, FXmlTagTIT.D_Length, len.ToString());
                        }
                    ...
                    else  // Variable
                    {
                        ...
                        {
                            fXmlNodeSrc = fXmlNodeListTit[i];

                            // --

                            // ***
                            // 1. Previous TCP Item은 Fixed 형식으로 처리
                            // 2. Variable TCP Item은 연속적으로 정의되어 있어 우선 처리
                            // 3. Next TCP Item은 Variable TCP Item 처리 이후 Fixed 형식으로 처리
                            // ***
                            fPattern = FEnumConverter.toPattern(fXmlNodeSrc.get_attrVal(FXmlTagTIT.A_Pattern, FXmlTagTIT.D_Pattern));
                            datlName = fXmlNodeSrc.get_attrVal(FXmlTagTIT.A_Name, FXmlTagTIT.A_Name);
                            // --
                            if (fPattern == FPattern.Variable)
                            {
                            ...
                            {
                                // ***
                                // Scan Mode가 Global인 TCP Item는 Variable 계산에 미포함
                                // ***
                                fScanMode = FEnumConverter.toDataScanMode(fXmlNodeSrc.get_attrVal(FXmlTagTIT.A_ScanMode, FXmlTagTIT.D_ScanMode));
                                if (fScanMode == FDataScanMode.Local && fixNameCount.ContainsKey(datlName))
                                {
                                    fixLen = int.Parse(fXmlNodeSrc.get_attrVal(FXmlTagTIT.A_FixedLength, FXmlTagTIT.D_FixedLength));
                        ...
                        for (int i = 0; i < varCnt; i++)
                        {
                            for (int j = 0; j < varLen; j++)
                            {
                                fXmlNodeTit = fXmlNodeListTit[index + j];
                                fFormat = FEnumConverter.toFormat(fXmlNodeTit.get_attrVal(FXmlTagTIT.A_Format, FXmlTagTIT.D_Format));
                                // --
                                datlName = fXmlNodeTit.get_attrVal(FXmlTagTIT.A_Name, FXmlTagTIT.D_Name);
                                datlPos = datlPositionKey[datlName];
                                ...
                                fXmlNodeTit2 = fXmlNodeParent.appendChild(fXmlNodeTit.clone(false));
                                fXmlNodeTit2.set_attrVal(FXmlTagTIT.A_Pattern, FXmlTagTIT.D_Pattern, FEnumConverter.fromPattern(FPattern.Fixed));
                                ...
                                else if (fFormat == FFormat.Unknown)
                                {
                                    ...
                                    if (fItemFormat == FFormat.List || fItemFormat == FFormat.AsciiList)
                                    {
                                        ...
                                        {
                                            fXmlNodeTgt = fXmlNodeSrc.clone(false);
                                            fXmlNodeTgt.set_attrVal(FXmlTagTIT.A_Pattern, FXmlTagTIT.D_Pattern, FEnumConverter.fromPattern(FPattern.Fixed));
                                            fXmlNodeTgt.set_attrVal(
                                                FXmlTagTIT.A_Name,
                                                FXmlTagTIT.D_Name,
                                                x.get_attrVal(FXmlTagDATL.A_TargetItem, FXmlTagDATL.D_TargetItem)
                                            ...
                                            // ***
                                            // fXmlNodeTgt = fXmlNodeTit.appendChild(fXmlNodeTgt);
                                            // ***
                                            // --
                                            generateTcpItemByDataLog(
                                                fScenarioData,
                        ...
                        // ***
                        // Parent가 TCP Item일 경우 추가된 Variable TCP Item 만큼 Length 증가
                        // ***
                        if (fXmlNodeParent.name == FXmlTagTIT.E_TcpItem)
                        {
                            len = int.Parse(fXmlNodeParent.get_attrVal(FXmlTagTIT.A_Length, FXmlTagTIT.D_Length)) + ((varCnt - 1) * varLen);
                            fXmlNodeParent.set_attrVal(FXmlTagTIT.A_Length, FXmlTagTIT.D_Length, len.ToString());
                        }
