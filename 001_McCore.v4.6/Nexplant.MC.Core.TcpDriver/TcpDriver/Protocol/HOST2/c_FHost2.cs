...
--  Description     : FAMate Core FaTcpDriver Host2 Parser Class
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    internal static class FHost2
    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fXmlNodeHsn == null)
                {
                    ...
                    // Not Define Session
                    // ***
                    fXmlNodeHmgl = FTcpDriverLogCommon.createXmlNodeHMGL(fTcd.fTcdCore.fXmlDoc);
                ...
                if (fXmlNodeRepHmg == null)
                {
                    ...
                    // --
                    fXmlNodeListHmg = fTcd.fXmlNode.selectNodes(xpath);
                    // --
                ...
                if (fXmlNodeHmg == null)
                {
                    fXmlNodeHmgl = FTcpDriverLogCommon.createXmlNodeHMGL(fTcd.fTcdCore.fXmlDoc);
                    setHostMessageLogInfo(fXmlNodeHmgl, fHdv.fXmlNode, fXmlNodeHsn, fHdmg.machineId, fHdmg.sessionId, fHdmg.command, 0, fHdmg.fHostMessageType, fHdmg.tid);
                    fXmlNodeHmgl.set_attrVal(FXmlTagTMGL.A_Name, FXmlTagTMGL.D_Name, "Undefined");
                    // --
                    generateHdmgToHmg(fXmlNodeHmgl, fHdmg);
                    // --
                    fResultCode = FResultCode.Warninig;
        ...
        private static void parseHdmgToHit(
            ...
            FXmlNodeList fXmlNodeListHit1,      // Host Message Log Item
            ...
            )
        {
            ...
            try
            {
                fXmlNodeHmg = fTcd.fXmlNode.selectSingleNode(
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeListHcn = fTcd.fXmlNode.selectNodes(xpath);
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeHcn in fXmlNodeListHcn)
                {
                    ...
                    {
                        compareCondition(fTcd, fXmlNodeHmgl, fXmlNodeHep, ref result);
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fExpressionType == FExpressionType.Bracket)
                {
                    ...
                    {
                        compareCondition(fTcd, fXmlNodeHmgl, fXmlNodeChild, ref newResult);
                    }
