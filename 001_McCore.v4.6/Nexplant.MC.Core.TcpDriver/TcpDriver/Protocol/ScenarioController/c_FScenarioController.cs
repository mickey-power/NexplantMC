...
--  Description     : FAMate Core FaTcpDriver Scenario Controller Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    internal static class FScenarioController
    {
            ...
            )
        {
            ...
            try
            {
                if (fLastEventArgs.fTcpEventId == FEventId.TcpTriggerRaised)
                {
                    fScenarioData = ((FTcpTriggerRaisedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.TcpTransmitterRaised)
                {
                    fScenarioData = ((FTcpTransmitterRaisedEventArgs)fLastEventArgs).fScenarioData;
                    ...
                    // Send Transfer
                    // ***
                    sendTcpMessageTransfer(fScenarioData);
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.HostTriggerRaised)
                {
                    fScenarioData = ((FHostTriggerRaisedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.HostTransmitterRaised)
                {
                ...
                else if (fLastEventArgs.fTcpEventId == FEventId.EquipmentStateSetAltererPerformed)
                {
                    fScenarioData = ((FEquipmentStateSetAltererPerformedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.JudgementPerformed)
                {
                    fScenarioData = ((FJudgementPerformedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.MapperPerformed)
                {
                    fScenarioData = ((FMapperPerformedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.StoragePerformed)
                {
                    fScenarioData = ((FStoragePerformedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.CallbackRaised)
                {
                ...
                else if (fLastEventArgs.fTcpEventId == FEventId.FunctionCalled)
                {
                    // ***
                ...
                else if (fLastEventArgs.fTcpEventId == FEventId.BranchRaised)
                {
                    fScenarioData = ((FBranchRaisedEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.CommentWritten)
                {
                    fScenarioData = ((FCommentWrittenEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.EntryPointCalled)
                {
                    fScenarioData = ((FEntryPointCalledEventArgs)fLastEventArgs).fScenarioData;
                }
                else if (fLastEventArgs.fTcpEventId == FEventId.PauserRaised)
                {
                    // ***
                ...
                if (fScenarioData.fNextFlow.fFlowType == FFlowType.TcpTransmitter)
                {
                    executeTcpTransmitter(fScenarioData);
                }
        ...
        public static void executeTcpTransmitter(
            FScenarioData fScenarioData
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushTcpTransmitterRaisedEvent(
                    FResultCode.Success,
                    string.Empty,
                    ((FTcpTransmitter)fScenarioData.fNextFlow).fXmlNode,
                    fScenarioData,
                    true
                    );
            }
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushEquipmentStateSetAltererPerformedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushJudgementPerformedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushHostTransmitterRaisedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushMapperPerformedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushStoragePerformedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushCallbackRaisedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushFunctionCalledEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushBranchRaisedEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushCommentWrittenEvent(
                    FResultCode.Success,
                    string.Empty,
            ...
            )
        {
            try
            {
                fScenarioData.fTcdCore.fEventPusher.pushPauserRaisedEvent(
                    FResultCode.Success,
                    string.Empty,
        ...
        public static void sendTcpMessageTransfer(
            FScenarioData fScenarioData
            )
        {
            FTcpTransfer fTtf = null;
            ...
            try
            {
                ...
                {
                    fTtf = (FTcpTransfer)fScenarioData.fTransferCollection[i].fTransfer;
                    fTmt = (FTcpMessageTransfer)fScenarioData.fTransferCollection[i].fMessageTransfer;                    

                    // --

                    // ***
                    // Reply TCP Message 전송 시, Last Command TCP Message Tid를 설정한다.
                    // ***
                    if (fTmt.fTcpMessageType == FTcpMessageType.Reply && !fTmt.hasTid)
                    {
                        if (fScenarioData.fTcdCore.fProtocolAgent.fTcpTidStorage.getTid(fTtf.fDevice.uniqueId, fTtf.fSession.uniqueId, fTmt.uniqueId, ref tid))
                        {
                            fTmt.setTid(tid);
                        }
                    }
                    ...
                    try
                    {
                        fTmt.send(fTtf.fSession);
                    }
                    catch (Exception inEx)
                    {
                        procTcpMessageTransferSendError(
                            fScenarioData.fTcdCore.fEventPusher,
                            fTtf.fSession.fParent,
                            fTtf.fSession,
                            fTmt,
                            inEx.Message
                            );
        ...
        private static void procTcpMessageTransferSendError(
            ...
            )
        {
            ...
            try
            {
                fXmlNodeTmgl = fTmt.fXmlNode.clone(true);
                // --
                if (fTcpDevice.fProtocol == FProtocol.CUSTOM_001)
                {
                    FCustom001_2.setTcpMessageLogInfo(fXmlNodeTmgl, fTcpDevice.fXmlNode, fTcpSession.fXmlNode);
                }                

                // --

                fLog = fEventPusher.createTcpDeviceDataMessageSentLog(fTcpSession.fXmlNode, fXmlNodeTmgl);
                fEventPusher.pushTcpDeviceDataMessageSentEvent(fTcpDevice, FResultCode.Error, errorMessage, fLog);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                for (int i = 0; i < fScenarioData.fTransferCollection.count; i++)
                {
                    ...
                    {
                        if (fScenarioData.fTcdCore.fProtocolAgent.fHostTidStorage.getTid(fHtf.fDevice.uniqueId, fHtf.fSession.uniqueId, fHmt.uniqueId, ref tid))
                        {
                            fHmt.setTid(tid);
                        }
                    }
