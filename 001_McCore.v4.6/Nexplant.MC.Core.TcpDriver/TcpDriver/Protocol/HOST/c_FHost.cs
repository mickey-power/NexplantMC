...
--  Description     : FAMate Core FaTcpDriver Host Class 
    ...
    internal class FHost : IDisposable
    {
        ...
        public FTcdCore fTcdCore
        {
            get
            {
                try
                {
                    return m_fHostProtocol.fTcdCore;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEventPusher fEventPusher
        {
            get
            {
                try
                {
                    return m_fHostProtocol.fTcdCore.fEventPusher;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FTcpDriver fTcpDriver
        {
            get
            {
                try
                {
                    return m_fHostProtocol.fTcdCore.fTcpDriver;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                m_fTranDataMessage = new FHostOpenTransaction(this.fTcpDriver, m_transactionTimeout);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNodeHtrList = FHost2.parseConnectionTrigger(this.fTcpDriver, this.fHostDevice.fXmlNode, fState);
                    // --

                    fLog = new FHostDeviceStateChangedLog(
                        FTcpDriverLogCommon.createXmlNodeHDVL(this.fHostDevice.fXmlNode, FXmlTagHDVL.L_StateChanged)
                        );
            ...
            )
        {
            ...
            try
            {
                ...
                this.fHostDriver.send(new FHostDriverDataMessage(this.fTcdCore, fXmlNodeHdmg));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                // --
                if (fTcpDriver.fTcdCore.fConfig.enabledEventsOfHostDeviceState)
                {
            ...
            try
            {
                ...
                if (fHdmg.fHostMessageType == FHostMessageType.Reply)
                {
                    ...
                    if (fTranLog != null)
                    {
                        ...
                        fXmlNodeHmg = FHost2.getReplyMessage(this.fTcpDriver, fXmlNodeHsn, fTranLog.uniqueIdToString);
                    }
                }
                ...
                if (
                    this.fTcdCore.fConfig.enabledLogOfVfei ||
                    this.fTcdCore.fConfig.enabledEventsOfHostDeviceVfei
                    )
                {
                    // ***
                    // VFEI Parsing
                    ...
                    // ***
                    if (this.fTcdCore.fConfig.enabledLogOfVfei)
                    {
                        this.fTcdCore.fLogWriter.pushVfeiLog(
                    ...
                    if (this.fTcdCore.fConfig.enabledEventsOfHostDeviceVfei)
                    {
                ...
                if (fResultCode == FResultCode.Success)
                {
                    if (fLog.fHostMessageType == FHostMessageType.Command || fLog.fHostMessageType == FHostMessageType.Unsolicited)
                    {
                        ...
                        {
                            fXmlNodeHmg = FHost2.getReplyMessage(this.fTcpDriver, fXmlNodeHsn, fLog.uniqueIdToString);
                            if (fXmlNodeHmg != null)
                            {
                                fHmg = new FHostMessage(this.fTcdCore, fXmlNodeHmg);
                            }
                        }                        

                        // --

                        if (fTcpDriver.fTcdCore.fConfig.enabledEventsOfHostDeviceDataMessage)
                        {
                        ...
                        if (fHmg != null)
                        {
                            if (fHmg.autoReply)
                            {
                                ...
                                FTcpDriverCommon.setHostItemRandomValue(fHmt.fXmlNode);

                                // --

                                this.sendDataMessage(new FHostSession(this.fTcdCore, fXmlNodeHsn), fHmt);
                            }
                            else
                            {
                                // ***
                    ...
                    if (fTcdCore.fConfig.enabledEventsOfScenario)
                    {
                        if (fResultCode == FResultCode.Success)
                        {
                            fXmlNodeHtrList = FHost2.parseExpressionTrigger(this.fTcpDriver, fXmlNodeHmgl);
                            foreach (FXmlNode fXmlNodeHtr in fXmlNodeHtrList)
                            {
                                this.fEventPusher.pushHostTriggerRaisedEvent(
                                    FResultCode.Success,
            ...
            )
        {
            ...
            try
            {
                while ((fLog = m_fTranDataMessage.getTimeoutTransaction()) != null)
                {
                    ...
                    if (fTcdCore.fConfig.enabledEventsOfScenario)
                    {
                        fXmlNodeHtrList = FHost2.parseTimeoutTrigger(this.fTcpDriver, fLog.fXmlNode, ref fXmlNodeRetryHcn);
                        foreach (FXmlNode fXmlNodeHtr in fXmlNodeHtrList)
                        {
                            this.fEventPusher.pushHostTriggerRaisedEvent(
                                FResultCode.Success,
            ...
            )
        {
            ...
            try
            {
                ...
                fHcn = new FHostCondition(this.fTcdCore, fXmlNodeHcn);
            ...
            )
        {
            try
            {
                ...
                // --
                if (this.fTcdCore.fConfig.enabledEventsOfHostDeviceError)
                {
            ...
            )
        {
            ...
            try
            {
                fXmlNodeListHcn = FHost2.getRetryCondition(this.fTcpDriver, fXmlNodeHmgl);
