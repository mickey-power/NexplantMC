...
--  Description     : FAMate Core FaTcpDriver Equipment State Material Storage Class 
    ...
    public class FEquipmentStateMaterialStorage : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fEsm == null)
                {
                    fEstNode = m_fTcdCore.fTcpDriver.fXmlNode.selectSingleNode(string.Format(EquipmentsStateQuery, estUniqueId));
                    if (fEstNode != null)
                    {
                        // --
                        ...
                        if (defaultState != FXmlTagEST.D_DefaultValue)
                        {
                            ...
                            this.fTcdCore.fEquipmentStateMaterialStorage.add(fEsm);
                        }                        
                    }
                }
