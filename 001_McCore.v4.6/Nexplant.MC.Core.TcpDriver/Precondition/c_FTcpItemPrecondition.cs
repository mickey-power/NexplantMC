...
{
    public class FTcpItemPrecondition : FIPrecondition, IDisposable
    {
        ...
        public FIPreconditionValueCollection fPreconditionValueCollection
        {
            get
            {
                try
                {
                    return new FTcpItemPreconditionValueCollection(m_fTit.fXmlNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                val = m_fTit.fXmlNode.get_attrVal(FXmlTagTIT.A_Precondition, FXmlTagTIT.D_Precondition);
                if (val == string.Empty)
                {
            ...
            )
        {
            try
            {
                m_fTit.fXmlNode.set_attrVal(
                    FXmlTagTIT.A_Precondition,
                    FXmlTagTIT.D_Precondition,
