...
--
--  Program Id      : c_FXmlTagHIT.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaTcpDriver Host Item XML Tag Definition Class 
...
{
    internal static class FXmlTagHIT
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Item Element and Attribute 
        // ***
        public const string E_HostItem = "HIT";
        // --
        ...
        public const string A_ArrayList = "AL";
        public const string A_ScanMode = "SM";
        public const string A_Value = "V";
        public const string A_Length = "L";
        public const string A_RandomValue = "RD";
        public const string A_RandomValueMin = "MN";
        public const string A_RandomValueMax = "MX";
        public const string A_Transformer = "TF";
        public const string A_Precondition = "PC";
        public const string A_ReservedWord = "RW";
        public const string A_Extraction = "ET";
        ...
        public const string D_ArrayList = "";
        public const string D_ScanMode = "L";
        public const string D_Value = "";
        public const string D_Length = "0";
        public const string D_RandomValue = "F";
        public const string D_RandomValueMin = "0";
        public const string D_RandomValueMax = "0";
        public const string D_Transformer = "";
        public const string D_Precondition = "";
        public const string D_ReservedWord = "";
        public const string D_Extraction = "F";
