...
--
--  Program Id      : c_FXmlTagTSN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.10
--  Description     : FAMate Core FaTcpDriver TCP Session Modeling XML Tag Definition Class 
...
{
    internal static class FXmlTagTSN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Session Element and Attribute 
        // ***
        public const string E_TcpSession = "TSN";
        // --
        ...
        public const string A_TcpLibraryId = "LI";       
        ...
        public const string D_TcpLibraryId = "";       
