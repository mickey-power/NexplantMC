...
--
--  Program Id      : c_FXmlTagTTF.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaTcpDriver TCP Transfer XML Tag Definition Class 
...
{
    internal static class FXmlTagTTF
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Transfer Element and Attribute 
        // ***
        public const string E_TcpTransfer = "TTF";
        // --
