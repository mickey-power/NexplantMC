...
--
--  Program Id      : c_FXmlTagTTR.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaTcpDriver TCP Trigger XML Tag Definition Class 
...
{
    internal static class FXmlTagTTR
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Trigger Element and Attribute 
        // ***
