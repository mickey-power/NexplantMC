...
--
--  Program Id      : c_FXmlTagTCN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaTcpDriver TCP Condition XML Tag Definition Class 
...
{
    internal static class FXmlTagTCN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Condition Element and Attribute 
        // ***
        public const string E_TcpCondition = "TCN";
        // --
        ...
        public const string A_TcpMessageId = "MI";        
        ...
        public const string D_TcpDeviceId = "";
        public const string D_TcpSessionId = "";
        public const string D_TcpMessageId = "";      
