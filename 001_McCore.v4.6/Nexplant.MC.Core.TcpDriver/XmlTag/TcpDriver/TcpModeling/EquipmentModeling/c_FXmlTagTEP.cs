...
--
--  Program Id      : c_FXmlTagTEP.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaTcpDriver TCP Expression XML Tag Definition Class 
...
{
    internal static class FXmlTagTEP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Expression Element and Attribute 
        // ***
        public const string E_TcpExpression = "TEP";
        // --
