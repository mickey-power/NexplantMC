...
--
--  Program Id      : c_FXmlTagCBK.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaTcpDriver Callback XML Tag Definition Class 
...
{
    internal static class FXmlTagCBK
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Callback Element and Attribute 
        // ***
