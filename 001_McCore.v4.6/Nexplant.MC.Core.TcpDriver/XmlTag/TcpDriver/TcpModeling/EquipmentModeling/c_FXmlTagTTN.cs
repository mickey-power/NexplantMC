...
--
--  Program Id      : c_FXmlTagTTN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaTcpDriver TCP Transmitter XML Tag Definition Class 
...
{
    internal static class FXmlTagTTN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Transmitter Element and Attribute 
        // ***
