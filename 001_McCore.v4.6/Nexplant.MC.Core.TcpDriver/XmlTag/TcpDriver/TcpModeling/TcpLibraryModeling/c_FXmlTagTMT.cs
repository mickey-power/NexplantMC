...
--
--  Program Id      : c_FXmlTagTMT.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.30
--  Description     : FAMate Core FaTcpDriver TCP Message Transfer XML Tag Definition Class 
...
{
    internal static class FXmlTagTMT
    {
        ...
        // ***
        // TCP Message Transfer Element and Attribute 
        // ***
