...
--
--  Program Id      : c_FXmlTagTLG.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.11
--  Description     : FAMate Core FaTcpDriver TCP Library Group XML Tag Definition Class 
...
{
    internal static class FXmlTagTLG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Library Group Element and Attribute 
        // ***
        public const string E_TcpLibraryGroup = "TLG";
        // --
