...
--
--  Program Id      : c_FXmlTagTMS.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.10.29
--  Description     : FAMate Core FaTcpDriver TCP Messages XML Tag Definition Class 
...
{
    internal static class FXmlTagTMS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Messages Element and Attribute 
        // ***
        public const string E_TcpMessages = "TMS";
        // --
