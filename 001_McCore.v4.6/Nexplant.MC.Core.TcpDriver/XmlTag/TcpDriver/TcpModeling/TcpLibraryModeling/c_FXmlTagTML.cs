...
--
--  Program Id      : c_FXmlTagTML.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaTcpDriver TCP Message List XML Tag Definition Class 
...
{
    internal static class FXmlTagTML
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Message List Element and Attribute 
        // ***
        public const string E_TcpMessageList = "TML";
        // --
