...
--
--  Program Id      : c_FXmlTagTLB.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.11
--  Description     : FAMate Core FaTcpDriver TCP Library XML Tag Definition Class 
...
{
    internal static class FXmlTagTLB
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Library Element and Attribute 
        // ***
        public const string E_TcpLibrary = "TLB";
        // --
