...
--
--  Program Id      : c_FXmlTagTMG.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.29
--  Description     : FAMate Core FaTcpDriver TCP Message XML Tag Definition Class 
...
{
    internal static class FXmlTagTMG
    {
        ...
        // ***
        // TCP Message Element and Attribute 
        // ***
