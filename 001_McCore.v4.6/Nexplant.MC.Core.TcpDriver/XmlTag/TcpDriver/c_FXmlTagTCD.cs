...
--
--  Program Id      : c_FXmlTagTCD.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.09
--  Description     : FAMate Core FaTcpDriver TCP Driver XML Tag Definition Class 
...
{
    internal static class FXmlTagTCD
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Driver Element and Attribute 
        // ***
