...
--
--  Program Id      : c_FXmlTagTCDL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.28
--  Description     : FAMate Core FaTcpDriver TCP Driver Log XML Tag Definition Class 
...
{
    internal static class FXmlTagTCDL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCD Driver Log Element and Attribute 
        // ***
        public const string E_TcpDriver = "TCD";
        // --
