...
--
--  Program Id      : c_FXmlTagTTNL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.27
--  Description     : FAMate Core FaTcpDriver TCP Transmitter Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagTTNL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Transmitter Raised Log Element and Attribute 
        // ***
        public const string E_TcpTransmitter = "TTN";
        // --
