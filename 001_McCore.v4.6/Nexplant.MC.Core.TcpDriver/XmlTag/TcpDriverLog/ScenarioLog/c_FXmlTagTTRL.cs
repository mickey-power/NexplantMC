...
--
--  Program Id      : c_FXmlTagTTRL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.26
--  Description     : FAMate Core FaTcpDriver TCP Trigger Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagTTRL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Trigger Raised Log Element and Attribute 
        // ***
        public const string E_TcpTrigger = "TTR";
        // --
