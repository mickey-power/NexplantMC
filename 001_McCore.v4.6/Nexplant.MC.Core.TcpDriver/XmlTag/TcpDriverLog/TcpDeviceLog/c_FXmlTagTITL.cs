...
--
--  Program Id      : c_FXmlTagTITL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaTcpDriver TCP Item Log XML Tag Definition Class 
...
{
    internal static class FXmlTagTITL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Item Element and Attribute 
        // ***
        public const string E_TcpItem = "TIT";
        // --
        ...
        public const string A_Result = "RT";
