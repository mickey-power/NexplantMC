...
--
--  Program Id      : c_FXmlTagTDEL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.09
--  Description     : FAMate Core FaTcpDriver TCP Device Error Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagTDEL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // TCP Device Error Log Element and Attribute 
        // ***
        public const string E_TcpDeviceError = "TDE";        
        // --
