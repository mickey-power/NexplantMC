...
--  Description     : FAMate Core FaTcpDriver Application Written Log Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FApplicationWrittenLog : FBaseObjectLog<FApplicationWrittenLog>, FIObjectLog
    {
        ...
        public FApplicationWrittenLog(      
            ...
            : base(FTcpDriverLogCommon.createXmlNodeAPPL(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FApplicationWrittenLog(
            ...
            : base(FTcpDriverLogCommon.createXmlNodeAPPL(fTcpDriver.fTcdCore.fXmlDoc, name))
        {
