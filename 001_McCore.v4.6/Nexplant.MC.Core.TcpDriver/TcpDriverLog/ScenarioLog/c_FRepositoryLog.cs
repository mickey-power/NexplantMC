...
--  Description     : FAMate Core FaTcpDriver Repository Log Class 
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FStoragePerformedLog(this.fTcdlCore, fXmlNodeParent);
                    }
        ...
        public FRepositoryLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryLog(this.fTcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryLog(this.fTcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
