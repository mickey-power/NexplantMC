...
--  Description     : FAMate Core FaTcpDriver Mapper Performed Log Class 
    ...
    public class FMapperPerformedLog : FBaseObjectLog<FMapperPerformedLog>, FIObjectLog
    {
        ...
        public FDataSetLogCollection fChildDataSetLogCollection
        {
            get
            {
                try
                {
                    return new FDataSetLogCollection(this.fTcdlCore, this.fXmlNode.selectNodes(FXmlTagDTSL.E_DataSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataSetLog(this.fTcdlCore, fXmlNodeDstl);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
