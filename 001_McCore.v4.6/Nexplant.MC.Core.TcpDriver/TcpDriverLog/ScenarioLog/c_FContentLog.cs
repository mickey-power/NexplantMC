...
--  Description     : FAMate Core FaTcpDriver Content Log Class 
...
namespace Nexplant.MC.Core.FaTcpDriver
{
    public class FContentLog : FBaseObjectLog<FContentLog>, FIObjectLog
    {
        ...
        public FContentLog(      
            ...
            : base(FTcpDriverLogCommon.createXmlNodeCTTL(fTcpDriver.fTcdCore.fXmlDoc))
        {
        ...
        public FContentLog(
            ...
            : base(FTcpDriverLogCommon.createXmlNodeCTTL(fTcpDriver.fTcdCore.fXmlDoc, name, fFormat, stringValue))
        {
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FApplicationWrittenLog(this.fTcdlCore, fXmlNodeParent);
                    }
                    return new FContentLog(this.fTcdlCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FContentLog(this.fTcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FContentLog(this.fTcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLogCollection fChildContentLogCollection
        {
            get
            {
                try
                {
                    return new FContentLogCollection(this.fTcdlCore, this.fXmlNode.selectNodes(FXmlTagCTTL.E_Content));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fTcdlCore, this.fXmlNode.appendChild(fNewChild.fXmlNode));
            ...
            )
        {
            try
            {
                return appendChildContentLog(new FContentLog(fTcpDriver, name, fFormat, stringValue));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fTcdlCore, this.fXmlNode.insertBefore(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                return insertBeforeChildContentLog(
                    new FContentLog(fTcpDriver, name, fFormat, stringValue),
                    fRefChild
                    );
            }
            catch (Exception ex)
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fTcdlCore, this.fXmlNode.insertAfter(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                ...
                {
                    FTcpDriverCommon.validateRemoveChildObject(this.fXmlNode, fCttl.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fTcdlCore, ((FApplicationWrittenLog)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fTcdlCore, ((FContentLog)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
