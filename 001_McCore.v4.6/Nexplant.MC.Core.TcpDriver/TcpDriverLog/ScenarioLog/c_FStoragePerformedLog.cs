...
--  Description     : FAMate Core FaTcpDriver Storage Performed Log Class 
    ...
    public class FStoragePerformedLog : FBaseObjectLog<FStoragePerformedLog>, FIObjectLog
    {
        ...
        public FRepositoryLogCollection fChildRepositoryLogCollection
        {
            get
            {
                try
                {
                    return new FRepositoryLogCollection(this.fTcdlCore, this.fXmlNode.selectNodes(FXmlTagRPSL.E_Repository));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FRepositoryLog(this.fTcdlCore, fXmlNodeRpsl);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
