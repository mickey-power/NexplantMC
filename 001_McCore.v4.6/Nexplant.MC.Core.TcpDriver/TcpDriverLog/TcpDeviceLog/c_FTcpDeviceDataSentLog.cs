...
--
--  Program Id      : c_FTcpDeviceDataSentLog.cs
--  Creator         : spike.lee
--  Create Date     : 2016.04.15
--  Description     : FAMate Core FaSecsDriver TCP Device Data Sent Log Class 
...
{
    public class FTcpDeviceDataSentLog : FTcpDeviceLog<FTcpDeviceDataSentLog>
    {
        ...
        internal FTcpDeviceDataSentLog(      
            FXmlNode fXmlNode            
            )
            : base(fXmlNode)
        {
        ...
        public override FObjectLogType fObjectLogType
        {
            get
            {
                try
                {
                    return FObjectLogType.TcpDeviceDataSentLog;
                }
                catch (Exception ex)
                {
