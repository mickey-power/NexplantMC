...
--
--  Program Id      : c_FFileCreatedTimeDescComparer.cs
--  Creator         : byungyun.jeon
--  Create Date     : 2012.03.16
--  Description     : FAMate Core FaCommon File Created Time Descending Order Comparer Class
...
{
    class FFileCreatedTimeDescComparer : IComparer, IDisposable
    {
        ...
        public FFileCreatedTimeDescComparer(
            )
        {
