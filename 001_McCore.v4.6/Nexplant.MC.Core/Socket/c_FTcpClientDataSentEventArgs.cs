...
--
--  Program Id      : c_FTcpClientDataSentEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2011.08.24
--  Description     : FAMate Core FaCommon FTcpClient Data Sent Event Arguments Class
--  History         : Created by spike.lee at 2011.08.24
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    [Serializable]
    public class FTcpClientDataSentEventArgs : FSocketEventArgsBase
    {
        ...
        internal FTcpClientDataSentEventArgs(
            FTcpClient fOwnerTcpClient,
            FSocketSendData fData
            ) 
            : base (FSocketEventId.TcpClientDataSent)
        {
