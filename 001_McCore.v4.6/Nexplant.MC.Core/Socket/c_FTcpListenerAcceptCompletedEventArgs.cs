...
--
--  Program Id      : c_FTcpListenerAcceptCompletedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2011.08.18
--  Description     : FAMate Core FaCommon FTcpListener Accept Completed Event Arguments Class
...
{
    [Serializable]
    public class FTcpListenerAcceptCompletedEventArgs : FSocketEventArgsBase
    {
        ...
        internal FTcpListenerAcceptCompletedEventArgs(
            FTcpListener fOwnerTcpListener,
            FTcpClient fTcpClient
            ) 
            : base (FSocketEventId.TcpListenerAcceptCompleted)
        {
