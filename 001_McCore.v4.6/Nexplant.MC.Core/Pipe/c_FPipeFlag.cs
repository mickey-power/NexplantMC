...
--
--  Program Id      : c_FPipeFlag.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.15
--  Description     : FAMate Core FaCommon Pipe Flag Class
--  History         : Created by spike.lee at 2011.09.15
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public class FPipeFlag : IDisposable
    {
            ...
            )
        {
            try
            {
                while (!this.doConnectCompleted || !this.doSendCompleted || !this.doReceiveCompleted)
                {
                    System.Threading.Thread.Sleep(1);
                }
            }
