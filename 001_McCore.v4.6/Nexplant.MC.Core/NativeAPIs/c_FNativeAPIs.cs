...
--
--  Program Id      : c_FNativeAPIs.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.13
--  Description     : FAMate Core FaCommon Native APIs Definition Class 
...
namespace Nexplant.MC.Core.FaCommon
{
    ...
    public static class FNativeAPIs
    {
        ...
        /// MF_GRAYED
        /// </summary>
        public const uint MF_DISABLE = 0x00000001;
        //------------------------------------------------------------------------------------------------------------------------
        ...
        public enum FWinMsgs : int
        {
            ...
            WM_NCLBUTTONDOWN = 0x00A1,      // Left Mouse Button Down
        ...
        public enum FWinStyles : int
        {
            ...
            WS_CAPTION = 0x00C00000,    // Caption (Title Bar) Enable
            WS_BORDER = 0x00800000,     // Border Enable
        ...
        public enum FCredUIReturnCodes
        {
            NO_ERROR = 0,
        ...
        public static extern int SendMessage(IntPtr hWnd, FWinMsgs Msg, FNCHITTEST wParam, int lParam);
        ...
        public static extern int ShellExecute(IntPtr hWnd, string operation, string file, string parameter, string directory, int nShowCmd);
        ...
        public static extern IntPtr SendMessage(IntPtr hWnd, UInt32 Msg, IntPtr wParam, ref FNativeAPIs.COPYDATASTRUCT lParam);
        ...
        [DllImport("credui.dll", CharSet = CharSet.Auto)]
        public static extern FCredUIReturnCodes CredUIPromptForCredentials(
            ref AUTH_INFO authInfo,
            string targetName,
            IntPtr reserved1,
            int authError,
        ...
        [DllImport("credui.dll", CharSet = CharSet.Auto)]
        public static extern FCredUIReturnCodes CredUIParseUserName(
            string userName,
            StringBuilder user,
            int userMaxChars,
        ...
        public static void DisableQuickEdit()
        {
            ...
            {
                Console.WriteLine("Disable QuickEdit Getmode Fail");
            ...
            {
                Console.WriteLine("Disable QuickEdit Setmode Fail");
        ...
        public static void EnableQuickEdit()
        {
            ...
            if (!GetConsoleMode(conHandle, out mode))
            {
                Console.WriteLine("Enable QuickEdit Getmode Fail");
                // error getting the console mode. Exit. 
                return;
            }
            ...
            if (!SetConsoleMode(conHandle, mode))
            {
                Console.WriteLine("Enable QuickEdit Setmode Fail");
                // error setting console mode. 
            }
        }
...

        {
            ...
            EnableMenuItem(sysMenu, SC_CLOSE, (uint)(MF_ENABLED | (enabled ? MF_ENABLED : MF_DISABLE)));
        }
