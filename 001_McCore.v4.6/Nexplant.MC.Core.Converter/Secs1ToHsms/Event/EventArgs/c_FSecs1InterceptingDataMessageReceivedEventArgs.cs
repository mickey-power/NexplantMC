...
--
--  Program Id      : c_FSecs1InterceptingDataMessageReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.17
--  Description     : FAmate Converter FaSecs1ToHsms SECS1 Intercepting Data Message Received Event Arguments Class
--  History         : Created by spike.lee at 2017.04.17
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    [Serializable]
    public class FSecs1InterceptingDataMessageReceivedEventArgs : FEventArgsBase
    {
        ...
        internal FSecs1InterceptingDataMessageReceivedEventArgs(
