...
--
--  Program Id      : c_FHsmsTimeoutRaisedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.12
--  Description     : FAmate Converter FaSecs1ToHsms HSMS Timeout Raised Event Arguments Class
...
{
    [Serializable]
    public class FHsmsTimeoutRaisedEventArgs : FEventArgsBase
    {
        ...
        internal FHsmsTimeoutRaisedEventArgs(
