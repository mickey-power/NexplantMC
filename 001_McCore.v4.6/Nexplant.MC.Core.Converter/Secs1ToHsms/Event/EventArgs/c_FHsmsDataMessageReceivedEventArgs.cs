...
--
--  Program Id      : c_FHsmsDataMessageReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.12
--  Description     : FAmate Converter FaSecs1ToHsms HSMS Data Message Received Event Arguments Class
...
{
    [Serializable]
    public class FHsmsDataMessageReceivedEventArgs : FEventArgsBase
    {
        ...
        internal FHsmsDataMessageReceivedEventArgs(
