...
--
--  Program Id      : c_FSecs1DataMessageReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.10
--  Description     : FAmate Converter FaSecs1ToHsms SECS1 Data Message Received Event Arguments Class
...
{
    [Serializable]
    public class FSecs1DataMessageReceivedEventArgs : FEventArgsBase
    {
        ...
        internal FSecs1DataMessageReceivedEventArgs(
