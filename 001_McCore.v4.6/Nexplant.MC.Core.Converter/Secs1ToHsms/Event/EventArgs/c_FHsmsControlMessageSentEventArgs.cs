...
--
--  Program Id      : c_FHsmsControlMessageSentEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.11
--  Description     : FAmate Converter FaSecs1ToHsms HSMS Control Message Sent Event Arguments Class
...
{
    [Serializable]
    public class FHsmsControlMessageSentEventArgs : FEventArgsBase
    {
        ...
        internal FHsmsControlMessageSentEventArgs(
