...
--
--  Program Id      : c_FSecs1DataMessageSentEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.10
--  Description     : FAmate Converter FaSecs1ToHsms SECS1 Data Message Sent Event Arguments Class
...
{
    [Serializable]
    public class FSecs1DataMessageSentEventArgs : FEventArgsBase
    {
        ...
        internal FSecs1DataMessageSentEventArgs(
