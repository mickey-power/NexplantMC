...
--
--  Program Id      : c_FSecs1HandshakeReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.10
--  Description     : FAmate Converter FaSecs1ToHsms SECS1 Handshake Received Event Arguments Class
...
{
    [Serializable]
    public class FSecs1HandshakeReceivedEventArgs : FEventArgsBase
    {
        ...
        internal FSecs1HandshakeReceivedEventArgs(
