...
--
--  Program Id      : c_FHsmsInterceptingDataMessageReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.17
--  Description     : FAmate Converter FaSecs1ToHsms HSMS Intercepting Data Message Received Event Arguments Class
...
{
    [Serializable]
    public class FHsmsInterceptingDataMessageReceivedEventArgs : FEventArgsBase
    {
        ...
        internal FHsmsInterceptingDataMessageReceivedEventArgs(
