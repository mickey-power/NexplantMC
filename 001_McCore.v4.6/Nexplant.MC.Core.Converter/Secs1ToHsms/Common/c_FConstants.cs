...
namespace Nexplant.MC.Core.FaSecs1ToHsms
{
    internal static class FConstants
    {
        ...
        /// </summary>
        #endregion
        public const string err_m_0062 = "{0} transmission failed.";
        ...
        #region Comments
        /// <summary>
        /// The received data ({0}) is not valid.
        /// </summary>
        #endregion
        public const string err_m_16001 = "The received data (0x{0,2:X2}) is not valid.";
        ...
        #region Comments
        /// <summary>
        /// The Block Length ({0}) is invalid.
        /// </summary>
        #endregion
        public const string err_m_16012 = "The Block Length ({0}) is invalid.";
        ...
        #region Comments
        /// <summary>
        /// T4 inter-block timeout occurred. (SessionId={0}, S{1}F{2}, SystemBytes={3})
        /// </summary>
        #endregion
        public const string err_m_20004 = "T4 inter-block timeout occurred. (S{0}F{1}, SID={2}, SB={3})";
