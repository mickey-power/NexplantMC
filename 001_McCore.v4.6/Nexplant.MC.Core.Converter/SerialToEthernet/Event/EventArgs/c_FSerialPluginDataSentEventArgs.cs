...
--
--  Program Id      : c_FSerialPluginDataSentEventArgs.cs
--  Creator         : mjkim
--  Create Date     : 2020.02.26
--  Description     : FAmate Converter FaSerialToEthernet Serial Data Sent Event Arguments Class
...
{
    [Serializable]
    public class FSerialPluginDataSentEventArgs : FEventArgsBase
    {
        ...
        private FSerialSendData m_fSerialData = null;

        //------------------------------------------------------------------------------------------------------------------------

        #region Class Construction and Destruction

        internal FSerialPluginDataSentEventArgs(
            FSerialToEthernet fSerialToEthernet,
            FEventId fEventId,
            FResultCode fResult,
            string errorMessage,
            FSerialSendData fSerialData
            )
        ...
        public FSerialSendData fSerialData
        {
            get
            {
                try
