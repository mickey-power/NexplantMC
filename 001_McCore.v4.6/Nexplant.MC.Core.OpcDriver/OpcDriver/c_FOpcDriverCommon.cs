...
--
--  Program Id      : c_FOpcDriverCommon.cs
--  Creator         : spike.lee
--  Create Date     : 2015.06.16
--  Description     : FAMate Core FaOpcDriver OPC Driver Common Function Class 
...
{
    internal static class FOpcDriverCommon
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNode.set_attrVal(FXmlTagFAM.A_FileFormat, FXmlTagFAM.D_FileFormat, "OSM");
                fXmlNode.set_attrVal(FXmlTagFAM.A_FileVersion, FXmlTagFAM.D_FileVersion, "4.5.0.1");
                ...
                fXmlNode.set_attrVal(FXmlTagFAM.A_FileDescription, FXmlTagFAM.D_FileDescription, "FAMate OPC Modeling File");
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOCD(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOCD.E_OpcDriver);
                // --
                fXmlNode.set_attrVal(FXmlTagOCD.A_UniqueId, FXmlTagOCD.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOCD.A_Locked, FXmlTagOCD.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOCD.A_Name, FXmlTagOCD.D_Name, "OpcDriver");
                fXmlNode.set_attrVal(FXmlTagOCD.A_Description, FXmlTagOCD.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOCD.A_FontColor, FXmlTagOCD.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOCD.A_FontBold, FXmlTagOCD.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOCD.A_EapName, FXmlTagOCD.D_EapName, "MC");
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOLB(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOLB.E_OpcLibrary);
                // --
                fXmlNode.set_attrVal(FXmlTagOLB.A_UniqueId, FXmlTagOLB.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOLB.A_Locked, FXmlTagOLB.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOLB.A_Name, FXmlTagOLB.D_Name, "OpcLibrary");
                fXmlNode.set_attrVal(FXmlTagOLB.A_Description, FXmlTagOLB.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOLB.A_FontColor, FXmlTagOLB.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOLB.A_FontBold, FXmlTagOLB.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOLB.A_Comment, FXmlTagOLB.D_Comment, FXmlTagOLB.D_Comment);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOLG(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOLG.E_OpcLibraryGroup);
                // --
                fXmlNode.set_attrVal(FXmlTagOLG.A_UniqueId, FXmlTagOLG.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOLG.A_Locked, FXmlTagOLG.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOLG.A_Name, FXmlTagOLG.D_Name, "OpcLibraryGroup");
                fXmlNode.set_attrVal(FXmlTagOLG.A_Description, FXmlTagOLG.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOLG.A_FontColor, FXmlTagOLG.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOLG.A_FontBold, FXmlTagOLG.D_FontBold, FBoolean.False);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNode.set_attrVal(FXmlTagONL.A_ObjectType, FXmlTagONL.D_ObjectType, FObjectType.OpcDriver.ToString());
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOSN(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOSN.E_OpcSession);
                // --
                fXmlNode.set_attrVal(FXmlTagOSN.A_UniqueId, FXmlTagOSN.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOSN.A_Locked, FXmlTagOSN.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOSN.A_Name, FXmlTagOSN.D_Name, "OpcSession");
                fXmlNode.set_attrVal(FXmlTagOSN.A_Description, FXmlTagOSN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOSN.A_FontColor, FXmlTagOSN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOSN.A_FontBold, FXmlTagOSN.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOSN.A_SessionId, FXmlTagOSN.D_SessionId, "0");
                fXmlNode.set_attrVal(FXmlTagOSN.A_Channel, FXmlTagOSN.D_Channel, "channel");
                fXmlNode.set_attrVal(FXmlTagOSN.A_UpdateRate, FXmlTagOSN.D_UpdateRate, FXmlTagOSN.D_UpdateRate);
                fXmlNode.set_attrVal(FXmlTagOSN.A_DeadBand, FXmlTagOSN.D_DeadBand, FXmlTagOSN.D_DeadBand);
                fXmlNode.set_attrVal(FXmlTagOSN.A_OpcLibraryId, FXmlTagOSN.D_OpcLibraryId, FXmlTagOSN.D_OpcLibraryId);                
                //--
                fXmlNode.set_attrVal(FXmlTagOSN.A_AutoClear, FXmlTagOSN.D_AutoClear, FXmlTagOSN.D_AutoClear);
        ...
        public static FXmlNode createXmlNodeITN(
            FXmlDocument fXmlDoc,
            string uniqueId,
            string name,
            string itemFormat,
            ...
            )
        {
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagITN.E_ItemName);
                // --
                fXmlNode.set_attrVal(FXmlTagITN.A_UniqueId, FXmlTagITN.D_UniqueId, uniqueId);
                fXmlNode.set_attrVal(FXmlTagITN.A_Locked, FXmlTagITN.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagITN.A_Name, FXmlTagITN.D_Name, name);
                fXmlNode.set_attrVal(FXmlTagITN.A_Description, FXmlTagITN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagITN.A_FontColor, FXmlTagITN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagITN.A_FontBold, FXmlTagITN.D_FontBold, FBoolean.False);
                // --                
                fXmlNode.set_attrVal(FXmlTagITN.A_ItemFormat, FXmlTagITN.D_ItemFormat, itemFormat);
                fXmlNode.set_attrVal(FXmlTagITN.A_ItemArray, FXmlTagITN.D_ItemArray, isArray);
        ...
        public static FXmlNode createXmlNodeOTR(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOTR.E_OpcTrigger);
                // --
                fXmlNode.set_attrVal(FXmlTagOTR.A_UniqueId, FXmlTagOTR.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOTR.A_Name, FXmlTagOTR.D_Name, "OpcTrigger");
                fXmlNode.set_attrVal(FXmlTagOTR.A_Description, FXmlTagOTR.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOTR.A_FontColor, FXmlTagOTR.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOTR.A_FontBold, FXmlTagOTR.D_FontBold, FBoolean.False);
                // --                
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOCN(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOCN.E_OpcCondition);
                // --
                fXmlNode.set_attrVal(FXmlTagOCN.A_UniqueId, FXmlTagOCN.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOCN.A_Name, FXmlTagOCN.D_Name, "OpcCondition");
                fXmlNode.set_attrVal(FXmlTagOCN.A_Description, FXmlTagOCN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOCN.A_FontColor, FXmlTagOCN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOCN.A_FontBold, FXmlTagOCN.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOCN.A_ConditionMode, FXmlTagOCN.D_ConditionMode, "E");
                // --
                fXmlNode.set_attrVal(FXmlTagOCN.A_OpcDeviceId, FXmlTagOCN.D_OpcDeviceId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagOCN.A_OpcSessionId, FXmlTagOCN.D_OpcSessionId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagOCN.A_OpcMessageId, FXmlTagOCN.D_OpcMessageId, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOCN.A_ConnectionState, FXmlTagOCN.D_ConnectionState, FXmlTagOCN.D_ConnectionState);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOEP(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOEP.E_OpcExpression);
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_UniqueId, FXmlTagOEP.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOEP.A_Name, FXmlTagOEP.D_Name, "OpcExpression");
                fXmlNode.set_attrVal(FXmlTagOEP.A_Description, FXmlTagOEP.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_FontColor, FXmlTagOEP.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOEP.A_FontBold, FXmlTagOEP.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_Logical, FXmlTagOEP.D_Logical, "A");
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_ExpressionType, FXmlTagOEP.D_ExpressionType, "C");
                fXmlNode.set_attrVal(FXmlTagOEP.A_ComparisonMode, FXmlTagOEP.D_ComparisonMode, "V");
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_OperandType, FXmlTagOEP.D_OperandType, "S");
                fXmlNode.set_attrVal(FXmlTagOEP.A_OperandId, FXmlTagOEP.D_OperandId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagOEP.A_OperandFormat, FXmlTagOEP.D_OperandFormat, "A");
                fXmlNode.set_attrVal(FXmlTagOEP.A_OperandIndex, FXmlTagOEP.D_OperandIndex, "0");
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_Operation, FXmlTagOEP.D_Operation, "E");
                // --
                fXmlNode.set_attrVal(FXmlTagOEP.A_Value, FXmlTagOEP.D_Value, "");
        ...
        public static FXmlNode createXmlNodeOTN(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOTN.E_OpcTransmitter);
                // --
                fXmlNode.set_attrVal(FXmlTagOTN.A_UniqueId, FXmlTagOTN.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOTN.A_Name, FXmlTagOTN.D_Name, "OpcTransmitter");
                fXmlNode.set_attrVal(FXmlTagOTN.A_Description, FXmlTagOTN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOTN.A_FontColor, FXmlTagOTN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOTN.A_FontBold, FXmlTagOTN.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionFirstSelect, FXmlTagOTN.D_AutoActionFirstSelect, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionFirstClose, FXmlTagOTN.D_AutoActionFirstClose, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionAlwaysSelect, FXmlTagOTN.D_AutoActionAlwaysSelect, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionAlwaysClose, FXmlTagOTN.D_AutoActionAlwaysClose, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOTN.A_UsedAutoCycle, FXmlTagOTN.D_UsedAutoCycle, FXmlTagOTN.D_UsedAutoCycle);
                fXmlNode.set_attrVal(FXmlTagOTN.A_AutoCyclePeriod, FXmlTagOTN.D_AutoCyclePeriod, FXmlTagOTN.D_AutoCyclePeriod);
                fXmlNode.set_attrVal(FXmlTagOTN.A_AutoCycleAction, FXmlTagOTN.D_AutoCycleAction, FXmlTagOTN.D_AutoCycleAction);
                // --                
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOTF(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOTF.E_OpcTransfer);
                // --
                fXmlNode.set_attrVal(FXmlTagOTF.A_UniqueId, FXmlTagOTF.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOTF.A_Name, FXmlTagOTF.D_Name, "OpcTransfer");
                fXmlNode.set_attrVal(FXmlTagOTF.A_Description, FXmlTagOTF.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOTF.A_FontColor, FXmlTagOTF.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOTF.A_FontBold, FXmlTagOTF.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOTF.A_OpcDeviceId, FXmlTagOTF.D_OpcDeviceId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagOTF.A_OpcSessionId, FXmlTagOTF.D_OpcSessionId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagOTF.A_OpcMessageId, FXmlTagOTF.D_OpcMessageId, string.Empty);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOLM(
            FXmlDocument fXmlDoc
            )
        {
            try
            {
                return fXmlDoc.createNode(FXmlTagOLM.E_OpcLibraryModeling);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static FXmlNode createXmlNodeODM(
            FXmlDocument fXmlDoc
            )
        {
            try
            {
                return fXmlDoc.createNode(FXmlTagODM.E_OpcDeviceModeling);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static FXmlNode createXmlNodeODV(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagODV.E_OpcDevice);
                // --
                fXmlNode.set_attrVal(FXmlTagODV.A_UniqueId, FXmlTagODV.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagODV.A_Locked, FXmlTagODV.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagODV.A_Name, FXmlTagODV.D_Name, "OpcDevice");
                fXmlNode.set_attrVal(FXmlTagODV.A_Description, FXmlTagODV.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagODV.A_FontColor, FXmlTagODV.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagODV.A_FontBold, FXmlTagODV.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagODV.A_Protocol, FXmlTagODV.D_Protocol, FXmlTagODV.D_Protocol);
                fXmlNode.set_attrVal(FXmlTagODV.A_Url, FXmlTagODV.D_Url, FXmlTagODV.D_Url);
                fXmlNode.set_attrVal(FXmlTagODV.A_ClientHandle, FXmlTagODV.D_ClientHandle, FXmlTagODV.D_ClientHandle);
                fXmlNode.set_attrVal(FXmlTagODV.A_LocalId, FXmlTagODV.D_LocalId, FXmlTagODV.D_LocalId);
                fXmlNode.set_attrVal(FXmlTagODV.A_DefaultNamespace, FXmlTagODV.D_DefaultNamespace, FXmlTagODV.D_DefaultNamespace);                
                // --
                fXmlNode.set_attrVal(FXmlTagODV.A_State, FXmlTagODV.D_State, FXmlTagODV.D_State);
        ...
        public static FXmlNode createXmlNodeOML(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOML.E_OpcMessageList);
                // --
                fXmlNode.set_attrVal(FXmlTagOML.A_UniqueId, FXmlTagOML.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOML.A_Locked, FXmlTagOML.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOML.A_Name, FXmlTagOML.D_Name, "OpcMessageList");
                fXmlNode.set_attrVal(FXmlTagOML.A_Description, FXmlTagOML.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOML.A_FontColor, FXmlTagOML.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOML.A_FontBold, FXmlTagOML.D_FontBold, FBoolean.False);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOMS(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOMS.E_OpcMessages);
                // --
                fXmlNode.set_attrVal(FXmlTagOMS.A_UniqueId, FXmlTagOMS.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOMS.A_Locked, FXmlTagOMS.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOMS.A_Name, FXmlTagOMS.D_Name, "OpcMessages");
                fXmlNode.set_attrVal(FXmlTagOMS.A_Description, FXmlTagOMS.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOMS.A_FontColor, FXmlTagOMS.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOMS.A_FontBold, FXmlTagOMS.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOMS.A_Direction, FXmlTagOMS.D_Direction, "R");
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOMG(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOMG.E_OpcMessage);
                // --
                fXmlNode.set_attrVal(FXmlTagOMG.A_MessageType, FXmlTagOMG.D_MessageType, FXmlTagOMG.M_Message);
                // --
                fXmlNode.set_attrVal(FXmlTagOMG.A_UniqueId, FXmlTagOMG.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOMG.A_Locked, FXmlTagOMG.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOMG.A_Name, FXmlTagOMG.D_Name, "OpcMessage");
                fXmlNode.set_attrVal(FXmlTagOMG.A_Description, FXmlTagOMG.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOMG.A_FontColor, FXmlTagOMG.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOMG.A_FontBold, FXmlTagOMG.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOMG.A_AutoReply, FXmlTagOMG.D_AutoReply, FBoolean.True);
                fXmlNode.set_attrVal(FXmlTagOMG.A_AutoReset, FXmlTagOMG.D_AutoReset, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagOMG.A_LogEnabled, FXmlTagOMG.D_LogEnabled, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagOMG.A_IsPrimary, FXmlTagOMG.D_IsPrimary, FBoolean.True);

                // --

                // **
                // OPC Message 생성시 OPC Event Item List 와 OPC Item List 를 추가 한다.
                //**
                fXmlNode.appendChild(FOpcDriverCommon.createXmlNodeOEL(fXmlDoc));
                fXmlNode.appendChild(FOpcDriverCommon.createXmlNodeOIL(fXmlDoc));
        ...
        public static FXmlNode createXmlNodeOMT(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOMT.E_OpcMessage);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_MessageType, FXmlTagOMT.D_MessageType, FXmlTagOMT.M_MessageTransfer);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_UniqueId, FXmlTagOMT.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOMT.A_Name, FXmlTagOMT.D_Name, "OpcMessage");
                fXmlNode.set_attrVal(FXmlTagOMT.A_Description, FXmlTagOMT.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_FontColor, FXmlTagOMT.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOMT.A_FontBold, FXmlTagOMT.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_AutoReply, FXmlTagOMT.D_AutoReply, FBoolean.True);
                fXmlNode.set_attrVal(FXmlTagOMT.A_AutoReset, FXmlTagOMT.D_AutoReset, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_LogEnabled, FXmlTagOMT.D_LogEnabled, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_IsPrimary, FXmlTagOMT.D_IsPrimary, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagOMT.A_IgnoreReadResult, FXmlTagOMT.D_IgnoreReadResult, FBoolean.False);
                // --
        ...
        public static FXmlNode createXmlNodeOEL(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOEL.E_OpcEventItemList);
                // --
                fXmlNode.set_attrVal(FXmlTagOEL.A_UniqueId, FXmlTagOEL.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOEL.A_Locked, FXmlTagOEL.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOEL.A_Name, FXmlTagOEL.D_Name, "OpcEventItemList");
                fXmlNode.set_attrVal(FXmlTagOEL.A_Description, FXmlTagOEL.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOEL.A_FontColor, FXmlTagOEL.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOEL.A_FontBold, FXmlTagOEL.D_FontBold, FBoolean.False);
                // --
        ...
        public static FXmlNode createXmlNodeOEI(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOEI.E_OpcEventItem);
                // --
                fXmlNode.set_attrVal(FXmlTagOEI.A_UniqueId, FXmlTagOEI.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOEI.A_Locked, FXmlTagOEI.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOEI.A_Name, FXmlTagOEI.D_Name, "OpcEventItem");
                fXmlNode.set_attrVal(FXmlTagOEI.A_Description, FXmlTagOEI.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOEI.A_FontColor, FXmlTagOEI.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOEI.A_FontBold, FXmlTagOEI.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOEI.A_ItemName, FXmlTagOEI.D_ItemName, "Tag");
                fXmlNode.set_attrVal(FXmlTagOEI.A_ItemFormat, FXmlTagOEI.D_ItemFormat, FXmlTagOEI.D_ItemFormat);
                // --
                fXmlNode.set_attrVal(FXmlTagOEI.A_Format, FXmlTagOEI.D_Format, FEnumConverter.fromOpcFormat(FOpcFormat.Boolean));
                fXmlNode.set_attrVal(FXmlTagOEI.A_Length, FXmlTagOEI.D_Length, FXmlTagOEI.D_Length);
                fXmlNode.set_attrVal(FXmlTagOEI.A_Value, FXmlTagOEI.D_Value, FXmlTagOEI.D_Value);
                // --
                fXmlNode.set_attrVal(FXmlTagOEI.A_Transformer, FXmlTagOEI.D_Transformer, FXmlTagOEI.D_Transformer);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeOIL(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOIL.E_OpcItemList);
                // --
                fXmlNode.set_attrVal(FXmlTagOIL.A_UniqueId, FXmlTagOIL.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOIL.A_Locked, FXmlTagOIL.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOIL.A_Name, FXmlTagOIL.D_Name, "OpcItemList");
                fXmlNode.set_attrVal(FXmlTagOIL.A_Description, FXmlTagOIL.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOIL.A_FontColor, FXmlTagOIL.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOIL.A_FontBold, FXmlTagOIL.D_FontBold, FBoolean.False);
                // --
        ...
        public static FXmlNode createXmlNodeOIT(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagOIT.E_OpcItem);
                // --
                fXmlNode.set_attrVal(FXmlTagOIT.A_UniqueId, FXmlTagOIT.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagOIT.A_Locked, FXmlTagOIT.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagOIT.A_Name, FXmlTagOIT.D_Name, "OpcItem");
                fXmlNode.set_attrVal(FXmlTagOIT.A_Description, FXmlTagOIT.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagOIT.A_FontColor, FXmlTagOIT.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagOIT.A_FontBold, FXmlTagOIT.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagOIT.A_ItemName, FXmlTagOIT.D_ItemName, "Tag");
                fXmlNode.set_attrVal(FXmlTagOIT.A_ItemFormat, FXmlTagOIT.D_ItemFormat, FXmlTagOIT.D_ItemFormat);
                // --
                fXmlNode.set_attrVal(FXmlTagOIT.A_Format, FXmlTagOIT.D_Format, FEnumConverter.fromOpcFormat(FOpcFormat.Ascii));
                fXmlNode.set_attrVal(FXmlTagOIT.A_Length, FXmlTagOIT.D_Length, FXmlTagOIT.D_Length);                                
                fXmlNode.set_attrVal(FXmlTagOIT.A_Value, FXmlTagOIT.D_Value, "");
                // --
                fXmlNode.set_attrVal(FXmlTagOIT.A_ScanMode, FXmlTagOIT.D_ScanMode, FXmlTagOIT.D_ScanMode);
                fXmlNode.set_attrVal(FXmlTagOIT.A_Transformer, FXmlTagOIT.D_Transformer, FXmlTagOIT.D_Transformer);                                
                fXmlNode.set_attrVal(FXmlTagOIT.A_ReservedWord, FXmlTagOIT.D_ReservedWord, FXmlTagOIT.D_ReservedWord);
                fXmlNode.set_attrVal(FXmlTagOIT.A_Extraction, FXmlTagOIT.D_Extraction, FXmlTagOIT.D_Extraction);
            ...
            )
        {
            ...
            try
            {
                ...
                if (name == FXmlTagOCD.E_OpcDriver)
                {
                    fObject = new FOpcDriver(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagONL.E_ObjectNameList)
                {
                    fObject = new FObjectNameList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagONA.E_ObjectName)
                {
                    fObject = new FObjectName(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagFNL.E_FunctionNameList)
                {
                    fObject = new FFunctionNameList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagFNA.E_FunctionName)
                {
                    fObject = new FFunctionName(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagPAN.E_ParameterName)
                {
                    fObject = new FParameterName(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagARG.E_Argument)
                {
                    fObject = new FArgument(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagUTN.E_UserTagName)
                {
                    fObject = new FUserTagName(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagDCL.E_DataConversionSetList)
                {
                    fObject = new FDataConversionSetList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagDCS.E_DataConversionSet)
                {
                    fObject = new FDataConversionSet(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagDCV.E_DataConversion)
                {
                    fObject = new FDataConversion(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagESL.E_EquipmentStateSetList)
                {
                    fObject = new FEquipmentStateSetList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagESS.E_EquipmentStateSet)
                {
                    fObject = new FEquipmentStateSet(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagEST.E_EquipmentState)
                {
                    fObject = new FEquipmentState(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagSTV.E_StateValue)
                {
                    fObject = new FStateValue(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagRPL.E_RepositoryList)
                {
                    fObject = new FRepositoryList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagRPS.E_Repository)
                {
                    ...
                    {
                        fObject = new FRepository(fOcdCore, fXmlNode);
                    }
                    else
                    {
                        fObject = new FRepositoryMaterial(fOcdCore, fXmlNode);
                    }
                }
                else if (name == FXmlTagCOL.E_Column)
                {
                    fObject = new FColumn(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagENL.E_EnvironmentList)
                {
                    fObject = new FEnvironmentList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagENV.E_Environment)
                {
                    fObject = new FEnvironment(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagDSL.E_DataSetList)
                {
                    fObject = new FDataSetList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagDTS.E_DataSet)
                {
                    fObject = new FDataSet(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagDAT.E_Data)
                {
                    fObject = new FData(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagOLG.E_OpcLibraryGroup)
                {
                    fObject = new FOpcLibraryGroup(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOLB.E_OpcLibrary)
                {
                    fObject = new FOpcLibrary(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOML.E_OpcMessageList)
                {
                    fObject = new FOpcMessageList(fOcdCore, fXmlNode);
                }
                // ***
                else if (name == FXmlTagOMS.E_OpcMessages)
                {
                    fObject = new FOpcMessages(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOMG.E_OpcMessage)
                {
                    fObject = new FOpcMessage(fOcdCore, fXmlNode);
                }                
                else if (name == FXmlTagOEL.E_OpcEventItemList)
                {
                    fObject = new FOpcEventItemList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOIL.E_OpcItemList)
                {
                    fObject = new FOpcItemList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOEI.E_OpcEventItem)
                {
                    fObject = new FOpcEventItem(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOIT.E_OpcItem)
                {
                    fObject = new FOpcItem(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagODV.E_OpcDevice)
                {
                    fObject = new FOpcDevice(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOSN.E_OpcSession)
                {
                    fObject = new FOpcSession(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagITN.E_ItemName)
                {
                    fObject = new FItemName(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagHLG.E_HostLibraryGroup)
                {
                    fObject = new FHostLibraryGroup(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHLB.E_HostLibrary)
                {
                    fObject = new FHostLibrary(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHML.E_HostMessageList)
                {
                    fObject = new FHostMessageList(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHMS.E_HostMessages)
                {
                    fObject = new FHostMessages(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHMG.E_HostMessage)
                {
                    ...
                    {
                        fObject = new FHostMessage(fOcdCore, fXmlNode);
                    }
                    ...
                    {
                        fObject = new FHostDriverDataMessage(fOcdCore, fXmlNode);
                    }
                }
                else if (name == FXmlTagHIT.E_HostItem)
                {
                    fObject = new FHostItem(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagHDV.E_HostDevice)
                {
                    fObject = new FHostDevice(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHSN.E_HostSession)
                {
                    fObject = new FHostSession(fOcdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagEQP.E_Equipment)
                {
                    fObject = new FEquipment(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagSNG.E_ScenarioGroup)
                {
                    fObject = new FScenarioGroup(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagSNR.E_Scenario)
                {
                    fObject = new FScenario(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOTR.E_OpcTrigger)
                {
                    fObject = new FOpcTrigger(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOCN.E_OpcCondition)
                {
                    fObject = new FOpcCondition(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOEP.E_OpcExpression)
                {
                    fObject = new FOpcExpression(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOTN.E_OpcTransmitter)
                {
                    fObject = new FOpcTransmitter(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagOTF.E_OpcTransfer)
                {
                    fObject = new FOpcTransfer(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHTR.E_HostTrigger)
                {
                    fObject = new FHostTrigger(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHCN.E_HostCondition)
                {
                    fObject = new FHostCondition(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHEP.E_HostExpression)
                {
                    fObject = new FHostExpression(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHTN.E_HostTransmitter)
                {
                    fObject = new FHostTransmitter(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagHTF.E_HostTransfer)
                {
                    fObject = new FHostTransfer(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagESA.E_EquipmentStateSetAlterer)
                {
                    fObject = new FEquipmentStateSetAlterer(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagEAT.E_EquipmentStateAlterer)
                {
                    fObject = new FEquipmentStateAlterer(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagJDM.E_Judgement)
                {
                    fObject = new FJudgement(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagJCN.E_JudgementCondition)
                {
                    fObject = new FJudgementCondition(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagJEP.E_JudgementExpression)
                {
                    fObject = new FJudgementExpression(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagMAP.E_Mapper)
                {
                    fObject = new FMapper(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagSTG.E_Storage)
                {
                    fObject = new FStorage(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagCBK.E_Callback)
                {
                    fObject = new FCallback(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagFUN.E_Function)
                {
                    fObject = new FFunction(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagBRN.E_Branch)
                {
                    fObject = new FBranch(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagCMT.E_Comment)
                {
                    fObject = new FComment(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagPAU.E_Pauser)
                {
                    fObject = new FPauser(fOcdCore, fXmlNode);
                }
                else if (name == FXmlTagETP.E_EntryPoint)
                {
                    fObject = new FEntryPoint(fOcdCore, fXmlNode);
                }
        ...
        {
            FObjectType type = FObjectType.OpcDriver;
            string name = string.Empty;
            string typeValue = string.Empty;
            ...
            try
            {
                ...
                {
                    type = FObjectType.OpcLibraryGroup;
                }
                else if (name == FXmlTagOLB.E_OpcLibrary)
                {
                    type = FObjectType.OpcLibrary;
                }
                else if (name == FXmlTagOML.E_OpcMessageList)
                {
                    type = FObjectType.OpcMessageList;
                }
                else if (name == FXmlTagOMS.E_OpcMessages)
                {
                    type = FObjectType.OpcMessages;
                }
                else if (name == FXmlTagOMG.E_OpcMessage)
                {
                    type = FObjectType.OpcMessage;
                }
                else if (name == FXmlTagOEL.E_OpcEventItemList)
                {
                    type = FObjectType.OpcEventItemList;
                }
                else if (name == FXmlTagOEI.E_OpcEventItem)
                {
                    type = FObjectType.OpcEventItem;
                }
                else if (name == FXmlTagOIL.E_OpcItemList)
                {
                    type = FObjectType.OpcItemList;
                }
                else if (name == FXmlTagOIT.E_OpcItem)
                {
                    type = FObjectType.OpcItem;
                }
                // --
                else if (name == FXmlTagODV.E_OpcDevice)
                {
                    type = FObjectType.OpcDevice;
                }
                else if (name == FXmlTagOSN.E_OpcSession)
                {
                    type = FObjectType.OpcSession;
                }
                else if (name == FXmlTagITN.E_ItemName)
                {
                    type = FObjectType.ItemName;
                }
                // --
                else if (name == FXmlTagHLG.E_HostLibraryGroup)
                {
                ...
                {
                    type = FObjectType.OpcTrigger;
                }
                else if (name == FXmlTagOCN.E_OpcCondition)
                {
                    type = FObjectType.OpcCondition;
                }
                else if (name == FXmlTagOEP.E_OpcExpression)
                {
                    type = FObjectType.OpcExpression;
                }
                else if (name == FXmlTagOTN.E_OpcTransmitter)
                {
                    type = FObjectType.OpcTransmitter;
                }
                else if (name == FXmlTagOTF.E_OpcTransfer)
                {
                    type = FObjectType.OpcTransfer;
                }
                else if (name == FXmlTagHTR.E_HostTrigger)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNode = ((FOpcDriver)fObject).fXmlNode;
                }
                // --
        ...
        public static void setOpcItemRandomValue(
            FXmlNode fXmlNodeMsg
            )
        {
            const string ItemQuery =
                "//" + FXmlTagOIT.E_OpcItem + "[@" +
                FXmlTagOIT.A_RandomValue + "='{0}']";
            ...
            )
        {
            ...
            try
            {
                ...
                FFormat format = FEnumConverter.toFormat(
                    fXmlNodeItem.get_attrVal(FXmlTagOIT.A_Format, FXmlTagOIT.D_Format)
                    );
                sMin = fXmlNodeItem.get_attrVal(FXmlTagOIT.A_RandomValueMin, FXmlTagOIT.D_RandomValueMin);
                sMax = fXmlNodeItem.get_attrVal(FXmlTagOIT.A_RandomValueMax, FXmlTagOIT.D_RandomValueMax);

                // --

                if (
                    sMin == FXmlTagOIT.D_RandomValueMin &&
                    sMax == FXmlTagOIT.D_RandomValueMax
                    )
                {
                    return;
                }
                    ...
                    format == FFormat.I1)
                {
                    ...
                    fXmlNodeItem.set_attrVal(FXmlTagOIT.A_Value, FXmlTagOIT.D_Value, val.ToString());
                }
