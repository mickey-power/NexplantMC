...
--  Description     : FAMate Core FaOpcDriver Equipment State Material Storage Class 
    ...
    public class FEquipmentStateMaterialStorage : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fEsm == null)
                {
                    fEstNode = m_fOcdCore.fOpcDriver.fXmlNode.selectSingleNode(string.Format(EquipmentsStateQuery, estUniqueId));
                    if (fEstNode != null)
                    {
                        // --
                        ...
                        if (defaultState != FXmlTagEST.D_DefaultValue)
                        {
                            ...
                            this.fOcdCore.fEquipmentStateMaterialStorage.add(fEsm);
                        }                        
                    }
                }
