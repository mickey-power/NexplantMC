...
--  Description     : FAMate Core FaOpcDriver Clipboard Object Format Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    internal static class FCbObjectFormat
    {
        ...
        private static string Prefix = "FAMATE_OPC_";

        // --

        public static string OpcDriver = Prefix + FXmlTagOCD.E_OpcDriver;
        // --
        ...
        // --
        public static string OpcLibraryGroup = Prefix + FXmlTagOLG.E_OpcLibraryGroup;
        public static string OpcLibrary = Prefix + FXmlTagOLB.E_OpcLibrary;
        public static string OpcMessageList = Prefix + FXmlTagOML.E_OpcMessageList;
        public static string OpcMessages = Prefix + FXmlTagOMS.E_OpcMessages;
        public static string OpcMessage = Prefix + FXmlTagOMG.E_OpcMessage;
        public static string OpcEventItemList = Prefix + FXmlTagOEL.E_OpcEventItemList;
        public static string OpcEventItem = Prefix + FXmlTagOEI.E_OpcEventItem;
        public static string OpcItemList = Prefix + FXmlTagOIL.E_OpcItemList;
        // --
        // Add by Jeff.Kim 2015.12.07 
        // Test 시에 Log에서 값만을 복사해서 Item에 값을 설정하기 위해 추가. Value 만 복사해서 붙여 넣기 할경우 사용
        public static string OpcItemListValues = Prefix + FXmlTagOIL.E_OpcItemListValues;
        public static string OpcItem = Prefix + FXmlTagOIT.E_OpcItem;
        //--
        public static string OpcDevice = Prefix + FXmlTagODV.E_OpcDevice;
        public static string OpcSession = Prefix + FXmlTagOSN.E_OpcSession;
        // --
        ...
        public static string OpcTrigger = Prefix + FXmlTagOTR.E_OpcTrigger;
        public static string OpcCondition = Prefix + FXmlTagOCN.E_OpcCondition;
        public static string OpcExpression = Prefix + FXmlTagOEP.E_OpcExpression;
        public static string OpcTransmitter = Prefix + FXmlTagOTN.E_OpcTransmitter;
        public static string OpcTransfer = Prefix + FXmlTagOTF.E_OpcTransfer;
