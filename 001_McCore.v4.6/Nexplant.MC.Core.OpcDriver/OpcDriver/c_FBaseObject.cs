...
--  Description     : FAMate Core FaOpcDriver Base Object Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public abstract class FBaseObject<T> : IDisposable
    {
            ...
            )
        {
            ...
            // FOpcDriver 생성자 Only
            // ***
            m_fOcdCore = new FOcdCore();
            m_fXmlNode = m_fOcdCore.fXmlNodeOcd;
            // --
            init();
        }
        ...
        // ***
        // 2014.02.03 by spike.lee
        // OPC Driver reopenModelingFile Method에서 사용
        // ***
        internal FBaseObject(                 
            )
        {
            ...
            )
        {
            ...
            // OPC Driver Clone 전용
            // ***
            m_fOcdCore = new FOcdCore(fXmlDoc);
            m_fXmlNode = m_fOcdCore.fXmlNodeOcd;
            // --
            init();
        }
            ...
            )
        {
            if (!m_disposed)
            {
                if (disposing)
                {
                    ...
                    if (this is FOpcDriver && m_fOcdCore != null)
                    {
                        m_fOcdCore.Dispose();
                    }
                    m_fOcdCore = null;
        ...
        internal FOpcDriver fOpcDriver
        {
            get
            {
                try
            ...
            try
            {
                if (this.isModelingObject)
                {
                    xpath =
                        ...
                        FXmlTagONL.E_ObjectNameList + "[@" + FXmlTagONL.A_ObjectType + "='" + FOpcDriverCommon.getObjectType(m_fXmlNode).ToString() + "']/" +
                ...
                // --
                return new FObjectNameCollection(m_fOcdCore, this.fOpcDriver.fXmlNode.selectNodes(xpath));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            try
            {
                if (this.isModelingObject)
                {
                    xpath =
                        ...
                        FXmlTagUTN.E_UserTagName + "[@" + FXmlTagUTN.A_ObjectType + "='" + FOpcDriverCommon.getObjectType(m_fXmlNode).ToString() + "']";
                    fXmlNodeUtn = this.fOpcDriver.fXmlNode.selectSingleNode(xpath);
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FJudgementCondition(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FEnvironmentList(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FEquipmentStateSetList(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FDataConversionSet(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
        ...
        internal FOpcLibrary getAncestorOpcLibrary(
            )
        {
            FXmlNode fXmlNodeParent = null;
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    if (fXmlNodeParent.name == FXmlTagOLB.E_OpcLibrary)
                    {
                        return new FOpcLibrary(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
        ...
        internal FOpcMessage getAncestorOpcMessage(
            )
        {
            try
            {
                ...
                try
                {
                    ...
                    while (fXmlNodeParent != null)
                    {
                        if (fXmlNodeParent.name == FXmlTagOMG.E_OpcMessage)
                        {
                            return new FOpcMessage(this.fOcdCore, fXmlNodeParent);
                        }
                        fXmlNodeParent = fXmlNodeParent.fParentNode;
                    }
                    return null;
        ...
        internal FOpcEventItemList getAncestorOpcEventItemList(
            )
        {
            FXmlNode fXmlNodeParent = null;
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    if (fXmlNodeParent.name == FXmlTagOEL.E_OpcEventItemList)
                    {
                        return new FOpcEventItemList(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
        ...
        internal FOpcItemList getAncestorOpcItemList(
            )
        {
            FXmlNode fXmlNodeParent = null;
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    if (fXmlNodeParent.name == FXmlTagOIL.E_OpcItemList)
                    {
                        return new FOpcItemList(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
        ...
        internal FOpcCondition getAncestorOpcCondition(
            )
        {
            FXmlNode fXmlNodeParent = null;
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    if (fXmlNodeParent.name == FXmlTagOCN.E_OpcCondition)
                    {
                        return new FOpcCondition(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FHostLibrary(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FHostCondition(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FRepository(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                while (fXmlNodeParent != null)
                {
                    ...
                    {
                        return new FDataSet(this.fOcdCore, fXmlNodeParent);
                    }
                    fXmlNodeParent = fXmlNodeParent.fParentNode;
                }
                return null;
            ...
            )
        {
            ...
            try
            {
                ...
                // --                                
                FOpcDriverCommon.resetUniqueId(this.fOcdCore.fIdPointer, fXmlNode);
                return FOpcDriverCommon.createObject(fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    format = FCbObjectFormat.HostMessages;
                }
                else if (FClipboard.containsData(FCbObjectFormat.OpcMessages))
                {
                    format = FCbObjectFormat.OpcMessages;
                }
                else if (FClipboard.containsData(FCbObjectFormat.DataSetList))
                {
                    format = FCbObjectFormat.DataSetList;
                }
                else if (FClipboard.containsData(FCbObjectFormat.DataConversionSet))
                {
                    format = FCbObjectFormat.DataConversionSet;
                }
                else if (FClipboard.containsData(FCbObjectFormat.OpcCondition))
                {
                    format = FCbObjectFormat.OpcCondition;
                }
                else
                {
                    return null;
            ...
            try
            {
                if (this.isModelingObject)
                {
                    args = new FObjectEventArgs(
                        ...
                        m_fOcdCore.fOpcDriver,
                        FOpcDriverCommon.createObject(m_fOcdCore, this.fXmlNode.fParentNode),
                        (FIObject)this
                        );
                    // --
                    m_fOcdCore.fEventPusher.pushEvent(args);
                }
            }
            catch (Exception ex)
            {
                FMessageBox.showError("FOpcBase", ex, null);
            }
            finally
            {
                args = null;
