...
--  Description     : FAMate Core FaOpcDriver Pauser Agent Class 
    ...
    internal class FPauserAgent : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                fXmlNodePau = m_fOcdCore.fOpcDriver.fXmlNode.selectSingleNode(string.Format(Query, fPauserData.uniqueId));
                if (fXmlNodePau == null)
                {
                    return;
                }
                ...
                // ***
                fXmlNodeFlow = m_fOcdCore.fOpcDriver.fXmlNode.selectSingleNode(
                ...
                {
                    FScenarioController.executeOpcTransmitter(fScenarioData);
                }
