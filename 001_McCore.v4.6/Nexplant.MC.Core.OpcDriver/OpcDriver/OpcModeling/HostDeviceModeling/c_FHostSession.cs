...
--  Description     : FAMate Core FaOpcDriver Host Session Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostSession : FBaseObject<FHostSession>, FIObject, FISession
    {
        ...
        public FHostSession(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeHSN(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FHostLibrary fLibrary
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostLibrary(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostDevice fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostDevice(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostSession(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostSession(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostSession);
