...
--  Description     : FAMate Core FaOpcDriver Host Message Transfer Class
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostMessageTransfer : FIObject, FIMessageTransfer, IDisposable
    {
            ...
            )
        {
            ...
            m_fXmlNode = FOpcDriverCommon.createXmlNodeHMT(m_fOcdCore.fXmlDoc);
        }
        ...
        public FHostItemCollection fChildHostItemCollection
        {
            get
            {
                try
                {
                    return new FHostItemCollection(this.m_fOcdCore, this.fXmlNode.selectNodes(FXmlTagHIT.E_HostItem));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                m_fOcdCore.fProtocolAgent.sendHostMessageTransfer(fHostSession, this);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.m_fOcdCore, this.fXmlNode.appendChild(fNewChild.fXmlNode));
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.m_fOcdCore, this.fXmlNode.insertBefore(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(m_fOcdCore, this.fXmlNode.insertAfter(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                return (FHostItem)FOpcDriverCommon.createObject(m_fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
