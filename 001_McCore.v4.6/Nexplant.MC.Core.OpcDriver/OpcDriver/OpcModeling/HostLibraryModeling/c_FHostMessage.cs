...
--  Description     : FAMate Core FaOpcDriver Host Message Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostMessage : FBaseObject<FHostMessage>, FIObject, FIMessage
    {
        ...
        public FHostMessage(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeHMG(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public bool noAckFlag
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagHMG.A_AtlasNoAckFlag, FXmlTagHMG.D_AtlasNoAckFlag));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagHMG.A_AtlasNoAckFlag, FXmlTagHMG.D_AtlasNoAckFlag, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string stationId
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagHMG.A_AtlasStationId, FXmlTagHMG.D_AtlasStationId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagHMG.A_AtlasStationId, FXmlTagHMG.D_AtlasStationId, value.ToString(), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string spindleId
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagHMG.A_AtlasSpindleId, FXmlTagHMG.D_AtlasSpindleId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagHMG.A_AtlasSpindleId, FXmlTagHMG.D_AtlasSpindleId, value.ToString(), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessage(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessage(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool hasHashTagChild
        {
            get
            {
                ...
                try
                {
                    xpath = FXmlTagHIT.E_HostItem + "[@" + FXmlTagHIT.A_HashTag + "='" + FBoolean.True + "']";
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeHmt.set_attrVal(FXmlTagHMT.A_MessageType, FXmlTagHMT.D_MessageType, FXmlTagHMT.M_MessageTransfer);                
                return new FHostMessageTransfer(this.fOcdCore, fXmlNodeHmt, tid);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
