...
--  Description     : FAMate Core FaOpcDriver Host Condition Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostCondition : FBaseObject<FHostCondition>, FIObject
    {
        ...
        public FHostCondition(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeHCN(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FHostDevice fDevice
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostDevice(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fSession
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostSession(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fMessage
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostMessage(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTrigger fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostTrigger(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostCondition fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostCondition(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostCondition fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostCondition(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpressionCollection fChildHostExpressionCollection
        {
            get
            {
                try
                {
                    return new FHostExpressionCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagHEP.E_HostExpression));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHep.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostCondition);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostExpression);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostExpression(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
