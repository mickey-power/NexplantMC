...
--  Description     : FAMate Core FaOpcDriver Host Transfer Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostTransfer : FBaseObject<FHostTransfer>, FIObject, FITransfer
    {
        ...
        public FHostTransfer(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeHTF(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FHostTransmitter fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransmitter(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTransfer fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransfer(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTransfer fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransfer(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostTransfer);
