...
--  Description     : FAMate Core FaOpcDriver Host Transmitter Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostTransmitter : FBaseObject<FHostTransmitter>, FIObject, FIFlow
    {
        ...
        public FHostTransmitter(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeHTN(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FHostTransferCollection fChildHostTransferCollection
        {
            get
            {
                try
                {
                    return new FHostTransferCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagHTF.E_HostTransfer));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHtf.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostTransfer);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostTransfer(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
