...
--  Description     : FAMate Core FaOpcDriver Judgement Condition Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FJudgementCondition : FBaseObject<FJudgementCondition>, FIObject
    {
        ...
        public FJudgementCondition(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeJCN(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FDataSet fDataSet
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FDataSet(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgement fParent
        {
            get
            {
                try
                {
                    ...
                    return new FJudgement(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementCondition fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementCondition(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementCondition fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementCondition(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.JudgementCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgementExpression(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
