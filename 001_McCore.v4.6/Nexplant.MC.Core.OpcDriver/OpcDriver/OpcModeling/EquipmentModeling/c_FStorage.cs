...
--  Description     : FAMate Core FaOpcDriver FStorage Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FStorage : FBaseObject<FStorage>, FIObject, FIFlow
    {
        ...
        public FStorage(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeSTG(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FRepository fRepository
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FRepository(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
