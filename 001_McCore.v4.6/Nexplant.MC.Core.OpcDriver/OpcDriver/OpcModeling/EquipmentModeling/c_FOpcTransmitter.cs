...
--
--  Program Id      : c_FOpcTransmitter.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.22
--  Description     : FAMate Core FaOpcDriver OPC Transmitter Class 
...
{
    public class FOpcTransmitter : FBaseObject<FOpcTransmitter>, FIObject, FIFlow
    {
        ...
        public FOpcTransmitter(
            FOpcDriver fOpcDriver
            )
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeOTN(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FObjectType fObjectType
        {
            get
            {
                try
                {
                    return FObjectType.OpcTransmitter;
                }
                catch (Exception ex)
                {
        ...
        public FFlowType fFlowType
        {
            get
            {
                try
                {
                    return FFlowType.OpcTransmitter;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string uniqueIdToString
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_UniqueId, FXmlTagOTN.D_UniqueId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string name
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_Name, FXmlTagOTN.D_Name);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_Name, FXmlTagOTN.D_Name, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string description
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_Description, FXmlTagOTN.D_Description);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_Description, FXmlTagOTN.D_Description, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public Color fontColor
        {
            get
            {
                try
                {
                    return Color.FromName(this.fXmlNode.get_attrVal(FXmlTagOTN.A_FontColor, FXmlTagOTN.D_FontColor));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_FontColor, FXmlTagOTN.D_FontColor, value.Name, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool fontBold
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagOTN.A_FontBold, FXmlTagOTN.D_FontBold));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_FontBold, FXmlTagOTN.D_FontBold, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool autoActionFirstSelect
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagOTN.A_AutoActionFirstSelect, FXmlTagOTN.D_AutoActionFirstSelect));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionFirstSelect, FXmlTagOTN.D_AutoActionFirstSelect, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool autoActionFirstClose
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagOTN.A_AutoActionFirstClose, FXmlTagOTN.D_AutoActionFirstClose));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionFirstClose, FXmlTagOTN.D_AutoActionFirstClose, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool autoActionAlwaysSelect
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagOTN.A_AutoActionAlwaysSelect, FXmlTagOTN.D_AutoActionAlwaysSelect));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionAlwaysSelect, FXmlTagOTN.D_AutoActionAlwaysSelect, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool autoActionAlwaysClose
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagOTN.A_AutoActionAlwaysClose, FXmlTagOTN.D_AutoActionAlwaysClose));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_AutoActionAlwaysClose, FXmlTagOTN.D_AutoActionAlwaysClose, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool usedAutoCycle
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagOTN.A_UsedAutoCycle, FXmlTagOTN.D_UsedAutoCycle));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_UsedAutoCycle, FXmlTagOTN.D_UsedAutoCycle, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public int autoCyclePeriod
        {
            get
            {
                try
                {
                    return int.Parse(this.fXmlNode.get_attrVal(FXmlTagOTN.A_AutoCyclePeriod, FXmlTagOTN.D_AutoCyclePeriod));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    // --
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_AutoCyclePeriod, FXmlTagOTN.D_AutoCyclePeriod, value.ToString(), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FAutoCycleAction fAutoCycleAction
        {
            get
            {
                try
                {
                    return FEnumConverter.toAutoCycleAction(this.fXmlNode.get_attrVal(FXmlTagOTN.A_AutoCycleAction, FXmlTagOTN.D_AutoCycleAction));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_AutoCycleAction, FXmlTagOTN.D_AutoCycleAction, FEnumConverter.fromAutoCycleAction(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag1
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_UserTag1, FXmlTagOTN.D_UserTag1);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_UserTag1, FXmlTagOTN.D_UserTag1, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag2
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_UserTag2, FXmlTagOTN.D_UserTag2);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_UserTag2, FXmlTagOTN.D_UserTag2, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag3
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_UserTag3, FXmlTagOTN.D_UserTag3);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_UserTag3, FXmlTagOTN.D_UserTag3, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag4
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_UserTag4, FXmlTagOTN.D_UserTag4);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_UserTag4, FXmlTagOTN.D_UserTag4, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag5
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagOTN.A_UserTag5, FXmlTagOTN.D_UserTag5);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagOTN.A_UserTag5, FXmlTagOTN.D_UserTag5, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FOpcTransferCollection fChildOpcTransferCollection
        {
            get
            {
                try
                {
                    return new FOpcTransferCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagOTF.E_OpcTransfer));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool hasChild
        {
            get
            {
                try
                {
                    return this.fXmlNode.containsNode(FXmlTagOTF.E_OpcTransfer);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool canPasteChild
        {
            get
            {
                try
                {
                    if (!FClipboard.containsData(FCbObjectFormat.OpcTransfer))
                    {
                        return false;
                    }
                    return true;
        ...
        public FOpcTransfer appendChildOpcTransfer(
            FOpcTransfer fNewChild
            )
        {
            try
            {
        ...
        public FOpcTransfer insertBeforeChildOpcTransfer(
            FOpcTransfer fNewChild,
        ...
        public FOpcTransfer insertAfterChildOpcTransfer(
            FOpcTransfer fNewChild,
            FOpcTransfer fRefChild
            )
        {
        ...
        public FOpcTransfer removeChildOpcTransfer(
            FOpcTransfer fChild
            )
        {
            try
        ...
        public void removeChildOpcTransfer(
            FOpcTransfer[] fChilds
            )
        {
            try
            {
                ...
                foreach (FOpcTransfer fPtf in fChilds)
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fPtf.fXmlNode);
                }
        ...
        public void removeAllChildOpcTransfer(
            )
        {
            FOpcTransferCollection fPtfCollction = null;

            try
            {
                fPtfCollction = this.fChildOpcTransferCollection;
                ...
                foreach (FOpcTransfer fPtf in fPtfCollction)
                {
                    fPtf.remove();
                }
            }
            ...
            )
        {
            try
            {
                foreach (FOpcTransfer fPtf in this.fChildOpcTransferCollection)
                {
                    fPtf.resetRelation();
                }
            }
            ...
            )
        {
            try
            {
                foreach (FXmlNode fXmlNodePtf in fXmlNode.selectNodes(FXmlTagOTF.E_OpcTransfer))
                {
            ...
            )
        {
            ...
            try
            {
                ...
                this.copyObject(FCbObjectFormat.OpcTransmitter, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.copyObject(FCbObjectFormat.OpcTransmitter, this.fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public FOpcTransfer pasteChild(
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.OpcTransfer);

                // --

                fOpcTransfer = (FOpcTransfer)this.pasteObject(FCbObjectFormat.OpcTransfer);
                this.appendChildOpcTransfer(fOpcTransfer);
        ...
        public FOpcTransferCollection selectOpcTransferByName(
            string name
            )
        {
            const string xpath = FXmlTagOTF.E_OpcTransfer + "[@" + FXmlTagOTF.A_Name + "='{0}']";

            try
            {
                return new FOpcTransferCollection(
                    this.fOcdCore,
        ...
        public FOpcTransfer selectSingleOpcTransferByName(
            string name
            )
        {
            const string xpath = FXmlTagOTF.E_OpcTransfer + "[@" + FXmlTagOTF.A_Name + "='{0}']";
            ...
            try
            {
                ...
                return new FOpcTransfer(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
