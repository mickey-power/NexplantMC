...
--  Description     : FAMate Core FaOpcDriver FCallback Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FCallback : FBaseObject<FCallback>, FIObject, FIFlow
    {
        ...
        public FCallback(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeCBK(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FFunctionCollection fChildFunctionCollection
        {
            get
            {
                try
                {
                    return new FFunctionCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagFUN.E_Function));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fFun.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Function);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FFunction(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
