...
--  Description     : FAMate Core FaOpcDriver Scenario Group Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FScenarioGroup : FBaseObject<FScenarioGroup>, FIObject
    {
        ...
        public FScenarioGroup(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeSNG(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FEquipment fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipment(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioGroup fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioGroup fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioCollection fChildScenarioCollection
        {
            get
            {
                try
                {
                    return new FScenarioCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagSNR.E_Scenario));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fSnr.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ScenarioGroup);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Scenario);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FScenario(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // Clone된 개체의 Lock 제거
                // ***
                fScenarioGroup = new FScenarioGroup(this.fOcdCore, this.fXmlNode.clone(true));
                // --
                xpath =
                    ". | " +
