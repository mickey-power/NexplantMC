...
--  Description     : FAMate Core FaOpcDriver Host Expression Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostExpression : FBaseObject<FHostExpression>, FIObject
    {
        ...
        public FHostExpression(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeHEP(fOpcDriver.fOcdCore.fXmlDoc))
        {
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (this.fOperandType == FHostOperandType.HostItem)
                    {
                        ...
                        // --
                        return new FHostItem(this.fOcdCore, this.fOpcDriver.fXmlNode.selectSingleNode(xpath));
                    }
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FHostCondition(this.fOcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FHostExpression(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpression fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostExpression(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpression fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostExpression(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostExpression);
