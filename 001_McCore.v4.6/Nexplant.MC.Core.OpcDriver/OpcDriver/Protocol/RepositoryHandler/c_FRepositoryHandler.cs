...
--  Description     : FAMate Core FaOpcDriver Repository Handler Class 
    ...
    internal static class FRepositoryHandler
    {
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeRps = fScenarioData.fOcdCore.fOpcDriver.fXmlNode.selectSingleNode(xpath).clone(true);                
                ...
                // ***
                fXmlNodeRpsl.set_attrVal(FXmlTagRPSL.A_RpmId, FXmlTagRPSL.D_RpmId, fScenarioData.fOcdCore.fRpmIdPointer.uniqueId.ToString());
                ...
                fRepositoryMaterial = new FRepositoryMaterial(fScenarioData.fOcdCore, fXmlNodeRpm);                
            ...
            )
        {
            ...
            try
            {
                ...
                if (fScenarioData.hasMapperPerformedLog && fScenarioData.fMapperPerformedLog.hasDataSetLog)
                {
                    ...
                    {
                        foreach (FRepositoryMaterial fRpm in fScenarioData.fOcdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                        {
                ...
                if (fRepositoryMaterial == null && fScenarioData.hasDataMessageReceivedLog)
                {
                    ...
                    if (fMessageLogType == FMessageLogType.HostDeviceDataMessageReceivedLog)
                    {
                        ...
                        if (fHdmrl.isSecondary)
                        {
                            ...
                            tid = fHdmrl.tid;
                            // --
                            foreach (FRepositoryMaterial fRtm in fScenarioData.fOcdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                            {
                                if (
           ...
           )
        {
            ...
            try
            {
                ...
                if (fXmlNodeStg.get_attrVal(FXmlTagSTG.A_Mode, FXmlTagSTG.D_Mode) == FEnumConverter.fromStorageMode(FStorageMode.Part))
                {
                    ...
                    {
                        fScenarioData.fOcdCore.fRepositoryMaterialStorage.remove(fScenarioData.fRepositoryMaterial);
                    }
           ...
           )
        {
            ...
            try
            {
                ...
                fScenarioData.fOcdCore.fRepositoryMaterialStorage.clear();
