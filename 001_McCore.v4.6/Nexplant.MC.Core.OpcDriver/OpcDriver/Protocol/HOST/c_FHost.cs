...
--  Description     : FAMate Core FaOpcDriver Host Class 
    ...
    internal class FHost : IDisposable
    {
        ...
        public FOcdCore fOcdCore
        {
            get
            {
                try
                {
                    return m_fHostProtocol.fOcdCore;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEventPusher fEventPusher
        {
            get
            {
                try
                {
                    return m_fHostProtocol.fOcdCore.fEventPusher;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FOpcDriver fOpcDriver
        {
            get
            {
                try
                {
                    return m_fHostProtocol.fOcdCore.fOpcDriver;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                m_fTranDataMessage = new FHostOpenTransaction(this.fOpcDriver, m_transactionTimeout);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNodeHtrList = FHost2.parseConnectionTrigger(this.fOpcDriver, this.fHostDevice.fXmlNode, fState);
                    // --

                    fLog = new FHostDeviceStateChangedLog(
                        FOpcDriverLogCommon.createXmlNodeHDVL(this.fHostDevice.fXmlNode, FXmlTagHDVL.L_StateChanged)
                        );
            ...
            )
        {
            ...
            try
            {
                ...
                this.fHostDriver.send(new FHostDriverDataMessage(this.fOcdCore, fXmlNodeHdmg));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                // --
                if (fOpcDriver.fOcdCore.fConfig.enabledEventsOfHostDeviceState)
                {
            ...
            try
            {
                ...
                if (fHdmg.fHostMessageType == FHostMessageType.Reply)
                {
                    ...
                    if (fTranLog != null)
                    {
                        ...
                        fXmlNodeHmg = FHost2.getReplyMessage(this.fOpcDriver, fXmlNodeHsn, fTranLog.uniqueIdToString);
                    }
                }
                ...
                if (
                    this.fOcdCore.fConfig.enabledLogOfVfei ||
                    this.fOcdCore.fConfig.enabledEventsOfHostDeviceVfei
                    )
                {
                    // ***
                    // VFEI Parsing
                    ...
                    // ***
                    if (this.fOcdCore.fConfig.enabledLogOfVfei)
                    {
                        this.fOcdCore.fLogWriter.pushVfeiLog(
                    ...
                    if (this.fOcdCore.fConfig.enabledEventsOfHostDeviceVfei)
                    {
                ...
                if (fResultCode == FResultCode.Success)
                {
                    if (fLog.fHostMessageType == FHostMessageType.Command || fLog.fHostMessageType == FHostMessageType.Unsolicited)
                    {
                        ...
                        {
                            fXmlNodeHmg = FHost2.getReplyMessage(this.fOpcDriver, fXmlNodeHsn, fLog.uniqueIdToString);
                            if (fXmlNodeHmg != null)
                            {
                                fHmg = new FHostMessage(this.fOcdCore, fXmlNodeHmg);
                            }
                        }                        

                        // --

                        if (fOpcDriver.fOcdCore.fConfig.enabledEventsOfHostDeviceDataMessage)
                        {
                        ...
                        if (fHmg != null)
                        {
                            if (fHmg.autoReply)
                            {
                                ...
                                FOpcDriverCommon.setHostItemRandomValue(fHmt.fXmlNode);

                                // --

                                this.sendDataMessage(new FHostSession(this.fOcdCore, fXmlNodeHsn), fHmt);
                            }
                            else
                            {
                                // ***
                    ...
                    if (fOcdCore.fConfig.enabledEventsOfScenario)
                    {
                        if (fResultCode == FResultCode.Success)
                        {
                            fXmlNodeHtrList = FHost2.parseExpressionTrigger(this.fOpcDriver, fXmlNodeHmgl);
                            foreach (FXmlNode fXmlNodeHtr in fXmlNodeHtrList)
                            {
                                this.fEventPusher.pushHostTriggerRaisedEvent(
                                    FResultCode.Success,
            ...
            )
        {
            ...
            try
            {
                ...
                if (fOcdCore.fConfig.enabledEventsOfHostDeviceDataMessage)
                {
            ...
            )
        {
            ...
            try
            {
                while ((fLog = m_fTranDataMessage.getTimeoutTransaction()) != null)
                {
                    ...
                    if (fOcdCore.fConfig.enabledEventsOfScenario)
                    {
                        fXmlNodeHtrList = FHost2.parseTimeoutTrigger(this.fOpcDriver, fLog.fXmlNode, ref fXmlNodeRetryHcn);
                        foreach (FXmlNode fXmlNodeHtr in fXmlNodeHtrList)
                        {
                            this.fEventPusher.pushHostTriggerRaisedEvent(
                                FResultCode.Success,
            ...
            )
        {
            ...
            try
            {
                ...
                fHcn = new FHostCondition(this.fOcdCore, fXmlNodeHcn);
            ...
            )
        {
            try
            {
                ...
                // --
                if (this.fOcdCore.fConfig.enabledEventsOfHostDeviceError)
                {
            ...
            )
        {
            ...
            try
            {
                fXmlNodeListHcn = FHost2.getRetryCondition(this.fOpcDriver, fXmlNodeHmgl);
