            ...
            )
        {
            ...
            try
            {
                    ...
                    retCode == ReturnCode.UNSUPPORTEDUPDATERATE)
                {
                    ...
                    fDebugLogArgs = new FDebugLogArgs(FDebugLogCategory.Information, "Subscribe", this.GetType(), "procSubscribereloadBySession");
            ...
            try
            {
                ...
                foreach (ulong key in m_fSubscriberPlcState.fSessionList.Keys)
                {
                    ...
                    else
                    {
                        ...
                        // ***
                        if (
                            m_isFirstConnect && (m_fDeviceState == FDeviceState.Selected) ||
                            !m_isFirstConnect
                            )
                        {
