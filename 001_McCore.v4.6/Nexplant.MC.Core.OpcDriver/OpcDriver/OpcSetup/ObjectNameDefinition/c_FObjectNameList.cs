...
--  Description     : FAMate Core FaOpcDriver Object Name List Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FObjectNameList : FBaseObject<FObjectNameList>, FIObject
    {
        ...
        public FObjectNameList(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeONL(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FObjectNameList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FObjectNameList(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectNameList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FObjectNameList(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectNameCollection fChildObjectNameCollection
        {
            get
            {
                try
                {
                    return new FObjectNameCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagONA.E_ObjectName));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fOna.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ObjectNameList);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.ObjectName);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FObjectName(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
