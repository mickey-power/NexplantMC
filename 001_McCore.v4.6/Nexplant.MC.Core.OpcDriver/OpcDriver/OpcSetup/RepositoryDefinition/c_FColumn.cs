...
--  Description     : FAMate Core FaOpcDriver Column Class
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FColumn : FBaseObject<FColumn>, FIObject
    {
        ...
        public FColumn(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeCOL(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FColumnCollection fChildColumnCollection
        {
            get
            {
                try
                {
                    return new FColumnCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagCOL.E_Column));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FRepository(this.fOcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FColumn(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumn fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumn(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumn fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumn(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fOcdCore, ((FRepository)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fOcdCore, ((FColumn)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fOcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fOpcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fOpcDriver, ((FColumn)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fCol.fXmlNode);                    
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Column);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Column);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FColumn(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
