...
--  Description     : FAMate Core FaOpcDriver Repository Class
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FRepository : FBaseObject<FRepository>, FIObject
    {
        ...
        public FRepository(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeRPS(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FRepositoryList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepository fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepository(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepository fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepository(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Repository);
