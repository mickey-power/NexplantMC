...
--  Description     : FAMate Core FaOpcDriver Evnironment Class
...
{
    public class FEnvironment : FBaseObject<FEnvironment>, FIObject, FIOpcOperand, FIHostOperand
    {
        ...
        public FEnvironment(
           FOpcDriver fOpcDriver
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeENV(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FEnvironmentList(this.fOcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FEnvironment(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch(Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironment fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironment(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironment fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironment(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fOcdCore, fEnl.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fOcdCore, ((FEnvironmentList)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fOcdCore, ((FEnvironment)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fOcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fOpcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fOpcDriver, ((FEnvironment)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEnv.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Environment);
