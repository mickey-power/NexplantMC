...
--  Description     : FAMate Core FaOpcDriver Data Conversion Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FDataConversion : FBaseObject<FDataConversion>, FIObject
    {
        ...
        public FDataConversion(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeDCV(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public string min
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!FOpcDriverCommon.validateMinMax(fFormat, value, max))
                    {
                        FDebug.throwFException(string.Format(FConstants.err_m_0014, "Min"));
                    }
        ...
        public string max
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!FOpcDriverCommon.validateMinMax(fFormat, min, value))
                    {
                        FDebug.throwFException(string.Format(FConstants.err_m_0014, "Max"));
                    }
        ...
        public FDataConversionSet fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversion fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversion(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversion fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversion(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversion);
