...
--  Description     : FAMate Core FaOpcDriver Data Conversion Set List Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FDataConversionSetList : FBaseObject<FDataConversionSetList>, FIObject
    {
        ...
        public FDataConversionSetList(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeDCL(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FDataConversionSetList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSetList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSetCollection fChildDataConversionSetCollection
        {
            get
            {
                try
                {
                    return new FDataConversionSetCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagDCS.E_DataConversionSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fDcs.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversionSetList);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.DataConversionSet);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataConversionSet(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
