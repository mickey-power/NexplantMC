...
--  Description     : FAMate Core FaOpcDriver Equipment State Set Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FEquipmentStateSet : FBaseObject<FEquipmentStateSet>, FIObject
    {
        ...
        public FEquipmentStateSet(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeESS(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSet(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSet(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateCollection fChildEquipmentStateCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagEST.E_EquipmentState));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEst.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSet);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentState);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentState(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
