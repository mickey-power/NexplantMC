...
--  Description     : FAMate Core FaOpcDriver Equipment State Set List Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FEquipmentStateSetList : FBaseObject<FEquipmentStateSetList>, FIObject
    {
        ...
        public FEquipmentStateSetList(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeESL(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSetList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSetCollection fChildEquipmentStateSetCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateSetCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagESS.E_EquipmentStateSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEss.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSetList);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSet);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateSet(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
