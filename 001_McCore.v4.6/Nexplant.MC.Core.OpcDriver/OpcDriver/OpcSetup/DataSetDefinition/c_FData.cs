...
--  Description     : FAMate Core FaOpcDriver Data Class
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FData : FBaseObject<FData>, FIObject
    {
        ...
        public FData(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeDAT(fOpcDriver.fOcdCore.fXmlDoc))
        {
            ...
            set
            {
                try
                {
                    ...
                    else if (value == FDataSourceType.Column)
                    {
                        ...
                        value == FDataSourceType.ItemName ||
            ...
            set
            {
                try
                {
                    ...
                    if (
                        ...
                        this.fSourceType != FDataSourceType.ItemName &&
        ...
        public FDataCollection fChildDataCollection
        {
            get
            {
                try
                {
                    return new FDataCollection(this.fOcdCore, this.fXmlNode.selectNodes(FXmlTagDAT.E_Data));
                }
                catch(Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataCollection fFixedChildDataCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    return new FDataCollection(this.fOcdCore, this.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FDataSet(this.fOcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FData(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FData fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FData(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FData fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FData(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fOcdCore, fDts.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        info.Append("itn: " + this.sourceItem);
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fOcdCore, ((FDataSet)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fOcdCore, ((FData)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fOcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fOpcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fOpcDriver, ((FData)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Data);
            ...
            )
        {
            ...
            try
            {
                FOpcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Data);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FData(this.fOcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
