...
--  Description     : FAMate Core FaOpcDriver Data Set Class
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FDataSet : FBaseObject<FDataSet>, FIObject
    {
        ...
        public FDataSet(
            ...
            : base(fOpcDriver.fOcdCore, FOpcDriverCommon.createXmlNodeDTS(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FDataSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataSetList(this.fOcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataSet(this.fOcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataSet(this.fOcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        {           
            ...
            try
            {
                FOpcDriverCommon.validatePasteSiblingObject(this.fXmlNode,FCbObjectFormat.DataSet);
