...
--  Description     : FAMate Core FaOpcDriver Base Object Log Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public abstract class FBaseObjectLog<T> : IDisposable
    {
        ...
        // --
        private FOcdlCore m_fOcdlCore = null;
        ...
        {
            // ***
            // FOpcDriverLog 생성자 Only
            // ***
            m_fOcdlCore = new FOcdlCore();
            //
            m_fXmlNode = m_fOcdlCore.fXmlNodeOcdl;
        }
            ...
            )
        {
            if (!m_disposed)
            {
                if (disposing)
                {
                    ...
                    if (this is FOpcDriverLog && m_fOcdlCore != null)
                    {
                        m_fOcdlCore.Dispose();
                    }
                    m_fOcdlCore = null;
        ...
        public FOpcDriverLog fOpcDriverLog
        {
            get
            {
                try
                {
                    ...
                    return m_fOcdlCore.fOpcDriverLog;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            internal set
            {
                try
                {
                    m_fOcdlCore.fOpcDriverLog = value;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
