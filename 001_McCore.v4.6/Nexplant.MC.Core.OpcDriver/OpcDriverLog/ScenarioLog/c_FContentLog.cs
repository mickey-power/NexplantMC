...
--  Description     : FAMate Core FaOpcDriver Content Log Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FContentLog : FBaseObjectLog<FContentLog>, FIObjectLog
    {
        ...
        public FContentLog(      
            ...
            : base(FOpcDriverLogCommon.createXmlNodeCTTL(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FContentLog(
            ...
            : base(FOpcDriverLogCommon.createXmlNodeCTTL(fOpcDriver.fOcdCore.fXmlDoc, name, fFormat, stringValue))
        {
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FApplicationWrittenLog(this.fOcdlCore, fXmlNodeParent);
                    }
                    return new FContentLog(this.fOcdlCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FContentLog(this.fOcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FContentLog(this.fOcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLogCollection fChildContentLogCollection
        {
            get
            {
                try
                {
                    return new FContentLogCollection(this.fOcdlCore, this.fXmlNode.selectNodes(FXmlTagCTTL.E_Content));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fOcdlCore, this.fXmlNode.appendChild(fNewChild.fXmlNode));
            ...
            )
        {
            try
            {
                return appendChildContentLog(new FContentLog(fOpcDriver, name, fFormat, stringValue));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fOcdlCore, this.fXmlNode.insertBefore(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                return insertBeforeChildContentLog(
                    new FContentLog(fOpcDriver, name, fFormat, stringValue),
                    fRefChild
                    );
            }
            catch (Exception ex)
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fOcdlCore, this.fXmlNode.insertAfter(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                ...
                {
                    FOpcDriverCommon.validateRemoveChildObject(this.fXmlNode, fCttl.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fOcdlCore, ((FApplicationWrittenLog)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fOcdlCore, ((FContentLog)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
