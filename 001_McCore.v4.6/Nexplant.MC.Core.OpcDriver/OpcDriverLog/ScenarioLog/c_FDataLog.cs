...
--  Description     : FAMate Core FaOpcDriver Data Log Class 
    ...
    public class FDataLog : FBaseObjectLog<FDataLog>, FIObjectLog
    {
        ...
        public FDataLogCollection fChildDataLogCollection
        {
            get
            {
                try
                {
                    return new FDataLogCollection(this.fOcdlCore, this.fXmlNode.selectNodes(FXmlTagDATL.E_Data));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FDataSetLog(this.fOcdlCore, fXmlNodeParent);
                    }
                    else if (fXmlNodeParent.name == FXmlTagDATL.E_Data)
                    {
                        return new FDataLog(this.fOcdlCore, fXmlNodeParent);
                    }
        ...
        public FDataLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataLog(this.fOcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataLog(this.fOcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
