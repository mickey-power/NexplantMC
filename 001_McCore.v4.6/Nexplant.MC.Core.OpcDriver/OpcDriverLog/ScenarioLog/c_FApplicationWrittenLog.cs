...
--  Description     : FAMate Core FaOpcDriver Application Written Log Class 
...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FApplicationWrittenLog : FBaseObjectLog<FApplicationWrittenLog>, FIObjectLog
    {
        ...
        public FApplicationWrittenLog(      
            ...
            : base(FOpcDriverLogCommon.createXmlNodeAPPL(fOpcDriver.fOcdCore.fXmlDoc))
        {
        ...
        public FApplicationWrittenLog(
            ...
            : base(FOpcDriverLogCommon.createXmlNodeAPPL(fOpcDriver.fOcdCore.fXmlDoc, name))
        {
