...
--  Description     : FAMate Core FaOpcDriver Mapper Performed Log Class 
    ...
    public class FMapperPerformedLog : FBaseObjectLog<FMapperPerformedLog>, FIObjectLog
    {
        ...
        public FDataSetLogCollection fChildDataSetLogCollection
        {
            get
            {
                try
                {
                    return new FDataSetLogCollection(this.fOcdlCore, this.fXmlNode.selectNodes(FXmlTagDTSL.E_DataSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataSetLog(this.fOcdlCore, fXmlNodeDstl);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
