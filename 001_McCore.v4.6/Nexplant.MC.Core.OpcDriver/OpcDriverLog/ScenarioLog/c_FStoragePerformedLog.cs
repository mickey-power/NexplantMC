...
--  Description     : FAMate Core FaOpcDriver Storage Performed Log Class 
    ...
    public class FStoragePerformedLog : FBaseObjectLog<FStoragePerformedLog>, FIObjectLog
    {
        ...
        public FRepositoryLogCollection fChildRepositoryLogCollection
        {
            get
            {
                try
                {
                    return new FRepositoryLogCollection(this.fOcdlCore, this.fXmlNode.selectNodes(FXmlTagRPSL.E_Repository));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FRepositoryLog(this.fOcdlCore, fXmlNodeRpsl);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
