...
--  Description     : FAMate Core FaOpcDriver Repository Log Class 
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FStoragePerformedLog(this.fOcdlCore, fXmlNodeParent);
                    }
        ...
        public FRepositoryLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryLog(this.fOcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryLog(this.fOcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
