...
namespace Nexplant.MC.Core.FaOpcDriver
{
    public class FHostItemLog : FBaseObjectLog<FHostItemLog>, FIObjectLog
    {
        ...
        public FHostItemLog(
            ...
            : base(fOpcDriverLog.fOcdlCore, FOpcDriverCommon.createXmlNodeHIT(fOpcDriverLog.fOcdlCore.fXmlDoc))
        {
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (fXmlNodeParent.name == FXmlTagHMGL.E_HostMessage)
                    {
                        ...
                        {
                            return new FHostDeviceDataMessageReceivedLog(this.fOcdlCore, fXmlNodeParent);
                        }
                        else if (logType == FXmlTagHMGL.L_Sent)
                        {
                            return new FHostDeviceDataMessageSentLog(this.fOcdlCore, fXmlNodeParent);
                        }
                        return null;
                    }
                    return new FHostItemLog(this.fOcdlCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItemLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItemLog(this.fOcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItemLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItemLog(this.fOcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
