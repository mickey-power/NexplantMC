...
--
--  Program Id      : c_FXmlTagOTNL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.27
--  Description     : FAMate Core FaOpcDriver OPC Transmitter Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagOTNL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Transmitter Raised Log Element and Attribute 
        // ***
        public const string E_OpcTransmitter = "OTN";
        // --
