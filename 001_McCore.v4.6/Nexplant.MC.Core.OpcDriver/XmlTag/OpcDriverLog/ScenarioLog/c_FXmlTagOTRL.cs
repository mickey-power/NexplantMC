...
--
--  Program Id      : c_FXmlTagOTRL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.26
--  Description     : FAMate Core FaOpcDriver OPC Trigger Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagOTRL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Trigger Raised Log Element and Attribute 
        // ***
        public const string E_OpcTrigger = "OTR";
        // --
