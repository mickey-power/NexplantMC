...
--
--  Program Id      : c_FXmlTagOCDL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.28
--  Description     : FAMate Core FaOpcDriver OPC Driver Log XML Tag Definition Class 
...
{
    internal static class FXmlTagOCDL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Driver Log Element and Attribute 
        // ***
        public const string E_OpcDriver = "OCD";
        // --
