...
--
--  Program Id      : c_FXmlTagODEL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.09
--  Description     : FAMate Core FaOpcDriver OPC Device Error Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagODEL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Device Error Log Element and Attribute 
        // ***
        public const string E_OpcDeviceError = "ODE";        
        // --
