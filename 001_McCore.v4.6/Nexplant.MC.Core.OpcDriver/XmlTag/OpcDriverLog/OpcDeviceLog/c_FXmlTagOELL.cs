...
--
--  Program Id      : c_FXmlTagOELL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaOpcDriver OPC Event Item List Log XML Tag Definition Class 
...
{
    internal static class FXmlTagOELL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Event Item List Element and Attribute 
        // ***
        public const string E_OpcEventItemList = "OEL";
        // --
