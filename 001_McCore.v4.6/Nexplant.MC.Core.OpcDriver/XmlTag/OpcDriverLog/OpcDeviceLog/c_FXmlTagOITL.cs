...
--
--  Program Id      : c_FXmlTagOITL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaOpcDriver OPC Item Log XML Tag Definition Class 
...
{
    internal static class FXmlTagOITL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Item Element and Attribute 
        // ***
        public const string E_OpcItem = "OIT";
        // --
        ...
        public const string D_ItemFormat = "BT";
