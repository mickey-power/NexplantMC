...
--
--  Program Id      : c_FXmlTagODTL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.08
--  Description     : FAMate Core FaOpcDriver OPC Device Timeout Raised Log XML Tag Definition Class 
--  History         : Created by spike.lee at 2011.09.08
----------------------------------------------------------------------------------------------------------*/

namespace Nexplant.MC.Core.FaOpcDriver
{
    internal static class FXmlTagODTL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Device Timeout Log Element and Attribute 
        // ***
        public const string E_OpcDeviceTimeout = "ODT";        
        // --
