...
--
--  Program Id      : c_FXmlTagHDMG.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaOpcDriver Host Driver Data Message XML Tag Definition Class 
...
{
    internal static class FXmlTagHDMG
    {
        ...
        // ***
        // Host Driver Data Message Element and Attribute 
        // ***
        ...
        // --
        // Atlas Copco
        public const string A_AtlasNoAckFlag = "ANF";
        public const string A_AtlasStationId = "AST";
        public const string A_AtlasSpindleId = "ASP";
        // --
        ...
        // --
        // Atlas Copco
        public const string D_AtlasNoAckFlag = "F";
        public const string D_AtlasStationId = "";
        public const string D_AtlasSpindleId = "";
        // --
