...
--
--  Program Id      : c_FXmlTagOIL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaOpcDriver OPC Item List XML Tag Definition Class 
...
{
    internal static class FXmlTagOIL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Item List Element and Attribute 
        // ***
        public const string E_OpcItemList = "OIL";
        public const string E_OpcItemListValues = "OILV";
        // --
