...
--
--  Program Id      : c_FXmlTagOLB.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.11
--  Description     : FAMate Core FaOpcDriver OPC Library XML Tag Definition Class 
--  History         : Created by spike.lee at 2013.07.11
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagOLB
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Library Element and Attribute 
        // ***
        public const string E_OpcLibrary = "OLB";
        // --
