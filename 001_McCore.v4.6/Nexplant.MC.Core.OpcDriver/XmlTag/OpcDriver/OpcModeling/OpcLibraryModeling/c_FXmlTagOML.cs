...
--
--  Program Id      : c_FXmlTagOML.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaOpcDriver OPC Message List XML Tag Definition Class 
...
{
    internal static class FXmlTagOML
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Message List Element and Attribute 
        // ***
        public const string E_OpcMessageList = "OML";
        // --
