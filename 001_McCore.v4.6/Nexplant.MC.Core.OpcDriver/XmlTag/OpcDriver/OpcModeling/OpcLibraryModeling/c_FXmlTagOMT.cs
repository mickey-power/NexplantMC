...
--
--  Program Id      : c_FXmlTagOMT.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.30
--  Description     : FAMate Core FaOpcDriver OPC Message Transfer XML Tag Definition Class 
...
{
    internal static class FXmlTagOMT
    {
        ...
        // ***
        // OPC Message Transfer Element and Attribute 
        // ***
        ...
        public const string D_AutoReset = "T";
