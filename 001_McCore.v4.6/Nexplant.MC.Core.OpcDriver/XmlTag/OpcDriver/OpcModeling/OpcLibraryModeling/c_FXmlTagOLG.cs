...
--
--  Program Id      : c_FXmlTagOLG.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.11
--  Description     : FAMate Core FaOpcDriver OPC Library Group XML Tag Definition Class 
...
{
    internal static class FXmlTagOLG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Library Group Element and Attribute 
        // ***
        public const string E_OpcLibraryGroup = "OLG";
        // --
