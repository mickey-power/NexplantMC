...
--
--  Program Id      : c_FXmlTagOMS.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.10.29
--  Description     : FAMate Core FaOpcDriver OPC Messages XML Tag Definition Class 
...
{
    internal static class FXmlTagOMS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Messages Element and Attribute 
        // ***
        public const string E_OpcMessages = "OMS";
        // --
