...
--
--  Program Id      : c_FXmlTagITN.cs
--  Creator         : spike.lee
--  Create Date     : 2015.07.09
--  Description     : FAMate Core FaOpcDriver Item Name XML Tag Definition Class 
...
{
    internal static class FXmlTagITN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Item Name Element and Attribute 
        // ***
        public const string E_ItemName = "ITN";
        // --
