...
--
--  Program Id      : c_FXmlTagOSN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.10
--  Description     : FAMate Core FaOpcDriver OPC Session Modeling XML Tag Definition Class 
...
{
    internal static class FXmlTagOSN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Session Element and Attribute 
        // ***
        public const string E_OpcSession = "OSN";
        // --
        ...
        public const string A_Channel = "CH";
        public const string A_UpdateRate = "UR";
        public const string A_DeadBand = "DB";
        public const string A_OpcLibraryId = "LI";
        ...
        public const string D_Channel = "";
        public const string D_UpdateRate = "500";
        public const string D_DeadBand = "0";
        public const string D_OpcLibraryId = "";
