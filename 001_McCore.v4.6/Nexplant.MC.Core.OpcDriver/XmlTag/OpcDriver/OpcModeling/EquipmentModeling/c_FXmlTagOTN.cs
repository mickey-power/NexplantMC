...
--
--  Program Id      : c_FXmlTagOTN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaOpcDriver OPC Transmitter XML Tag Definition Class 
...
{
    internal static class FXmlTagOTN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Transmitter Element and Attribute 
        // ***
