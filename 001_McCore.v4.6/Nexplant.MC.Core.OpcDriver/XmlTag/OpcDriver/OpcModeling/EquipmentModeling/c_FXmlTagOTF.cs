...
--
--  Program Id      : c_FXmlTagOTF.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaOpcDriver OPC Transfer XML Tag Definition Class 
...
{
    internal static class FXmlTagOTF
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Transfer Element and Attribute 
        // ***
        public const string E_OpcTransfer = "OTF";
        // --
