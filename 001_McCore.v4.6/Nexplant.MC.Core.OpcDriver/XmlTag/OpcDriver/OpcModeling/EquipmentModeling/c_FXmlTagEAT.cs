...
--
--  Program Id      : c_FXmlTagEAT.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaOpcDriver Equipment State Alterer XML Tag Definition Class 
--  History         : Created by spike.lee at 2012.08.09
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagEAT
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment State Alterer Element and Attribute 
        // ***
        ...
        public const string D_EquipmentStateId = "";
