...
--
--  Program Id      : c_FXmlTagOTR.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaOpcDriver OPC Trigger XML Tag Definition Class 
...
{
    internal static class FXmlTagOTR
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Trigger Element and Attribute 
        // ***
