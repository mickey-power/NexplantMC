...
--
--  Program Id      : c_FXmlTagOCN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaOpcDriver OPC Condition XML Tag Definition Class 
...
{
    internal static class FXmlTagOCN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Condition Element and Attribute 
        // ***
        public const string E_OpcCondition = "OCN";
        // --
        ...
        public const string A_ConditionMode = "CM";
        public const string A_OpcDeviceId = "DI";
        public const string A_OpcSessionId = "SI";
        public const string A_OpcMessageId = "MI";        
        public const string A_ConnectionState = "CS";
        public const string A_OpcMessageName = "MN";
        public const string A_ParentName = "PN";
        ...
        public const string D_ConditionMode = "";
        public const string D_OpcDeviceId = "";
        public const string D_OpcSessionId = "";
        public const string D_OpcMessageId = "";
        public const string D_OpcMessageName = "";
        public const string D_ParentName = "";
        public const string D_ConnectionState = "";
