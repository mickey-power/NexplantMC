...
--
--  Program Id      : c_FXmlTagOCD.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.09
--  Description     : FAMate Core FaOpcDriver OPC Driver XML Tag Definition Class 
...
{
    internal static class FXmlTagOCD
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // OPC Driver Element and Attribute 
        // ***
