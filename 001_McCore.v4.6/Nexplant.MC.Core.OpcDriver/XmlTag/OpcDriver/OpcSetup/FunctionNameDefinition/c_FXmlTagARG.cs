...
--
--  Program Id      : c_FXmlTagARG.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.10
--  Description     : FAMate Core FaOpcDriver Argument XML Tag Definition Class 
...
{
    internal static class FXmlTagARG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Argument Element and Attribute 
        // ***
        public const string E_Argument = "ARG";
        // --
