...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostItemLog : FBaseObjectLog<FHostItemLog>, FIObjectLog
    {
        ...
        public FHostItemLog(
            ...
            : base(fSecsDriverLog.fScdlCore, FSecsDriverCommon.createXmlNodeHIT(fSecsDriverLog.fScdlCore.fXmlDoc))
        {
        ...
        public FHostItemLogCollection fChildHostItemLogCollection
        {
            get
            {
                try
                {
                    return new FHostItemLogCollection(this.fScdlCore, this.fXmlNode.selectNodes(FXmlTagHITL.E_HostItem));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (fXmlNodeParent.name == FXmlTagHMGL.E_HostMessage)
                    {
                        ...
                        {
                            return new FHostDeviceDataMessageReceivedLog(this.fScdlCore, fXmlNodeParent);
                        }
                        else if (logType == FXmlTagHMGL.L_Sent)
                        {
                            return new FHostDeviceDataMessageSentLog(this.fScdlCore, fXmlNodeParent);
                        }
                        return null;
                    }
                    return new FHostItemLog(this.fScdlCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItemLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItemLog(this.fScdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItemLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItemLog(this.fScdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostItemLog(this.fScdlCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
