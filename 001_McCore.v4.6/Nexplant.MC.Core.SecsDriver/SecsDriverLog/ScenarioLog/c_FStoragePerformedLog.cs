...
--  Description     : FAMate Core FaSecsDriver Storage Performed Log Class 
    ...
    public class FStoragePerformedLog : FBaseObjectLog<FStoragePerformedLog>, FIObjectLog
    {
        ...
        public FRepositoryLogCollection fChildRepositoryLogCollection
        {
            get
            {
                try
                {
                    return new FRepositoryLogCollection(this.fScdlCore, this.fXmlNode.selectNodes(FXmlTagRPSL.E_Repository));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FRepositoryLog(this.fScdlCore, fXmlNodeRpsl);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FRepositoryLog(this.fScdlCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
