...
--  Description     : FAMate Core FaSecsDriver Repository Log Class 
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FStoragePerformedLog(fScdlCore, fXmlNodeParent);
                    }
        ...
        public FRepositoryLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryLog(this.fScdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryLog(this.fScdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
