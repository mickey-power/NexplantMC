...
--  Description     : FAMate Core FaSecsDriver Column Log Class 
    ...
    public class FColumnLog : FBaseObjectLog<FColumnLog>, FIObjectLog
    {
        ...
        public FColumnLogCollection fChildColumnLogCollection
        {
            get
            {
                try
                {
                    return new FColumnLogCollection(this.fScdlCore, this.fXmlNode.selectNodes(FXmlTagCOLL.E_Column));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FRepositoryLog(fScdlCore, fXmlNodeParent);
                    }
                    else if (fXmlNodeParent.name == FXmlTagCOLL.E_Column)
                    {
                        return new FColumnLog(fScdlCore, fXmlNodeParent);
                    }
        ...
        public FColumnLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumnLog(this.fScdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumnLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumnLog(this.fScdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FColumnLog(this.fScdlCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
