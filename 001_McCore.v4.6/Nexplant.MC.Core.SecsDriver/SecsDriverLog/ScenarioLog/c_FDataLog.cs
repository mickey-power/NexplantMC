...
--  Description     : FAMate Core FaSecsDriver Data Log Class 
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FDataSetLog(fScdlCore, fXmlNodeParent);
                    }
                    else if (fXmlNodeParent.name == FXmlTagDATL.E_Data)
                    {
                        return new FDataLog(fScdlCore, fXmlNodeParent);
                    }
        ...
        public FDataLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataLog(this.fScdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataLog(this.fScdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
