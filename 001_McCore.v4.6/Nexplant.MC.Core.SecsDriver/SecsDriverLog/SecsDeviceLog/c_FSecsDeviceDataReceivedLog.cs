...
--
--  Program Id      : c_FSecsDeviceDataReceivedLog.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.06
--  Description     : FAMate Core FaSecsDriver SECS Device Data Received Log Class 
...
{
    public class FSecsDeviceDataReceivedLog : FSecsDeviceLog<FSecsDeviceDataReceivedLog>
    {
        ...
        internal FSecsDeviceDataReceivedLog(      
            FXmlNode fXmlNode
            )
            : base(fXmlNode)
        {
        ...
        public override FObjectLogType fObjectLogType
        {
            get
            {
                try
                {
                    return FObjectLogType.SecsDeviceDataReceivedLog;
                }
                catch (Exception ex)
                {
