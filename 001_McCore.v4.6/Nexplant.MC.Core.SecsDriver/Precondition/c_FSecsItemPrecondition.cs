...
--
--  Program Id      : c_FSecsItemPrecondition.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.09
--  Description     : FAMate Core FaSecsDriver SECS Item Precondition Class 
...
{
    public class FSecsItemPrecondition : FIPrecondition, IDisposable
    {
        ...
        internal FSecsItemPrecondition(            
            FSecsItem fSit
            )            
        {
            m_fSit = fSit;
        ...
        public FIPreconditionValueCollection fPreconditionValueCollection
        {
            get
            {
                try
                {
                    return new FSecsItemPreconditionValueCollection(m_fSit.fXmlNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                val = m_fSit.fXmlNode.get_attrVal(FXmlTagSIT.A_Precondition, FXmlTagSIT.D_Precondition);
                if (val == string.Empty)
                {
            ...
            )
        {
            try
            {
                m_fSit.fXmlNode.set_attrVal(
                    FXmlTagSIT.A_Precondition,
                    FXmlTagSIT.D_Precondition,
