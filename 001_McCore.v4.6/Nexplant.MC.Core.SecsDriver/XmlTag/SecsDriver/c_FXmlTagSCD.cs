...
--
--  Program Id      : c_FXmlTagSCD.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.31
--  Description     : FAMate Core FaSecsDriver SECS Driver XML Tag Definition Class 
...
{
    internal static class FXmlTagSCD
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Driver Element and Attribute 
        // ***
