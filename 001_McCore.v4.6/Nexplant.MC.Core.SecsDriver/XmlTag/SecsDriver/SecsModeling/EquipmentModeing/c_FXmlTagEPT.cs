...
--
--  Program Id      : c_FXmlTagETP.cs
--  Creator         : spike.lee
--  Create Date     : 2014.03.20
--  Description     : FAMate Core FaSecsDriver Entry Pointer XML Tag Definition Class 
...
{
    internal static class FXmlTagETP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Entry Point Element and Attribute 
        // ***
