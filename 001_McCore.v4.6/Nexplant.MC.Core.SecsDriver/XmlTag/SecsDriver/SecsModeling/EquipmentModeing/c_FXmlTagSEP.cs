...
--
--  Program Id      : c_FXmlTagSEP.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver SECS Expression XML Tag Definition Class 
...
{
    internal static class FXmlTagSEP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Expression Element and Attribute 
        // ***
        public const string E_SecsExpression = "SEP";
        // --
        ...
        public const string D_OperandType = "S";
