...
--
--  Program Id      : c_FXmlTagPAU.cs
--  Creator         : jeff.lee
--  Create Date     : 2013.01.23
--  Description     : FAMate Core FaSecsDriver Pauser XML Tag Definition Class 
...
{
    internal static class FXmlTagPAU
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Pauser Element and Attribute 
        // ***
