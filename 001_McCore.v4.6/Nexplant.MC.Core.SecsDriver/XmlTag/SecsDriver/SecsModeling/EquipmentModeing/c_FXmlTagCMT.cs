...
--
--  Program Id      : c_FXmlTagCMT.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.03
--  Description     : FAMate Core FaSecsDriver Comment XML Tag Definition Class 
...
{
    internal static class FXmlTagCMT
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Comment Element and Attribute 
        // ***
