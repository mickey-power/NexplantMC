...
--
--  Program Id      : c_FXmlTagESA.cs
--  Creator         : spike.lee
--  Create Date     : 2012.03.07
--  Description     : FAMate Core FaSecsDriver Equipment State Set Alterer XML Tag Definition Class 
...
{
    internal static class FXmlTagESA
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment State Set Alterer Element and Attribute 
        // ***
        ...
        public const string D_EquipmentStateSetId = "";
