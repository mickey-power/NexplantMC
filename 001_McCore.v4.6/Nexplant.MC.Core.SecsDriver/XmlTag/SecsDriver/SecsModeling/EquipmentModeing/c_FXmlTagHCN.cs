...
--
--  Program Id      : c_FXmlTagHCN.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver Host Condition XML Tag Definition Class 
...
{
    internal static class FXmlTagHCN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Condition Element and Attribute 
        // ***
        public const string E_HostCondition = "HCN";
        // --
