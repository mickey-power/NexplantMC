...
--
--  Program Id      : c_FXmlTagHEP.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver Host Expression XML Tag Definition Class 
...
{
    internal static class FXmlTagHEP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Expression Element and Attribute 
        // ***
        public const string E_HostExpression = "HEP";
        // --
        ...
        public const string D_OperandType = "H";
