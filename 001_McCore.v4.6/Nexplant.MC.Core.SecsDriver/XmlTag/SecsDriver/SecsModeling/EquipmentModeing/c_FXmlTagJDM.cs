...
--
--  Program Id      : c_FXmlTagJDM.cs
--  Creator         : spike.lee
--  Create Date     : 2012.01.16
--  Description     : FAMate Core FaSecsDriver Judgement XML Tag Definition Class 
...
{
    internal static class FXmlTagJDM
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Judgement Element and Attribute 
        // ***
