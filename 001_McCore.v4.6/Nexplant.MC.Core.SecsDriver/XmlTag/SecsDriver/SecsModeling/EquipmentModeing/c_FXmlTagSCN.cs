...
--
--  Program Id      : c_FXmlTagSCN.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver SECS Condition XML Tag Definition Class 
...
{
    internal static class FXmlTagSCN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Condition Element and Attribute 
        // ***
        public const string E_SecsCondition = "SCN";
        // --
        ...
        public const string D_SecsDeviceId = "";
        public const string D_SecsSessionId = "";
        public const string D_SecsMessageId = "";
        public const string D_ConnectionState = "";
        public const string D_RetryLimit = "0";
        public const string D_RetryCount = "0";
