...
--
--  Program Id      : c_FXmlTagSTN.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver SECS Transmitter XML Tag Definition Class 
...
{
    internal static class FXmlTagSTN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Transmitter Element and Attribute 
        // ***
