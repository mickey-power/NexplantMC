...
--
--  Program Id      : c_FXmlTagSTR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver SECS Trigger XML Tag Definition Class 
...
{
    internal static class FXmlTagSTR
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Trigger Element and Attribute 
        // ***
