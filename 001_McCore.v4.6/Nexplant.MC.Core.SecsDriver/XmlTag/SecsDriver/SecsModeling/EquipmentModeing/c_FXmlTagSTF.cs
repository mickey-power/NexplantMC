...
--
--  Program Id      : c_FXmlTagSTF.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver SECS Transfer XML Tag Definition Class 
...
{
    internal static class FXmlTagSTF
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Transfer Element and Attribute 
        // ***
        public const string E_SecsTransfer = "STF";
        // --
