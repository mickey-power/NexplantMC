...
--  Description     : FAMate Core FaSecsDriver Scenario XML Tag Definition Class 
...
{
    internal static class FXmlTagSNR
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Scenario Element and Attribute 
        // ***
        public const string E_Scenario = "SNR";
        // --
