...
--
--  Program Id      : c_FXmlTagSNG.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.24
--  Description     : FAMate Core FaSecsDriver Scenario Group XML Tag Definition Class 
...
{
    internal static class FXmlTagSNG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Scenario Group Element and Attribute 
        // ***
        public const string E_ScenarioGroup = "SNG";
        // --
        ...
        public const string A_EquipmentAlias = "EA";
        public const string A_EapAlias = "AA";
        public const string A_HostAlias = "HS";
        ...
        public const string D_EquipmentAlias = "EQ";
        public const string D_EapAlias = "MC";
        public const string D_HostAlias = "HOST";
