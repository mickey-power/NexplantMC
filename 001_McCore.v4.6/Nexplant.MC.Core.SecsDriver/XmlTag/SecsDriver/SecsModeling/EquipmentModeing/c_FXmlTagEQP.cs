...
--
--  Program Id      : c_FXmlTagEQP.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.19
--  Description     : FAMate Core FaSecsDriver Equipment XML Tag Definition Class 
...
{
    internal static class FXmlTagEQP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment Element and Attribute 
        // ***
        public const string E_Equipment = "EQP";
        // --
