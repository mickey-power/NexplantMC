...
--
--  Program Id      : c_FXmlTagBRN.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.18
--  Description     : FAMate Core FaSecsDriver Branch XML Tag Definition Class 
...
{
    internal static class FXmlTagBRN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Branch Element and Attribute 
        // ***
        public const string E_Branch = "BRN";
        // --
