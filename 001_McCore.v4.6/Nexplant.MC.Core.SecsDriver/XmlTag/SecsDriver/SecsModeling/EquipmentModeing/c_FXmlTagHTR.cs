...
--
--  Program Id      : c_FXmlTagHTR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.05.30
--  Description     : FAMate Core FaSecsDriver Host Trigger XML Tag Definition Class 
...
{
    internal static class FXmlTagHTR
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Trigger Element and Attribute 
        // ***
