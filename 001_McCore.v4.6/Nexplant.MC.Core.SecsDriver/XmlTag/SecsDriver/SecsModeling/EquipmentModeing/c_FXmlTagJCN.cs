...
--
--  Program Id      : c_FXmlTagJCN.cs
--  Creator         : spike.lee
--  Create Date     : 2012.01.17
--  Description     : FAMate Core FaSecsDriver Judgement Condition XML Tag Definition Class 
...
{
    internal static class FXmlTagJCN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Judgement Condition Element and Attribute 
        // ***
        public const string E_JudgementCondition = "JCN";
        // --
        ...
        public const string D_DataSetId = "";
