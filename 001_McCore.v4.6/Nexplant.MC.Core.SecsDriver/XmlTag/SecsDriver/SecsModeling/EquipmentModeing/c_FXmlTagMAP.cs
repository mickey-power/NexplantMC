...
--
--  Program Id      : c_FXmlTagMAP.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.30
--  Description     : FAMate Core FaSecsDriver Mapper XML Tag Definition Class 
...
{
    internal static class FXmlTagMAP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Mapper Element and Attribute 
        // ***
