...
--
--  Program Id      : c_FXmlTagSMS.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.10
--  Description     : FAMate Core FaSecsDriver SECS Messages XML Tag Definition Class 
...
{
    internal static class FXmlTagSMS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Messages Element and Attribute 
        // ***
        public const string E_SecsMessages = "SMS";
        // --
