...
--
--  Program Id      : c_FXmlTagSLG.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.28
--  Description     : FAMate Core FaSecsDriver SECS Library Group XML Tag Definition Class 
...
{
    internal static class FXmlTagSLG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Library Group Element and Attribute 
        // ***
        public const string E_SecsLibraryGroup = "SLG";
        // --
