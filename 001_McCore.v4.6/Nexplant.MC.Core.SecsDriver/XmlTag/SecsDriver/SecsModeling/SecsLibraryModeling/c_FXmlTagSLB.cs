...
--
--  Program Id      : c_FXmlTagSLB.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.31
--  Description     : FAMate Core FaSecsDriver SECS Library XML Tag Definition Class 
...
{
    internal static class FXmlTagSLB
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Library Element and Attribute 
        // ***
        public const string E_SecsLibrary = "SLB";
        // --
