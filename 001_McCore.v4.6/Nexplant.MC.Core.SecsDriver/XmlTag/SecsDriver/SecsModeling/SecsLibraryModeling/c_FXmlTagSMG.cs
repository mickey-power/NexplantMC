...
--
--  Program Id      : c_FXmlTagSMG.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.10
--  Description     : FAMate Core FaSecsDriver SECS Message XML Tag Definition Class 
...
{
    internal static class FXmlTagSMG
    {
        ...
        // ***
        // SECS Message Element and Attribute 
        // ***
