...
--
--  Program Id      : c_FXmlTagSML.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.31
--  Description     : FAMate Core FaSecsDriver SECS Message List XML Tag Definition Class 
...
{
    internal static class FXmlTagSML
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Message List Element and Attribute 
        // ***
        public const string E_SecsMessageList = "SML";
        // --
