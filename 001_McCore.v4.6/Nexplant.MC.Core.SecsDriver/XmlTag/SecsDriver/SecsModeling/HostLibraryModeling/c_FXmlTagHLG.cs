...
--
--  Program Id      : c_FXmlTagHLG.cs
--  Creator         : Kimsh
--  Create Date     : 2011.02.25
--  Description     : FAMate Core FaSecsDriver Host Library Group XML Tag Definition Class 
...
{
    internal static class FXmlTagHLG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Library Group Element and Attribute 
        // ***
        public const string E_HostLibraryGroup = "HLG";
        // --
