...
--
--  Program Id      : c_FXmlTagHMS.cs
--  Creator         : Kimsh
--  Create Date     : 2011.02.25
--  Description     : FAMate Core FaSecsDriver Host Messages XML Tag Definition Class 
...
{
    internal static class FXmlTagHMS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Messages Element and Attribute 
        // ***
        public const string E_HostMessages = "HMS";
        // --
        ...
        public const string A_Direction = "DI";
        ...
        public const string D_Direction = "";
