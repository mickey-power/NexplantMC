...
--
--  Program Id      : c_FXmlTagHLB.cs
--  Creator         : Kimsh
--  Create Date     : 2011.02.25
--  Description     : FAMate Core FaSecsDriver Host Library XML Tag Definition Class 
...
{
    internal static class FXmlTagHLB
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Library Element and Attribute 
        // ***
        public const string E_HostLibrary = "HLB";
        // --
        ...
        public const string A_Comment = "CMT";
