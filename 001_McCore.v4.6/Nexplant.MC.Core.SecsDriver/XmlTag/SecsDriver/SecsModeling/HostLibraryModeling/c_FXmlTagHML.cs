...
--
--  Program Id      : c_FXmlTagHML.cs
--  Creator         : Kimsh
--  Create Date     : 2011.02.25
--  Description     : FAMate Core FaSecsDriver Host Message List XML Tag Definition Class 
...
{
    internal static class FXmlTagHML
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Message List Element and Attribute 
        // ***
        public const string E_HostMessageList = "HML";
        // --
