...
--
--  Program Id      : c_FXmlTagSSN.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.14
--  Description     : FAMate Core FaSecsDriver SECS Session Modeling XML Tag Definition Class 
...
{
    internal static class FXmlTagSSN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Session Element and Attribute 
        // ***
        public const string E_SecsSession = "SSN";
        // --
        ...
        public const string A_SecsLibraryId = "LI";
        ...
        public const string D_SecsLibraryId = "";
