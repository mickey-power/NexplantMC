...
--
--  Program Id      : c_FXmlTagCOL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.10
--  Description     : FAMate Core FaSecsDriver Column Tag Definition Class 
...
{
    internal static class FXmlTagCOL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Column Element and Attribute 
        // ***
        ...
        public const string A_PartTag = "PT";           // 2017.03.29 by spike.lee Repository Select/Remove Part Option 지원 Tag
        ...
        public const string D_PartTag = "";         // 2017.03.29 by spike.lee Repository Select/Remove Part Option 지원 Tag
