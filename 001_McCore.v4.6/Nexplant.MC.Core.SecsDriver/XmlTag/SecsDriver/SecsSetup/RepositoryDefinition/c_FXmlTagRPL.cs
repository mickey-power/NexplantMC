...
--
--  Program Id      : c_FXmlTagRPL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.10
--  Description     : FAMate Core FaSecsDriver Repository List XML Tag Definition Class 
...
{
    internal static class FXmlTagRPL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Repository List Element and Attribute 
        // ***
        public const string E_RepositoryList = "RPL";
        // --
