...
--
--  Program Id      : c_FXmlTagPAN.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.11
--  Description     : FAMate Core FaSecsDriver Parameter Name XML Tag Definition Class 
...
{
    internal static class FXmlTagPAN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Parameter Name Element and Attribute 
        // ***
        public const string E_ParameterName = "PAN";
        // --
