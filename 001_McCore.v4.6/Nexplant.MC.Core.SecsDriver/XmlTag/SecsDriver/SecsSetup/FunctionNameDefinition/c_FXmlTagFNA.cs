...
--
--  Program Id      : c_FXmlTagFNA.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.11
--  Description     : FAMate Core FaSecsDriver Function Name XML Tag Definition Class 
...
{
    internal static class FXmlTagFNA
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Function Name Element and Attribute 
        // ***
        public const string E_FunctionName = "FNA";
        // --
