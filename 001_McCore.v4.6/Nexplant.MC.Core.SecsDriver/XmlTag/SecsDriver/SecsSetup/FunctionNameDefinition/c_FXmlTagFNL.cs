...
--
--  Program Id      : c_FXmlTagFNL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.11
--  Description     : FAMate Core FaSecsDriver Function Name List XML Tag Definition Class 
...
{
    internal static class FXmlTagFNL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Function Name List Element and Attribute 
        // ***
        public const string E_FunctionNameList = "FNL";
        // --
