...
--
--  Program Id      : c_FXmlTagENL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.18
--  Description     : FAMate Core FaSecsDriver Environment List XML Tag Definition Class 
...
{
    internal static class FXmlTagENL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Environment List Element and Attribute 
        // ***
        public const string E_EnvironmentList = "ENL";
        // --
