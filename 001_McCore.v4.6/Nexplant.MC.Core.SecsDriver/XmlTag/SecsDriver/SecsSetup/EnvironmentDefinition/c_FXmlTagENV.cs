...
--
--  Program Id      : c_FXmlTagENV.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.18
--  Description     : FAMate Core FaSecsDriver Environment XML Tag Definition Class 
...
{
    internal static class FXmlTagENV
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Environment Element and Attribute 
        // ***
        public const string E_Environment = "ENV";
        // --
