...
--
--  Program Id      : c_FXmlTagDSL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.28
--  Description     : FAMate Core FaSecsDriver Data Set List XML Tag Definition Class 
...
{
    internal static class FXmlTagDSL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Data Set List Element and Attribute 
        // ***
        public const string E_DataSetList = "DSL";
        // --
