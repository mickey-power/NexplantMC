...
--
--  Program Id      : c_FXmlTagDTS.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.28
--  Description     : FAMate Core FaSecsDriver Data Set XML Tag Definition Class 
...
{
    internal static class FXmlTagDTS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Data Set Element and Attribute 
        // ***
        public const string E_DataSet = "DTS";
        // --
