...
--
--  Program Id      : c_FXmlTagDAT.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.28
--  Description     : FAMate Core FaSecsDriver Data XML Tag Definition Class 
--  History         : Created by spike.lee at 2011.04.28
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagDAT
    {
        ...
        public const string A_SourceMessage = "SG";
        ...
        public const string A_Merge = "MG";
        ...
        public const string D_SourceMessage = "";
