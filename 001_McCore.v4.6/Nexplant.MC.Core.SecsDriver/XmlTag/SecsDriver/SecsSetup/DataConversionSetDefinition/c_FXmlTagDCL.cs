...
--
--  Program Id      : c_FXmlTagDCL.cs
--  Creator         : spike.lee
--  Create Date     : 2012.03.05
--  Description     : FAMate Core FaSecsDriver Data Conversion Set List XML Tag Definition Class 
...
{
    internal static class FXmlTagDCL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Data Conversion Set List Element and Attribute 
        // ***
        public const string E_DataConversionSetList = "DCL";
        // --
