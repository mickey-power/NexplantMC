...
--
--  Program Id      : c_FXmlTagDCS.cs
--  Creator         : spike.lee
--  Create Date     : 2012.03.05
--  Description     : FAMate Core FaSecsDriver Data Conversion Set XML Tag Definition Class 
...
{
    internal static class FXmlTagDCS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Data Conversion Set Element and Attribute 
        // ***
        public const string E_DataConversionSet = "DCS";
        // --
