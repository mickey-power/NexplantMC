...
--
--  Program Id      : c_FXmlTagONL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.11
--  Description     : FAMate Core FaSecsDriver Objecdt Name List XML Tag Definition Class 
...
{
    internal static class FXmlTagONL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Object Name List Element and Attribute 
        // ***
        public const string E_ObjectNameList = "ONL";
        // --
