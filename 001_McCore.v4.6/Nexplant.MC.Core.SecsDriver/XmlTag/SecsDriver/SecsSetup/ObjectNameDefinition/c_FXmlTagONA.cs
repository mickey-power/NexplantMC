...
--
--  Program Id      : c_FXmlTagONA.cs
--  Creator         : spike.lee
--  Create Date     : 2011.03.11
--  Description     : FAMate Core FaSecsDriver Objecdt Name XML Tag Definition Class 
...
{
    internal static class FXmlTagONA
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Object Name Element and Attribute 
        // ***
        public const string E_ObjectName = "ONA";
        // --
