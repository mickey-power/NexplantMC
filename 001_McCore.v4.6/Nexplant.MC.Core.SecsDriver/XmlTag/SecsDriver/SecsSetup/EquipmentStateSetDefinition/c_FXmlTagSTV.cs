...
--
--  Program Id      : c_FXmlTagSTV.cs
--  Creator         : spike.lee
--  Create Date     : 2012.02.22
--  Description     : FAMate Core FaSecsDriver State Value XML Tag Definition Class 
...
{
    internal static class FXmlTagSTV
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // State Value Element and Attribute 
        // ***
        public const string E_StateValue = "STV";
        // --
