...
--
--  Program Id      : c_FXmlTagESL.cs
--  Creator         : spike.lee
--  Create Date     : 2012.02.22
--  Description     : FAMate Core FaSecsDriver Equipment State Set List XML Tag Definition Class 
...
{
    internal static class FXmlTagESL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment State Set List Element and Attribute 
        // ***
        public const string E_EquipmentStateSetList = "ESL";
        // --
