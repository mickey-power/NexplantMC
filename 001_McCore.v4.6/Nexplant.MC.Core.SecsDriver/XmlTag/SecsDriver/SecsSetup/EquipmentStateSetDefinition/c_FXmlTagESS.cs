...
--
--  Program Id      : c_FXmlTagESS.cs
--  Creator         : spike.lee
--  Create Date     : 2012.03.05
--  Description     : FAMate Core FaSecsDriver Equipment State Set XML Tag Definition Class 
...
{
    internal static class FXmlTagESS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment State Set Element and Attribute 
        // ***
        public const string E_EquipmentStateSet = "ESS";
        // --
