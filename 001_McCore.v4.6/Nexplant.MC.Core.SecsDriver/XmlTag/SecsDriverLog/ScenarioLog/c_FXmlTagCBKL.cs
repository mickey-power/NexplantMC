...
--
--  Program Id      : c_FXmlTagCBKL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.31
--  Description     : FAMate Core FaSecsDriver Callback Raised Log XML Tag Definition Class 
--  History         : Created by spike.lee at 2011.10.31
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagCBKL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Callback Raised Log Element and Attribute 
        // ***
        public const string E_Callback = "CBK";
        // --
