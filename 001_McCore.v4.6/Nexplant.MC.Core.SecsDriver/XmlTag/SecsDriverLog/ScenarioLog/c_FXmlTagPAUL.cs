...
--
--  Program Id      : c_FXmlTagPAUL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.03
--  Description     : FAMate Core FaSecsDriver Pauser Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPAUL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Pauser Written Log Element and Attribute 
        // ***
        public const string E_Pauser = "PAU";
        // --
        ...
        public const string A_PauseMode = "PM";
        public const string A_PauseMinTime = "MN";
        public const string A_PauseMaxTime = "MX";
        public const string A_PauseTime = "PT";
        ...
        public const string D_PauseMode = "F";
        public const string D_PauseMinTime = "0";
        public const string D_PauseMaxTime = "0";
        public const string D_PauseTime = "1000";        
