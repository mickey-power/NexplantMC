...
--
--  Program Id      : c_FXmlTagMAPL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.30
--  Description     : FAMate Core FaSecsDriver Mapper Performed Log XML Tag Definition Class 
...
{
    internal static class FXmlTagMAPL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Mapper Performed Log Element and Attribute 
        // ***
        public const string E_Mapper = "MAP";
        // --
        ...
        public const string A_DataSetId = "DI";
        public const string A_DataSetName = "DN";
        ...
        public const string D_DataSetId = "0";
        public const string D_DataSetName = "";
