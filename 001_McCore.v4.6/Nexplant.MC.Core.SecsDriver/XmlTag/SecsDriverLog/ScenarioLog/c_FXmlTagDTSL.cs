...
--
--  Program Id      : c_FXmlTagDTSL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.12.07
--  Description     : FAMate Core FaSecsDriver Data Set Log XML Tag Definition Class 
...
{
    internal static class FXmlTagDTSL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Data Set Log Element and Attribute 
        // ***
