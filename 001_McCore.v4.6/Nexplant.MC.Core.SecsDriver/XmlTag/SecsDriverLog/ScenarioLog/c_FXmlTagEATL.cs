...
--
--  Program Id      : c_FXmlTagEATL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.06.21
--  Description     : FAMate Core FaSecsDriver Equipment State Alterer Log XML Tag Definition Class 
--  History         : Created by spike.lee at 2013.06.21
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagEATL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment State Alterer Log Element and Attribute 
        // ***
        public const string E_EquipmentStateAlterer = "EAT";
        // --
        ...
        public const string A_EquipmentStateId = "AI";
        public const string A_EquipmentStateName = "AN";
        ...
        public const string D_EquipmentStateId = "0";
        public const string D_EquipmentStateName = "";
