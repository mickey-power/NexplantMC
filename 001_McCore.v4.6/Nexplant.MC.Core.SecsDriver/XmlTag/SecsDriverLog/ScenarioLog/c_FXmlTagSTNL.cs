...
--
--  Program Id      : c_FXmlTagSTNL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.27
--  Description     : FAMate Core FaSecsDriver SECS Transmitter Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSTNL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Transmitter Raised Log Element and Attribute 
        // ***
        public const string E_SecsTransmitter = "STN";
        // --
