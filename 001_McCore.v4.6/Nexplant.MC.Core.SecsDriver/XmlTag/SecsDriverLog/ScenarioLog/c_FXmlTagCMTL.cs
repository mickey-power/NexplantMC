...
--
--  Program Id      : c_FXmlTagCMTL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.03
--  Description     : FAMate Core FaSecsDriver Comment Written Log XML Tag Definition Class 
...
{
    internal static class FXmlTagCMTL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Comment Written Log Element and Attribute 
        // ***
        public const string E_Comment = "CMT";
        // --
