...
--
--  Program Id      : c_FXmlTagSTGL.cs
--  Creator         : spike.lee
--  Create Date     : 2012.01.02
--  Description     : FAMate Core FaSecsDriver Storage Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSTGL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Storage Log Element and Attribute 
        // ***
        ...
        public const string A_RepositoryName = "RN";
        ...
        public const string A_RepositoryMaterialCount = "C";
        ...
        public const string D_RepositoryName = "";
        ...
        public const string D_RepositoryMaterialCount = "0";
