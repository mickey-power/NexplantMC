...
--
--  Program Id      : c_FXmlTagSTRL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.26
--  Description     : FAMate Core FaSecsDriver SECS Trigger Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSTRL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Trigger Raised Log Element and Attribute 
        // ***
        public const string E_SecsTrigger = "STR";
        // --
