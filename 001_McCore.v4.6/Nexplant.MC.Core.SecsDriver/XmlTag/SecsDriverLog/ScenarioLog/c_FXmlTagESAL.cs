...
--  Description     : FAMate Core FaSecsDriver Equipment State Set Alterer Performed Log XML Tag Definition Class 
...
{
    internal static class FXmlTagESAL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Equipment State Set Alterer Performed Log Element and Attribute 
        // ***
        public const string E_EquipmentStateSetAlterer = "ESA";
        // --
        ...
        public const string A_EquipmentStateSetId = "AI";
        public const string A_EquipmentStateSetName = "AN";
        ...
        public const string D_EquipmentStateSetId = "0";
        public const string D_EquipmentStateSetName = "";
