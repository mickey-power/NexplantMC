...
--
--  Program Id      : c_FXmlTagSCDL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.28
--  Description     : FAMate Core FaSecsDriver SECS Driver Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSCDL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Driver Log Element and Attribute 
        // ***
        public const string E_SecsDriver = "SCD";
        // --
        ...
        public const string A_EapName = "EN";
