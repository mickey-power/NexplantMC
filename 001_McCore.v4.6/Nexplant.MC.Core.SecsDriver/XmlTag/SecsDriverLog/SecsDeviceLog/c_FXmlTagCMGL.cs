...
--
--  Program Id      : c_FXmlTagCMGL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.05
--  Description     : FAMate Core FaSecsDriver SECS Device HSMS Control Message Log XML Tag Definition Class 
...
{
    internal static class FXmlTagCMGL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Control Message Log Type
        // ***
        ...
        // ***
        // Control Message Log Element and Attribute 
        // ***
        public const string E_ControlMessage = "CMG";        
        // --
        ...
        public const string A_Type = "TP";
        public const string A_Reason = "RS";
        public const string A_SessionId = "EI";
        public const string A_Byte2 = "B2";
        public const string A_Byte3 = "B3";
        public const string A_PType = "P";
        public const string A_SType = "S";
        ...
        public const string D_Type = "5";
        public const string D_Reason = "";
        public const string D_SessionId = "0";
        public const string D_Byte2 = "0";
        public const string D_Byte3 = "0";
        public const string D_PType = "0";
        public const string D_SType = "5";
