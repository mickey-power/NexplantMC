...
--
--  Program Id      : c_FXmlTagSDTL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.08
--  Description     : FAMate Core FaSecsDriver SECS Device Timeout Raised Log XML Tag Definition Class 
--  History         : Created by spike.lee at 2011.09.08
----------------------------------------------------------------------------------------------------------*/

namespace Nexplant.MC.Core.FaSecsDriver
{
    internal static class FXmlTagSDTL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Device Timeout Log Element and Attribute 
        // ***
        public const string E_SecsDeviceTimeout = "SDT";        
        // --
        ...
        public const string D_Timeout = "6";
