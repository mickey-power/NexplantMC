...
--
--  Program Id      : c_FXmlTagSITL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.07
--  Description     : FAMate Core FaSecsDriver SECS Item Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSITL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Item Log Element and Attribute 
        // ***
        ...
        public const string A_LengthBytes = "B";
        ...
        public const string D_LengthBytes = "0";
