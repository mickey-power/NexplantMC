...
--
--  Program Id      : c_FXmlTagSDEL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.09.09
--  Description     : FAMate Core FaSecsDriver SECS Device Error Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSDEL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Device Error Log Element and Attribute 
        // ***
        public const string E_SecsDeviceError = "SDE";        
        // --
