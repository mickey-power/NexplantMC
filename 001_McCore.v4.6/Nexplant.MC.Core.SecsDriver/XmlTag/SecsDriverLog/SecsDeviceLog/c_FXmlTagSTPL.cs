...
{
    internal static class FXmlTagSTPL
    {
        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Device Telnet State Changed Log Type
        // ***
        public const string L_Received = "R";
        public const string L_Sent = "S";

        // ***
        // SECS Device Telnet Packet Log Element and Attribute 
        // ***
        public const string E_SecsDeviceTelnetPacket = "STP";
        // --
        ...
        public const string A_PacketType = "PT";
        public const string A_TelnetCommand = "TC";
        public const string A_TelnetOption = "TO";
        public const string A_TelnetData = "TD";
        ...
        public const string D_PacketType = "C";
        public const string D_TelnetCommand = "";
        public const string D_TelnetOption = "";
        public const string D_TelnetData = "";
