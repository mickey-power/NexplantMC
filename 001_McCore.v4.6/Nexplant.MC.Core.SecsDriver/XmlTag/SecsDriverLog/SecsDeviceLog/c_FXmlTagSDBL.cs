...
--
--  Program Id      : c_FXmlTagSDBL.cs
--  Creator         : byungyun.jeon
--  Create Date     : 2011.11.07
--  Description     : FAMate Core FaSecsDriver SECS Device SECS-I Block Log XML Tag Definition Class 
...
{
    internal static class FXmlTagSDBL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // SECS Device Block Log Type
        // ***
        ...
        // ***
        // SECS Device Block Log Element and Attribute 
        // ***
        public const string E_SecsDeviceBlock = "SDB";
        // --
        ...
        public const string A_EBit = "E";
        public const string A_BlockNo = "BN";
        ...
        public const string D_RBit = "F";
        public const string D_SessionId = "0";
        public const string D_WBit = "F";
        public const string D_Stream = "";
        public const string D_Function = "";
        public const string D_EBit = "F";
        public const string D_BlockNo = "0";
