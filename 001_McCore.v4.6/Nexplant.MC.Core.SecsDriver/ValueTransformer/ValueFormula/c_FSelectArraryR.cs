...
--
--  Program Id      : c_FSelectArrayR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.24
--  Description     : FAMate Core FaSecsDriver Select Array Reverse Formula Class 
...
{
    public class FSelectArrayR : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.SelectArrayR;
                }
                catch (Exception ex)
                {
