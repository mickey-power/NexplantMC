...
--
--  Program Id      : c_FChooseR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Choose Reverse Formula Class 
...
{
    public class FChooseR : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.ChooseR;
                }
                catch (Exception ex)
                {
