...
--
--  Program Id      : c_FRemove.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Remove Formula Class 
...
{
    public class FRemove : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.Remove;
                }
                catch (Exception ex)
                {
