...
--
--  Program Id      : c_FSelectIncluded.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Select Included Formula Class 
...
{
    public class FSelectIncluded : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.SelectIncluded;
                }
                catch (Exception ex)
                {
