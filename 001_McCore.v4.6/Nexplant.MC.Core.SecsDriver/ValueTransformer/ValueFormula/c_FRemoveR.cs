...
--
--  Program Id      : c_FRemoveR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Remove Reverse Formula Class 
...
{
    public class FRemoveR : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.RemoveR;
                }
                catch (Exception ex)
                {
