...
--
--  Program Id      : c_FPadLeft.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Pad Left Formula Class 
...
{
    public class FPadLeft : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.PadLeft;
                }
                catch (Exception ex)
                {
