...
--
--  Program Id      : c_FSelectArray.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.24
--  Description     : FAMate Core FaSecsDriver Select Array Formula Class 
...
{
    public class FSelectArray : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.SelectArray;
                }
                catch (Exception ex)
                {
