...
--  Description     : FAMate Core FaSecsDriver Value Formula Base Class 
    ...
    public abstract class FValueFormulaBase : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                else if (fType == FValueFormulaType.DateTimeTicks)
                {
                    fValueFormula = new FDateTimeTicks();
                }
                ...
                else if (fType == FValueFormulaType.RemoveNonPrintable)
                {
                    fValueFormula = new FRemoveNonPrintable();
                }
