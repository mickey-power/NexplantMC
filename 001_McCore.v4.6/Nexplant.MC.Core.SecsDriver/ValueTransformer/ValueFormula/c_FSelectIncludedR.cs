...
--
--  Program Id      : c_FSelectIncludedR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Select Included Reverse Formula Class 
...
{
    public class FSelectIncludedR : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.SelectIncludedR;
                }
                catch (Exception ex)
                {
