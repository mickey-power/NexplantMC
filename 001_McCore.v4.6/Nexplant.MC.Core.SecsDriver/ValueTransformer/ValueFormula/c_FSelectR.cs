...
--
--  Program Id      : c_FSelectR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Select Reverse Formula Class 
...
{
    public class FSelectR : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.SelectR;
                }
                catch (Exception ex)
                {
