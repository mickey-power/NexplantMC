...
--
--  Program Id      : c_FChooseIncluded.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Choose Included Reverse Formula Class 
...
{
    public class FChooseIncludedR : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.ChooseIncludedR;
                }
                catch (Exception ex)
                {
