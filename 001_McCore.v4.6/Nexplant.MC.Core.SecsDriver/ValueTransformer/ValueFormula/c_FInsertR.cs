...
--
--  Program Id      : c_FInsertR.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.21
--  Description     : FAMate Core FaSecsDriver Insert Reverse Formula Class 
...
{
    public class FInsertR : FValueFormulaBase, FIValueFormula
    {
            ...
            )
        {
            ...
            m_value = FValueConverter.fromStringValue(FFormat.Ascii, value);
        }
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.InsertR;
                }
                catch (Exception ex)
                {
                ...
                return FValueFormulaType.Insert;
            }
        }
           ...
           )
        {
            ...
            try
            {
                return string.Format(Format, this.fType.ToString(), m_startIndex, m_value);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
