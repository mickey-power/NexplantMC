...
--  Description     : FAMate Core FaSecsDriver Equipment State Material Storage Class 
    ...
    public class FEquipmentStateMaterialStorage : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fEsm == null)
                {
                    fEstNode = m_fScdCore.fSecsDriver.fXmlNode.selectSingleNode(string.Format(EquipmentsStateQuery, estUniqueId));
                    if (fEstNode != null)
                    {
                        // --
                        ...
                        if (defaultState != FXmlTagEST.D_DefaultValue)
                        {
                            ...
                            this.fScdCore.fEquipmentStateMaterialStorage.add(fEsm);
                        }                        
                    }
                }
