...
--  Description     : FAMate Core FaSecsDriver Host Message Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostMessage : FBaseObject<FHostMessage>, FIObject, FIMessage
    {
        ...
        public FHostMessage(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHMG(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public string castChannel
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagHMG.A_CastChannel, FXmlTagHMG.D_CastChannel);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagHMG.A_CastChannel, FXmlTagHMG.D_CastChannel, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessage(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessage(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeHmt.set_attrVal(FXmlTagHMT.A_MessageType, FXmlTagHMT.D_MessageType, FXmlTagHMT.M_MessageTransfer);                
                return new FHostMessageTransfer(this.fScdCore, fXmlNodeHmt, tid);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
