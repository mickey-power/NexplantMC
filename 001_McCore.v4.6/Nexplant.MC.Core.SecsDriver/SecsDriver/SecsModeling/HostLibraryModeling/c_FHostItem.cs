...
--  Description     : FAMate Core FaSecsDriver Host Item Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostItem : FBaseObject<FHostItem>, FIObject, FIHostOperand
    {
        ...
        public FHostItem(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHIT(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FHostItem(
            ...
            : base(FSecsDriverCommon.createXmlNodeHIT(fSecsDriver.fScdCore.fXmlDoc, name, fForamt, stringValue))
        {
        ...
        public FPattern fPattern
        {
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagHIT.A_ScanMode, FXmlTagHIT.D_ScanMode, FXmlTagDAT.D_ScanMode);
        ...
        public FHostItemCollection fChildHostItemCollection
        {
            get
            {
                try
                {
                    return new FHostItemCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagHIT.E_HostItem));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (fXmlNodeParent.name == FXmlTagHMG.E_HostMessage)
                    {
                        ...
                        {
                            return new FHostMessageTransfer(this.fScdCore, fXmlNodeParent);
                        }
                        else if (messageType == FXmlTagHMG.M_HostDriverDataMessage)
                        {
                            return new FHostDriverDataMessage(this.fScdCore, fXmlNodeParent);
                        }
                        return null;
                    }
                    return new FHostItem(this.fScdCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItem fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItem(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItem fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItem(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fScdCore, fHmg.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                return insertBeforeChildHostItem(
                    new FHostItem(fSecsDriver, name, fFormat, stringValue),
                    fRefChild
                    );
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fScdCore, ((FHostMessage)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else if (fParent.fObjectType == FObjectType.HostMessageTransfer)
                {
                    this.replace(this.fScdCore, ((FHostMessageTransfer)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else if (fParent.fObjectType == FObjectType.HostDriverDataMessage)
                {
                    this.replace(this.fScdCore, ((FHostDriverDataMessage)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fScdCore, ((FHostItem)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fScdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fSecsDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fSecsDriver, ((FHostItem)fParent).fParent, fParent)
                            });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostItem);
