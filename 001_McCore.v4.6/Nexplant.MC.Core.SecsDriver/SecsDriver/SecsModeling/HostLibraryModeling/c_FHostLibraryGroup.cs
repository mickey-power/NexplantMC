...
--  Description     : FAMate Core FaSecsDriver Host Library Group Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostLibraryGroup : FBaseObject<FHostLibraryGroup>, FIObject
    {
        ...
        public FHostLibraryGroup(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHLG(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FHostLibraryGroup fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostLibraryGroup(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostLibraryGroup fNextSibling
        {
            get 
            {
                try
                {
                    ...
                    return new FHostLibraryGroup(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostLibraryCollection fChildHostLibraryCollection
        {
            get
            {
                try
                {
                    return new FHostLibraryCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagHLB.E_HostLibrary));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fHlb.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostLibraryGroup);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostLibrary);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostLibrary(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
