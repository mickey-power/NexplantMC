...
--  Description     : FAMate Core FaSecsDriver Host Messages Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostMessages : FBaseObject<FHostMessages>, FIObject
    {
        ...
        public FHostMessages(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHMS(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public string command
        {
            ...
            set
            {
                string oldCommand = string.Empty;

                try
                {
                    oldCommand = this.command;
                    if (oldCommand == value)
                    {
                        return;
                    }                    
                    ...
                    changeCommandAndVersion(oldCommand);                    
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public int version
        {
            ...
            set
            {
                try
                {
                    ...
                    changeCommandAndVersion(this.command);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessageList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessageList(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessageCollection fChildHostMessageCollection
        {
            get
            {
                try
                {
                    return new FHostMessageCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagHMG.E_HostMessage));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fHmg.fXmlNode);
                }
        ...
        private void changeCommandAndVersion(
            string oldCommand
           )           
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeHmg in fXmlNodeListHmg)
                {
                    ...
                    {
                        fXmlNodeHmg.set_attrVal(FXmlTagHMG.A_Command, FXmlTagHMG.D_Command, newCommand);
                    }                    
                    fXmlNodeHmg.set_attrVal(FXmlTagHMG.A_Version, FXmlTagHMG.D_Version, newVersion.ToString());
                    ...
                    {
                        this.fScdCore.fEventPusher.pushEvent(
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fSecsDriver, this, FSecsDriverCommon.createObject(this.fScdCore, fXmlNodeHmg))
                            );
                    }
                }
            }
            ...
            )
        {
            try
            {
                ...
                this.copyObject(FCbObjectFormat.HostMessages, this.fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostMessages);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostMessage);
                // --
                if (this.hasChildPrimaryHostMessage)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostMessage(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
