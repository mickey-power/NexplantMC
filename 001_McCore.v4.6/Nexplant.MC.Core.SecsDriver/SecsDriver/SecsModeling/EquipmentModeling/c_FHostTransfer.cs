...
--  Description     : FAMate Core FaSecsDriver Host Transfer Class 
--  History         : Created by spike.lee at 2011.07.29
----------------------------------------------------------------------------------------------------------*/
using System;
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostTransfer : FBaseObject<FHostTransfer>, FIObject, FITransfer
    {
        ...
        public FHostTransfer(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHTF(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FHostTransmitter fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransmitter(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTransfer fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransfer(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostTransfer fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostTransfer(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostTransfer);
