...
--  Description     : FAMate Core FaSecsDriver JudgementExpression Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FJudgementExpression : FBaseObject<FJudgementExpression>, FIObject
    {
        ...
        public FJudgementExpression(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeJEP(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FData fOperand
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FData(this.fScdCore, this.fSecsDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FJudgementCondition(this.fScdCore, this.fXmlNode.fParentNode);
                    }
                    return new FJudgementExpression(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpression fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementExpression(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpression fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementExpression(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpressionCollection fChildJudgementExpressionCollection
        {
            get
            {
                try
                {
                    return new FJudgementExpressionCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagJEP.E_JudgementExpression));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fJep.fXmlNode);
                }
              ...
              )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.JudgementExpression);
            ...
            ) 
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.JudgementExpression);
