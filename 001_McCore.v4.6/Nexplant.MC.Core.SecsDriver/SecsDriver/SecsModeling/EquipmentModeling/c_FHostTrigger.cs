...
--  Description     : FAMate Core FaSecsDriver Host Trigger Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostTrigger : FBaseObject<FHostTrigger>, FIObject, FIFlow
    {
        ...
        public FHostTrigger(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHTR(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FHostConditionCollection fChildHostConditionCollection
        {
            get
            {
                try
                {
                    return new FHostConditionCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagHCN.E_HostCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fHcn.fXmlNode);
                }
       ...
       public FIFlow pasteSibling(
            )
        {
            ...
            {                
                ...
                {
                    fNewFlowObject = (FPauser)this.pasteObject(FCbObjectFormat.EntryPoint);
                }
                else
                {
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostCondition(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
