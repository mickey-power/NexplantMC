...
--  Description     : FAMate Core FaSecsDriver Host Expression Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostExpression : FBaseObject<FHostExpression>, FIObject
    {
        ...
        public FHostExpression(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHEP(fSecsDriver.fScdCore.fXmlDoc))
        {
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (this.fOperandType == FHostOperandType.HostItem)
                    {
                        ...
                        // --
                        return new FHostItem(this.fScdCore, this.fSecsDriver.fXmlNode.selectSingleNode(xpath));
                    }
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FHostCondition(this.fScdCore, this.fXmlNode.fParentNode);
                    }
                    return new FHostExpression(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpression fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostExpression(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpression fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostExpression(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostExpression);
