...
--  Description     : FAMate Core FaSecsDriver Branch Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FBranch : FBaseObject<FBranch>, FIObject, FIFlow
    {
        ...
        public FBranch(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeBRN(fSecsDriver.fScdCore.fXmlDoc))
        {
            ...
            get
            {
                ...
                try
                {
                    ...
                    xpath =
                        ...
                        "/" + FXmlTagSNR.E_Scenario + "[@" + FXmlTagSMG.A_UniqueId + "='" + id + "']";
                    // --
            ...
            )
        {
            ...
            try
            {
                ...
                this.fXmlNode.set_attrVal(FXmlTagBRN.A_LocationId, FXmlTagBRN.D_LocationId, string.Empty, isModifyEvent);
