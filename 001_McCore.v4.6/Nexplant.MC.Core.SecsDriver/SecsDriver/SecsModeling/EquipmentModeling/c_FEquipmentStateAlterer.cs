...
--  Description     : FAMate Core FaSecsDriver Equipment State Alterer Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FEquipmentStateAlterer : FBaseObject<FEquipmentStateAlterer>, FIObject
    {
        ...
        public FEquipmentStateAlterer(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeEAT(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetAlterer fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetAlterer(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAlterer fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateAlterer(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAlterer fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateAlterer(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateAlterer);
