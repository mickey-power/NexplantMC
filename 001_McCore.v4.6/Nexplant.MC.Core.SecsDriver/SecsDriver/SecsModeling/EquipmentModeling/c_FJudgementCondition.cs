...
--  Description     : FAMate Core FaSecsDriver Judgement Condition Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FJudgementCondition : FBaseObject<FJudgementCondition>, FIObject
    {
        ...
        public FJudgementCondition(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeJCN(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FJudgement fParent
        {
            get
            {
                try
                {
                    ...
                    return new FJudgement(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementCondition fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementCondition(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementCondition fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementCondition(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.JudgementCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgementExpression(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
