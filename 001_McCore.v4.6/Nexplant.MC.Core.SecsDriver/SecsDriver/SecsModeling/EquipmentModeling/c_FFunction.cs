...
--  Description     : FAMate Core FaSecsDriver FFunction Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FFunction : FBaseObject<FFunction>, FIObject
    {
        ...
        public FFunction(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeFUN(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FCallback fParent
        {
            get
            {
                try
                {
                    ...
                    return new FCallback(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunction fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunction(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunction fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunction(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionName fFunctionName
        {
            get
            {
                ...
                try
                {
                    ...
                    fXmlNodeFna = this.fSecsDriver.fXmlNode.selectSingleNode(xpath);
                    if (fXmlNodeFna == null)
                    {
                        return null;
                    }
                    ...
                    return new FFunctionName(this.fScdCore, fXmlNodeFna);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Function);
