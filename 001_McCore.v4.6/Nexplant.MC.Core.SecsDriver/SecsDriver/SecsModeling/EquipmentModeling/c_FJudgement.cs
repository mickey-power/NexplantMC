...
--  Description     : FAMate Core FaSecsDriver Judgement Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FJudgement : FBaseObject<FJudgement>, FIObject, FIFlow
    {
        ...
        public FJudgement(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeJDM(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FJudgementConditionCollection fChildJudgementConditionCollection
        {
            get
            {
                try
                {
                    return new FJudgementConditionCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagJCN.E_JudgementCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fJdm.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.JudgementCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgementCondition(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
