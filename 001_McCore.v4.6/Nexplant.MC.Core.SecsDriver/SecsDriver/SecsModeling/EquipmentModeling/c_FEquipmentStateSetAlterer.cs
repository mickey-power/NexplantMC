...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FEquipmentStateSetAlterer : FBaseObject<FEquipmentStateSetAlterer>, FIObject, FIFlow
    {
        ...
        public FEquipmentStateSetAlterer(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeESA(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSet fEquipmentStateSet
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FEquipmentStateSet(this.fScdCore, this.fSecsDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAltererCollection fChildEquipmentStateAltererCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateAltererCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagEAT.E_EquipmentStateAlterer));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fEat.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentStateAlterer);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateAlterer(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
