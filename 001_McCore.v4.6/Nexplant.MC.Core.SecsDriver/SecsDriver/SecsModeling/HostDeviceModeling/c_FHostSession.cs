...
--  Description     : FAMate Core FaSecsDriver Host Session Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostSession : FBaseObject<FHostSession>, FIObject, FISession
    {
        ...
        public FHostSession(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHSN(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FHostLibrary fLibrary
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostLibrary(this.fScdCore, this.fSecsDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostDevice fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostDevice(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostSession(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostSession(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostSession);
