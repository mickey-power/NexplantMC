...
--  Description     : FAMate Core FaSecsDriver Host Device Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FHostDevice : FBaseObject<FHostDevice>, FIObject, FIDevice
    {
        ...
        public FHostDevice(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeHDV(fSecsDriver.fScdCore.fXmlDoc))
        {
            // init();
        }
        ...
        public string driverOption
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        fBaseProtocol = this.fScdCore.fProtocolAgent.getProtocol(this.uniqueId);
        ...
        public FHostDevice fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostDevice(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostDevice fNextSibling
        {
            get 
            {
                try
                {
                    ...
                    return new FHostDevice(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSessionCollection fChildHostSessionCollection
        {
            get
            {
                try
                {
                    return new FHostSessionCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagHSN.E_HostSession));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fHsn.fXmlNode);
                }
            ...
            )
        {
            try
            {
                ...
                return (FIHostDriver)FReflection.createInstance(
                    ...
                    new object[] { new FHostDriverArgs(this.fSecsDriver, this) }
                );
#else                 
            ...
            )
        {
            try
            {
                ...
                // --
                return createHostDriver(this.fSecsDriver.hostDriverDirectory + "//" + this.driver);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.resetHostDriver();
                    FDebug.throwFException(FConstants.err_m_0036);
                }
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                // Host Condition에 Device가 설정되어 있는지 검색하는 XPath 수정
                // Host Device 내에서 검색하는 것이 아니라 SECS Driver에서 XPath 검색을 수정하도록 처리
                // ***
            ...
            )
        {
            try
            {
                ...
                this.fScdCore.fProtocolAgent.openHostDevice(this);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.fScdCore.fProtocolAgent.closeHostDevice(this);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostDevice);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostSession);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostSession(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
