...
--  Description     : FAMate Core FaSecsDriver Data Set Class
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FDataSet : FBaseObject<FDataSet>, FIObject
    {
        ...
        public FDataSet(
            ...
            : base(fsecsDriver.fScdCore,FSecsDriverCommon.createXmlNodeDTS(fsecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FDataSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataSetList(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataSet(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataSet(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        {           
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode,FCbObjectFormat.DataSet);
        ...
        // ***
        // 2018.01.05 by Jeff.Kim
        // 객체 Clone 기능 추가
        // ***
        public FDataSet clone(
            )
        {
            FXmlNode fXmlNode = null;
