...
--  Description     : FAMate Core FaSecsDriver Data Class
--  History         : Created by kitae at 2011.05.23
                      Modified by spike.lee at 2011.12.02
                        - 기존 Data를 Source Data와 Target Data로 분리 적용
----------------------------------------------------------------------------------------------------------*/
using System;
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FData : FBaseObject<FData>, FIObject
    {
        ...
        public FData(
            ...
            : base(fsecsDriver.fScdCore,FSecsDriverCommon.createXmlNodeDAT(fsecsDriver.fScdCore.fXmlDoc))
        {
            ...
            set
            {
                try
                {
                    ...
                    if (value == FDataSourceType.Constant || 
                        value == FDataSourceType.Resource || 
                        value == FDataSourceType.EquipmentState ||
                        value == FDataSourceType.Message
                        )
                    {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagDAT.A_SourceMessage, FXmlTagDAT.D_SourceMessage, "");
                    ...
                    {
                        this.fXmlNode.set_attrVal(FXmlTagDAT.A_SourceMessage, FXmlTagDAT.D_SourceMessage, "N");
                    }
                    ...
                    else if (value == FDataSourceType.Item)
                    {
        ...
        public FMessageSourceType sourceMessage
        {
            get
            {
                ...
                try
                {
                    val = this.fXmlNode.get_attrVal(FXmlTagDAT.A_SourceMessage, FXmlTagDAT.D_SourceMessage);
                    if (val == string.Empty)
                    {
                        return FMessageSourceType.None;
                    }
                    // --
                    return FEnumConverter.toMessageSourceType(val);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    if (this.fSourceType != FDataSourceType.Message)
                    {
                        FDebug.throwFException(string.Format(FConstants.err_m_0011, "Source Type", "Message"));
                    }
                    // --
                    this.fXmlNode.set_attrVal(FXmlTagDAT.A_SourceMessage, FXmlTagDAT.D_SourceMessage, FEnumConverter.fromMessageSourceType(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string targetConstant
        {
            ...
            set
            {
                try
                {
                    FSecsDriverCommon.validateName(value, false);
                    // --
        ...
        public FDataCollection fChildDataCollection
        {
            get
            {
                try
                {
                    return new FDataCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagDAT.E_Data));
                }
                catch(Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataCollection fFixedChildDataCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    return new FDataCollection(this.fScdCore, this.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FDataSet(this.fScdCore, this.fXmlNode.fParentNode);
                    }
                    return new FData(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FData fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FData(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FData fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FData(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        // --
                        return new FObjectCollection(this.fScdCore, fDts.fXmlNode.selectNodes(xpath));
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else if (fSourceType == FDataSourceType.Message)
                    {
                        info.Append("msg: " + this.sourceMessage.ToString());
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fScdCore, ((FDataSet)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fScdCore, ((FData)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fScdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fSecsDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fSecsDriver, ((FData)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Data);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Data);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FData(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        // ***
        // 2017.12.27 by Jeff.Kim
        // DataConversion Set을 유지시킨다. 
        // ***
        public FData forceClone(
            )
        {
            FXmlNode fXmlNode = null;
