...
--  Description     : FAMate Core FaSecsDriver Object Name List Class 
--  History         : Created by spike.lee at 2011.03.11
----------------------------------------------------------------------------------------------------------*/
using System;
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FObjectNameList : FBaseObject<FObjectNameList>, FIObject
    {
        ...
        public FObjectNameList(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeONL(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FObjectNameList fPreviousSibling  
        {
            get
            {
                try
                {
                    ...
                    return new FObjectNameList(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectNameList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FObjectNameList(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectNameCollection fChildObjectNameCollection
        {
            get
            {
                try
                {
                    return new FObjectNameCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagONA.E_ObjectName));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fOna.fXmlNode);                       
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ObjectNameList);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.ObjectName); 
            ...
            )
        {
            ...
            try
            {
                ...
                return new FObjectName(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
