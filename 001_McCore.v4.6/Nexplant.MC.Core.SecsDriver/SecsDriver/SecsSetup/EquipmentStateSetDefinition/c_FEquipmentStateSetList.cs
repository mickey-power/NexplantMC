...
--  Description     : FAMate Core FaSecsDriver Equipment State Set List Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FEquipmentStateSetList : FBaseObject<FEquipmentStateSetList>, FIObject
    {
        ...
        public FEquipmentStateSetList(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeESL(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSetList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSetCollection fChildEquipmentStateSetCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateSetCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagESS.E_EquipmentStateSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fEss.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSetList);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSet);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateSet(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
