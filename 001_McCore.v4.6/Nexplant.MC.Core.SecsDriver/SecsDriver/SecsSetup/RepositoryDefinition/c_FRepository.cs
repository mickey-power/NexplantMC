...
--  Description     : FAMate Core FaSecsDriver Repository Class
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FRepository : FBaseObject<FRepository>, FIObject
    {
        ...
        public FRepository(
            ...
            : base(fsecsDriver.fScdCore,FSecsDriverCommon.createXmlNodeRPS(fsecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FRepositoryList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepository fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepository(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepository fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepository(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Repository);
