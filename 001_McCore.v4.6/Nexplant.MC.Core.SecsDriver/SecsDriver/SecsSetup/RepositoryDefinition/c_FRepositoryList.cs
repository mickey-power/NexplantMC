    ...
    public class FRepositoryList : FBaseObject<FRepositoryList>, FIObject
    {
        ...
        public FRepositoryList(
          FSecsDriver fSecsDriver
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeRPL(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FRepositoryList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepositoryCollection fChildRepositoryCollection
        {
            get
            {
                try
                {
                    return new FRepositoryCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagRPS.E_Repository));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fRps.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.RepositoryList);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Repository);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FRepository(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
