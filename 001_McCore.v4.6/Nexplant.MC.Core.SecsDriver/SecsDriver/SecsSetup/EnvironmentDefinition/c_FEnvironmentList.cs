...
--  Description     : FAMate Core FaSecsDriver Evnironment List Class
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FEnvironmentList : FBaseObject<FEnvironmentList>, FIObject
    {
        ...
        public FEnvironmentList(
            ...
            :base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeENL(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FEnvironmentList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironmentList(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironmentList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironmentList(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fEvn.fXmlNode);                   
                }
            ...
            )
        {
            try
            {
                FSecsDriverCommon.validateCutObject(fXmlNode);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EnvironmentList);
