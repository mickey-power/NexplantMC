...
--  Description     : FAMate Core FaSecsDriver Data Conversion Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FDataConversion : FBaseObject<FDataConversion>, FIObject
    {
        ...
        public FDataConversion(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeDCV(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public string min
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!FSecsDriverCommon.validateMinMax(fFormat, value, max))
                    {
        ...
        public string max
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!FSecsDriverCommon.validateMinMax(fFormat, min, value))
                    {
        ...
        public FDataConversionSet fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fScdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversion fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversion(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversion fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversion(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversion);
