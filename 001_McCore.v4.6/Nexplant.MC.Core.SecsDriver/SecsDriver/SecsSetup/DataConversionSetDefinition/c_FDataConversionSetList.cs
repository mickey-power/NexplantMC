...
--  Description     : FAMate Core FaSecsDriver Data Conversion Set List Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FDataConversionSetList : FBaseObject<FDataConversionSetList>, FIObject
    {
        ...
        public FDataConversionSetList(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeDCL(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FDataConversionSetList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSetList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSetCollection fChildDataConversionSetCollection
        {
            get
            {
                try
                {
                    return new FDataConversionSetCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagDCS.E_DataConversionSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fDcs.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversionSetList);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.DataConversionSet);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataConversionSet(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
