...
--  Description     : FAMate Core FaSecsDriver Parameter Name Class
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FParameterName : FBaseObject<FParameterName>, FIObject
    {
        ...
        public FParameterName(
            ...
            :base(fsecsDriver.fScdCore, FSecsDriverCommon.createXmlNodePAN(fsecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FFunctionName fParent
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionName(this.fScdCore,this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FParameterName fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FParameterName(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FParameterName fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FParameterName(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FArgumentCollection fChildFArgumentCollection
        {
            get
            {
                try
                {
                    return new FArgumentCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagARG.E_Argument));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fArg.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ParameterName);
        ...
        {            
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Argument);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FArgument(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
