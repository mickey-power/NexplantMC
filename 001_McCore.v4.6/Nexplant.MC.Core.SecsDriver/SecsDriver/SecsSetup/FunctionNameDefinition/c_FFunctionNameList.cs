...
--  Description     : FAMate Core FaSecsDriver Function Name List Class 
...
namespace Nexplant.MC.Core.FaSecsDriver
{
    public class FFunctionNameList : FBaseObject<FFunctionNameList>, FIObject
    {
        ...
        public FFunctionNameList(
            ...
            : base(fSecsDriver.fScdCore, FSecsDriverCommon.createXmlNodeFNL(fSecsDriver.fScdCore.fXmlDoc))
        {
        ...
        public FFunctionNameList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionNameList(this.fScdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionNameList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionNameList(this.fScdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionNameCollection fChildFunctionNameCollection
        {
            get
            {
                try
                {
                    return new FFunctionNameCollection(this.fScdCore, this.fXmlNode.selectNodes(FXmlTagFNA.E_FunctionName));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FSecsDriverCommon.validateRemoveChildObject(this.fXmlNode, fFna.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.FunctionNameList);
            ...
            )
        {
            ...
            try
            {
                FSecsDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.FunctionName);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FFunctionName(this.fScdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
