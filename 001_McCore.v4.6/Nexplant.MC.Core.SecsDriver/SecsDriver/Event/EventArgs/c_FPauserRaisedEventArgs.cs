...
--
--  Program Id      : c_FPauserEventArgs.cs
--  Creator         : jeff.kim
--  Create Date     : 2013.01.24
--  Description     : FAMate Core FaSecsDriver Pauser Raised Event Arguments Class 
--  History         : Created by jeff.kim at 2013.01.24
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    [Serializable]
    public class FPauserRaisedEventArgs : FEventArgsBase
    {
        ...
        private FPauserRaisedLog m_fPauserRaisedLog = null;
        ...
        internal FPauserRaisedEventArgs(            
            FEventId fEventId,
            ...
            : base(fEventId)
        {
            ...
            m_fPauserRaisedLog = fPauserRaisedLog;
            m_fScenarioData = fScenarioData;
        }

        //------------------------------------------------------------------------------------------------------------------------

        ~FPauserRaisedEventArgs(
           )
        {
            myDispose(false);
        }
