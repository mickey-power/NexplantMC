...
--  Description     : FAMate Core FaSecsDriver Repository Handler Class 
--  History         : Created by spike.lee at 2012.01.05
----------------------------------------------------------------------------------------------------------*/
using System;
    ...
    internal static class FRepositoryHandler
    {
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeRps = fScenarioData.fScdCore.fSecsDriver.fXmlNode.selectSingleNode(xpath).clone(true);                
                ...
                // ***
                fXmlNodeRpsl.set_attrVal(FXmlTagRPSL.A_RpmId, FXmlTagRPSL.D_RpmId, fScenarioData.fScdCore.fRpmIdPointer.uniqueId.ToString());
                ...
                fRepositoryMaterial = new FRepositoryMaterial(fScenarioData.fScdCore, fXmlNodeRpm);                
            ...
            )
        {
            ...
            FSecsDeviceDataMessageReceivedLog fSdmrl = null;
            FSecsDeviceDataMessageSentLog fSdmsl = null;
            ...
            try
            {
                ...
                if (fScenarioData.hasMapperPerformedLog && fScenarioData.fMapperPerformedLog.hasDataSetLog)
                {
                    ...
                    {
                        foreach (FRepositoryMaterial fRpm in fScenarioData.fScdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                        {
                ...
                if (fRepositoryMaterial == null && fScenarioData.hasDataMessageReceivedLog)
                {
                    ...
                    // --
                    if (fMessageLogType == FMessageLogType.SecsDeviceDataMessageReceivedLog)
                    {
                        fSdmrl = (FSecsDeviceDataMessageReceivedLog)fScenarioData.fDataMessageReceivedLog;
                        if (fSdmrl.isSecondary)
                        {
                            deviceUniqueId = fSdmrl.deviceUniqueId;
                            sessionUniqueId = fSdmrl.sessionUniqueId;
                            systemBytes = fSdmrl.systemBytes;
                            // --
                            foreach (FRepositoryMaterial fRtm in fScenarioData.fScdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                            {
                                if (
                                    id == fRtm.uniqueIdToString &&
                                    fRtm.containsSecsReplyKey(deviceUniqueId, sessionUniqueId, systemBytes)
                                    )
                                {
                    ...
                    else if (fMessageLogType == FMessageLogType.SecsDeviceDataMessageSentLog)
                    {
                        fSdmsl = (FSecsDeviceDataMessageSentLog)fScenarioData.fDataMessageReceivedLog;
                        if (fSdmsl.isPrimary)
                        {
                            deviceUniqueId = fSdmsl.deviceUniqueId;
                            sessionUniqueId = fSdmsl.sessionUniqueId;
                            systemBytes = fSdmsl.systemBytes;
                            // --
                            foreach (FRepositoryMaterial fRtm in fScenarioData.fScdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                            {
                                if (
                    ...
                    else if (fMessageLogType == FMessageLogType.HostDeviceDataMessageReceivedLog)
                    {
           ...
           )
        {
            ...
            try
            {
                ...
                if (fXmlNodeStg.get_attrVal(FXmlTagSTG.A_Mode, FXmlTagSTG.D_Mode) == FEnumConverter.fromStorageMode(FStorageMode.Part))
                {
                    ...
                    {
                        fScenarioData.fScdCore.fRepositoryMaterialStorage.remove(fScenarioData.fRepositoryMaterial);
                    }
           ...
           )
        {
            ...
            try
            {
                ...
                fScenarioData.fScdCore.fRepositoryMaterialStorage.clear();
        ...
        private static void makeRepositorySelectPath_back(
            FXmlNode fXmlNodeRps,
            FXmlNodeList fXmlNodeListDatl,
            List<List<string>> colXPathList
            )
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeDatl in fXmlNodeListDatl)
                {
                    ...
                    if (fDatlFormat == FFormat.List || fDatlFormat == FFormat.AsciiList)
                    {
                        ...
                        {
                            name = fXmlNodeDatl.get_attrVal(FXmlTagDATL.A_TargetColumn, FXmlTagDATL.D_TargetColumn);
                            temp.Add(string.Format(ColumnQuery1, name));
                        }
                    ...
                    else
                    {
                        ...
                        temp.Add(string.Format(ColumnQuery2, name, val));
                    }
                }
