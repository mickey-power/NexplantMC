...
--
--  Program Id      : c_FBaseTelnet.cs
--  Creator         : byjeon
--  Create Date     : 2012.01.27
--  Description     : FAMate Core FaSecsDriver TELNET Base Class 
...
{
    internal abstract class FBaseTelnet : IDisposable
    {
        ...
        // -- 
        private FTelnetProtocol m_fTelnetProtocol = null;
        ...
        {
            m_fTelnetProtocol = fTelnetProtocol;
            // -- 
            init();
        }
        ...
        public FTelnetProtocol fTelnetProtocol
        {
            get
            {
                try
                {
                    return m_fTelnetProtocol;
                }
                catch (Exception ex)
                {
        ...
        public FProtocolAgent fProtocolAgent
        {
            get
            {
                try
                {
                    return m_fTelnetProtocol.fProtocolAgent;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScdCore fScdCore
        {
            get
            {
                try
                {
                    return m_fTelnetProtocol.fScdCore;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEventPusher fEventPusher
        {
            get
            {
                try
                {
                    return m_fTelnetProtocol.fScdCore.fEventPusher;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FSecsDriver fSecsDriver
        {
            get
            {
                try
                {
                    return m_fTelnetProtocol.fScdCore.fSecsDriver;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FSecsDevice fSecsDevice
        {
            get
            {
                try
                {
                    return m_fTelnetProtocol.fSecsDevice;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                if (m_fTelnetProtocol.fSecsDevice.maxSystemBytes > 0)
                {
                    maxSystemBytes = m_fTelnetProtocol.fSecsDevice.maxSystemBytes;
                }
                ...
                // -- 
                m_localIp = m_fTelnetProtocol.fSecsDevice.localIp;
                m_localPort = m_fTelnetProtocol.fSecsDevice.localPort;
                m_remoteIp = m_fTelnetProtocol.fSecsDevice.remoteIp;
                m_remotePort = m_fTelnetProtocol.fSecsDevice.remotePort;
                // -- 
                m_rbit = m_fTelnetProtocol.fSecsDevice.rbit;
                m_duplicateError = m_fTelnetProtocol.fSecsDevice.duplicateError;
                m_interleave = m_fTelnetProtocol.fSecsDevice.interleave;
                m_retryLimit = m_fTelnetProtocol.fSecsDevice.retryLimit;
                m_ignoreSystemBytes = m_fTelnetProtocol.fSecsDevice.ignoreSystemBytes;
                // --
                m_t1Timeout = (int)(m_fTelnetProtocol.fSecsDevice.t1Timeout * 1000);
                m_t2Timeout = (int)(m_fTelnetProtocol.fSecsDevice.t2Timeout * 1000);
                m_t3Timeout = m_fTelnetProtocol.fSecsDevice.t3Timeout * 1000;
                m_t4Timeout = m_fTelnetProtocol.fSecsDevice.t4Timeout * 1000;
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
