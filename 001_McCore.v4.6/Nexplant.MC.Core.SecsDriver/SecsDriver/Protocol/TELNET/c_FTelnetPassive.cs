...
--
--  Program Id      : c_FTelnetPassive.cs
--  Creator         : byjeon
--  Create Date     : 2012.01.27
--  Description     : FAMate Core FaSecsDriver TELNET Passive Class 
...
{
    internal class FTelnetPassive : FBaseTelnet
    {
            ...
            )
        {
            try
            {
                ...
                m_fThdMain = new FThread("FTelnetPassiveMainThread");
            ...
            )
        {
            try
            {
                m_fTcpListener = new FTcpListener(
                    ...
                    this.fTelnetProtocol.fSecsDevice.localPort,
                    1
                    );
                // --
                m_fTcpListener.TcpListenerAcceptCompleted += new FTcpListenerAcceptCompletedEventHandler(m_fTcpListener_TcpListenerAcceptCompleted);
            ...
            )
        {
            ...
            try
            {
                ...
                if (isDuplicate(fBlockInfo))
                {
                    if (duplicateError)
                    {
                        procDeviceErrorRaised(FConstants.err_m_16005);
                    }
                    return;
                }
        ...
        #region m_fTelnetClient Mehtods and Event Handler
