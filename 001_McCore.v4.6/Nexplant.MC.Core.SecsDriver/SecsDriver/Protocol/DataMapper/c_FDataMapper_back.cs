...
{
    internal static class FDataMapper_back
    {
            ...
            )
        {
            ...
            try
            {
                ...
                xpath = string.Format(SecsItemLogQuery, uniqueId, sitlName);
            ...
            )
        {
            ...
            try
            {
                ...
                sw.Stop();
                System.Diagnostics.Debug.WriteLine("M_Time=" + sw.ElapsedMilliseconds.ToString());
