...
--
--  Program Id      : c_FTcpIpPassive.cs
--  Creator         : byjeon
--  Create Date     : 2012.01.02
--  Description     : FAMate Core FaSecsDriver TCP/IP Passive Class 
...
{
    internal class FTcpIpPassive : FBaseTcpIp
    {
            ...
            )
        {
            try
            {
                ...
                m_fThdMain = new FThread("FTcpIpPassiveMainThread");
            ...
            )
        {
            try
            {
                m_fTcpListener = new FTcpListener(
                    ...
                    this.fTcpIpProtocol.fSecsDevice.localPort,
                    1
                    );
                // --
                m_fTcpListener.TcpListenerAcceptCompleted += new FTcpListenerAcceptCompletedEventHandler(m_fTcpListener_TcpListenerAcceptCompleted);
