...
--
--  Program Id      : c_FSecsDriverCommon.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.28
--  Description     : FAMate Core FaSecsDriver SECS Driver Common Function Class 
...
{
    internal static class FSecsDriverCommon
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNode.set_attrVal(FXmlTagFAM.A_FileFormat, FXmlTagFAM.D_FileFormat, "SSM");
                ...
                fXmlNode.set_attrVal(FXmlTagFAM.A_FileDescription, FXmlTagFAM.D_FileDescription, "FAMate SECS Modeling File");
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSCD(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSCD.E_SecsDriver);
                // --
                fXmlNode.set_attrVal(FXmlTagSCD.A_UniqueId, FXmlTagSCD.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSCD.A_Locked, FXmlTagSCD.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSCD.A_Name, FXmlTagSCD.D_Name, "SecsDriver");
                fXmlNode.set_attrVal(FXmlTagSCD.A_Description, FXmlTagSCD.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSCD.A_FontColor, FXmlTagSCD.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSCD.A_FontBold, FXmlTagSCD.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSCD.A_EapName, FXmlTagSCD.D_EapName, "MC");
                // --
                return fXmlNode;
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNode.set_attrVal(FXmlTagONL.A_ObjectType, FXmlTagONL.D_ObjectType, FObjectType.SecsDriver.ToString());
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSLM(
            FXmlDocument fXmlDoc
            )
        {
            try
            {
                return fXmlDoc.createNode(FXmlTagSLM.E_SecsLibraryModeling);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static FXmlNode createXmlNodeSLG(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;                        
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSLG.E_SecsLibraryGroup);
                // --
                fXmlNode.set_attrVal(FXmlTagSLG.A_UniqueId, FXmlTagSLG.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSLG.A_Locked, FXmlTagSLG.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSLG.A_Name, FXmlTagSLG.D_Name, "SecsLibraryGroup");
                fXmlNode.set_attrVal(FXmlTagSLG.A_Description, FXmlTagSLG.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSLG.A_FontColor, FXmlTagSLG.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSLG.A_FontBold, FXmlTagSLG.D_FontBold, FBoolean.False);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSLB(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSLB.E_SecsLibrary);
                // --
                fXmlNode.set_attrVal(FXmlTagSLB.A_UniqueId, FXmlTagSLB.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSLB.A_Locked, FXmlTagSLB.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSLB.A_Name, FXmlTagSLB.D_Name, "SecsLibrary");
                fXmlNode.set_attrVal(FXmlTagSLB.A_Description, FXmlTagSLB.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSLB.A_FontColor, FXmlTagSLB.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSLB.A_FontBold, FXmlTagSLB.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSLB.A_Comment, FXmlTagSLB.D_Comment, FXmlTagSLB.D_Comment);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSML(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSML.E_SecsMessageList);
                // --
                fXmlNode.set_attrVal(FXmlTagSML.A_UniqueId, FXmlTagSML.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSML.A_Locked, FXmlTagSML.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSML.A_Name, FXmlTagSML.D_Name, "SecsMessageList");
                fXmlNode.set_attrVal(FXmlTagSML.A_Description, FXmlTagSML.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSML.A_FontColor, FXmlTagSML.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSML.A_FontBold, FXmlTagSML.D_FontBold, FBoolean.False);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSMS(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSMS.E_SecsMessages);
                // --
                fXmlNode.set_attrVal(FXmlTagSMS.A_UniqueId, FXmlTagSMS.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSMS.A_Locked, FXmlTagSMS.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSMS.A_Name, FXmlTagSMS.D_Name, "SecsMessages");
                fXmlNode.set_attrVal(FXmlTagSMS.A_Description, FXmlTagSMS.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSMS.A_FontColor, FXmlTagSMS.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSMS.A_FontBold, FXmlTagSMS.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSMS.A_Stream, FXmlTagSMS.D_Stream, "0");
                fXmlNode.set_attrVal(FXmlTagSMS.A_Function, FXmlTagSMS.D_Function, "0");
                fXmlNode.set_attrVal(FXmlTagSMS.A_Version, FXmlTagSMS.D_Version, "0");
                fXmlNode.set_attrVal(FXmlTagSMS.A_Direction, FXmlTagSMS.D_Direction, FEnumConverter.fromDirection(FDirection.Both));
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSMG(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSMG.E_SecsMessage);
                // --
                fXmlNode.set_attrVal(FXmlTagSMG.A_MessageType, FXmlTagSMG.D_MessageType, FXmlTagSMG.M_Message);
                // --
                fXmlNode.set_attrVal(FXmlTagSMG.A_UniqueId, FXmlTagSMG.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSMG.A_Locked, FXmlTagSMG.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSMG.A_Name, FXmlTagSMG.D_Name, "SecsMessage");
                fXmlNode.set_attrVal(FXmlTagSMG.A_Description, FXmlTagSMG.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSMG.A_FontColor, FXmlTagSMG.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSMG.A_FontBold, FXmlTagSMG.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSMG.A_Stream, FXmlTagSMG.D_Stream, "0");
                fXmlNode.set_attrVal(FXmlTagSMG.A_Function, FXmlTagSMG.D_Function, "0");
                fXmlNode.set_attrVal(FXmlTagSMG.A_Version, FXmlTagSMG.D_Version, "0");
                fXmlNode.set_attrVal(FXmlTagSMG.A_WBit, FXmlTagSMG.D_WBit, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagSMG.A_AutoReply, FXmlTagSMG.D_AutoReply, FBoolean.True);
                // --
                fXmlNode.set_attrVal(FXmlTagSMG.A_LogEnabled, FXmlTagSMG.D_LogEnabled, FBoolean.True);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSMT(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSMT.E_SecsMessage);
                // --
                fXmlNode.set_attrVal(FXmlTagSMT.A_MessageType, FXmlTagSMT.D_MessageType, FXmlTagSMT.M_MessageTransfer);
                // --
                fXmlNode.set_attrVal(FXmlTagSMT.A_UniqueId, FXmlTagSMT.D_UniqueId, "0");                
                fXmlNode.set_attrVal(FXmlTagSMT.A_Name, FXmlTagSMT.D_Name, "SecsMessage");
                fXmlNode.set_attrVal(FXmlTagSMT.A_Description, FXmlTagSMT.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSMT.A_FontColor, FXmlTagSMT.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSMT.A_FontBold, FXmlTagSMT.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSMT.A_Stream, FXmlTagSMT.D_Stream, "0");
                fXmlNode.set_attrVal(FXmlTagSMT.A_Function, FXmlTagSMT.D_Function, "0");
                fXmlNode.set_attrVal(FXmlTagSMT.A_Version, FXmlTagSMT.D_Version, "0");
                fXmlNode.set_attrVal(FXmlTagSMT.A_WBit, FXmlTagSMT.D_WBit, FBoolean.True);                
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSIT(
            FXmlDocument fXmlDoc
            )
        {            
            try
            {
                return createXmlNodeSIT(fXmlDoc, "SecsItem", FFormat.List, string.Empty);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNode = fXmlDoc.createNode(FXmlTagSIT.E_SecsItem);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_UniqueId, FXmlTagSIT.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSIT.A_Locked, FXmlTagSIT.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSIT.A_Name, FXmlTagSIT.D_Name, name);
                fXmlNode.set_attrVal(FXmlTagSIT.A_Description, FXmlTagSIT.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_FontColor, FXmlTagSIT.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSIT.A_FontBold, FXmlTagSIT.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_Pattern, FXmlTagSIT.D_Pattern, "F");
                fXmlNode.set_attrVal(FXmlTagSIT.A_FixedLength, FXmlTagSIT.D_FixedLength, FXmlTagSIT.D_FixedLength);
                fXmlNode.set_attrVal(FXmlTagSIT.A_Format, FXmlTagSIT.D_Format, FEnumConverter.fromFormat(fFormat));
                fXmlNode.set_attrVal(FXmlTagSIT.A_LengthBytes, FXmlTagSIT.D_LengthBytes, FXmlTagSIT.D_LengthBytes);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_ScanMode, FXmlTagSIT.D_ScanMode, FXmlTagSIT.D_ScanMode);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_Value, FXmlTagSIT.D_Value, val);
                fXmlNode.set_attrVal(FXmlTagSIT.A_Length, FXmlTagSIT.D_Length, length.ToString());
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_Transformer, FXmlTagSIT.D_Transformer, FXmlTagSIT.D_Transformer);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_Precondition, FXmlTagSIT.D_Precondition, FXmlTagSIT.D_Precondition);
                // --
                fXmlNode.set_attrVal(FXmlTagSIT.A_ReservedWord, FXmlTagSIT.D_ReservedWord, FXmlTagSIT.D_ReservedWord);
                fXmlNode.set_attrVal(FXmlTagSIT.A_Extraction, FXmlTagSIT.D_Extraction, FXmlTagSIT.D_Extraction);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSDM(
            FXmlDocument fXmlDoc
            )
        {
            try
            {
                return fXmlDoc.createNode(FXmlTagSDM.E_SecsDeviceModeling);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static FXmlNode createXmlNodeSDV(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSDV.E_SecsDevice);
                // --
                fXmlNode.set_attrVal(FXmlTagSDV.A_UniqueId, FXmlTagSDV.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSDV.A_Locked, FXmlTagSDV.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSDV.A_Name, FXmlTagSDV.D_Name, "SecsDevice");
                fXmlNode.set_attrVal(FXmlTagSDV.A_Description, FXmlTagSDV.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSDV.A_FontColor, FXmlTagSDV.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSDV.A_FontBold, FXmlTagSDV.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSDV.A_Mode, FXmlTagSDV.D_Mode, FXmlTagSDV.D_Mode);
                fXmlNode.set_attrVal(FXmlTagSDV.A_Protocol, FXmlTagSDV.D_Protocol, FXmlTagSDV.D_Protocol);
                fXmlNode.set_attrVal(FXmlTagSDV.A_ConnectMode, FXmlTagSDV.D_ConnectMode, FXmlTagSDV.D_ConnectMode);
                fXmlNode.set_attrVal(FXmlTagSDV.A_LocalIp, FXmlTagSDV.D_LocalIp, FXmlTagSDV.D_LocalIp);
                fXmlNode.set_attrVal(FXmlTagSDV.A_LocalPort, FXmlTagSDV.D_LocalPort, FXmlTagSDV.D_LocalPort);
                fXmlNode.set_attrVal(FXmlTagSDV.A_RemoteIp, FXmlTagSDV.D_RemoteIp, FXmlTagSDV.D_RemoteIp);
                fXmlNode.set_attrVal(FXmlTagSDV.A_RemotePort, FXmlTagSDV.D_RemotePort, FXmlTagSDV.D_RemotePort);
                fXmlNode.set_attrVal(FXmlTagSDV.A_SerialPort, FXmlTagSDV.D_SerialPort, FXmlTagSDV.D_SerialPort);
                fXmlNode.set_attrVal(FXmlTagSDV.A_Baud, FXmlTagSDV.D_Baud, FXmlTagSDV.D_Baud);
                fXmlNode.set_attrVal(FXmlTagSDV.A_RBit, FXmlTagSDV.D_RBit, FXmlTagSDV.D_RBit);
                fXmlNode.set_attrVal(FXmlTagSDV.A_Interleave, FXmlTagSDV.D_Interleave, FXmlTagSDV.D_Interleave);
                fXmlNode.set_attrVal(FXmlTagSDV.A_DuplicateError, FXmlTagSDV.D_DuplicateError, FXmlTagSDV.D_DuplicateError);
                fXmlNode.set_attrVal(FXmlTagSDV.A_IgnoreSytemBytes, FXmlTagSDV.D_IgnoreSytemBytes, FXmlTagSDV.D_IgnoreSytemBytes);
                fXmlNode.set_attrVal(FXmlTagSDV.A_LinkTestPeriod, FXmlTagSDV.D_LinkTestPeriod, FXmlTagSDV.D_LinkTestPeriod);
                fXmlNode.set_attrVal(FXmlTagSDV.A_RetryLimit, FXmlTagSDV.D_RetryLimit, FXmlTagSDV.D_RetryLimit);
                // --
                fXmlNode.set_attrVal(FXmlTagSDV.A_T1Timeout, FXmlTagSDV.D_T1Timeout, FXmlTagSDV.D_T1Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T2Timeout, FXmlTagSDV.D_T2Timeout, FXmlTagSDV.D_T2Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T3Timeout, FXmlTagSDV.D_T3Timeout, FXmlTagSDV.D_T3Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T4Timeout, FXmlTagSDV.D_T4Timeout, FXmlTagSDV.D_T4Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T5Timeout, FXmlTagSDV.D_T5Timeout, FXmlTagSDV.D_T5Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T6Timeout, FXmlTagSDV.D_T6Timeout, FXmlTagSDV.D_T6Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T7Timeout, FXmlTagSDV.D_T7Timeout, FXmlTagSDV.D_T7Timeout);
                fXmlNode.set_attrVal(FXmlTagSDV.A_T8Timeout, FXmlTagSDV.D_T8Timeout, FXmlTagSDV.D_T8Timeout);
                // --
                fXmlNode.set_attrVal(FXmlTagSDV.A_State, FXmlTagSDV.D_State, FXmlTagSDV.D_State);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSSN(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSSN.E_SecsSession);
                // --
                fXmlNode.set_attrVal(FXmlTagSSN.A_UniqueId, FXmlTagSSN.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSSN.A_Locked, FXmlTagSSN.D_Locked, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSSN.A_Name, FXmlTagSSN.D_Name, "SecsSession");
                fXmlNode.set_attrVal(FXmlTagSSN.A_Description, FXmlTagSSN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSSN.A_FontColor, FXmlTagSSN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSSN.A_FontBold, FXmlTagSSN.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSSN.A_SessionId, FXmlTagSSN.D_SessionId, "0");
                fXmlNode.set_attrVal(FXmlTagSSN.A_SecsLibraryId, FXmlTagSSN.D_SecsLibraryId, FXmlTagSSN.D_SecsLibraryId);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNode.set_attrVal(FXmlTagHMG.A_LogEnabled, FXmlTagHMG.D_LogEnabled, FBoolean.True);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSTR(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSTR.E_SecsTrigger);
                // --
                fXmlNode.set_attrVal(FXmlTagSTR.A_UniqueId, FXmlTagSTR.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSTR.A_Name, FXmlTagSTR.D_Name, "SecsTrigger");
                fXmlNode.set_attrVal(FXmlTagSTR.A_Description, FXmlTagSTR.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSTR.A_FontColor, FXmlTagSTR.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSTR.A_FontBold, FXmlTagSTR.D_FontBold, FBoolean.False);
                // --                
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSCN(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSCN.E_SecsCondition);
                // --
                fXmlNode.set_attrVal(FXmlTagSCN.A_UniqueId, FXmlTagSCN.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSCN.A_Name, FXmlTagSCN.D_Name, "SecsCondition");
                fXmlNode.set_attrVal(FXmlTagSCN.A_Description, FXmlTagSCN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSCN.A_FontColor, FXmlTagSCN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSCN.A_FontBold, FXmlTagSCN.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSCN.A_ConditionMode, FXmlTagSCN.D_ConditionMode, "E");
                // --
                fXmlNode.set_attrVal(FXmlTagSCN.A_SecsDeviceId, FXmlTagSCN.D_SecsDeviceId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagSCN.A_SecsSessionId, FXmlTagSCN.D_SecsSessionId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagSCN.A_SecsMessageId, FXmlTagSCN.D_SecsMessageId, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSCN.A_RetryLimit, FXmlTagSCN.D_RetryLimit, FXmlTagSCN.D_RetryLimit);
                fXmlNode.set_attrVal(FXmlTagSCN.A_RetryCount, FXmlTagSCN.D_RetryCount, FXmlTagSCN.D_RetryCount);
                // --
                fXmlNode.set_attrVal(FXmlTagSCN.A_ConnectionState, FXmlTagSCN.D_ConnectionState, FXmlTagSCN.D_ConnectionState);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSEP(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSEP.E_SecsExpression);
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_UniqueId, FXmlTagSEP.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSEP.A_Name, FXmlTagSEP.D_Name, "SecsExpression");
                fXmlNode.set_attrVal(FXmlTagSEP.A_Description, FXmlTagSEP.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_FontColor, FXmlTagSEP.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSEP.A_FontBold, FXmlTagSEP.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_Logical, FXmlTagSEP.D_Logical, "A");
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_ExpressionType, FXmlTagSEP.D_ExpressionType, "C");
                fXmlNode.set_attrVal(FXmlTagSEP.A_ComparisonMode, FXmlTagSEP.D_ComparisonMode, "V");
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_OperandType, FXmlTagSEP.D_OperandType, "S");
                fXmlNode.set_attrVal(FXmlTagSEP.A_OperandId, FXmlTagSEP.D_OperandId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagSEP.A_OperandFormat, FXmlTagSEP.D_OperandFormat, "A");
                fXmlNode.set_attrVal(FXmlTagSEP.A_OperandIndex, FXmlTagSEP.D_OperandIndex, "0");
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_Operation, FXmlTagSEP.D_Operation, "E");
                // --
                fXmlNode.set_attrVal(FXmlTagSEP.A_Value, FXmlTagSEP.D_Value, "");
                fXmlNode.set_attrVal(FXmlTagSEP.A_Transformer, FXmlTagSEP.D_Transformer, "");
                // --
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSTN(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSTN.E_SecsTransmitter);
                // --
                fXmlNode.set_attrVal(FXmlTagSTN.A_UniqueId, FXmlTagSTN.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSTN.A_Name, FXmlTagSTN.D_Name, "SecsTransmitter");
                fXmlNode.set_attrVal(FXmlTagSTN.A_Description, FXmlTagSTN.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSTN.A_FontColor, FXmlTagSTN.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSTN.A_FontBold, FXmlTagSTN.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSTN.A_AutoActionFirstSelect, FXmlTagSTN.D_AutoActionFirstSelect, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSTN.A_AutoActionFirstClose, FXmlTagSTN.D_AutoActionFirstClose, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSTN.A_AutoActionAlwaysSelect, FXmlTagSTN.D_AutoActionAlwaysSelect, FBoolean.False);
                fXmlNode.set_attrVal(FXmlTagSTN.A_AutoActionAlwaysClose, FXmlTagSTN.D_AutoActionAlwaysClose, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSTN.A_UsedAutoCycle, FXmlTagSTN.D_UsedAutoCycle, FXmlTagSTN.D_UsedAutoCycle);
                fXmlNode.set_attrVal(FXmlTagSTN.A_AutoCyclePeriod, FXmlTagSTN.D_AutoCyclePeriod, FXmlTagSTN.D_AutoCyclePeriod);
                fXmlNode.set_attrVal(FXmlTagSTN.A_AutoCycleAction, FXmlTagSTN.D_AutoCycleAction, FXmlTagSTN.D_AutoCycleAction);
                // --                
                return fXmlNode;
            }
            catch (Exception ex)
        ...
        public static FXmlNode createXmlNodeSTF(
            FXmlDocument fXmlDoc
            )
        {
            FXmlNode fXmlNode = null;
            ...
            try
            {
                fXmlNode = fXmlDoc.createNode(FXmlTagSTF.E_SecsTransfer);
                // --
                fXmlNode.set_attrVal(FXmlTagSTF.A_UniqueId, FXmlTagSTF.D_UniqueId, "0");
                fXmlNode.set_attrVal(FXmlTagSTF.A_Name, FXmlTagSTF.D_Name, "SecsTransfer");
                fXmlNode.set_attrVal(FXmlTagSTF.A_Description, FXmlTagSTF.D_Description, string.Empty);
                // --
                fXmlNode.set_attrVal(FXmlTagSTF.A_FontColor, FXmlTagSTF.D_FontColor, Color.Black.Name);
                fXmlNode.set_attrVal(FXmlTagSTF.A_FontBold, FXmlTagSTF.D_FontBold, FBoolean.False);
                // --
                fXmlNode.set_attrVal(FXmlTagSTF.A_SecsDeviceId, FXmlTagSTF.D_SecsDeviceId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagSTF.A_SecsSessionId, FXmlTagSTF.D_SecsSessionId, string.Empty);
                fXmlNode.set_attrVal(FXmlTagSTF.A_SecsMessageId, FXmlTagSTF.D_SecsMessageId, string.Empty);
                // --
                return fXmlNode;
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                if (name == FXmlTagSCD.E_SecsDriver)
                {
                    fObject = new FSecsDriver(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagONL.E_ObjectNameList)
                {
                    fObject = new FObjectNameList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagONA.E_ObjectName)
                {
                    fObject = new FObjectName(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagFNL.E_FunctionNameList)
                {
                    fObject = new FFunctionNameList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagFNA.E_FunctionName)
                {
                    fObject = new FFunctionName(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagPAN.E_ParameterName)
                {
                    fObject = new FParameterName(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagARG.E_Argument)
                {
                    fObject = new FArgument(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagUTN.E_UserTagName)
                {
                    fObject = new FUserTagName(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagDCL.E_DataConversionSetList)
                {
                    fObject = new FDataConversionSetList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagDCS.E_DataConversionSet)
                {
                    fObject = new FDataConversionSet(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagDCV.E_DataConversion)
                {
                    fObject = new FDataConversion(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagESL.E_EquipmentStateSetList)
                {
                    fObject = new FEquipmentStateSetList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagESS.E_EquipmentStateSet)
                {
                    fObject = new FEquipmentStateSet(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagEST.E_EquipmentState)
                {
                    fObject = new FEquipmentState(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSTV.E_StateValue)
                {
                    fObject = new FStateValue(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagRPL.E_RepositoryList)
                {
                    fObject = new FRepositoryList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagRPS.E_Repository)
                {
                    ...
                    {
                        fObject = new FRepository(fScdCore, fXmlNode);
                    }
                    else
                    {
                        fObject = new FRepositoryMaterial(fScdCore, fXmlNode);
                    }
                }
                else if (name == FXmlTagCOL.E_Column)
                {
                    fObject = new FColumn(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagENL.E_EnvironmentList)
                {
                    fObject = new FEnvironmentList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagENV.E_Environment)
                {
                    fObject = new FEnvironment(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagDSL.E_DataSetList)
                {
                    fObject = new FDataSetList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagDTS.E_DataSet)
                {
                    fObject = new FDataSet(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagDAT.E_Data)
                {
                    fObject = new FData(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagSLG.E_SecsLibraryGroup)
                {
                    fObject = new FSecsLibraryGroup(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSLB.E_SecsLibrary)
                {
                    fObject = new FSecsLibrary(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSML.E_SecsMessageList)
                {
                    fObject = new FSecsMessageList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSMS.E_SecsMessages)
                {
                    fObject = new FSecsMessages(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSMG.E_SecsMessage)
                {
                    typeValue = fXmlNode.get_attrVal(FXmlTagSMG.A_MessageType, FXmlTagSMG.D_MessageType);
                    if (typeValue == FXmlTagSMG.M_Message)
                    {
                        fObject = new FSecsMessage(fScdCore, fXmlNode);
                    }
                    else if (typeValue == FXmlTagSMG.M_MessageTransfer)
                    {
                        fObject = new FSecsMessageTransfer(fScdCore, fXmlNode);
                    }
                }
                else if (name == FXmlTagSIT.E_SecsItem)
                {
                    fObject = new FSecsItem(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagSDV.E_SecsDevice)
                {
                    fObject = new FSecsDevice(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSSN.E_SecsSession)
                {
                    fObject = new FSecsSession(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagHLG.E_HostLibraryGroup)
                {
                    fObject = new FHostLibraryGroup(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHLB.E_HostLibrary)
                {
                    fObject = new FHostLibrary(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHML.E_HostMessageList)
                {
                    fObject = new FHostMessageList(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHMS.E_HostMessages)
                {
                    fObject = new FHostMessages(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHMG.E_HostMessage)
                {
                    ...
                    {
                        fObject = new FHostMessage(fScdCore, fXmlNode);
                    }
                    ...
                    {
                        fObject = new FHostDriverDataMessage(fScdCore, fXmlNode);
                    }
                }
                else if (name == FXmlTagHIT.E_HostItem)
                {
                    fObject = new FHostItem(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagHDV.E_HostDevice)
                {
                    fObject = new FHostDevice(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHSN.E_HostSession)
                {
                    fObject = new FHostSession(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagEQP.E_Equipment)
                {
                    fObject = new FEquipment(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSNG.E_ScenarioGroup)
                {
                    fObject = new FScenarioGroup(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSNR.E_Scenario)
                {
                    fObject = new FScenario(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSTR.E_SecsTrigger)
                {
                    fObject = new FSecsTrigger(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSCN.E_SecsCondition)
                {
                    fObject = new FSecsCondition(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSEP.E_SecsExpression)
                {
                    fObject = new FSecsExpression(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSTN.E_SecsTransmitter)
                {
                    fObject = new FSecsTransmitter(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSTF.E_SecsTransfer)
                {
                    fObject = new FSecsTransfer(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHTR.E_HostTrigger)
                {
                    fObject = new FHostTrigger(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHCN.E_HostCondition)
                {
                    fObject = new FHostCondition(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHEP.E_HostExpression)
                {
                    fObject = new FHostExpression(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHTN.E_HostTransmitter)
                {
                    fObject = new FHostTransmitter(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagHTF.E_HostTransfer)
                {
                    fObject = new FHostTransfer(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagESA.E_EquipmentStateSetAlterer)
                {
                    fObject = new FEquipmentStateSetAlterer(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagEAT.E_EquipmentStateAlterer)
                {
                    fObject = new FEquipmentStateAlterer(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagJDM.E_Judgement)
                {
                    fObject = new FJudgement(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagJCN.E_JudgementCondition)
                {
                    fObject = new FJudgementCondition(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagJEP.E_JudgementExpression)
                {
                    fObject = new FJudgementExpression(fScdCore, fXmlNode);
                }
                // --
                else if (name == FXmlTagMAP.E_Mapper)
                {
                    fObject = new FMapper(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagSTG.E_Storage)
                {
                    fObject = new FStorage(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagCBK.E_Callback)
                {
                    fObject = new FCallback(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagFUN.E_Function)
                {
                    fObject = new FFunction(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagBRN.E_Branch)
                {
                    fObject = new FBranch(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagCMT.E_Comment)
                {
                    fObject = new FComment(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagPAU.E_Pauser)
                {
                    fObject = new FPauser(fScdCore, fXmlNode);
                }
                else if (name == FXmlTagETP.E_EntryPoint)
                {
                    fObject = new FEntryPoint(fScdCore, fXmlNode);
                }
        ...
        {
            FObjectType type = FObjectType.SecsDriver;
            string name = string.Empty;
            string typeValue = string.Empty;
            ...
            try
            {
                ...
                {
                    type = FObjectType.SecsLibraryGroup;
                }
                else if (name == FXmlTagSLB.E_SecsLibrary)
                {
                    type = FObjectType.SecsLibrary;
                }
                else if (name == FXmlTagSML.E_SecsMessageList)
                {
                    type = FObjectType.SecsMessageList;
                }
                else if (name == FXmlTagSMS.E_SecsMessages)
                {
                    type = FObjectType.SecsMessages;
                }
                else if (name == FXmlTagSMG.E_SecsMessage)
                {
                    typeValue = fXmlNode.get_attrVal(FXmlTagSMG.A_MessageType, FXmlTagSMG.D_MessageType);
                    if (typeValue == FXmlTagSMG.M_Message)
                    {
                        type = FObjectType.SecsMessage;
                    }
                    else if (typeValue == FXmlTagSMG.M_MessageTransfer)
                    {
                        type = FObjectType.SecsMessageTransfer;
                    }
                }
                else if (name == FXmlTagSIT.E_SecsItem)
                {
                    type = FObjectType.SecsItem;
                }
                // --
                else if (name == FXmlTagSDV.E_SecsDevice)
                {
                    type = FObjectType.SecsDevice;
                }
                else if (name == FXmlTagSSN.E_SecsSession)
                {
                    type = FObjectType.SecsSession;
                }
                // --
                else if (name == FXmlTagHLG.E_HostLibraryGroup)
                {
                ...
                {
                    type = FObjectType.SecsTrigger;
                }
                else if (name == FXmlTagSCN.E_SecsCondition)
                {
                    type = FObjectType.SecsCondition;
                }
                else if (name == FXmlTagSEP.E_SecsExpression)
                {
                    type = FObjectType.SecsExpression;
                }
                else if (name == FXmlTagSTN.E_SecsTransmitter)
                {
                    type = FObjectType.SecsTransmitter;
                }
                else if (name == FXmlTagSTF.E_SecsTransfer)
                {
                    type = FObjectType.SecsTransfer;
                }
                else if (name == FXmlTagHTR.E_HostTrigger)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNode = ((FSecsDriver)fObject).fXmlNode;
                }
                // --
                ...
                {
                    fXmlNode = ((FSecsLibraryGroup)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsLibrary)
                {
                    fXmlNode = ((FSecsLibrary)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsMessageList)
                {
                    fXmlNode = ((FSecsMessageList)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsMessages)
                {
                    fXmlNode = ((FSecsMessages)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsMessage)
                {
                    fXmlNode = ((FSecsMessage)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsMessageTransfer)
                {
                    fXmlNode = ((FSecsMessageTransfer)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsItem)
                {
                    fXmlNode = ((FSecsItem)fObject).fXmlNode;
                }
                // --
                else if (fObject.fObjectType == FObjectType.SecsDevice)
                {
                    fXmlNode = ((FSecsDevice)fObject).fXmlNode;
                }
                else if (fObject.fObjectType == FObjectType.SecsSession)
                {
                    fXmlNode = ((FSecsSession)fObject).fXmlNode;
                }
                // --
        ...
        public static void setSecsItemRandomValue(
            FXmlNode fXmlNodeMsg
            )
        {
            const string ItemQuery =
                "//" + FXmlTagSIT.E_SecsItem + "[@" +
                FXmlTagSIT.A_RandomValue + "='{0}']";
            ...
            )
        {
            ...
            try
            {
                ...
                FFormat format = FEnumConverter.toFormat(
                    fXmlNodeItem.get_attrVal(FXmlTagSIT.A_Format, FXmlTagSIT.D_Format)
                    );
                sMin = fXmlNodeItem.get_attrVal(FXmlTagSIT.A_RandomValueMin, FXmlTagSIT.D_RandomValueMin);
                sMax = fXmlNodeItem.get_attrVal(FXmlTagSIT.A_RandomValueMax, FXmlTagSIT.D_RandomValueMax);

                // --

                if (sMin == FXmlTagSIT.D_RandomValueMin &&
                    sMax == FXmlTagSIT.D_RandomValueMax)
                {
                    return;
                }
                    ...
                    format == FFormat.I1)
                {
                    ...
                    objVal = (Int64)(rnd.NextDouble() * (max - min) + min);
                    // --
                }
                else if (format == FFormat.F8 ||
                    format == FFormat.F4)
                {
                    ...
                    // --
                    objVal = rnd.NextDouble() * (max - min) + min;
                }
                else if (format == FFormat.U8 ||
                    format == FFormat.U4 ||
                    format == FFormat.U2 ||
                    format == FFormat.U1)
                {
                    ...
                    objVal = (UInt64)(rnd.NextDouble() * (max - min) + min);
                }

                // --

                val = FValueConverter.fromValue(format, FSecsLengthBytes.Auto, objVal, out length);

                // --
                fXmlNodeItem.set_attrVal(FXmlTagSIT.A_Length, FXmlTagSIT.D_Length, length.ToString());
                fXmlNodeItem.set_attrVal(FXmlTagSIT.A_Value, FXmlTagSIT.D_Value, val);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
