...
--
--  Program Id      : c_FXmlTagFAMate.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.04
--  Description     : FAMate Core FaUIs FAMate XML Tag Definition Class 
...
namespace Miracom.FAMate.Core.FaUIs
{
    public static class FXmlTagFAMate
    {
