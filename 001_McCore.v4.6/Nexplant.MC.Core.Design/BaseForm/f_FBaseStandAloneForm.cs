...
{
    public partial class FBaseStandAloneForm : Nexplant.MC.Core.FaUIs.FBaseForm
    {
        ...
        #region FBaseStandAloneForm Form Event Handler

        private void FBaseStandAloneForm_Load(
            object sender, 
            EventArgs e
            )
        {
            ...
            {
                FMessageBox.showError("FBaseStandAloneForm", ex, null);
            }
            finally
            {
        ...
        private void FBaseStandAloneForm_Activated(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FBaseStandAloneForm_Deactivate(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FBaseStandAloneForm_Enter(object sender, EventArgs e)
        {
            try
            {
                if (!m_actived)
        ...
        private void FBaseStandAloneForm_Leave(object sender, EventArgs e)
        {
            try
            {
                if (m_actived)
        ...
        private void FBaseStandAloneForm_TextChanged(
            object sender, 
            EventArgs e
            )
        {
