...
--
--  Program Id      : f_FBaseTabChildDialogForm.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.20
--  Description     : FAMate Core FaUIs TAB Child Dialog Form Base Class
...
{
    public partial class FBaseTabChildDialogForm : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        public FBaseTabChildDialogForm(
            )
        {
            InitializeComponent();
            // --
        ...
        public bool resizable
        {
            get
            {
                ...
                {
                    FMessageBox.showError("FBaseTabChildDialogForm", ex, null);
                }
                finally
                {
        ...
        #region FBaseTabChildDialogForm Form Event Handler

        private void FBaseTabChildDialogForm_Shown(
            object sender, 
            EventArgs e
            )
        {
