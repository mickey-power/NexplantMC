...
--
--  Program Id      : t_FRibbonToolbarsManager.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.04
--  Description     : FAMate Core FaUIs Ribbon Toolbars Manager Control
...
{
    public partial class FRibbonToolbarsManager : UltraToolbarsManager
    {
            ...
            )
        {
            try
            {
                ...
                //this.Style = ToolbarStyle.ScenicRibbon;
