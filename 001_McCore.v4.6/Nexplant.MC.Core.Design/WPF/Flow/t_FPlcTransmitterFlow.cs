...
--
--  Program Id      : t_FPlcTransmitterFlow.cs
--  Creator         : duchoi
--  Create Date     : 2013.08.22
--  Description     : FAMate Core FaUIs PLC Transmitter Flow Control
...
{
    public partial class FPlcTransmitterFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.PlcTransmitter;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    // -- 
                    panel = drawImageAndText(FFlowCtrlType.PlcTransmitter, text);
