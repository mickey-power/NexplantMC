...
--
--  Program Id      : t_FTcpTriggerFlow.cs
--  Creator         : duchoi
--  Create Date     : 2013.08.22
--  Description     : FAMate Core FaUIs TCP Trigger Flow Control
...
{
    public partial class FTcpTriggerFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.TcpTrigger;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    panel = drawImageAndText(FFlowCtrlType.TcpTrigger, text);
