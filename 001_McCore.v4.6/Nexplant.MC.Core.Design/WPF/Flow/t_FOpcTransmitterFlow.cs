...
--
--  Program Id      : t_FOpcTransmitterFlow.cs
--  Creator         : duchoi
--  Create Date     : 2013.08.22
--  Description     : FAMate Core FaUIs OPC Transmitter Flow Control
...
{
    public partial class FOpcTransmitterFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.OpcTransmitter;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    // -- 
                    panel = drawImageAndText(FFlowCtrlType.OpcTransmitter, text);
