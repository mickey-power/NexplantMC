...
--
--  Program Id      : t_FSecsTransmitterFlow.cs
--  Creator         : spike.lee
--  Create Date     : 2011.06.02
--  Description     : FAMate Core FaUIs SECS Transmitter Flow Control
...
{
    public partial class FSecsTransmitterFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FSecsTransmitterFlow(
            ...
            : base("SecsTransmitterFlow", image)
        {
            InitializeComponent();
            init();
        }
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.SecsTransmitter;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    fArrowLine.Stroke = System.Windows.Media.Brushes.Green;
                    fArrowLine.StrokeThickness = strokeThickness;
                    // --
                    fArrowLine.Points.Add(new System.Windows.Point(eapPosition - 1, height - verticalMargin - additionalY));
                    fArrowLine.Points.Add(new System.Windows.Point(eqPosition + 2, height - verticalMargin - additionalY));
                    // --
                    ...
                    // -- 
                    panel = drawImageAndText(FFlowCtrlType.SecsTransmitter, text);
