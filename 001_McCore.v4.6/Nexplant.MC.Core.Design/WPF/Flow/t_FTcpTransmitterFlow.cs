...
--
--  Program Id      : t_FTcpTransmitterFlow.cs
--  Creator         : duchoi
--  Create Date     : 2013.08.22
--  Description     : FAMate Core FaUIs TCP Transmitter Flow Control
...
{
    public partial class FTcpTransmitterFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.TcpTransmitter;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    // -- 
                    panel = drawImageAndText(FFlowCtrlType.TcpTransmitter, text);
