...
--
--  Program Id      : t_FHostTriggerFlow.cs
--  Creator         : spike.lee
--  Create Date     : 2011.07.21
--  Description     : FAMate Core FaUIs Host Trigger Flow Control
...
{
    public partial class FHostTriggerFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.HostTrigger;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    // -- 
                    fArrowLine.Points.Add(new System.Windows.Point(hostPosition - 1, height - verticalMargin - additionalY));
                    ...
                    // --
                    panel = drawImageAndText(FFlowCtrlType.HostTrigger, text);
