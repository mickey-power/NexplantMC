...
--
--  Program Id      : t_FPlcTriggerFlow.cs
--  Creator         : duchoi
--  Create Date     : 2013.08.22
--  Description     : FAMate Core FaUIs PLC Trigger Flow Control
...
{
    public partial class FPlcTriggerFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FFlowCtrlType fFlowCtrlType
        {
            get
            {
                try
                {
                    return FFlowCtrlType.PlcTrigger;
                }
                catch (Exception ex)
                {
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    panel = drawImageAndText(FFlowCtrlType.PlcTrigger, text);
