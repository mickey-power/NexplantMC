...
namespace Nexplant.MC.Core.FaUIs.WPF
{
    public partial class FHostTransmitterFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        public FHostTransmitterFlow(
            ...
            : base("HostTransmitterFlow", image)
        {
            InitializeComponent();
            init();
        }
        ...
        public System.Windows.Controls.Canvas symbol
        {
            get
            {
                ...
                try
                {
                    ...
                    fArrowLine.Points.Add(new System.Windows.Point(hostPosition - 2, height - verticalMargin - additionalY));
                    // --
                    ...
                    // --
                    panel = drawImageAndText(FFlowCtrlType.HostTransmitter, text);
