...
--
--  Program Id      : t_FMapperFlow.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.30
--  Description     : FAMate Core FaUIs Mapper Flow Control
...
{
    public partial class FMapperFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        #region FMapperFlow Control Event Handler

        private void FMapperFlow_Load(
            object sender, 
            EventArgs e
            )
        {
            ...
            {
                FMessageBox.showError("FMapperFlow", ex, null);
            }
            finally
            {
