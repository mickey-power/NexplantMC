...
namespace Nexplant.MC.Core.FaUIs
{
    public partial class FCommentFlow : FBaseFlowCtrl, FIFlowCtrl
    {
        ...
        #region FCommentFlow Control Event Handler

        private void FCommentFlow_Load(
            object sender, 
            EventArgs e
            )
        {
            ...
            {
                FMessageBox.showError("FCommentFlow", ex, null);
            }
            finally
            {
            ...
            )
        {
            ...
            try
            {
                ...
                pen = new Pen(Color.MediumOrchid, 2);
               
                // --

                x1 = (pnlMain.Width - 26) / 4 + 34;
                x2 = x1 - 8;
                y1 = 10;
                y2 = 26;
                e.Graphics.DrawLine(pen, x1, y1, x2, y2);

                x1 = (pnlMain.Width - 26) / 4 + 39;
                x2 = x1 - 8;
                y1 = 10;
                y2 = 26;
                e.Graphics.DrawLine(pen, x1, y1, x2, y2);
