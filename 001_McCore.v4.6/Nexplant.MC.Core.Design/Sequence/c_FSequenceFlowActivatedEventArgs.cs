...
--
--  Program Id      : c_FSequenceFlowActivatedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2011.04.12
--  Description     : FAMate Core FaUIs Sequence Flow Activated Event Arguments Class
...
{
    [Serializable]
    public class FSequenceFlowActivatedEventArgs : EventArgs, IDisposable
    {
        ...
        internal FSequenceFlowActivatedEventArgs(
            FSequenceFlow fActiveSequenceFlow,
            FGrid fActiveGrid,
            UltraGridRow activeGridRow,
            UltraDataRow activeDataRow
            )
        {
            m_fActiveSequenceFlow = fActiveSequenceFlow;
        ...
        ~FSequenceFlowActivatedEventArgs(
            )
        {
            myDispose(false);
        }
