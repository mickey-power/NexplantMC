...
--
--  Program Id      : t_FBarChart.cs
--  Creator         : mjkim
--  Create Date     : 2013.02.18
--  Description     : FAMate Core FaUIs MS Chart - Column Type Control
...
{
    public partial class FBarChart : Chart
    {
            ...
            )
        {
            try
            {
                this.HandleCreated += new EventHandler(FBarChart_HandleCreated);
                this.MouseDown += new System.Windows.Forms.MouseEventHandler(FBarChart_MouseDown);
            }
            catch (Exception ex)
            {
