...
--  Description     : FAMate Core FaPlcDriver Column Tag Definition Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    internal static class FXmlTagCOL
    {
        ...
        public const string A_PartTag = "PT";           // 2017.03.29 by spike.lee Repository Select/Remote Part Option 지원 Tag
        // --
        ...
        public const string D_PartTag = "";         // 2017.03.29 by spike.lee Repository Select/Remote Part Option 지원 Tag
