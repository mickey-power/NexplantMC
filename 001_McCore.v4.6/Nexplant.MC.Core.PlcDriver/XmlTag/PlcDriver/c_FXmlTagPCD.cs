...
--
--  Program Id      : c_FXmlTagPCD.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.09
--  Description     : FAMate Core FaPlcDriver PLC Driver XML Tag Definition Class 
...
{
    internal static class FXmlTagPCD
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Driver Element and Attribute 
        // ***
