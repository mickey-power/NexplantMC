...
--
--  Program Id      : c_FXmlTagPBL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaPlcDriver PLC Bit List XML Tag Definition Class 
...
{
    internal static class FXmlTagPBL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Bit List Element and Attribute 
        // ***
