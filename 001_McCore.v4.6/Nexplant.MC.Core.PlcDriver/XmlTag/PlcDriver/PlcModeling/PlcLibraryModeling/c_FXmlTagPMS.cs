...
--
--  Program Id      : c_FXmlTagPMS.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.10.29
--  Description     : FAMate Core FaPlcDriver PLC Messages XML Tag Definition Class 
...
{
    internal static class FXmlTagPMS
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Messages Element and Attribute 
        // ***
        public const string E_PlcMessages = "PMS";
        // --
