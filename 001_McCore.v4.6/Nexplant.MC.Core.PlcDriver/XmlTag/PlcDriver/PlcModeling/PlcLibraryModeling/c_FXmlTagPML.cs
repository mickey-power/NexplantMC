...
--
--  Program Id      : c_FXmlTagPML.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaPlcDriver PLC Message List XML Tag Definition Class 
...
{
    internal static class FXmlTagPML
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Message List Element and Attribute 
        // ***
        public const string E_PlcMessageList = "PML";
        // --
