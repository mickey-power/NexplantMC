...
--
--  Program Id      : c_FXmlTagPLB.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.11
--  Description     : FAMate Core FaPlcDriver PLC Library XML Tag Definition Class 
...
{
    internal static class FXmlTagPLB
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Library Element and Attribute 
        // ***
        public const string E_PlcLibrary = "PLB";
        // --
