...
--
--  Program Id      : c_FXmlTagPWD.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaPlcDriver PLC Word XML Tag Definition Class 
...
{
    internal static class FXmlTagPWD
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Word Element and Attribute 
        // ***
