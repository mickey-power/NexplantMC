...
--
--  Program Id      : c_FXmlTagPMG.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.29
--  Description     : FAMate Core FaPlcDriver PLC Message XML Tag Definition Class 
--  History         : Created by spike.lee at 2013.10.29
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagPMG
    {
        ...
        // ***
        // PLC Message Element and Attribute 
        // ***
