...
--
--  Program Id      : c_FXmlTagPLG.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.11
--  Description     : FAMate Core FaPlcDriver PLC Library Group XML Tag Definition Class 
...
{
    internal static class FXmlTagPLG
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Library Group Element and Attribute 
        // ***
        public const string E_PlcLibraryGroup = "PLG";
        // --
