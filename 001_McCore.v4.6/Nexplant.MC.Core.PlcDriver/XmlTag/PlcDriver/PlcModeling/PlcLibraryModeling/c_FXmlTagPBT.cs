...
--
--  Program Id      : c_FXmlTagPBT.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaPlcDriver PLC Bit XML Tag Definition Class 
...
{
    internal static class FXmlTagPBT
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Bit Element and Attribute 
        // ***
        public const string E_PlcBit = "PBT";
        // --
