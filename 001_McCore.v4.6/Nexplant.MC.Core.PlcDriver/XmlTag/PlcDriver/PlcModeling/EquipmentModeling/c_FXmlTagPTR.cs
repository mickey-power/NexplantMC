...
--
--  Program Id      : c_FXmlTagPTR.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaPlcDriver PLC Trigger XML Tag Definition Class 
...
{
    internal static class FXmlTagPTR
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Trigger Element and Attribute 
        // ***
