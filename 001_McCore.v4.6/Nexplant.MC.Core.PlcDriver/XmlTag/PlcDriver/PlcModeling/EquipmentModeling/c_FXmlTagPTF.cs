...
--
--  Program Id      : c_FXmlTagPTF.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaPlcDriver PLC Transfer XML Tag Definition Class 
...
{
    internal static class FXmlTagPTF
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Transfer Element and Attribute 
        // ***
        public const string E_PlcTransfer = "PTF";
        // --
