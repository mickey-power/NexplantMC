...
--
--  Program Id      : c_FXmlTagPEP.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaPlcDriver PLC Expression XML Tag Definition Class 
...
{
    internal static class FXmlTagPEP
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Expression Element and Attribute 
        // ***
        public const string E_PlcExpression = "PEP";
        // --
