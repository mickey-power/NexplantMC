...
--
--  Program Id      : c_FXmlTagPTN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaPlcDriver PLC Transmitter XML Tag Definition Class 
...
{
    internal static class FXmlTagPTN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Transmitter Element and Attribute 
        // ***
