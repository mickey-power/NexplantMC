...
--
--  Program Id      : c_FXmlTagPCN.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaPlcDriver PLC Condition XML Tag Definition Class 
...
{
    internal static class FXmlTagPCN
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Condition Element and Attribute 
        // ***
        public const string E_PlcCondition = "PCN";
        // --
        ...
        public const string A_PlcMessageId = "MI";
        ...
        public const string D_PlcDeviceId = "";
        public const string D_PlcSessionId = "";
        public const string D_PlcMessageId = "";
