...
--
--  Program Id      : c_FXmlTagHITL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.08
--  Description     : FAMate Core FaSecsDriver Host Item Log XML Tag Definition Class 
...
{
    internal static class FXmlTagHITL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Item Log Element and Attribute 
        // ***
