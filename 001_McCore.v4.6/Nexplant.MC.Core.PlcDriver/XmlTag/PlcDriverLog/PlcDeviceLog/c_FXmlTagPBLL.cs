...
--
--  Program Id      : c_FXmlTagPBLL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.28
--  Description     : FAMate Core FaPlcDriver PLC Bit List Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPBLL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Bit List Log Element and Attribute 
        // ***
        public const string E_PlcBitList = "PBL";
        // --
