...
--
--  Program Id      : c_FXmlTagPBTL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.28
--  Description     : FAMate Core FaPlcDriver PLC Bit Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPBTL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Bit Log Element and Attribute 
        // ***
