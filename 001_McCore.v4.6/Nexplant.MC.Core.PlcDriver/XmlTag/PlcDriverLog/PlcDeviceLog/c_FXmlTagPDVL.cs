...
--
--  Program Id      : c_FXmlTagPDVL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.10
--  Description     : FAMate Core FaPlcDriver PLC Device XML Tag Definition Class 
...
{
    internal static class FXmlTagPDVL
    {
        ...
        // --
        // ***
        // PLC Device Element and Attribute 
        // ***
        public const string E_PlcDevice = "PDV";
        // --
        ...
        public const string A_Timeout = "TT";   // 삭제 예정
        ...
        public const string D_Protocol = "MELSECE";
        ...
        public const string D_Timeout = "5";    // 삭제 예정
        public const string D_State = "C";
        public const string D_Length = "14";
