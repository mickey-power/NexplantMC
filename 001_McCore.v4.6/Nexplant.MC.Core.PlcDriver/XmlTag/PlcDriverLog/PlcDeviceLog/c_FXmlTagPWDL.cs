...
--
--  Program Id      : c_FXmlTagPWDL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.10.28
--  Description     : FAMate Core FaPlcDriver PLC Word Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPWDL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Word Log Element and Attribute 
        // ***
        public const string E_PlcWord = "PWD";
        // --
        ...
        public const string A_Address = "AD";
        ...
        public const string D_Address = "";
        public const string D_Length = "1";
