...
--
--  Program Id      : c_FXmlTagPWLL.cs
--  Creator         : spike.lee
--  Create Date     : 2013.07.12
--  Description     : FAMate Core FaPlcDriver PLC Word List Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPWLL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Word List Element and Attribute 
        // ***
        public const string E_PlcWordList = "PWL";
        // --
