...
--
--  Program Id      : c_FXmlTagPTRL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.26
--  Description     : FAMate Core FaPlcDriver PLC Trigger Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPTRL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Trigger Raised Log Element and Attribute 
        // ***
        public const string E_PlcTrigger = "PTR";
        // --
