...
--
--  Program Id      : c_FXmlTagCTT.cs
--  Creator         : spike.lee
--  Create Date     : 2012.04.24
--  Description     : FAMate Core FaSecsDriver Content Log Tag Definition Class 
...
{
    internal static class FXmlTagCTTL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Content Log Element and Attribute 
        // ***
        public const string E_Content = "CTT";
        // --
