...
--
--  Program Id      : c_FXmlTagHTRL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.21
--  Description     : FAMate Core FaSecsDriver Host Trigger Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagHTRL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Trigger Raised Log Element and Attribute 
        // ***
        public const string E_HostTrigger = "HTR";
        // --
