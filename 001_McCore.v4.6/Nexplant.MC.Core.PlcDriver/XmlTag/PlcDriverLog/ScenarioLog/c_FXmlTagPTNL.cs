...
--
--  Program Id      : c_FXmlTagPTNL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.10.27
--  Description     : FAMate Core FaPlcDriver PLC Transmitter Raised Log XML Tag Definition Class 
...
{
    internal static class FXmlTagPTNL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // PLC Transmitter Raised Log Element and Attribute 
        // ***
        public const string E_PlcTransmitter = "PTN";
        // --
