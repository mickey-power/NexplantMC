...
--
--  Program Id      : c_FXmlTagAPPL.cs
--  Creator         : spike.lee
--  Create Date     : 2012.04.24
--  Description     : FAMate Core FaSecsDriver Application Written Log XML Tag Definition Class 
...
{
    internal static class FXmlTagAPPL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Application Written Log Element and Attribute 
        // ***
        public const string E_Application = "APP";
        // --
