...
--
--  Program Id      : c_FXmlTagETPL.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2014.03.24
--  Description     : FAMate Core FaPlcDriver Entry Point Called Log XML Tag Definition Class 
...
{
    internal static class FXmlTagETPL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Entry Pointer Called Log Element and Attribute 
        // ***
        public const string E_EntryPoint = "ETP";
        // --
