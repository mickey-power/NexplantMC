...
--
--  Program Id      : c_FXmlTagHTNL.cs
--  Creator         : spike.lee
--  Create Date     : 2011.11.22
--  Description     : FAMate Core FaSecsDriver Host Transmitter Raised Log XML Tag Definition Class 
--  History         : Created by spike.lee at 2011.11.22
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FXmlTagHTNL
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // Host Transmitter Raised Log Element and Attribute 
        // ***
