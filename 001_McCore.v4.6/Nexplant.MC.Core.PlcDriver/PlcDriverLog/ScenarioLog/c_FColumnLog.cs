...
--  Description     : FAMate Core FaPlcDriver Column Log Class 
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FRepositoryLog(this.fPcdlCore, fXmlNodeParent);
                    }
                    else if (fXmlNodeParent.name == FXmlTagCOLL.E_Column)
                    {
                        return new FColumnLog(this.fPcdlCore, fXmlNodeParent);
                    }
        ...
        public FColumnLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumnLog(this.fPcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumnLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumnLog(this.fPcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
