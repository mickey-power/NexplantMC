...
--  Description     : FAMate Core FaPlcDriver Data Log Class 
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FDataSetLog(this.fPcdlCore, fXmlNodeParent);
                    }
                    else if (fXmlNodeParent.name == FXmlTagDATL.E_Data)
                    {
                        return new FDataLog(this.fPcdlCore, fXmlNodeParent);
                    }
        ...
        public FDataLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataLog(this.fPcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataLog(this.fPcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
