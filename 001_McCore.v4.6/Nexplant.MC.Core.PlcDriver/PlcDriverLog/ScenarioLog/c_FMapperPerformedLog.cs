...
--  Description     : FAMate Core FaPlcDriver Mapper Performed Log Class 
    ...
    public class FMapperPerformedLog : FBaseObjectLog<FMapperPerformedLog>, FIObjectLog
    {
        ...
        public FDataSetLogCollection fChildDataSetLogCollection
        {
            get
            {
                try
                {
                    return new FDataSetLogCollection(this.fPcdlCore, this.fXmlNode.selectNodes(FXmlTagDTSL.E_DataSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataSetLog(this.fPcdlCore, fXmlNodeDstl);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
