...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FContentLog : FBaseObjectLog<FContentLog>, FIObjectLog
    {
        ...
        public FContentLog(      
            ...
            : base(FPlcDriverLogCommon.createXmlNodeCTTL(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FContentLog(
            ...
            : base(FPlcDriverLogCommon.createXmlNodeCTTL(fPlcDriver.fPcdCore.fXmlDoc, name, fFormat, stringValue))
        {
        ...
        public FIObjectLog fParent
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        return new FApplicationWrittenLog(this.fPcdlCore, fXmlNodeParent);
                    }
                    return new FContentLog(this.fPcdlCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FContentLog(this.fPcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FContentLog(this.fPcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FContentLogCollection fChildContentLogCollection
        {
            get
            {
                try
                {
                    return new FContentLogCollection(this.fPcdlCore, this.fXmlNode.selectNodes(FXmlTagCTTL.E_Content));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fPcdlCore, this.fXmlNode.appendChild(fNewChild.fXmlNode));
            ...
            )
        {
            try
            {
                return appendChildContentLog(new FContentLog(fPlcDriver, name, fFormat, stringValue));
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fPcdlCore, this.fXmlNode.insertBefore(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                return insertBeforeChildContentLog(
                    new FContentLog(fPlcDriver, name, fFormat, stringValue),
                    fRefChild
                    );
            }
            catch (Exception ex)
            ...
            )
        {
            try
            {
                ...
                fNewChild.replace(this.fPcdlCore, this.fXmlNode.insertAfter(fNewChild.fXmlNode, fRefChild.fXmlNode));
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fCttl.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fPcdlCore, ((FApplicationWrittenLog)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fPcdlCore, ((FContentLog)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
