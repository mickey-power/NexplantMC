...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostItemLog : FBaseObjectLog<FHostItemLog>, FIObjectLog
    {
        ...
        public FHostItemLog(
            ...
            : base(fPlcDriverLog.fPcdlCore, FPlcDriverCommon.createXmlNodeHIT(fPlcDriverLog.fPcdlCore.fXmlDoc))
        {
        ...
        public FHostItemLogCollection fChildHostItemLogCollection
        {
            get
            {
                try
                {
                    return new FHostItemLogCollection(this.fPcdlCore, this.fXmlNode.selectNodes(FXmlTagHITL.E_HostItem));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (fXmlNodeParent.name == FXmlTagHMGL.E_HostMessage)
                    {
                        ...
                        {
                            return new FHostDeviceDataMessageReceivedLog(this.fPcdlCore, fXmlNodeParent);
                        }
                        else if (logType == FXmlTagHMGL.L_Sent)
                        {
                            return new FHostDeviceDataMessageSentLog(this.fPcdlCore, fXmlNodeParent);
                        }
                        return null;
                    }
                    return new FHostItemLog(this.fPcdlCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItemLog fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItemLog(this.fPcdlCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItemLog fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItemLog(this.fPcdlCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostItemLog(this.fPcdlCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
