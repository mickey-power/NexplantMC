...
--
--  Program Id      : c_FPlcDeviceDataReceivedLog.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2011.09.06
--  Description     : FAMate Core FaPlcDriver PLC Device Data Received Log Class 
...
{
    public class FPlcDeviceDataReceivedLog : FPlcDeviceLog<FPlcDeviceDataReceivedLog>
    {
        ...
        internal FPlcDeviceDataReceivedLog(      
            FXmlNode fXmlNode
            )
            : base(fXmlNode)
        {
        ...
        public override FObjectLogType fObjectLogType
        {
            get
            {
                try
                {
                    return FObjectLogType.PlcDeviceDataReceivedLog;
                }
                catch (Exception ex)
                {
