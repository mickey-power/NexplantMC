...
--  Description     : FAMate Core FaPlcDriver Enum Converter Function Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    internal static class FEnumConverter 
    {
        ...
        public static string fromPlcDirection(
            FPlcDirection value
            )
        {
            try
            {
                if (value == FPlcDirection.Read)
                {
                    return "R";
                }
                return "W";
        ...
        public static FPlcDirection toPlcDirection(
            string value
            )
        {
            try
        ...
        public static string fromPlcOperandType(
            FPlcOperandType value
            )
        {
            try
            {
                if (value == FPlcOperandType.PlcWord)
                {
                    return "W";
                }
                else if (value == FPlcOperandType.Environment)
                {
                    return "E";
                }
                return "Q";
        ...
        public static FPlcOperandType toPlcOperandType(
            string value
            )
        {
            try
            {
                ...
                {
                    return FPlcOperandType.Environment;
                }
                return FPlcOperandType.EquipmentState;
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static string fromPlcResourceSourceType(
            FPlcResourceSourceType value
            )
        {
            try
            {
                if (value == FPlcResourceSourceType.EapName)
                {
                    return "PN";
                }
                else if (value == FPlcResourceSourceType.EquipmentName)
                {
                    return "EN";
                }
                else if (value == FPlcResourceSourceType.PlcDeviceName)
                {
                    return "PDN";
                }
                else if (value == FPlcResourceSourceType.PlcSessionName)
                {
                    return "PSN";
                }
                else if (value == FPlcResourceSourceType.PlcSessionId)
                {
                    return "PSI";
                }
                return "N";
        ...
        public static FPlcResourceSourceType toPlcResourceSourceType(
            string value
            )
        {
            try
            {
                if (value == "PN")
                {
                    return FPlcResourceSourceType.EapName;
                }
                else if (value == "EN")
                {
                    return FPlcResourceSourceType.EquipmentName;
                }
                else if (value == "PDN")
                {
                    return FPlcResourceSourceType.PlcDeviceName;
                }
                else if (value == "PSN")
                {
                    return FPlcResourceSourceType.PlcSessionName;
                }
                else if (value == "PSI")
                {
                    return FPlcResourceSourceType.PlcSessionId;
                }
            ...
            )
        {
            try
            {
                ...
                else if (value == FResourceSourceType.PlcDeviceName)
                {
                    return "PDN";
                }
                else if (value == FResourceSourceType.PlcSessionName)
                {
                    return "PSN";
                }
                else if (value == FResourceSourceType.PlcSessionId)
                {
                    return "PSI";
                }
            ...
            )
        {
            try
            {
                ...
                {
                    return FResourceSourceType.PlcDeviceName;
                }
                else if (value == "PSN")
                {
                    return FResourceSourceType.PlcSessionName;
                }
                else if (value == "PSI")
                {
                    return FResourceSourceType.PlcSessionId;
                }
                else if (value == "HDN")
                {
        ...
        public static string fromPlcDeviceTimeout(
            FPlcDeviceTimeout value
            )
        {
            try
            {
        ...
        public static FPlcDeviceTimeout toPlcDeviceTimeout(
            string value
            )
        {
            try
            {
                return (FPlcDeviceTimeout)Enum.Parse(typeof(FPlcDeviceTimeout), value);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static string fromPlcConditionMode(
            FPlcConditionMode value
            )
        {
            try
            {
                if (value == FPlcConditionMode.Expression)
                {
                    return "E";
                }
                return "C";
        ...
        public static FPlcConditionMode toPlcConditionMode(
            string value
            )
        {
            try
            {
                ...
                return FPlcConditionMode.Connection;
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static string fromLinkMapExpression(
            FLinkMapExpression value
            )
        {
            try
            {
                if (value == FLinkMapExpression.Decimal)
                {
                    return "D";
                }
                return "H";
        ...
        public static FLinkMapExpression toLinkMapExpression(
            string value
            )
        {
            try
        ...
        public static string fromPlcWordFormat(
            FPlcWordFormat value
            )
        {
            try
            {
                return ((FPlcWordFormatShortName)value).ToString();
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public static FPlcWordFormat toPlcWordFormat(
            string value
            )
        {
            try
            {
                return (FPlcWordFormat)Enum.Parse(typeof(FPlcWordFormatShortName), value);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
