...
--  Description     : FAMate Core FaPlcDriver Delegate Definition File
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    ...
    // --
    public delegate void FPlcDeviceStateChangedEventHandler(object sender, FPlcDeviceStateChangedEventArgs e);
    public delegate void FPlcDeviceDataReceivedEventHandler(object sender, FPlcDeviceDataReceivedEventArgs e);
    public delegate void FPlcDeviceDataSentEventHandler(object sender, FPlcDeviceDataSentEventArgs e);    
    public delegate void FPlcDeviceErrorRaisedEventHandler(object sender, FPlcDeviceErrorRaisedEventArgs e);
    public delegate void FPlcDeviceDataMessageReadEventHandler(object sender, FPlcDeviceDataMessageReadEventArgs e);
    public delegate void FPlcDeviceDataMessageWrittenEventHandler(object sender, FPlcDeviceDataMessageWrittenEventArgs e);
    public delegate void FPlcDeviceTimeoutRaisedEventHandler(object sender, FPlcDeviceTimeoutRaisedEventArgs e);
    // --
    ...
    // --
    public delegate void FPlcTriggerRaisedEventHandler(object sender, FPlcTriggerRaisedEventArgs e);
    public delegate void FPlcTransmitterRaisedEventHandler(object sender, FPlcTransmitterRaisedEventArgs e);
