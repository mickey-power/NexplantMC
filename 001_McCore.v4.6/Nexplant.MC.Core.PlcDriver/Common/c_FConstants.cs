...
--  Description     : FAMate Core FaPlcDriver Constant Definition Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    internal static class FConstants
    {
        ...
        public const byte BitOn = 0x01;
        public const byte BitOff = 0x00;
        ...
        // ***
        public const string HostDriverName = "Nexplant.MC.HostDriver.PLC.FHostDriver";        
        // --
        ...
        /// </summary>
        #endregion
        public const string err_m_0039 = "The {0} occurred.";
        ...
        #region Comments
        /// <summary>
        /// The {0} can not change the {1} for {2}.
        /// </summary>
        #endregion
        public const string err_m_0042 = "The {0} can not change the {1} for {2}.";
