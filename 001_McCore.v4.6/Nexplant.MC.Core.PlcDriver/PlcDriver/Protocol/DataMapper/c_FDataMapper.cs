...
--  Description     : FAMate Core FaPlcDriver Data Mapper Class 
    ...
    internal static class FDataMapper
    {
           ...
           )
        {
            try
            {
                ...
                // --
                fScenarioData.fResourceData.setEapName(fScenarioData.fPcdCore.fPlcDriver.eapName);
                fScenarioData.fResourceData.setEquipmentName(fScenarioData.fEquipment.name);
                // --
                if (fScenarioData.fDataMessageReceivedLog != null)
                {
                    if (fScenarioData.fDataMessageReceivedLog.fMessageLogType == FMessageLogType.PlcDeviceDataMessageReadLog)
                    {
                        fScenarioData.fResourceData.setPlcDeviceName(((FPlcDeviceDataMessageReadLog)fScenarioData.fDataMessageReceivedLog).deviceName);
                        fScenarioData.fResourceData.setPlcSessionName(((FPlcDeviceDataMessageReadLog)fScenarioData.fDataMessageReceivedLog).sessionName);
                        fScenarioData.fResourceData.setPlcSessionId(((FPlcDeviceDataMessageReadLog)fScenarioData.fDataMessageReceivedLog).sessionId.ToString());
                    }
                ...
                else if (fScenarioData.fIObjectLog != null)
                {
                    ...
                    // Device State Change
                    // ***
                    if (fScenarioData.fIObjectLog.fObjectLogType == FObjectLogType.PlcDeviceStateChangedLog)
                    {
                        fScenarioData.fResourceData.setPlcDeviceName(fScenarioData.fIObjectLog.name);
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                return fScenarioData.fPcdCore.fPlcDriver.fXmlNode.selectSingleNode(xpath);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
           ...
           )
        {
            ...
            try
            {
                ...
                // --
                xpath = string.Format(EnvironmentQuery, uniqueId, envName);
                // --
                while (
            ...
            )
        {
            ...
            try
            {
                ...
                return fScenarioData.fPcdCore.fPlcDriver.fXmlNode.selectNodes(xpath);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private static FXmlNodeList collectPlcWordLog(
            FScenarioData fScenarioData,
            string pwdlName
            )
        {
            ...
            try
            {
                xpath = string.Format(PlcWordLogQuery, pwdlName);
                return ((FPlcDeviceDataMessageReadLog)fScenarioData.fDataMessageReceivedLog).fXmlNode.selectNodes(xpath);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                xpath = string.Format(HostItemLogQuery, uniqueId, hitlName);
                // --
                while (
        ...
        {
            const string DataLogQuery1 =
                "../" + FXmlTagDATL.E_Data + "[@" + FXmlTagDATL.A_UniqueId + "='{0}' and @" + FXmlTagDATL.A_TargetType + "='{1}' and @" + FXmlTagDATL.A_TargetColumn + "='{2}'] | " +
                ".//" + FXmlTagDATL.E_Data + "[@" + FXmlTagDATL.A_TargetType + "='{1}' and @" + FXmlTagDATL.A_TargetColumn + "='{2}']";
            // --
            const string DataLogQuery2 =
                "../" + FXmlTagDATL.E_Data + "[@" + FXmlTagDATL.A_UniqueId + "='{0}' and @" + FXmlTagDATL.A_TargetType + "='{1}' and @" + FXmlTagDATL.A_TargetItem + "='{2}'] | " +
            ...
            try
            {
                ...
                if (fTargetType == FDataTargetType.Column)
                {
                    xpath = string.Format(DataLogQuery1, uniqueId, FEnumConverter.fromDataTargetType(FDataTargetType.Column), datlName);
                }
                else
                {
                    xpath = string.Format(DataLogQuery2, uniqueId, FEnumConverter.fromDataTargetType(FDataTargetType.Item), datlName);
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                xpath = string.Format(ColumnQuery, uniqueId, colName);
                // --
                while (
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Receive된 PLC 메시지 또는 Host 메시지 Mapping
                // ***
                if (fScenarioData.hasDataMessageReceivedLog)
                {
                    if (fScenarioData.fDataMessageReceivedLog.fMessageLogType == FMessageLogType.PlcDeviceDataMessageReadLog)
                    {
                        fXmlNodeDtsl = generateDataSetLogByPlcMessageLog(fScenarioData, fXmlNodeDtsl);
                    }
                    else
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeDatl in fXmlNodeDtsl.selectNodes(xpath))
                {
                    ...
                    else if (fResourceSourceType == FResourceSourceType.PlcDeviceName)
                    {
                        val = fScenarioData.fResourceData.plcDeviceName;
                    }
                    else if (fResourceSourceType == FResourceSourceType.PlcSessionName)
                    {
                        val = fScenarioData.fResourceData.plcSessionName;
                    }
                    else if (fResourceSourceType == FResourceSourceType.PlcSessionId)
                    {
                        val = fScenarioData.fResourceData.plcSessionId;
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeDatl in fXmlNodeDtsl.selectNodes(xpath))
                {
                    ...
                    fEquipmentStateMaterial = fScenarioData.fPcdCore.fEquipmentStateMaterialStorage.getEquipmentStateMaterial(eqpUniqueId, estUniqueId);
        ...
        private static FXmlNode generateDataSetLogByPlcMessageLog(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeDts
            )
        {
        ...
        private static void generateDataLogByPlcWordLog(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeParent,
            FXmlNodeList fXmlNodeListDat
            )
        {
            ...
            FXmlNode fXmlNodePwdl = null;
            FXmlNode fXmlNodeSrc = null;
            int datCount = 0;
            int index = 0;
            Dictionary<string, int> pwdlPositionKey = null;
            Dictionary<string, FXmlNodeList> pwdlPositionData = null;
            Dictionary<string, int> varNameCount = null;
            Dictionary<string, int> fixNameCount = null;
            int pwdlPos = 0;
            FDataSourceType fSourceType;
            string pwdlName = string.Empty;
            FFormat fFormat;
            FPattern fPattern;
            int fixedLength = 0;
            int fixLen = 0;
            ...
            {
                // ***
                // 동일한 이름의 PLC Word Log가 사용된 회수를 보관하기 위한 Storage 생성
                // ***
                pwdlPositionKey = new Dictionary<string, int>();
                pwdlPositionData = new Dictionary<string, FXmlNodeList>();
                datCount = fXmlNodeListDat.count;
                ...
                while (index < datCount)
                {
                    ...
                    if (fPattern == FPattern.Fixed)
                    {
                        ...
                        pwdlName = fXmlNodeDat.get_attrVal(FXmlTagDAT.A_SourceItem, FXmlTagDAT.D_SourceItem);
                        // --
                        if (pwdlPositionKey.ContainsKey(pwdlName))
                        {
                            pwdlPos = pwdlPositionKey[pwdlName];
                            fXmlNodeListPwdl = pwdlPositionData[pwdlName];
                        }
                        else
                        {
                            pwdlPos = 0;
                            fXmlNodeListPwdl = collectPlcWordLog(fScenarioData, pwdlName);
                            // --
                            pwdlPositionKey.Add(pwdlName, pwdlPos);
                            pwdlPositionData.Add(pwdlName, fXmlNodeListPwdl);
                        }
                        ...
                        for (int i = 0; i < fixedLength; i++)
                        {
                            ...
                            // ***
                            if (fXmlNodeListPwdl.count == 0)
                            {
                                fXmlNodePwdl = null;
                            }
                            else
                            {
                                if (pwdlPos >= fXmlNodeListPwdl.count)
                                {
                                    pwdlPos = 0; // 순환
                                }
                                fXmlNodePwdl = fXmlNodeListPwdl[pwdlPos];
                                pwdlPos++;
                                ...
                                // Position 저장 위치를 변경 함.
                                // *** 
                                pwdlPositionKey[pwdlName] = pwdlPos;
                            }

                            // --

                            if (fXmlNodePwdl == null)
                            {
                                if (fFormat == FFormat.List || fFormat == FFormat.AsciiList)
                                {
                                    generateDataLogByPlcWordLog(
                            ...
                            else
                            {
                                ...
                                else if (fFormat == FFormat.Unknown)
                                {
                                    ...
                                    // fFormat를 fItemFormat으로 변경
                                    // ***
                                    fItemFormat = FEnumConverter.toFormat(fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_Format, FXmlTagPWDL.D_Format));
                                    fXmlNodeDatl.set_attrVal(FXmlTagDATL.A_Format, FXmlTagDATL.D_Format, FEnumConverter.fromFormat(fItemFormat));

                                    // --

                                    len = int.Parse(fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_Length, FXmlTagPWDL.D_Length));
                                    val = FValueConverter.toDataConversionStringValue(
                                        fItemFormat,
                                        ...
                                        fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_DataConversionSetExpression, FXmlTagPWDL.D_DataConversionSetExpression),
                                        ref len
                                        );
                                    // --
                                    fXmlNodeDatl.set_attrVal(FXmlTagDATL.A_Value, FXmlTagDATL.D_Value, val);
                                ...
                                {
                                    val = FValueConverter.toDataConversionStringValue(
                                        FEnumConverter.toFormat(fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_Format, FXmlTagPWDL.D_Format)),
                                        fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_Value, FXmlTagPWDL.D_Value),
                                        fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_Transformer, FXmlTagPWDL.D_Transformer),
                                        fXmlNodePwdl.get_attrVal(FXmlTagPWDL.A_DataConversionSetExpression, FXmlTagPWDL.D_DataConversionSetExpression)
                                        );
                    ...
                    else   // Variable
                    {
                        ...
                        for (int i = index; i < datCount; i++)
                        {
                            ...
                            // ***
                            fPattern = FEnumConverter.toPattern(fXmlNodeSrc.get_attrVal(FXmlTagDAT.A_Pattern, FXmlTagDAT.D_Pattern));
                            pwdlName = fXmlNodeSrc.get_attrVal(FXmlTagDAT.A_SourceItem, FXmlTagDAT.D_SourceItem);
                            // --
                            if (fPattern == FPattern.Variable)
                            {
                                if (varNameCount.ContainsKey(pwdlName))
                                {
                                    varNameCount[pwdlName] = varNameCount[pwdlName] + 1;
                                }
                                else
                                {
                                    varNameCount.Add(pwdlName, 1);
                                    fixNameCount.Add(pwdlName, 0);
                                }
                                varLen++;
                                ...
                                if (!pwdlPositionKey.ContainsKey(pwdlName))
                                {
                                    pwdlPositionKey.Add(pwdlName, 0);
                                    pwdlPositionData.Add(pwdlName, collectPlcWordLog(fScenarioData, pwdlName));
                                }
                            }
                            else
                            {
                                if (fixNameCount.ContainsKey(pwdlName))
                                {
                                    fixLen = int.Parse(fXmlNodeSrc.get_attrVal(FXmlTagDAT.A_FixedLength, FXmlTagDAT.D_FixedLength));
                                    fixNameCount[pwdlName] = fixNameCount[pwdlName] + fixLen;
                                }
                            }
                        }
                        ...
                        foreach (string s in varNameCount.Keys)
                        {
                            calVarCnt = (pwdlPositionData[s].count - pwdlPositionKey[s] - fixNameCount[s]) / varNameCount[s];
                            if (calVarCnt < 1)
                            {
                                varCnt = 0;
                                break;
                        ...
                        for (int i = 0; i < varCnt; i++)
                        {
                            for (int j = 0; j < varLen; j++)
                            {
                                ...
                                fFormat = FEnumConverter.toFormat(fXmlNodeDat.get_attrVal(FXmlTagDAT.A_Format, FXmlTagDAT.D_Format));
                                // --
                                pwdlName = fXmlNodeDat.get_attrVal(FXmlTagDATL.A_SourceItem, FXmlTagDATL.D_SourceItem);
                                pwdlPos = pwdlPositionKey[pwdlName];
                                fXmlNodePwdl = pwdlPositionData[pwdlName][pwdlPos];
                                pwdlPos++;
            ...
            finally
            {
                ...
                fXmlNodePwdl = null;
                fXmlNodeSrc = null;
                pwdlPositionKey = null;
                pwdlPositionData = null;
                varNameCount = null;
                fixNameCount = null;
            }
        }
                ...
                while (index < datCount)
                {
                    ...
                    if (fPattern == FPattern.Fixed)
                    {
                        ...
                        if (fScanMode == FDataScanMode.Local)
                        {
                            ...
                            {
                                hitlPos = hitlPositionKey[hitlName];
                            ...
                            else
                            {
                                ...
                                // --
                                hitlPositionKey.Add(hitlName, hitlPos);
                        ...
                        else
                        {
                            ...
                            {
                                hitlPos = gHitlPositionKey[hitlName];
                            ...
                            else
                            {
                                ...
                                // --
                                gHitlPositionKey.Add(hitlName, hitlPos);
                        ...
                        for (int i = 0; i < fixedLength; i++)
                        {
                            ...
                            else
                            {
                                ...
                                if (fScanMode == FDataScanMode.Local)
                                {
                                    hitlPositionKey[hitlName] = hitlPos;
                                }
                                else
                                {
                                    gHitlPositionKey[hitlName] = hitlPos;
                                }
                            }
                    ...
                    else  // Variable
                    {
                        ...
                        for (int i = index; i < datCount; i++)
                        {
                            ...
                            if (fPattern == FPattern.Variable)
                            {
                                ...
                                if (!hitlPositionKey.ContainsKey(hitlName))
                                {
                                    hitlPositionKey.Add(hitlName, 0);
                        ...
                        foreach (string s in varNameCount.Keys)
                        {
                            calVarCnt = (hitlPositionData[s].count - hitlPositionKey[s] - fixNameCount[s]) / varNameCount[s];
                            if (calVarCnt < 1)
                            {
                                varCnt = 0;
                                break;
        ...
        #region PlcMessageTransfer Generation Methods

        public static FXmlNode generatePlcMessageTransfer(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeDtsl,
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodePmt = fXmlNodePmg.clone(true);
                fXmlNodePwl = fXmlNodePmt.selectSingleNode(FXmlTagPWL.E_PlcWordList);
                foreach (FXmlNode fXmlNodePwd in fXmlNodePwl.selectNodes(FXmlTagPWD.E_PlcWord))
                {
                    fXmlNodePwl.removeChild(fXmlNodePwd);
                }
                // --
                generatePlcWordByDataLog(
                    fScenarioData,
                    fXmlNodePwl,
                    fXmlNodePmg.selectNodes(FXmlTagPWL.E_PlcWordList + "/" + FXmlTagPWD.E_PlcWord),
                    gDatlPositionKey,
                    gDatlPositionData,
                    null
                    );
        ...
        private static void generatePlcWordByDataLog(
            FScenarioData fScenarioData,
            FXmlNode fXmlNodeParent,
            FXmlNodeList fXmlNodeListPwd,
            Dictionary<string, int> gDatlPositionKey,
            Dictionary<string, FXmlNodeList> gDatlPositionData,
            FXmlNode fXmlNodeParentDatl
            )
        {
            FXmlNode fXmlNodePwd = null;
            FXmlNode fXmlNodePwd2 = null;
            FXmlNodeList fXmlNodeListDatl = null;
            FXmlNode fXmlNodeDatl = null;
            int pwdCount = 0;
            int index = 0;
            ...
            try
            {
                ...
                pwdCount = fXmlNodeListPwd.count;

                // --

                while (index < pwdCount)
                {
                    fXmlNodePwd = fXmlNodeListPwd[index];
                    fFormat = FEnumConverter.toFormat(fXmlNodePwd.get_attrVal(FXmlTagPWD.A_Format, FXmlTagPWD.D_Format));
                    length = int.Parse(fXmlNodePwd.get_attrVal(FXmlTagPWD.A_Length, FXmlTagPWD.D_Length));
                    fScanMode = FEnumConverter.toDataScanMode(fXmlNodePwd.get_attrVal(FXmlTagPWD.A_ScanMode, FXmlTagPWD.D_ScanMode));
                    datlName = fXmlNodePwd.get_attrVal(FXmlTagPWD.A_Name, FXmlTagPWD.D_Name);
                    ...
                    fXmlNodePwd2 = fXmlNodeParent.appendChild(fXmlNodePwd.clone(false));
                    ...
                    if (fXmlNodeDatl != null)
                    {
                        ...
                        val = FValueConverter.convertStringValue(fFormat, val, out len);
                        // --
                        fXmlNodePwd2.set_attrVal(
                            FXmlTagPWD.A_Value,
                            FXmlTagPWD.D_Value,
                            FPlcValueConverter.fromWordStringValue((FPlcWordFormat)fFormat, val, length)
                            );
                    }
