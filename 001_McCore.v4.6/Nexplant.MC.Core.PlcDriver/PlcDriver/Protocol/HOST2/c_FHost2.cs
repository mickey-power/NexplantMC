...
--  Description     : FAMate Core FaPlcDriver Host2 Parser Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    internal static class FHost2
    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fXmlNodeHsn == null)
                {
                    ...
                    // Not Define Session
                    // ***
                    fXmlNodeHmgl = FPlcDriverLogCommon.createXmlNodeHMGL(fPcd.fPcdCore.fXmlDoc);
                ...
                if (fXmlNodeRepHmg == null)
                {
                    ...
                    // --
                    fXmlNodeListHmg = fPcd.fXmlNode.selectNodes(xpath);
                    // --
                ...
                if (fXmlNodeHmg == null)
                {
                    fXmlNodeHmgl = FPlcDriverLogCommon.createXmlNodeHMGL(fPcd.fPcdCore.fXmlDoc);
                    setHostMessageLogInfo(fXmlNodeHmgl, fHdv.fXmlNode, fXmlNodeHsn, fHdmg.machineId, fHdmg.sessionId, fHdmg.command, 0, fHdmg.fHostMessageType, fHdmg.tid);
                    fXmlNodeHmgl.set_attrVal(FXmlTagPMGL.A_Name, FXmlTagPMGL.D_Name, "Undefined");
                    // --
                    generateHdmgToHmg(fXmlNodeHmgl, fHdmg);
                    // --
                    fResultCode = FResultCode.Warninig;
            ...
            )
        {
            ...
            try
            {
                fXmlNodeHmg = fPcd.fXmlNode.selectSingleNode(
