...
--  Description     : FAMate Core FaPlcDriver Repository Handler Class 
    ...
    internal static class FRepositoryHandler
    {
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeRps = fScenarioData.fPcdCore.fPlcDriver.fXmlNode.selectSingleNode(xpath).clone(true);                
                ...
                // ***
                fXmlNodeRpsl.set_attrVal(FXmlTagRPSL.A_RpmId, FXmlTagRPSL.D_RpmId, fScenarioData.fPcdCore.fRpmIdPointer.uniqueId.ToString());
                ...
                fRepositoryMaterial = new FRepositoryMaterial(fScenarioData.fPcdCore, fXmlNodeRpm);                
            ...
            )
        {
            ...
            try
            {
                ...
                if (fScenarioData.hasMapperPerformedLog && fScenarioData.fMapperPerformedLog.hasDataSetLog)
                {
                    ...
                    {
                        foreach (FRepositoryMaterial fRpm in fScenarioData.fPcdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                        {
                ...
                if (fRepositoryMaterial == null && fScenarioData.hasDataMessageReceivedLog)
                {
                    ...
                    if (fMessageLogType == FMessageLogType.HostDeviceDataMessageReceivedLog)
                    {
                        ...
                        if (fHdmrl.isSecondary)
                        {
                            ...
                            tid = fHdmrl.tid;
                            // --
                            foreach (FRepositoryMaterial fRtm in fScenarioData.fPcdCore.fRepositoryMaterialStorage.fRepositoryMaterialCollection)
                            {
                                if (
           ...
           )
        {
            ...
            try
            {
                ...
                if (fXmlNodeStg.get_attrVal(FXmlTagSTG.A_Mode, FXmlTagSTG.D_Mode) == FEnumConverter.fromStorageMode(FStorageMode.Part))
                {
                    ...
                    {
                        fScenarioData.fPcdCore.fRepositoryMaterialStorage.remove(fScenarioData.fRepositoryMaterial);
                    }
           ...
           )
        {
            ...
            try
            {
                ...
                fScenarioData.fPcdCore.fRepositoryMaterialStorage.clear();
