...
--  Description     : FAMate Core FaPlcDriver Host Expression Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostExpression : FBaseObject<FHostExpression>, FIObject
    {
        ...
        public FHostExpression(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHEP(fPlcDriver.fPcdCore.fXmlDoc))
        {
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (this.fOperandType == FHostOperandType.HostItem)
                    {
                        ...
                        // --
                        return new FHostItem(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                    }
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FHostCondition(this.fPcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FHostExpression(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpression fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostExpression(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpression fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostExpression(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostExpressionCollection fChildHostExpressionCollection
        {
            get
            {
                try
                {
                    return new FHostExpressionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagHEP.E_HostExpression));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHep.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostExpression);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostExpression);
