...
--
--  Program Id      : c_FBranch.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2011.04.19
--  Description     : FAMate Core FaPlcDriver Branch Class 
--  History         : Created by Jeff.Kim at 2011.04.19
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public class FBranch : FBaseObject<FBranch>, FIObject, FIFlow
    {
        ...
        public FBranch(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeBRN(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public string uniqueIdToString
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_UniqueId, FXmlTagBRN.D_UniqueId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string name
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_Name, FXmlTagBRN.D_Name);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_Name, FXmlTagBRN.D_Name, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string description
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_Description, FXmlTagBRN.D_Description);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_Description, FXmlTagBRN.D_Description, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public Color fontColor
        {
            get
            {
                try
                {
                    return Color.FromName(this.fXmlNode.get_attrVal(FXmlTagBRN.A_FontColor, FXmlTagBRN.D_FontColor));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_FontColor, FXmlTagBRN.D_FontColor, value.Name, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool fontBold
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagBRN.A_FontBold, FXmlTagBRN.D_FontBold));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_FontBold, FXmlTagBRN.D_FontBold, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenario fLocation
        {
            get
            {
                ...
                try
                {
                    id = this.fXmlNode.get_attrVal(FXmlTagBRN.A_LocationId, FXmlTagBRN.D_LocationId);
                    if (id == string.Empty)
                    {
                        return null;
                    }
                    ...
                    // --
                    return new FScenario(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag1
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_UserTag1, FXmlTagBRN.D_UserTag1);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_UserTag1, FXmlTagBRN.D_UserTag1, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag2
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_UserTag2, FXmlTagBRN.D_UserTag2);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_UserTag2, FXmlTagBRN.D_UserTag2, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag3
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_UserTag3, FXmlTagBRN.D_UserTag3);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_UserTag3, FXmlTagBRN.D_UserTag3, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag4
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_UserTag4, FXmlTagBRN.D_UserTag4);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_UserTag4, FXmlTagBRN.D_UserTag4, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag5
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagBRN.A_UserTag5, FXmlTagBRN.D_UserTag5);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagBRN.A_UserTag5, FXmlTagBRN.D_UserTag5, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool hasLocation
        {
            get
            {
                try
                {
                    if (this.fXmlNode.get_attrVal(FXmlTagBRN.A_LocationId, FXmlTagBRN.D_LocationId) == string.Empty)
                    {
                        return false;
                    }
                    return true;
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Branch 개체가 Modeling File에 포함된 개체인지 검사
                // ***
                if (!this.isModelingObject)
                {
                    FDebug.throwFException(string.Format(FConstants.err_m_0017, "Branch", "Modeling File"));
                }

                // ***
                // Scnario개체와 Branch 개체의 Modeling File이 동일한지 검사
                // ***
                if (!this.equalsModelingFile(fScenario))
                {
                    FDebug.throwFException(string.Format(FConstants.err_m_0011, "Modeling File of the Scenario and the Branch", "same"));
                }

                // --

                oldSnrId = this.fXmlNode.get_attrVal(FXmlTagBRN.A_LocationId, FXmlTagBRN.D_LocationId);
                ...
                this.fXmlNode.set_attrVal(FXmlTagBRN.A_LocationId, FXmlTagBRN.D_LocationId, newSnrId, true);
            ...
            )
        {
            ...
            try
            {
                ...
                this.fXmlNode.set_attrVal(FXmlTagBRN.A_LocationId, FXmlTagBRN.D_LocationId, string.Empty, false);
            ...
            )
        {
            ...
            try
            {
                ...
                this.copyObject(FCbObjectFormat.Branch, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.copyObject(FCbObjectFormat.Branch, this.fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
