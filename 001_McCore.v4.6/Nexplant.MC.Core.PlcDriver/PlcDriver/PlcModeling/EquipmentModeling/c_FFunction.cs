...
--  Description     : FAMate Core FaPlcDriver FFunction Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FFunction : FBaseObject<FFunction>, FIObject
    {
        ...
        public FFunction(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeFUN(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FCallback fParent
        {
            get
            {
                try
                {
                    ...
                    return new FCallback(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunction fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunction(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunction fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FFunction(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FFunctionName fFunctionName
        {
            get
            {
                ...
                try
                {
                    ...
                    fXmlNodeFna = this.fPlcDriver.fXmlNode.selectSingleNode(xpath);
                    if (fXmlNodeFna == null)
                    {
                        return null;
                    }
                    ...
                    return new FFunctionName(this.fPcdCore, fXmlNodeFna);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Function);
