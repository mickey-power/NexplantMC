...
--  Description     : FAMate Core FaPlcDriver Equipment State Alterer Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FEquipmentStateAlterer : FBaseObject<FEquipmentStateAlterer>, FIObject
    {
        ...
        public FEquipmentStateAlterer(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeEAT(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetAlterer fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetAlterer(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAlterer fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateAlterer(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAlterer fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateAlterer(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateAlterer);
