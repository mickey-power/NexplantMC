...
--  Description     : FAMate Core FaPlcDriver JudgementExpression Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FJudgementExpression : FBaseObject<FJudgementExpression>, FIObject
    {
        ...
        public FJudgementExpression(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeJEP(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FData fOperand
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FData(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FJudgementCondition(this.fPcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FJudgementExpression(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpression fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementExpression(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpression fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementExpression(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementExpressionCollection fChildJudgementExpressionCollection
        {
            get
            {
                try
                {
                    return new FJudgementExpressionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagJEP.E_JudgementExpression));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fJep.fXmlNode);
                }
              ...
              )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.JudgementExpression);
            ...
            ) 
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.JudgementExpression);
