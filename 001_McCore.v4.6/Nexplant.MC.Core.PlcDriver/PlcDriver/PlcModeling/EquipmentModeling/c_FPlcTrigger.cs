...
--
--  Program Id      : c_FPlcTrigger.cs
--  Creator         : spike.lee
--  Create Date     : 2013.08.09
--  Description     : FAMate Core FaPlcDriver Plc Trigger Class 
...
{
    public class FPlcTrigger : FBaseObject<FPlcTrigger>, FIObject, FIFlow
    {
        ...
        public FPlcTrigger(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodePTR(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public string uniqueIdToString
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_UniqueId, FXmlTagPTR.D_UniqueId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string name
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_Name, FXmlTagPTR.D_Name);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_Name, FXmlTagPTR.D_Name, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string description
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_Description, FXmlTagPTR.D_Description);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_Description, FXmlTagPTR.D_Description, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public Color fontColor
        {
            get
            {
                try
                {
                    return Color.FromName(this.fXmlNode.get_attrVal(FXmlTagPTR.A_FontColor, FXmlTagPTR.D_FontColor));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_FontColor, FXmlTagPTR.D_FontColor, value.Name, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool fontBold
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagPTR.A_FontBold, FXmlTagPTR.D_FontBold));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_FontBold, FXmlTagPTR.D_FontBold, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag1
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_UserTag1, FXmlTagPTR.D_UserTag1);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_UserTag1, FXmlTagPTR.D_UserTag1, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag2
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_UserTag2, FXmlTagPTR.D_UserTag2);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_UserTag2, FXmlTagPTR.D_UserTag2, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag3
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_UserTag3, FXmlTagPTR.D_UserTag3);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_UserTag3, FXmlTagPTR.D_UserTag3, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag4
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_UserTag4, FXmlTagPTR.D_UserTag4);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_UserTag4, FXmlTagPTR.D_UserTag4, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag5
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagPTR.A_UserTag5, FXmlTagPTR.D_UserTag5);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagPTR.A_UserTag5, FXmlTagPTR.D_UserTag5, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FPlcConditionCollection fChildPlcConditionCollection
        {
            get
            {
                try
                {
                    return new FPlcConditionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagPCN.E_PlcCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool hasChild
        {
            get
            {
                try
                {
                    return this.fXmlNode.containsNode(FXmlTagPCN.E_PlcCondition);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool canPasteChild
        {
            get
            {
                try
                {
                    if (!FClipboard.containsData(FCbObjectFormat.PlcCondition))
                    {
                        return false;
                    }
        ...
        public FPlcCondition appendChildPlcCondition(
            FPlcCondition fNewChild
            )
        {
            try
            {
        ...
        public FPlcCondition insertBeforeChildPlcCondition(
            FPlcCondition fNewChild,
            FPlcCondition fRefChild
            )
        {
            try
            {
        ...
        public FPlcCondition insertAfterChildPlcCondition(
            FPlcCondition fNewChild,
            FPlcCondition fRefChild
            )
        {
        ...
        public FPlcCondition removeChildPlcCondition(
            FPlcCondition fChild
            )
        {
            try
            {
        ...
        public void removeChildPlcCondition(
            FPlcCondition[] fChilds
            )
        {
            try
            {
                ...
                foreach (FPlcCondition fPcn in fChilds)
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fPcn.fXmlNode);
                }
        ...
        public void removeAllChildPlcCondition(
            )
        {
            FPlcConditionCollection fPcnCollction = null;

            try
            {
                fPcnCollction = this.fChildPlcConditionCollection;
                if (fPcnCollction.count == 0)
                {
                    return;
                }
                ...
                foreach (FPlcCondition fPcn in fPcnCollction)
                {
                    fPcn.remove();
                }
            }
            ...
            {
                if (fPcnCollction != null)
                {
                    fPcnCollction.Dispose();
                    fPcnCollction = null;
                }
            }
        }
            ...
            )
        {
            try
            {
                foreach (FPlcCondition fPcn in this.fChildPlcConditionCollection)
                {
                    fPcn.resetRelation();
                }
            }
            ...
            )
        {
            try
            {
                foreach (FXmlNode fXmlNodePcn in fXmlNode.selectNodes(FXmlTagPCN.E_PlcCondition))
                {
                    FPlcCondition.resetFlowNode(fXmlNodePcn);
                }
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                ...
                this.copyObject(FCbObjectFormat.PlcTrigger, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.copyObject(FCbObjectFormat.PlcTrigger, this.fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public FPlcCondition pasteChild(
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.PlcCondition);

                // --

                fPlcCondition = (FPlcCondition)this.pasteObject(FCbObjectFormat.PlcCondition);
                this.appendChildPlcCondition(fPlcCondition);

                return fPlcCondition;
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public FPlcConditionCollection selectPlcConditionByName(
            string name
            )
        {
            const string xpath = FXmlTagPCN.E_PlcCondition + "[@" + FXmlTagPCN.A_Name + "='{0}']";

            try
            {
                return new FPlcConditionCollection(
                    this.fPcdCore,
        ...
        public FPlcCondition selectSinglePlcConditionByName(
            string name
            )
        {
            const string xpath = FXmlTagPCN.E_PlcCondition + "[@" + FXmlTagPCN.A_Name + "='{0}']";
            ...
            try
            {
                ...
                return new FPlcCondition(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
