...
--  Description     : FAMate Core FaPlcDriver Judgement Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FJudgement : FBaseObject<FJudgement>, FIObject, FIFlow
    {
        ...
        public FJudgement(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeJDM(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FJudgementConditionCollection fChildJudgementConditionCollection
        {
            get
            {
                try
                {
                    return new FJudgementConditionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagJCN.E_JudgementCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fJdm.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.JudgementCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgementCondition(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
