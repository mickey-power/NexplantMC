...
--  Description     : FAMate Core FaPlcDriver FStorage Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FStorage : FBaseObject<FStorage>, FIObject, FIFlow
    {
        ...
        public FStorage(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeSTG(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FRepository fRepository
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FRepository(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
