...
--
--  Program Id      : c_FEntryPoint.cs
--  Creator         : spike.lee
--  Create Date     : 2014.03.20
--  Description     : FAMate Core FaPlcDriver Entry Point Class 
--  History         : Created by spike.lee at 2014.03.20
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public class FEntryPoint : FBaseObject<FEntryPoint>, FIObject, FIFlow
    {
        ...
        public FEntryPoint(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeETP(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public string uniqueIdToString
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_UniqueId, FXmlTagETP.D_UniqueId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string name
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_Name, FXmlTagETP.D_Name);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_Name, FXmlTagETP.D_Name, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string description
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_Description, FXmlTagETP.D_Description);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_Description, FXmlTagETP.D_Description, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public Color fontColor
        {
            get
            {
                try
                {
                    return Color.FromName(this.fXmlNode.get_attrVal(FXmlTagETP.A_FontColor, FXmlTagETP.D_FontColor));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_FontColor, FXmlTagETP.D_FontColor, value.Name, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool fontBold
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagETP.A_FontBold, FXmlTagETP.D_FontBold));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_FontBold, FXmlTagETP.D_FontBold, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag1
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_UserTag1, FXmlTagETP.D_UserTag1);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_UserTag1, FXmlTagETP.D_UserTag1, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag2
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_UserTag2, FXmlTagETP.D_UserTag2);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_UserTag2, FXmlTagETP.D_UserTag2, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag3
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_UserTag3, FXmlTagETP.D_UserTag3);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_UserTag3, FXmlTagETP.D_UserTag3, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag4
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_UserTag4, FXmlTagETP.D_UserTag4);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_UserTag4, FXmlTagETP.D_UserTag4, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag5
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagETP.A_UserTag5, FXmlTagETP.D_UserTag5);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagETP.A_UserTag5, FXmlTagETP.D_UserTag5, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                this.copyObject(FCbObjectFormat.EntryPoint, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.copyObject(FCbObjectFormat.EntryPoint, this.fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
