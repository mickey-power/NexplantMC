...
--  Description     : FAMate Core FaPlcDriver Judgement Condition Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FJudgementCondition : FBaseObject<FJudgementCondition>, FIObject
    {
        ...
        public FJudgementCondition(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeJCN(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FDataSet fDataSet
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FDataSet(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgement fParent
        {
            get
            {
                try
                {
                    ...
                    return new FJudgement(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementCondition fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementCondition(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FJudgementCondition fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FJudgementCondition(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
              ...
              )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.JudgementCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FJudgementExpression(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
