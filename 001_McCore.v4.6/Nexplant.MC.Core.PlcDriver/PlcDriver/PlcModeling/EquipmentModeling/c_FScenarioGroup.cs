...
--  Description     : FAMate Core FaPlcDriver Scenario Group Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FScenarioGroup : FBaseObject<FScenarioGroup>, FIObject
    {
        ...
        public FScenarioGroup(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeSNG(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FEquipment fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipment(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioGroup fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioGroup fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FScenarioGroup(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FScenarioCollection fChildScenarioCollection
        {
            get
            {
                try
                {
                    return new FScenarioCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagSNR.E_Scenario));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fSnr.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ScenarioGroup);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Scenario);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FScenario(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // Clone된 개체의 Lock 제거
                // ***
                fScenarioGroup = new FScenarioGroup(this.fPcdCore, this.fXmlNode.clone(true));
                // --
                xpath =
                    ". | " +
