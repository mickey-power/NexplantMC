...
--  Description     : FAMate Core FaPlcDriver Host Trigger Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostTrigger : FBaseObject<FHostTrigger>, FIObject, FIFlow
    {
        ...
        public FHostTrigger(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHTR(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostConditionCollection fChildHostConditionCollection
        {
            get
            {
                try
                {
                    return new FHostConditionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagHCN.E_HostCondition));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHcn.fXmlNode);
                }
       ...
       public FIFlow pasteSibling(
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostCondition(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
