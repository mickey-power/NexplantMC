...
--
--  Program Id      : c_FComment.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2011.11.03
--  Description     : FAMate Core FaPlcDriver Comment Class 
...
{
    public class FComment : FBaseObject<FComment>, FIObject, FIFlow
    {
        ...
        public FComment(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeCMT(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public string uniqueIdToString
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_UniqueId, FXmlTagCMT.D_UniqueId);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string name
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_Name, FXmlTagCMT.D_Name);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    ...
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_Name, FXmlTagCMT.D_Name, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string description
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_Description, FXmlTagCMT.D_Description);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_Description, FXmlTagCMT.D_Description, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public Color fontColor
        {
            get
            {
                try
                {
                    return Color.FromName(this.fXmlNode.get_attrVal(FXmlTagCMT.A_FontColor, FXmlTagCMT.D_FontColor));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_FontColor, FXmlTagCMT.D_FontColor, value.Name, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool fontBold
        {
            get
            {
                try
                {
                    return FBoolean.toBool(this.fXmlNode.get_attrVal(FXmlTagCMT.A_FontBold, FXmlTagCMT.D_FontBold));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_FontBold, FXmlTagCMT.D_FontBold, FBoolean.fromBool(value), true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag1
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_UserTag1, FXmlTagCMT.D_UserTag1);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_UserTag1, FXmlTagCMT.D_UserTag1, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag2
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_UserTag2, FXmlTagCMT.D_UserTag2);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_UserTag2, FXmlTagCMT.D_UserTag2, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag3
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_UserTag3, FXmlTagCMT.D_UserTag3);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_UserTag3, FXmlTagCMT.D_UserTag3, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag4
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_UserTag4, FXmlTagCMT.D_UserTag4);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_UserTag4, FXmlTagCMT.D_UserTag4, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string userTag5
        {
            get
            {
                try
                {
                    return this.fXmlNode.get_attrVal(FXmlTagCMT.A_UserTag5, FXmlTagCMT.D_UserTag5);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            set
            {
                try
                {
                    this.fXmlNode.set_attrVal(FXmlTagCMT.A_UserTag5, FXmlTagCMT.D_UserTag5, value, true);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                this.copyObject(FCbObjectFormat.Comment, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.copyObject(FCbObjectFormat.Comment, this.fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
