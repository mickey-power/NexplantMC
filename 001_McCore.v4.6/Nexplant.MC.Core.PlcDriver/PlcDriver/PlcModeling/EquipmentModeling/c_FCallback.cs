...
--  Description     : FAMate Core FaPlcDriver FCallback Class 
--  History         : Created by Jeff.Kim at 2011.05.30
----------------------------------------------------------------------------------------------------------*/
using System;
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FCallback : FBaseObject<FCallback>, FIObject, FIFlow
    {
        ...
        public FCallback(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeCBK(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FFunctionCollection fChildFunctionCollection
        {
            get
            {
                try
                {
                    return new FFunctionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagFUN.E_Function));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fFun.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Function);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FFunction(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
