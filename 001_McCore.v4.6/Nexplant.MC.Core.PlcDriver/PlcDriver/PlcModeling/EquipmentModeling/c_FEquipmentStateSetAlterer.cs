...
--  Description     : FAMate Core FaPlcDriver Equipment State Set Alterer Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FEquipmentStateSetAlterer : FBaseObject<FEquipmentStateSetAlterer>, FIObject, FIFlow
    {
        ...
        public FEquipmentStateSetAlterer(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeESA(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSet fEquipmentStateSet
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FEquipmentStateSet(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateAltererCollection fChildEquipmentStateAltererCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateAltererCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagEAT.E_EquipmentStateAlterer));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEat.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentStateAlterer);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateAlterer(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
