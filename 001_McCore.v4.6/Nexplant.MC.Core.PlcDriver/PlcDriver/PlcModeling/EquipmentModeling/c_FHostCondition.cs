...
--  Description     : FAMate Core FaPlcDriver Host Condition Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostCondition : FBaseObject<FHostCondition>, FIObject
    {
        ...
        public FHostCondition(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHCN(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostTrigger fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostTrigger(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostCondition fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostCondition(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostCondition fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostCondition(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostCondition);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostExpression(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
