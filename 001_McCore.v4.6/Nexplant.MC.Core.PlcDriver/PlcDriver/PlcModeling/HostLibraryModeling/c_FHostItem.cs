...
--  Description     : FAMate Core FaPlcDriver Host Item Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostItem : FBaseObject<FHostItem>, FIObject, FIHostOperand
    {
        ...
        public FHostItem(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHIT(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostItem(
            ...
            : base(FPlcDriverCommon.createXmlNodeHIT(fPlcDriver.fPcdCore.fXmlDoc, name, fForamt, stringValue))
        {
        ...
        public FHostItemCollection fChildHostItemCollection
        {
            get
            {
                try
                {
                    return new FHostItemCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagHIT.E_HostItem));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (fXmlNodeParent.name == FXmlTagHMG.E_HostMessage)
                    {
                        ...
                        {
                            return new FHostMessageTransfer(this.fPcdCore, fXmlNodeParent);
                        }
                        else if (messageType == FXmlTagHMG.M_HostDriverDataMessage)
                        {
                            return new FHostDriverDataMessage(this.fPcdCore, fXmlNodeParent);
                        }
                        return null;
                    }
                    return new FHostItem(this.fPcdCore, fXmlNodeParent);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItem fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItem(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostItem fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostItem(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public string randomValueMin
        {
            ...
            set
            {
                try
                {
                    ...
                    {
                        if (!FPlcDriverCommon.validateFormatRange(fFormat, value))
                        {
                            FDebug.throwFException(string.Format(FConstants.err_m_0014, "Min"));
                        }

                        if (!FPlcDriverCommon.validateMinMax(fFormat, value, randomValueMax))
                        {
                            FDebug.throwFException(string.Format(FConstants.err_m_0014, "Min"));
                        }
                    }
            ...
            set
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if (!FPlcDriverCommon.validateMinMax(fFormat, randomValueMin, value))
                        {
                            FDebug.throwFException(string.Format(FConstants.err_m_0014, "Max"));
                        }
                    }
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fPcdCore, fHmg.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                return insertBeforeChildHostItem(
                    new FHostItem(fPlcDriver, name, fFormat, stringValue),
                    fRefChild
                    );
            }
            catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fPcdCore, ((FHostMessage)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else if (fParent.fObjectType == FObjectType.HostMessageTransfer)
                {
                    this.replace(this.fPcdCore, ((FHostMessageTransfer)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else if (fParent.fObjectType == FObjectType.HostDriverDataMessage)
                {
                    this.replace(this.fPcdCore, ((FHostDriverDataMessage)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fPcdCore, ((FHostItem)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fPcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fPlcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fPlcDriver, ((FHostItem)fParent).fParent, fParent)
                            });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostItem);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostItem(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
