...
--  Description     : FAMate Core FaPlcDriver Host Message Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostMessage : FBaseObject<FHostMessage>, FIObject, FIMessage
    {
        ...
        public FHostMessage(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHMG(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostMessages fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessage(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessage fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessage(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeHmt.set_attrVal(FXmlTagHMT.A_MessageType, FXmlTagHMT.D_MessageType, FXmlTagHMT.M_MessageTransfer);
                return new FHostMessageTransfer(this.fPcdCore, fXmlNodeHmt, tid);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
