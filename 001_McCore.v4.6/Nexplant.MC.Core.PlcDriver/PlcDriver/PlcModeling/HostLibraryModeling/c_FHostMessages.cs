...
--  Description     : FAMate Core FaPlcDriver Host Messages Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostMessages : FBaseObject<FHostMessages>, FIObject
    {
        ...
        public FHostMessages(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHMS(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostMessageList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessageList(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessages fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostMessages(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostMessageCollection fChildHostMessageCollection
        {
            get
            {
                try
                {
                    return new FHostMessageCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagHMG.E_HostMessage));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool canAppendChild
        {
            get
            {
                try
                {
                    //if (this.fXmlNode.selectNodes(FXmlTagSMG.E_PlcMessage).count >= 2)
                    //{
                    //    return false;
                    //}
                    return true;
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHmg.fXmlNode);
                }
           ...
           )           
        {
            ...
            try
            {
                ...
                foreach (FXmlNode fXmlNodeHmg in fXmlNodeListHmg)
                {
                    ...
                    {
                        this.fPcdCore.fEventPusher.pushEvent(
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fPlcDriver, this, FPlcDriverCommon.createObject(this.fPcdCore, fXmlNodeHmg))
                            );
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostMessages);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostMessage);
                // --
                if (this.hasChildPrimaryHostMessage)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostMessage(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
