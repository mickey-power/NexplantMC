...
--  Description     : FAMate Core FaPlcDriver Host Library Group Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostLibraryGroup : FBaseObject<FHostLibraryGroup>, FIObject
    {
        ...
        public FHostLibraryGroup(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHLG(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostLibraryGroup fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostLibraryGroup(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostLibraryGroup fNextSibling
        {
            get 
            {
                try
                {
                    ...
                    return new FHostLibraryGroup(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostLibraryCollection fChildHostLibraryCollection
        {
            get
            {
                try
                {
                    return new FHostLibraryCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagHLB.E_HostLibrary));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHlb.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostLibraryGroup);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostLibrary);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostLibrary(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
