...
--  Description     : FAMate Core FaPlcDriver Host Device Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostDevice : FBaseObject<FHostDevice>, FIObject, FIDevice
    {
        ...
        public FHostDevice(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHDV(fPlcDriver.fPcdCore.fXmlDoc))
        {
            // init();
        }
        ...
        public string driverOption
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        fBaseProtocol = this.fPcdCore.fProtocolAgent.getProtocol(this.uniqueId);
        ...
        public FHostDevice fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostDevice(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostDevice fNextSibling
        {
            get 
            {
                try
                {
                    ...
                    return new FHostDevice(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSessionCollection fChildHostSessionCollection
        {
            get
            {
                try
                {
                    return new FHostSessionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagHSN.E_HostSession));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fHsn.fXmlNode);
                }
            ...
            )
        {
            try
            {
                ...
                return (FIHostDriver)FReflection.createInstanceInMemory(
                    ...
                    new object[] { new FHostDriverArgs(this.fPlcDriver, this) }
                    );
            }
            catch (Exception ex)
            {
            ...
            )
        {
            try
            {
                ...
                // --
                return createHostDriver(this.fPlcDriver.hostDriverDirectory + "//" + this.driver);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.fPcdCore.fProtocolAgent.openHostDevice(this);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                this.fPcdCore.fProtocolAgent.closeHostDevice(this);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostDevice);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.HostSession);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FHostSession(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
