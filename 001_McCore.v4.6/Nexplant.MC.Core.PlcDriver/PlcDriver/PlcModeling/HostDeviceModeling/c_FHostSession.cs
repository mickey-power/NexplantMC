...
--  Description     : FAMate Core FaPlcDriver Host Session Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FHostSession : FBaseObject<FHostSession>, FIObject, FISession
    {
        ...
        public FHostSession(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeHSN(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FHostLibrary fLibrary
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FHostLibrary(this.fPcdCore, this.fPlcDriver.fXmlNode.selectSingleNode(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostDevice fParent
        {
            get
            {
                try
                {
                    ...
                    return new FHostDevice(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostSession(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FHostSession fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FHostSession(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.HostSession);
