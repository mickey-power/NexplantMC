    ...
    internal class FPauserAgent : IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                fXmlNodePau = m_fPcdCore.fPlcDriver.fXmlNode.selectSingleNode(string.Format(Query, fPauserData.uniqueId));
                if (fXmlNodePau == null)
                {
                    return;
                }
                ...
                // ***
                fXmlNodeFlow = m_fPcdCore.fPlcDriver.fXmlNode.selectSingleNode(
                ...
                {
                    FScenarioController.executePlcTransmitter(fScenarioData);
                }
