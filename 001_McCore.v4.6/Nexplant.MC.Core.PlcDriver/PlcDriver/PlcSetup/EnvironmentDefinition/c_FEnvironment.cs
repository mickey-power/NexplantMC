...
--  Description     : FAMate Core FaPlcDriver Evnironment Class
...
{
    public class FEnvironment : FBaseObject<FEnvironment>, FIObject, FIPlcOperand, FIHostOperand
    {
        ...
        public FEnvironment(
           FPlcDriver fPlcDriver
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeENV(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FEnvironmentList(this.fPcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FEnvironment(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch(Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironment fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironment(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironment fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironment(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fPcdCore, fEnl.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fPcdCore, ((FEnvironmentList)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fPcdCore, ((FEnvironment)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fPcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fPlcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fPlcDriver, ((FEnvironment)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEnv.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Environment가 PLC Expression이나 Host Expression에 사용되었을 경우 Unlock 작업을 취소한다.
                // ***
                xpath =
                    FXmlTagEQM.E_EquipmentModeling +
                    "/" + FXmlTagEQP.E_Equipment +
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Environment);
