...
--  Description     : FAMate Core FaPlcDriver Evnironment List Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FEnvironmentList : FBaseObject<FEnvironmentList>, FIObject
    {
        ...
        public FEnvironmentList(
            ...
            :base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeENL(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FEnvironmentList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironmentList(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironmentList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEnvironmentList(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEnvironmentCollection fChildEnvironmentCollection
        {
            get
            {
                try
                {
                    return new FEnvironmentCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagENV.E_Environment));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEvn.fXmlNode);                   
                }
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEnvironment(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                FPlcDriverCommon.validateCutObject(fXmlNode);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EnvironmentList);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Environment);
