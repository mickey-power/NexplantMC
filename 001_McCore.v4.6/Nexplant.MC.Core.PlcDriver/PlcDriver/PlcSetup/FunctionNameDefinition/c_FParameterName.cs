...
--  Description     : FAMate Core FaPlcDriver Parameter Name Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FParameterName : FBaseObject<FParameterName>, FIObject
    {
        ...
        public FParameterName(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodePAN(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FFunctionName fParent
        {
            get
            {
                try
                {
                    ...
                    return new FFunctionName(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FParameterName fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FParameterName(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FParameterName fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FParameterName(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FArgumentCollection fChildFArgumentCollection
        {
            get
            {
                try
                {
                    return new FArgumentCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagARG.E_Argument));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fArg.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ParameterName);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Argument);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FArgument(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
