...
--  Description     : FAMate Core FaPlcDriver Data Conversion Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FDataConversion : FBaseObject<FDataConversion>, FIObject
    {
        ...
        public FDataConversion(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeDCV(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public string min
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!FPlcDriverCommon.validateMinMax(fFormat, value, max))
                    {
                        FDebug.throwFException(string.Format(FConstants.err_m_0014, "Min"));
                    }
        ...
        public string max
        {
            ...
            set
            {
                try
                {
                    ...
                    if (!FPlcDriverCommon.validateMinMax(fFormat, min, value))
                    {
                        FDebug.throwFException(string.Format(FConstants.err_m_0014, "Max"));
                    }
        ...
        public FDataConversionSet fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversion fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversion(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversion fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversion(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversion);
