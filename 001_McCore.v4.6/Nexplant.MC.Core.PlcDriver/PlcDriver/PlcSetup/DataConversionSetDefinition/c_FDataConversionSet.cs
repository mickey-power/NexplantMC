...
--  Description     : FAMate Core FaPlcDriver Data Conversion Set Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FDataConversionSet : FBaseObject<FDataConversionSet>, FIObject
    {
        ...
        public FDataConversionSet(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeDCS(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FDataConversionSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSetList(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataConversionSet(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataConversionCollection fChildDataConversionCollection
        {
            get
            {
                try
                {
                    return new FDataConversionCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagDCV.E_DataConversion));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            get
            {
                ...
                try
                {
                    xpath =
                        ...
                        "//" + FXmlTagPWD.E_PlcWord + "[@" + FXmlTagPWD.A_DataConversionSetID + "='" + this.uniqueIdToString + "']" +
                        " | " +
                        ...
                        "//" + FXmlTagPEP.E_PlcExpression + "[@" + FXmlTagPEP.A_DataConversionSetID + "='" + this.uniqueIdToString + "']" +                    
                        " | " +
                        "../../../../" + FXmlTagEQM.E_EquipmentModeling +
                        "/" + FXmlTagEQP.E_Equipment +
                        "/" + FXmlTagSNG.E_ScenarioGroup +
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fDcv.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.DataConversionSet);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.DataConversion);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FDataConversion(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    if (obj.fObjectType == FObjectType.PlcWord)
                    {
                        ((FPlcWord)obj).dataConversionSetName = this.name;
                        ((FPlcWord)obj).dataConversionSetExpression = expression;
                    }
                    ...
                    else if (obj.fObjectType == FObjectType.PlcExpression)
                    {
                        ((FPlcExpression)obj).dataConversionSetName = this.name;
                        ((FPlcExpression)obj).dataConversionSetExpression = expression;
                    }
