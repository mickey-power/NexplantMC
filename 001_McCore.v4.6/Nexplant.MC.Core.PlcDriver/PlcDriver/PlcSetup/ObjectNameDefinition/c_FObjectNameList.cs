...
--  Description     : FAMate Core FaPlcDriver Object Name List Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FObjectNameList : FBaseObject<FObjectNameList>, FIObject
    {
        ...
        public FObjectNameList(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeONL(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FObjectNameList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FObjectNameList(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectNameList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FObjectNameList(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectNameCollection fChildObjectNameCollection
        {
            get
            {
                try
                {
                    return new FObjectNameCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagONA.E_ObjectName));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fOna.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.ObjectNameList);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.ObjectName);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FObjectName(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
