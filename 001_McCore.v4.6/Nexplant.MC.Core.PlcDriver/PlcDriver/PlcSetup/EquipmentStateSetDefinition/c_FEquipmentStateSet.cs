...
--  Description     : FAMate Core FaPlcDriver Equipment State Set Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FEquipmentStateSet : FBaseObject<FEquipmentStateSet>, FIObject
    {
        ...
        public FEquipmentStateSet(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeESS(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSet(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSet(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateCollection fChildEquipmentStateCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagEST.E_EquipmentState));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEst.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSet);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentState);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentState(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
