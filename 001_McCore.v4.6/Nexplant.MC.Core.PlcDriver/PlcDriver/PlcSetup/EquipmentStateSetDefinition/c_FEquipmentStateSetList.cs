...
--  Description     : FAMate Core FaPlcDriver Equipment State Set List Class 
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FEquipmentStateSetList : FBaseObject<FEquipmentStateSetList>, FIObject
    {
        ...
        public FEquipmentStateSetList(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeESL(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FEquipmentStateSetList fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSetList fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FEquipmentStateSetList(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FEquipmentStateSetCollection fChildEquipmentStateSetCollection
        {
            get
            {
                try
                {
                    return new FEquipmentStateSetCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagESS.E_EquipmentStateSet));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fEss.fXmlNode);
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSetList);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.EquipmentStateSet);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FEquipmentStateSet(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
