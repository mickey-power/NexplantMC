...
--  Description     : FAMate Core FaPlcDriver Data Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FData : FBaseObject<FData>, FIObject
    {
        ...
        public FData(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeDAT(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public string sourceItem
        {
            ...
            set
            {
                try
                {
                    FPlcDriverCommon.validateName(value, true);
                    // --
                    if (this.fSourceType != FDataSourceType.Item)
                    {
        ...
        public string targetConstant
        {
            ...
            set
            {
                try
                {
                    FPlcDriverCommon.validateName(value, false);
                    // --
        ...
        public FDataCollection fChildDataCollection
        {
            get
            {
                try
                {
                    return new FDataCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagDAT.E_Data));
                }
                catch(Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataCollection fFixedChildDataCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    return new FDataCollection(this.fPcdCore, this.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FDataSet(this.fPcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FData(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FData fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FData(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FData fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FData(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FObjectCollection fReferenceObjectCollection
        {
            get
            {
                ...
                try
                {
                    ...
                    // --
                    return new FObjectCollection(this.fPcdCore, fDts.fXmlNode.selectNodes(xpath));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fPcdCore, ((FDataSet)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fPcdCore, ((FData)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fPcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fPlcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fPlcDriver, ((FData)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Data);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Data);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FData(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
