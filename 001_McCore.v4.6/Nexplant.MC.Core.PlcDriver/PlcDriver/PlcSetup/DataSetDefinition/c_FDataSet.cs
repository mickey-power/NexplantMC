...
--  Description     : FAMate Core FaPlcDriver Data Set Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FDataSet : FBaseObject<FDataSet>, FIObject
    {
        ...
        public FDataSet(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeDTS(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FDataSetList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FDataSetList(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataSet fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataSet(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FDataSet fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FDataSet(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        {           
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode,FCbObjectFormat.DataSet);
