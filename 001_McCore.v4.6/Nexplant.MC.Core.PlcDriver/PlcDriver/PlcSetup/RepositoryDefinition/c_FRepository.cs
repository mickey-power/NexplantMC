...
--  Description     : FAMate Core FaPlcDriver Repository Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FRepository : FBaseObject<FRepository>, FIObject
    {
        ...
        public FRepository(
            ...
            : base(fPlcDriver.fPcdCore,FPlcDriverCommon.createXmlNodeRPS(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FRepositoryList fParent
        {
            get
            {
                try
                {
                    ...
                    return new FRepositoryList(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepository fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepository(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FRepository fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FRepository(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Repository);
