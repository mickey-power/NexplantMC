...
--  Description     : FAMate Core FaPlcDriver Column Class
...
namespace Nexplant.MC.Core.FaPlcDriver
{
    public class FColumn : FBaseObject<FColumn>, FIObject
    {
        ...
        public FColumn(
            ...
            : base(fPlcDriver.fPcdCore, FPlcDriverCommon.createXmlNodeCOL(fPlcDriver.fPcdCore.fXmlDoc))
        {
        ...
        public FColumnCollection fChildColumnCollection
        {
            get
            {
                try
                {
                    return new FColumnCollection(this.fPcdCore, this.fXmlNode.selectNodes(FXmlTagCOL.E_Column));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FIObject fParent
        {
            get
            {
                try
                {
                    ...
                    {
                        return new FRepository(this.fPcdCore, this.fXmlNode.fParentNode);
                    }
                    return new FColumn(this.fPcdCore, this.fXmlNode.fParentNode);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumn fPreviousSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumn(this.fPcdCore, this.fXmlNode.fPreviousSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public FColumn fNextSibling
        {
            get
            {
                try
                {
                    ...
                    return new FColumn(this.fPcdCore, this.fXmlNode.fNextSibling);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
        ...
        public bool canAppendChild
        {
            get
            {
                ...
                {
                    // ***
                    // Column 이 List인 경우에만 Child Item을 가질 수 있다.
                    // ***
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    this.replace(this.fPcdCore, ((FRepository)fParent).fXmlNode.removeChild(this.fXmlNode));
                }
                else
                {
                    this.replace(this.fPcdCore, ((FColumn)fParent).fXmlNode.removeChild(this.fXmlNode));
                    // --
                ...
                if (isModelingObject)
                {
                    ...
                    else
                    {
                        this.fPcdCore.fEventPusher.pushEvent(new FEventArgsBase[]{
                            new FObjectEventArgs(FEventId.ObjectRemoveCompleted, this.fPlcDriver, fParent, this),
                            new FObjectEventArgs(FEventId.ObjectModifyCompleted, this.fPlcDriver, ((FColumn)fParent).fParent, fParent)
                        });
                    }
                }
            }
            ...
            )
        {
            try
            {
                ...
                {
                    FPlcDriverCommon.validateRemoveChildObject(this.fXmlNode, fCol.fXmlNode);                    
                }
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteSiblingObject(this.fXmlNode, FCbObjectFormat.Column);
            ...
            )
        {
            ...
            try
            {
                FPlcDriverCommon.validatePasteChildObject(this.fXmlNode, FCbObjectFormat.Column);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FColumn(this.fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
