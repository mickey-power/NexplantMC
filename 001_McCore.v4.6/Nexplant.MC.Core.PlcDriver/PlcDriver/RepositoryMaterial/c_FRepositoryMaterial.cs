...
--  Description     : FAMate Core FaPlcDriver Repository Material Class 
    ...
    public class FRepositoryMaterial : FIObject, IDisposable
    {
        ...
        public FColumnCollection fChildColumnCollection
        {
            get
            {
                try
                {
                    return new FColumnCollection(m_fPcdCore, this.fXmlNode.selectNodes(FXmlTagCOL.E_Column));
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                return new FColumn(m_fPcdCore, fXmlNode);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
