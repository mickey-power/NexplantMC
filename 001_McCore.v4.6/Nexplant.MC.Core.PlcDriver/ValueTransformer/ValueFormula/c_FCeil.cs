...
--
--  Program Id      : c_FCeil.cs
--  Creator         : jeff.kim
--  Create Date     : 2013.06.03
--  Description     : FAMate Core FaSecsDriver Ceil Formula Class 
...
{
    public class FCeil : FValueFormulaBase, FIValueFormula
    {
