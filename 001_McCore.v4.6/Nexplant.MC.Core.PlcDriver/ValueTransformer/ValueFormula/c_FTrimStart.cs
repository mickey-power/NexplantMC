...
--
--  Program Id      : c_FTrimStart.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.24
--  Description     : FAMate Core FaSecsDriver Trim Start Formula Class 
...
{
    public class FTrimStart : FValueFormulaBase, FIValueFormula
    {
        ...
        public FValueFormulaType fType
        {
            get
            {
                try
                {
                    return FValueFormulaType.TrimStart;
                }
                catch (Exception ex)
                {
