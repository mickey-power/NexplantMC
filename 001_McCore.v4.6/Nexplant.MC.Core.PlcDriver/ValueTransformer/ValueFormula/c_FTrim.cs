...
--
--  Program Id      : c_FTrim.cs
--  Creator         : spike.lee
--  Create Date     : 2011.02.24
--  Description     : FAMate Core FaSecsDriver Trim Formula Class 
...
{
    public class FTrim : FValueFormulaBase, FIValueFormula
    {
