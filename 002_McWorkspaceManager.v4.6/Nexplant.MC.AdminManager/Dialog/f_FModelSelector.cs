...
--
--  Program Id      : f_FModelSelector.cs
--  Creator         : mjkim
--  Create Date     : 2015.08.26
--  Description     : FAMate Admin Manager Model Select Dialog Form Class 
...
{
    public partial class FModelSelector : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdList.DisplayLayout.Bands[0].Columns["Model"].CellAppearance.Image = Properties.Resources.Model;
                // --
                grdList.DisplayLayout.Bands[0].Columns["Model"].Width = 170;
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Dialog", "ModelSelector", "ListAllModel", fSqlParams, false, ref nextRowNumber);
                    // --
                ...
                if (grdList.Rows.Count > 0)
                {
                    ...
                    {
                        grdList.activateDataRow(m_oldModel);
                    }
                    // --
        ...
        #region FModelSelector Form Event Handler

        private void FModelSelector_Load(
            object sender, 
            EventArgs e
            )
        {
            try
            {
                ...
                btnReset.Enabled = (m_oldModel == string.Empty ? false : true);
        ...
        private void FModelSelector_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FModelSelector_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
