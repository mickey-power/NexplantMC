...
--
--  Program Id      : c_FPropEwdTcpHdv.cs
--  Creator         : spike.lee
--  Create Date     : 2012.05.21
--  Description     : FAMate Admin Manager EAP Wizard Host Device Source Object for TCP Class 
...
{
    public class FPropEwdTcpHdv : FDynPropCusBase<FAdmCore>
    {
        ...
        [Category(CategoryProtocol)]
        [Editor(typeof(FPropAttrEwdTcpHdvDriverUITypeEditor), typeof(UITypeEditor))]
        ...
        [Category(CategoryProtocol)]
        [Editor(typeof(FPropAttrEwdTcpHdvDriverOptionUITypeEditor), typeof(UITypeEditor))]
