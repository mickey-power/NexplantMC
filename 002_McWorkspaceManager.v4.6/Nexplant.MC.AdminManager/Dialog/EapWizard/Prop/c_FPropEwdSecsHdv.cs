...
--
--  Program Id      : c_FPropEwdSecsHdv.cs
--  Creator         : spike.lee
--  Create Date     : 2012.05.21
--  Description     : FAMate Admin Manager EAP Wizard Host Device Source Object for SECS Class 
...
{
    public class FPropEwdSecsHdv : FDynPropCusBase<FAdmCore>
    {
        ...
        [Category(CategoryProtocol)]
        [Editor(typeof(FPropAttrEwdSecsHdvDriverUITypeEditor), typeof(UITypeEditor))]
        ...
        [Category(CategoryProtocol)]
        [Editor(typeof(FPropAttrEwdSecsHdvDriverOptionUITypeEditor), typeof(UITypeEditor))]
