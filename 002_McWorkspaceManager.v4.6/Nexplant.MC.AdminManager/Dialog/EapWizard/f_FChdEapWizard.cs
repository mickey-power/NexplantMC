...
--
--  Program Id      : f_FChdEapWizard.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2015.11.11
--  Description     : FAMate Admin Manager EAP Wizard for Custom Host Driver Form Class 
...
{
    public partial class FChdEapWizard : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm
    {
            ...
            : this()
        {
            ...
            m_fEapWizardData.fEapType = FEapType.CHD;
            ...
            )
        {
            ...
            try
            {
                fDialog = new FPackageVersionSelector(m_fAdmCore, FEapType.CHD.ToString(), txtPackage.Text, txtPackageVer.Text);
                if (fDialog.ShowDialog() == DialogResult.Cancel)
                {
                    return;
                }
            ...
            )
        {
            ...
            try
            {
                fDialog = new FModelVersionSelector(m_fAdmCore, FEapType.CHD.ToString(), txtModel.Text, txtModelVer.Text);
                if (fDialog.ShowDialog() == DialogResult.Cancel)
                {
                    return;
                }
            ...
            )
        {
            ...
            try
            {
                fDialog = new FComponentVersionSelector(m_fAdmCore, FEapType.CHD.ToString(), txtComponent.Text, txtComponentVer.Text);
                if (fDialog.ShowDialog() == DialogResult.Cancel)
                {
                    return;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fXmlNode.name == FADMADS_DlgEapWizardEapSchemaSearch_Out.FSchema.FSecsDriver.E_SecsDriver)
                {
                    if (fTreeView == tvwOdv)
                    {
                        pgdOdv.selectedObject = new FPropEwdChdOcd(m_fAdmCore, pgdOdv, this, fTreeView.ActiveNode, fXmlNode);
                    }
                    else if (fTreeView == tvwHdv)
                    {
                        pgdHdv.selectedObject = new FPropEwdChdOcd(m_fAdmCore, pgdHdv, this, fTreeView.ActiveNode, fXmlNode);
                    }
                    else if (fTreeView == tvwEqp)
                    {
                        pgdEqp.selectedObject = new FPropEwdChdOcd(m_fAdmCore, pgdEqp, this, fTreeView.ActiveNode, fXmlNode);
                    }
                    else if (fTreeView == tvwEnv)
                    {
                        pgdEnv.selectedObject = new FPropEwdChdOcd(m_fAdmCore, pgdEnv, this, fTreeView.ActiveNode, fXmlNode);
                    }
                }                
                else if (fXmlNode.name == FADMADS_DlgEapWizardEapSchemaSearch_Out.FSchema.FSecsDriver.FHostDevice.E_HostDevice)
                {
                    pgdHdv.selectedObject = new FPropEwdChdHdv(m_fAdmCore, pgdHdv, this, fTreeView.ActiveNode, fXmlNode);
                }
                else if (fXmlNode.name == FADMADS_DlgEapWizardEapSchemaSearch_Out.FSchema.FSecsDriver.FHostDevice.FHostSession.E_HostSession)
                {
                    pgdHdv.selectedObject = new FPropEwdChdHsn(m_fAdmCore, pgdHdv, this, fTreeView.ActiveNode, fXmlNode);
                }
                else if (fXmlNode.name == FADMADS_DlgEapWizardEapSchemaSearch_Out.FSchema.FSecsDriver.FEquipment.E_Equipment)
                {
                    pgdEqp.selectedObject = new FPropEwdChdEqp(m_fAdmCore, pgdEqp, this, fTreeView.ActiveNode, fXmlNode);
                }
                else if (fXmlNode.name == FADMADS_DlgEapWizardEapSchemaSearch_Out.FSchema.FSecsDriver.FEnvironmentList.E_EnvironmentList)
                {
                    pgdEnv.selectedObject = new FPropEwdChdEnl(m_fAdmCore, pgdEnv, this, fTreeView.ActiveNode, fXmlNode);
                }
                else if (fXmlNode.name == FADMADS_DlgEapWizardEapSchemaSearch_Out.FSchema.FSecsDriver.FEnvironmentList.FEnvironment.E_Environment)
                {
                    pgdEnv.selectedObject = new FPropEwdChdEnv(m_fAdmCore, pgdEnv, this, fTreeView.ActiveNode, fXmlNode, m_fEnvironmentS);
                }
            }
            catch (Exception ex)
            {
