...
--
--  Program Id      : f_FSecsHostMessageSender.cs
--  Creator         : Jeff.Kim
--  Create Date     : 2018.03.22
--  Description     : FAMate Admin Manager SECS Host Message Sender Dialog Form Class 
--  History         : Created by Jeff.Kim at 2018.03.22
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FSecsHostMessageSender : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm, FITransaction
    {
        //------------------------------------------------------------------------------------------------------------------------
        ...
        private const string typeName = "Nexplant.MC.HostDriver.SECS.FHostDriver";

        //------------------------------------------------------------------------------------------------------------------------

        #region Class Construction and Destruction

        public FSecsHostMessageSender(
            )
        {
            InitializeComponent();
        }
            ...
            )
        {
            ...
            try
            {
                ...
                fHdmg = new FHostDriverDataMessage(m_fSecsDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fHit = new FHostItem(m_fSecsDriver);
        ...
        #region FSecsHostMessageSender Form Event Handler

        private void FSecsHostMessageSender_Load(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FSecsHostMessageSender_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FSecsHostMessageSender_FormClosing(
            object sender, 
        ...
        {
            FSecsHostDriverSelector dialog = null;
            ...
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuThsOpen)
                {
                    ...
                    dialog = new FSecsHostDriverSelector(m_fAdmCore, m_fHostDevice);
                    ...
                    else
                    {
                        ...
                        m_fHostDriver = FReflection.createInstance(
                            m_hostDriverPath,
                            typeName,
                            new object[] { m_fSecsDriver, m_fHostDevice
                            });
