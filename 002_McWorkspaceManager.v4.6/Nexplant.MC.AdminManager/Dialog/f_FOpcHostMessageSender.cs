...
--
--  Program Id      : f_FOpcHostMessageSender.cs
--  Creator         : mjkim
--  Create Date     : 2020.07.03
--  Description     : FAmate Admin Manager OPC Host Message Sender Dialog Form Class 
...
{
    public partial class FOpcHostMessageSender : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm, FITransaction
    {
        //------------------------------------------------------------------------------------------------------------------------
        ...
        private const string typeName = "Nexplant.MC.HostDriver.OPC.FHostDriver";

        //------------------------------------------------------------------------------------------------------------------------

        #region Class Construction and Destruction

        public FOpcHostMessageSender(
            )
        {
            InitializeComponent();
        }
            ...
            )
        {
            ...
            try
            {
                ...
                fHdmg = new FHostDriverDataMessage(m_fOpcDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fHit = new FHostItem(m_fOpcDriver);
        ...
        #region FOpcHostMessageSender Form Event Handler

        private void FOpcHostMessageSender_Load(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FOpcHostMessageSender_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FOpcHostMessageSender_FormClosing(
            object sender, 
            ...
            )
        {
            ...
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuThsOpen)
                {
                    ...
                    dialog = new FOpcHostDriverSelector(m_fAdmCore, m_fHostDevice);
                    ...
                    else
                    {
                        ...
                        m_fHostDriver = FReflection.createInstance(
                            m_hostDriverPath,
                            typeName,
                            new object[] { m_fOpcDriver, m_fHostDevice
                            });
