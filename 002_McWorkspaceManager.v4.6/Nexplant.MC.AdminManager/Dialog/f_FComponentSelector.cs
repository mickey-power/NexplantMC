...
--
--  Program Id      : f_FComponentSelector.cs
--  Creator         : mjkim
--  Create Date     : 2015.08.26
--  Description     : FAMate Admin Manager Component Select Dialog Form Class 
...
{
    public partial class FComponentSelector : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdList.DisplayLayout.Bands[0].Columns["Component"].CellAppearance.Image = Properties.Resources.Component;
                // --
                grdList.DisplayLayout.Bands[0].Columns["Component"].Width = 170;
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Dialog", "ComponentSelector", "ListAllComponent", fSqlParams, false, ref nextRowNumber);
                    // --
                ...
                if (grdList.Rows.Count > 0)
                {
                    ...
                    {
                        grdList.activateDataRow(m_oldComponent);
                    }
                    // --
        ...
        #region FComponentSelector Form Event Handler

        private void FComponentSelector_Load(
            object sender, 
            EventArgs e
            )
        {
            try
            {
                ...
                btnReset.Enabled = (m_oldComponent == string.Empty ? false : true);
        ...
        private void FComponentSelector_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FComponentSelector_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
