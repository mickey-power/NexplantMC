...
--
--  Program Id      : c_FMonitoringPackageDataReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2013.02.16
--  Description     : FAMate Admin Manager Monitroing Package Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringPackageDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringPackageDataReceivedEventArgs(            
        ...
        ~FMonitoringPackageDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
