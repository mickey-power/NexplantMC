...
--
--  Program Id      : c_FMonitoringEquipmentDataReceivedEventArgs.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.07.15
--  Description     : FAMate Admin Manager Monitroing Equipment Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringEquipmentDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringEquipmentDataReceivedEventArgs(            
        ...
        ~FMonitoringEquipmentDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
