...
--
--  Program Id      : c_FMonitoringServerDataReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2013.02.16
--  Description     : FAMate Admin Manager Monitroing Server Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringServerDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringServerDataReceivedEventArgs(            
        ...
        ~FMonitoringServerDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
