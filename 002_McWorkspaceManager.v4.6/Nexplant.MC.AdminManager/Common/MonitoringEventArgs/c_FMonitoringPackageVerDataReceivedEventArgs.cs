...
--
--  Program Id      : c_FMonitoringPackageVerDataReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2013.02.17
--  Description     : FAMate Admin Manager Monitroing Package Version Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringPackageVerDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringPackageVerDataReceivedEventArgs(            
        ...
        ~FMonitoringPackageVerDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
