...
--
--  Program Id      : c_FMonitoringEquipmentTypeDataReceivedEventArgs.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.07.15
--  Description     : FAMate Admin Manager Monitroing Equipment Type Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringEquipmentTypeDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringEquipmentTypeDataReceivedEventArgs(            
        ...
        ~FMonitoringEquipmentTypeDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
