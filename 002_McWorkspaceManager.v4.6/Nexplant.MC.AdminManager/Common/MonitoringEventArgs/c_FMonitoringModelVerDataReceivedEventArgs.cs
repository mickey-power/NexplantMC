...
--
--  Program Id      : c_FMonitoringModelVerDataReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2013.02.17
--  Description     : FAMate Admin Manager Monitroing Model Version Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringModelVerDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringModelVerDataReceivedEventArgs(            
        ...
        ~FMonitoringModelVerDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
