...
--
--  Program Id      : c_FMonitoringDeviceDataReceivedEventArgs.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2014.03.28
--  Description     : FAMate Admin Manager Monitroing Device Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringDeviceDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringDeviceDataReceivedEventArgs(            
        ...
        ~FMonitoringDeviceDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
