...
--
--  Program Id      : c_FMonitoringComponentDataReceivedEventArgs.cs
--  Creator         : spike.lee
--  Create Date     : 2013.02.17
--  Description     : FAMate Admin Manager Monitroing Component Data Received Event Arguments Class 
...
{
    [Serializable]
    public class FMonitoringComponentDataReceivedEventArgs : EventArgs, IDisposable
    {
        ...
        public FMonitoringComponentDataReceivedEventArgs(            
        ...
        ~FMonitoringComponentDataReceivedEventArgs(
            )
        {
            myDispose(false);
        }
