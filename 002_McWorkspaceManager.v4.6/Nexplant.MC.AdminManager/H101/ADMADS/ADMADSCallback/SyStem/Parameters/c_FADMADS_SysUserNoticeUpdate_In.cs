...
--
--  Program Id      : c_FADMADS_SysUserNoticeUpdate_In.cs
...
{
    internal static class FADMADS_SysUserNoticeUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SysUserNoticeUpdate_In = "ADMADS_SysUserNoticeUpdate_In";
        ...
        public static class FUser
        {
            ...
            public const string A_LastNoticeTime = "LastNoticeTime";

            // --

            public const string D_UserId = "";
            public const string D_LastNoticeTime = "";
        }
