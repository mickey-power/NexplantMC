...
--
--  Program Id      : c_FADMADS_SysPasswordReset_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_SysPasswordReset_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SysPasswordReset_In = "ADMADS_SysPasswordReset_In";
        ...
        public static class FUser
        {
            ...
            public const string A_CurrentUserPassword = "CurrentUserPassword";

            // --

            public const string D_UserId = "";
            public const string D_CurrentUserPassword = "";
        }
