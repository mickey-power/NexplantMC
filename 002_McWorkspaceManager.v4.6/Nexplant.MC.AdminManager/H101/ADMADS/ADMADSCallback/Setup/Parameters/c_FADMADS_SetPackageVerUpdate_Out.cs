...
--
--  Program Id      : c_FADMADS_SetPackageVerUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetPackageVerUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetPackageVerUpdate_Out = "ADMADS_SetPackageVerUpdate_Out";
