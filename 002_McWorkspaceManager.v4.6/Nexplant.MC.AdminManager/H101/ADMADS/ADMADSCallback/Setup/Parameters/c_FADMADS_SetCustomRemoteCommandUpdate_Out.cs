...
--
--  Program Id      : c_FADMADS_SetCustomRemoteCommandUpdate_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_SetCustomRemoteCommandUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetCustomRemoteCommandUpdate_Out = "ADMADS_SetCustomRemoteCommandUpdate_Out";
