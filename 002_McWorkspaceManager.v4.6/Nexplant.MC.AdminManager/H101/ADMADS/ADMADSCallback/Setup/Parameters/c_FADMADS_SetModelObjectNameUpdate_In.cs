...
--
--  Program Id      : c_FADMADS_SetModelObjectNameUpdate_In.cs
...
{
    internal static class FADMADS_SetModelObjectNameUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelObjectNameUpdate_In = "ADMADS_SetModelObjectNameUpdate_In";
        ...
        public static class FObejctName
        {
            public const string E_ObejctName = "ObejctName";

            // --

            public const string A_ModelType = "ModelType";
            public const string A_ObjectType = "ObjectType";
            public const string A_ObjectName = "ObjectName";
            ...
            public const string D_ObjectName = "";
