...
--
--  Program Id      : c_FADMADS_SetModelVerUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetModelVerUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelVerUpdate_Out = "ADMADS_SetModelVerUpdate_Out";
