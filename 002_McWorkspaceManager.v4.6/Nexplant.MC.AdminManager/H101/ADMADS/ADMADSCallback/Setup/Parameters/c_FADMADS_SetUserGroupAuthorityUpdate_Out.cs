...
--
--  Program Id      : c_FADMADS_SetUserGroupAuthorityUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetUserGroupAuthorityUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserGroupAuthorityUpdate_Out = "ADMADS_SetUserGroupAuthorityUpdate_Out";
