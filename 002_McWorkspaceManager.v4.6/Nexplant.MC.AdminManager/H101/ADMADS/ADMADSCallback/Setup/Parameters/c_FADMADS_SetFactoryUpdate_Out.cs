...
--
--  Program Id      : c_FADMADS_SetFactoryUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetFactoryUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetFactoryUpdate_Out = "ADMADS_SetFactoryUpdate_Out";
