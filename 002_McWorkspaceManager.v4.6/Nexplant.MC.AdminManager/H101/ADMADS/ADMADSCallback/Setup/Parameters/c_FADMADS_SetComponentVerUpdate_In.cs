...
--
--  Program Id      : c_FADMADS_SetComponentVerUpdate_In.cs
--  Creator         : hsshim
--  Create Date     : 2013.04.08
--  Description     :  <Generated Class File Description>
--  History         : Created by hsshim at 2013.04.08
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetComponentVerUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetComponentVerUpdate_In = "ADMADS_SetComponentVerUpdate_In";
        ...
        {
            public const string E_Version = "Version";
            ...
            public const string A_Release = "Release";
