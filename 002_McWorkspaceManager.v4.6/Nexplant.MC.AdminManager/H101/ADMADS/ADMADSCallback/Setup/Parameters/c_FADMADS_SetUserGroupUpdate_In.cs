...
--
--  Program Id      : c_FADMADS_SetUserGroupUpdate_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetUserGroupUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserGroupUpdate_In = "ADMADS_SetUserGroupUpdate_In";
        ...
        public static class FUserGroup
        {
            public const string E_UserGroup = "UserGroup";
