...
--
--  Program Id      : c_FADMADS_SetModelAlarmGroupUpdate_In.cs
--  Creator         : TJ.Kim
--  Create Date     : 2013.05.22
--  Description     : <Generated Class File Description>
--  History         : Created by TJ.Kim at 2013.05.22
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetModelAlarmGroupUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelAlarmGroupUpdate_In = "ADMADS_SetModelAlarmGroupUpdate_In";
        ...
        public static class FAlarmGroup
        {
            public const string E_AlarmGroup = "AlarmGroup";
            ...
            public const string A_AlarmLevel = "AlarmLevel";
            ...
            public const string D_AlarmLevel = "";
        }
