...
--
--  Program Id      : c_FADMADS_SetGcmDataUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetGcmDataUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetGcmDataUpdate_Out = "ADMADS_SetGcmDataUpdate_Out";
