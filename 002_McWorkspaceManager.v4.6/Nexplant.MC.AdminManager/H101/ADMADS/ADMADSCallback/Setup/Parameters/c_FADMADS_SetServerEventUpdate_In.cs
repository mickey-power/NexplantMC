...
--
--  Program Id      : c_FADMADS_SetServerEventUpdate_In.cs
...
{
    internal static class FADMADS_SetServerEventUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetServerEventUpdate_In = "ADMADS_SetServerEventUpdate_In";
        ...
        public static class FServerEvent
        {
            public const string E_ServerEvent = "ServerEvent";
