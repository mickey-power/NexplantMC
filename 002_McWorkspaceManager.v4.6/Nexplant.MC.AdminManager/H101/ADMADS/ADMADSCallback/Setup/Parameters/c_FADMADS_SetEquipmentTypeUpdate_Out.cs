...
--
--  Program Id      : c_FADMADS_SetEquipmentTypeUpdate_Out.cs
...
{
    internal static class FADMADS_SetEquipmentTypeUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEquipmentTypeUpdate_Out = "ADMADS_SetEquipmentTypeUpdate_Out";
