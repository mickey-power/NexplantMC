...
--
--  Program Id      : c_FADMADS_SetPackageVerUpdate_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetPackageVerUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetPackageVerUpdate_In = "ADMADS_SetPackageVerUpdate_In";
