...
--
--  Program Id      : c_FADMADS_SetUserEventUpdate_In.cs
...
{
    internal static class FADMADS_SetUserEventUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserEventUpdate_In = "ADMADS_SetUserEventUpdate_In";
        ...
        public static class FUserEvent
        {
            public const string E_UserEvent = "UserEvent";
