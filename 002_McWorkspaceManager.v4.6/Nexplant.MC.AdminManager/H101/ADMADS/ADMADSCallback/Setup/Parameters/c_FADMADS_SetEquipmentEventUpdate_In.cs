...
--
--  Program Id      : c_FADMADS_SetEquipmentEventUpdate_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.07.12
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.07.12
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetEquipmentEventUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEquipmentEventUpdate_In = "ADMADS_SetEquipmentEventUpdate_In";
        ...
        public static class FEquipmentEvent
        {
            public const string E_EquipmentEvent = "EquipmentEvent";
            ...
            public const string A_SystemEvent = "SystemEvent";
            public const string A_IssueEvent = "IssueEvent";
            ...
            public const string D_SystemEvent = "";
            public const string D_IssueEvent = "";
