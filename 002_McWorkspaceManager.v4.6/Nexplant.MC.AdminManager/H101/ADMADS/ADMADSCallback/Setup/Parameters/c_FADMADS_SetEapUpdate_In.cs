...
--
--  Program Id      : c_FADMADS_SetEapUpdate_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_SetEapUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEapUpdate_In = "ADMADS_SetEapUpdate_In";
        ...
        public static class FEap
        {
            ...
            public const string A_Package = "Package";
            public const string A_PackageVer = "PackageVer";
            public const string A_Model = "Model";
            public const string A_ModelVer = "ModelVer";
            public const string A_UsedComponent = "UsedComponent";
            public const string A_Component = "Component";
            public const string A_ComponentVer = "ComponentVer";
            ...
            public const string D_Package = "";
            public const string D_PackageVer = "";
            public const string D_Model = "";
            public const string D_ModelVer = "";
            public const string D_UsedComponent = "";
            public const string D_Component = "";
            public const string D_ComponentVer = "";

            // --

            public static class FConfig
            {
                public const string E_Config = "Config";
                ...
                public const string A_UseSftp = "UseSFTP";
