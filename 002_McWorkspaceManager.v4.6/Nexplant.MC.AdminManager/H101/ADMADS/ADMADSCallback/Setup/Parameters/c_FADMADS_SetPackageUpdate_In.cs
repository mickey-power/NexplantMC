...
--
--  Program Id      : c_FADMADS_SetPackageUpdate_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_SetPackageUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetPackageUpdate_In = "ADMADS_SetPackageUpdate_In";
