...
--
--  Program Id      : c_FADMADS_SetModelSheetUpdate_In.cs
--  Creator         : byjeon
--  Create Date     : 2014.01.17
--  Description     : <Generated Class File Description>
--  History         : Created by byjeon at 2014.01.17
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetModelSheetUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelSheetUpdate_In = "ADMADS_SetModelSheetUpdate_In";
        ...
        public static class FSheet
        {
            public const string E_Sheet = "Sheet";
