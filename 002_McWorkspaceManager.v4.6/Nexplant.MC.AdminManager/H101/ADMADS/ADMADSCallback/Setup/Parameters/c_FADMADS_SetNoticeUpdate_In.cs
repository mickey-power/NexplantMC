...
--
--  Program Id      : c_FADMADS_SetNoticeUpdate_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_SetNoticeUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetNoticeUpdate_In = "ADMADS_SetNoticeUpdate_In";
