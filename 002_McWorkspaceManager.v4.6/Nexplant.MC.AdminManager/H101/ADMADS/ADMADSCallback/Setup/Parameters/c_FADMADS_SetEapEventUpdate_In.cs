...
--
--  Program Id      : c_FADMADS_SetEapEventUpdate_In.cs
...
{
    internal static class FADMADS_SetEapEventUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEapEventUpdate_In = "ADMADS_SetEapEventUpdate_In";
        ...
        public static class FEapEvent
        {
            public const string E_EapEvent = "EapEvent";
