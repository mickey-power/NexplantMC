...
--
--  Program Id      : c_FADMADS_SetHostDriverDownload_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetHostDriverDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetHostDriverDownload_In = "ADMADS_SetHostDriverDownload_In";
