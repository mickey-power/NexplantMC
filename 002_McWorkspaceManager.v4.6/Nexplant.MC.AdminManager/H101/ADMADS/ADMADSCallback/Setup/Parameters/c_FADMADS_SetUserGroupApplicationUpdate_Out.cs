...
--
--  Program Id      : c_FADMADS_SetUserGroupApplicationUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetUserGroupApplicationUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserGroupApplicationUpdate_Out = "ADMADS_SetUserGroupApplicationUpdate_Out";
