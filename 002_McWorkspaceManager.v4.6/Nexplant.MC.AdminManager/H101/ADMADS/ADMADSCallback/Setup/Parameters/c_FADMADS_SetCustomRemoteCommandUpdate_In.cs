...
--
--  Program Id      : c_FADMADS_SetCustomRemoteCommandUpdate_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_SetCustomRemoteCommandUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetCustomRemoteCommandUpdate_In = "ADMADS_SetCustomRemoteCommandUpdate_In";
        ...
        public static class FCustomRemoteCommand
        {
            public const string E_CustomRemoteCommand = "CustomRemoteCommand";

            // --

            public const string A_Command = "Command";
            public const string A_Description = "Description";
            public const string A_DataPrompt = "DataPrompt";

            // --

            public const string D_Command = "";
            public const string D_Description = "";
            public const string D_DataPrompt = "";
        }
