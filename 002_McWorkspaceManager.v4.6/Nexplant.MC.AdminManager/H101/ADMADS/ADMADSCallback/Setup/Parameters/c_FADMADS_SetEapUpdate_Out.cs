...
--
--  Program Id      : c_FADMADS_SetEapUpdate_Out.cs
...
{
    internal static class FADMADS_SetEapUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEapUpdate_Out = "ADMADS_SetEapUpdate_Out";
