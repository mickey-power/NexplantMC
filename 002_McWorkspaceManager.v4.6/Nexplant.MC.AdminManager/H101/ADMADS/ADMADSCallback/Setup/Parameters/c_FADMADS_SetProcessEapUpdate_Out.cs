...
--
--  Program Id      : c_FADMADS_SetProcessEapUpdate_Out.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2015.08.05
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2015.08.05
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetProcessEapUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetProcessEapUpdate_Out = "ADMADS_SetProcessEapUpdate_Out";
