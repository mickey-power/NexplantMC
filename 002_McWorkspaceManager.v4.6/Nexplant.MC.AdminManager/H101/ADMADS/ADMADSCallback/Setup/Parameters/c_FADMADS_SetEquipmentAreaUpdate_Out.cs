...
--
--  Program Id      : c_FADMADS_SetEquipmentAreaUpdate_Out.cs
...
{
    internal static class FADMADS_SetEquipmentAreaUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEquipmentAreaUpdate_Out = "ADMADS_SetEquipmentAreaUpdate_Out";
