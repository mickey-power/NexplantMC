...
--
--  Program Id      : c_FADMADS_SetPackageVerDownload_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetPackageVerDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetPackageVerDownload_In = "ADMADS_SetPackageVerDownload_In";
