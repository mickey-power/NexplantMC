...
--
--  Program Id      : c_FADMADS_SetModelVerFileSearch_In.cs
--  Creator         : kitae
...
{
    internal static class FADMADS_SetModelVerFileSearch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelVerFileSearch_In = "ADMADS_SetModelVerFileSearch_In";
