...
--
--  Program Id      : c_FADMADS_SetEapEventUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetEapEventUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEapEventUpdate_Out = "ADMADS_SetEapEventUpdate_Out";
