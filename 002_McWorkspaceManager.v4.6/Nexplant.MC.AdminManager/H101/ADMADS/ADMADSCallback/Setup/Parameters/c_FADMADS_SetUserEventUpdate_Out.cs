...
--
--  Program Id      : c_FADMADS_SetUserEventUpdate_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_SetUserEventUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserEventUpdate_Out = "ADMADS_SetUserEventUpdate_Out";
