...
--
--  Program Id      : c_FADMADS_SetNoticeUpdate_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_SetNoticeUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetNoticeUpdate_Out = "ADMADS_SetNoticeUpdate_Out";
