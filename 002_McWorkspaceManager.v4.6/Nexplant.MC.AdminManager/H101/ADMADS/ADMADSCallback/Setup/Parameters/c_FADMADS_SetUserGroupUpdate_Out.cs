...
--
--  Program Id      : c_FADMADS_SetUserGroupUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetUserGroupUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserGroupUpdate_Out = "ADMADS_SetUserGroupUpdate_Out";
