...
--
--  Program Id      : c_FADMADS_SetServerUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetServerUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetServerUpdate_Out = "ADMADS_SetServerUpdate_Out";
