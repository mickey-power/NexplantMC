...
--
--  Program Id      : c_FADMADS_SetModelVerUpdate_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetModelVerUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelVerUpdate_In = "ADMADS_SetModelVerUpdate_In";
