...
--
--  Program Id      : c_FADMADS_SetEquipmentLineUpdate_Out.cs
...
{
    internal static class FADMADS_SetEquipmentLineUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEquipmentLineUpdate_Out = "ADMADS_SetEquipmentLineUpdate_Out";
