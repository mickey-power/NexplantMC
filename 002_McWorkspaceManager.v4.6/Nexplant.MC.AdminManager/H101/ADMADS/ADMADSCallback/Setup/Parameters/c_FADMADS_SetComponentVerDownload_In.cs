...
--
--  Program Id      : c_FADMADS_SetComponentVerDownload_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetComponentVerDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetComponentVerDownload_In = "ADMADS_SetComponentVerDownload_In";
