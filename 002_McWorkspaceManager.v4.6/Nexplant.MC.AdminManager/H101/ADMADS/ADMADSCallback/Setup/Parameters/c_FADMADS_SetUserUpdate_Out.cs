...
--
--  Program Id      : c_FADMADS_SetUserUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetUserUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserUpdate_Out = "ADMADS_SetUserUpdate_Out";
