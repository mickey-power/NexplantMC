...
--
--  Program Id      : c_FADMADS_SetModelFunctionNameListUpdate_In.cs
...
{
    internal static class FADMADS_SetModelFunctionNameListUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelFunctionNameListUpdate_In = "ADMADS_SetModelFunctionNameListUpdate_In";
        ...
        public static class FFunctionNameList
        {
            public const string E_FunctionNameList = "FunctionNameList";
