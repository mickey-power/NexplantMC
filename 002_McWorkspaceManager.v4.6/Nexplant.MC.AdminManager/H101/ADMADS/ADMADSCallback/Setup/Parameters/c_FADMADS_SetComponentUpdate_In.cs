...
--
--  Program Id      : c_FADMADS_SetComponentUpdate_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_SetComponentUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetComponentUpdate_In = "ADMADS_SetComponentUpdate_In";
