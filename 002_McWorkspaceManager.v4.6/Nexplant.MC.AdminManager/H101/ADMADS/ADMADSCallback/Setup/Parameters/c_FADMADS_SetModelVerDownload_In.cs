...
--
--  Program Id      : c_FADMADS_SetModelVerDownload_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetModelVerDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelVerDownload_In = "ADMADS_SetModelVerDownload_In";
