...
--
--  Program Id      : c_FADMADS_SetHostDriverUpdate_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetHostDriverUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetHostDriverUpdate_In = "ADMADS_SetHostDriverUpdate_In";
        ...
        public static class FHostDriver
        {
            public const string E_HostDriver = "HostDriver";

            // --

            public const string A_HostDriver = "HostDriver";
            public const string A_Description = "Description";
            public const string A_Comment = "Comment";
            public const string A_Path = "Path";
            public const string A_FileName = "FileName";
            public const string A_FileVersion = "FileVersion";

            // --

            public const string D_HostDriver = "";
            public const string D_Description = "";
            public const string D_Comment = "";
            public const string D_Path = "";
            public const string D_FileName = "";
