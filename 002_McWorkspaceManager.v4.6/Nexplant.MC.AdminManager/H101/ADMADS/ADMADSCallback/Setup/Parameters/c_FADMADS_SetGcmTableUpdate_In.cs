...
--
--  Program Id      : c_FADMADS_SetGcmTableUpdate_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.05.24
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.05.24
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetGcmTableUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetGcmTableUpdate_In = "ADMADS_SetGcmTableUpdate_In";
        ...
        public static class FGcmTable
        {
            public const string E_GcmTable = "GcmTable";

            // --

            public const string A_Table = "Table";
            public const string A_Description = "Description";
            public const string A_SystemTable = "SystemTable";

            // --

            public const string D_Table = "";
            public const string D_Description = "";
            public const string D_SystemTable = "";
            ...
            public static class FKey
            {
                ...
                public const string A_Prompt = "Prompt";
                public const string A_Format = "Format";
                public const string A_Size = "Size";

                // --

                public const string D_Prompt = "";
                public const string D_Format = "";
                public const string D_Size = "";
            }
            ...
            {
                public const string E_Data = "Data";
