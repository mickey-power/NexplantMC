...
--
--  Program Id      : c_FADMADS_SetMakerUpdate_Out.cs
--  Creator         : TJ.Kim
...
{
    internal static class FADMADS_SetMakerUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetMakerUpdate_Out = "ADMADS_SetMakerUpdate_Out";
