...
--
--  Program Id      : c_FADMADS_SetEquipmentLineUpdate_In.cs
...
{
    internal static class FADMADS_SetEquipmentLineUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetEquipmentLineUpdate_In = "ADMADS_SetEquipmentLineUpdate_In";
        ...
        public static class FEquipmentLine
        {
            public const string E_EquipmentLine = "EquipmentLine";
