...
--
--  Program Id      : c_FADMADS_SetGcmDataUpdate_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetGcmDataUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetGcmDataUpdate_In = "ADMADS_SetGcmDataUpdate_In";
        ...
        public static class FGcmData
        {
            public const string E_GcmData = "GcmData";
