...
--
--  Program Id      : c_FADMADS_SetUserGroupAlertUpdate_Out.cs
--  Creator         : TJ.Kim
...
{
    internal static class FADMADS_SetUserGroupAlertUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserGroupAlertUpdate_Out = "ADMADS_SetUserGroupAlertUpdate_Out";
