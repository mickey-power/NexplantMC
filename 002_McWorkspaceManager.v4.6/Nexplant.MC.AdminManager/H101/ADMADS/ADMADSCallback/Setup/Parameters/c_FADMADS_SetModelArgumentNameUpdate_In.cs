...
--
--  Program Id      : c_FADMADS_SetModelArgumentNameUpdate_In.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.12.10
--  Description     : <Generated Class File Description>
--  History         : Created by jungyoul.moon at 2013.12.10
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetModelArgumentNameUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelArgumentNameUpdate_In = "ADMADS_SetModelArgumentNameUpdate_In";
        ...
        public static class FArgument
        {
            public const string E_Argument = "Argument";

            // --

            public const string A_ModelType = "ModelType";
            public const string A_Argument = "Argument";
            public const string A_Description = "Description";
            public const string A_FunctionNameList = "FunctionNameList";
            ...
            public const string D_Argument = "";
            public const string D_Description = "";
            public const string D_FunctionNameList = "";
