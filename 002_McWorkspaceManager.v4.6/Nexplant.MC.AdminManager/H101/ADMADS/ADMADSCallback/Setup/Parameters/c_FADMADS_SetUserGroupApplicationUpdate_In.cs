...
--
--  Program Id      : c_FADMADS_SetUserGroupApplicationUpdate_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetUserGroupApplicationUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetUserGroupApplicationUpdate_In = "ADMADS_SetUserGroupApplicationUpdate_In";
        ...
        {
            public const string E_Application = "Application";
