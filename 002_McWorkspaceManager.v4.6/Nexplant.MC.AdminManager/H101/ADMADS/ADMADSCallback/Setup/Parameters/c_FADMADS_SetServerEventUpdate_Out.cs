...
--
--  Program Id      : c_FADMADS_SetServerEventUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetServerEventUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetServerEventUpdate_Out = "ADMADS_SetServerEventUpdate_Out";
