...
--
--  Program Id      : c_FADMADS_SetModelUpdate_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_SetModelUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelUpdate_In = "ADMADS_SetModelUpdate_In";
