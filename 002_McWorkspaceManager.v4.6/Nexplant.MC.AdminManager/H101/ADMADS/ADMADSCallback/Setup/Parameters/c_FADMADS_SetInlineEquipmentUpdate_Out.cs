...
--
--  Program Id      : c_FADMADS_SetInlineEquipmentUpdate_Out.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_SetInlineEquipmentUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetInlineEquipmentUpdate_Out = "ADMADS_SetInlineEquipmentUpdate_Out";
