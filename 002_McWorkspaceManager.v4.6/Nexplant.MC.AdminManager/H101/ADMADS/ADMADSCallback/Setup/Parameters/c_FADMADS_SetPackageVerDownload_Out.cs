...
--
--  Program Id      : c_FADMADS_SetPackageVerDownload_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetPackageVerDownload_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetPackageVerDownload_Out = "ADMADS_SetPackageVerDownload_Out";
