...
--
--  Program Id      : c_FADMADS_SetGcmTableUpdate_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_SetGcmTableUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetGcmTableUpdate_Out = "ADMADS_SetGcmTableUpdate_Out";
