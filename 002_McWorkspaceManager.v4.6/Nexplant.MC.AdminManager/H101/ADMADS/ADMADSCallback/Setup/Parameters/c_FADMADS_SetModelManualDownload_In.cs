...
--
--  Program Id      : c_FADMADS_SetModelManualDownload_In.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2014.01.21
--  Description     : <Generated Class File Description>
--  History         : Created by jungyoul.moon at 2014.01.21
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetModelManualDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelManualDownload_In = "ADMADS_SetModelManualDownload_In";
        ...
        public static class FManual
        {
            public const string E_Manual = "Manual";

            // --

            public const string A_Model = "Model";
            public const string A_ManualType = "ManualType";
            public const string A_ManualName = "ManualName";

            // --

            public const string D_Model = "";
            public const string D_ManualType = "";
            public const string D_ManualName = "";
        }
