...
--
--  Program Id      : c_FADMADS_SetModelStateUpdate_In.cs
--  Creator         : TJ.Kim
--  Create Date     : 2013.05.15
--  Description     : <Generated Class File Description>
--  History         : Created by TJ.Kim at 2013.05.15
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetModelStateUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelStateUpdate_In = "ADMADS_SetModelStateUpdate_In";
        ...
        {
            public const string E_State = "State";

            // --

            public const string A_Model = "Model";
            public const string A_State = "State";
            public const string A_PriState = "PriState";
            public const string A_Default = "Default";

            // --

            public const string D_Model = "";
            public const string D_State = "";
            public const string D_PriState = "";
            public const string D_Default = "";
        }
