...
--
--  Program Id      : c_FADMADS_SetModelVerFileSearch_Out.cs
--  Creator         : kitae
--  Create Date     : 2012.04.09
--  Description     : Generation File Description
--  History         : Created by kitae at 2012.04.09
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_SetModelVerFileSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetModelVerFileSearch_Out = "ADMADS_SetModelVerFileSearch_Out";
