...
--
--  Program Id      : c_FADMADS_RcmRemotePingTest_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_RcmRemotePingTest_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_RcmRemotePingTest_Out = "ADMADS_RcmRemotePingTest_Out";
