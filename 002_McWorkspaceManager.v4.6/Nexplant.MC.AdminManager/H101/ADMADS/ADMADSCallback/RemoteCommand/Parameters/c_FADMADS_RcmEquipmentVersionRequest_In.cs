...
--
--  Program Id      : c_FADMADS_RcmEquipmentVersionRequest_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_RcmEquipmentVersionRequest_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_RcmEquipmentVersionRequest_In = "ADMADS_RcmEquipmentVersionRequest_In";
