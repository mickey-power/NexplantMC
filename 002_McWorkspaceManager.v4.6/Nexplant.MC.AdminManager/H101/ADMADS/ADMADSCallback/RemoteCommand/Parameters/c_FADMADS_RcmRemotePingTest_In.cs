...
--
--  Program Id      : c_FADMADS_RcmRemotePingTest_In.cs
--  Creator         : hsshim
--  Create Date     : 2013.04.10
--  Description     :  <Generated Class File Description>
--  History         : Created by hsshim at 2013.04.10
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_RcmRemotePingTest_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_RcmRemotePingTest_In = "ADMADS_RcmRemotePingTest_In";
        ...
        public static class FServerData
        {
            public const string E_ServerData = "ServerData";

            // --

            public const string A_ServerName = "ServerName";
            public const string A_RemoteIp = "RemoteIp";

            // --

            public const string D_ServerName = "";
