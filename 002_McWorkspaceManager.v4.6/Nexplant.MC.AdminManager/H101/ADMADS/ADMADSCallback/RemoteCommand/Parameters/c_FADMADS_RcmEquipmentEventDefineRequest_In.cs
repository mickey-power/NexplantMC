...
--
--  Program Id      : c_FADMADS_RcmEquipmentEventDefineRequest_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_RcmEquipmentEventDefineRequest_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_RcmEquipmentEventDefineRequest_In = "ADMADS_RcmEquipmentEventDefineRequest_In";
