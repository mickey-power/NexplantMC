...
--
--  Program Id      : c_FADMADS_RcmEquipmentControlModeRequest_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_RcmEquipmentControlModeRequest_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_RcmEquipmentControlModeRequest_In = "ADMADS_RcmEquipmentControlModeRequest_In";
