...
--
--  Program Id      : c_FADMADS_RcmEquipmentCustomRequest_Out.cs
...
{
    internal static class FADMADS_RcmEquipmentCustomRequest_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_RcmEquipmentCustomRequest_Out = "ADMADS_RcmEquipmentCustomRequest_Out";
