...
--
--  Program Id      : c_FADMADS_ComSqlQuery_Out.cs
--  Creator         : spike.lee
--  Create Date     : 2012.06.28
--  Description     : <Generated Class File Description>
--  History         : Created by spike.lee at 2012.06.28
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_ComSqlQuery_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_ComSqlQuery_Out = "ADMADS_ComSqlQuery_Out";
