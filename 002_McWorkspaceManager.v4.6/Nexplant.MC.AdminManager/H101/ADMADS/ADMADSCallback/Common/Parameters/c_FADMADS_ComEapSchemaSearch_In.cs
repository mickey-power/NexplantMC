...
--
--  Program Id      : c_FADMADS_ComEapSchemaSearch_In.cs
...
{
    internal static class FADMADS_ComEapSchemaSearch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_ComEapSchemaSearch_In = "ADMADS_ComEapSchemaSearch_In";
        ...
        public static class FEap
        {
            ...
            public const string A_Category = "Category";

            // --

            public const string D_Name = "";
            public const string D_Category = "";
        }
