...
--
--  Program Id      : c_FADMADS_TrnServerBackupSwitch_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnServerBackupSwitch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnServerBackupSwitch_Out = "ADMADS_TrnServerBackupSwitch_Out";
