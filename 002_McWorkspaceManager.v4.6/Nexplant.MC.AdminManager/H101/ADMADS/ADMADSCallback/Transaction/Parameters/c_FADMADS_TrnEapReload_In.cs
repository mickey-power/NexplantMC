...
--
--  Program Id      : c_FADMADS_TrnEapReload_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TrnEapReload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapReload_In = "ADMADS_TrnEapReload_In";
