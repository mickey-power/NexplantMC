...
--
--  Program Id      : c_FADMADS_TrnEapRepositoryClear_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.06.08
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.06.08
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TrnEapRepositoryClear_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapRepositoryClear_In = "ADMADS_TrnEapRepositoryClear_In";
        ...
        public static class FEap
        {
            ...
            public static class FRepository
            {
                public const string E_Repository = "Repository";

                // --

                public const string A_RawData = "RawData";

                // --

                public const string D_RawData = "";
            }
        }
