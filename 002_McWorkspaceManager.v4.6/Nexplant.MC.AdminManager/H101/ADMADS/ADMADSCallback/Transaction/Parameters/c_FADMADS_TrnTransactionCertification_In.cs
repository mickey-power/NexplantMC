...
--
--  Program Id      : c_FADMADS_TrnTransactionCertification_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2015.10.27
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2015.10.27
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TrnTransactionCertification_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnTransactionCertification_In = "ADMADS_TrnTransactionCertification_In";
        ...
        public static class FUser
        {
            ...
            public const string A_Password = "Password";

            // --

            public const string D_Password = "";
        }
