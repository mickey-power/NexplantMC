...
--
--  Program Id      : c_FADMADS_TrnServerMainSwitch_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnServerMainSwitch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnServerMainSwitch_Out = "ADMADS_TrnServerMainSwitch_Out";
