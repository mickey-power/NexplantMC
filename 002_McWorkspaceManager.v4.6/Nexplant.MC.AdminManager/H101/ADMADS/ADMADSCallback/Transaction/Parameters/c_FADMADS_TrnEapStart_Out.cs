...
--
--  Program Id      : c_FADMADS_TrnEapStart_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapStart_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapStart_Out = "ADMADS_TrnEapStart_Out";
