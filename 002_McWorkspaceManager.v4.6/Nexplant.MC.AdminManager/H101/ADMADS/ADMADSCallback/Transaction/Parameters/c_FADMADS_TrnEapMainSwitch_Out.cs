...
--
--  Program Id      : c_FADMADS_TrnEapMainSwitch_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapMainSwitch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapMainSwitch_Out = "ADMADS_TrnEapMainSwitch_Out";
