...
--
--  Program Id      : c_FADMADS_TrnServerMainSwitch_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnServerMainSwitch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnServerMainSwitch_In = "ADMADS_TrnServerMainSwitch_In";
