...
--
--  Program Id      : c_FADMADS_TrnEapReload_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TrnEapReload_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapReload_Out = "ADMADS_TrnEapReload_Out";
