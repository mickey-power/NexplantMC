...
--
--  Program Id      : c_FADMADS_TrnEapBackupSwitch_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapBackupSwitch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapBackupSwitch_Out = "ADMADS_TrnEapBackupSwitch_Out";
