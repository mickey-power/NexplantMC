...
--
--  Program Id      : c_FADMADS_TrnEapBatchModification_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapBatchModification_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapBatchModification_In = "ADMADS_TrnEapBatchModification_In";
