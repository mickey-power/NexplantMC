...
--
--  Program Id      : c_FADMADS_TrnEapLogLevelSetup_Out.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.07.05
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.07.05
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TrnEapLogLevelSetup_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapLogLevelSetup_Out = "ADMADS_TrnEapLogLevelSetup_Out";
