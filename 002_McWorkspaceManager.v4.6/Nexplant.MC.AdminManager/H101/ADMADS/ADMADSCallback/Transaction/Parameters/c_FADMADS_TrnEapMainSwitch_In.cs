...
--
--  Program Id      : c_FADMADS_TrnEapMainSwitch_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapMainSwitch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapMainSwitch_In = "ADMADS_TrnEapMainSwitch_In";
