...
--
--  Program Id      : c_FADMADS_TrnEapAbort_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapAbort_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapAbort_Out = "ADMADS_TrnEapAbort_Out";
