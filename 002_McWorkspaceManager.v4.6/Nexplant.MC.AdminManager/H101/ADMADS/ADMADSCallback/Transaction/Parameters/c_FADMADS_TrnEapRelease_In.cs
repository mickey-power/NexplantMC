...
--
--  Program Id      : c_FADMADS_TrnEapRelease_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapRelease_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapRelease_In = "ADMADS_TrnEapRelease_In";
