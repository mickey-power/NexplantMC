...
--
--  Program Id      : c_FADMADS_TrnTransactionCertification_Out.cs
...
{
    internal static class FADMADS_TrnTransactionCertification_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnTransactionCertification_Out = "ADMADS_TrnTransactionCertification_Out";
