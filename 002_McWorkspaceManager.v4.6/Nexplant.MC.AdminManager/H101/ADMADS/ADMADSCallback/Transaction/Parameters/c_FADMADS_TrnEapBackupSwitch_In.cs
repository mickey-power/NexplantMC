...
--
--  Program Id      : c_FADMADS_TrnEapBackupSwitch_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapBackupSwitch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapBackupSwitch_In = "ADMADS_TrnEapBackupSwitch_In";
