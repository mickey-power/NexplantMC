...
--
--  Program Id      : c_FADMADS_TrnEapRestart_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapRestart_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapRestart_In = "ADMADS_TrnEapRestart_In";
