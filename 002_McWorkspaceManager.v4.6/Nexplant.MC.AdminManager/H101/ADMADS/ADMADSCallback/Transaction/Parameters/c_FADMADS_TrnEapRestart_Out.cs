...
--
--  Program Id      : c_FADMADS_TrnEapRestart_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapRestart_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapRestart_Out = "ADMADS_TrnEapRestart_Out";
