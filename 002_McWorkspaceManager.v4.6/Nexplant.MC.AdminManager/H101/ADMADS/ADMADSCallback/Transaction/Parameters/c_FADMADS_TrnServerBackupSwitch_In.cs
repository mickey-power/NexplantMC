...
--
--  Program Id      : c_FADMADS_TrnServerBackupSwitch_In.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnServerBackupSwitch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnServerBackupSwitch_In = "ADMADS_TrnServerBackupSwitch_In";
