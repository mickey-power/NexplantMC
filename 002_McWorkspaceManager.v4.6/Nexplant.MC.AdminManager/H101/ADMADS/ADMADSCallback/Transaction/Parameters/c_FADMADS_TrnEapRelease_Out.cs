...
--
--  Program Id      : c_FADMADS_TrnEapRelease_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapRelease_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapRelease_Out = "ADMADS_TrnEapRelease_Out";
