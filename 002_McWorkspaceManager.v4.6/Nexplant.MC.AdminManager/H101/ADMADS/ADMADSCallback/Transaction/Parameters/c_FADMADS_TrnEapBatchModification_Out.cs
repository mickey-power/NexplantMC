...
--
--  Program Id      : c_FADMADS_TrnEapBatchModification_Out.cs
--  Creator         : hsshim
...
{
    internal static class FADMADS_TrnEapBatchModification_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TrnEapBatchModification_Out = "ADMADS_TrnEapBatchModification_Out";
