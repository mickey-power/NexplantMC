...
--
--  Program Id      : c_FADMADS_InqModelManualDownload_In.cs
--  Creator         : mjkim
--  Create Date     : 2014.03.24
--  Description     : <Generated Class File Description>
--  History         : Created by mjkim at 2014.03.24
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_InqModelManualDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_InqModelManualDownload_In = "ADMADS_InqModelManualDownload_In";
