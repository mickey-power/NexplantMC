...
--
--  Program Id      : c_FADMADS_InqEquipmentGemStatus_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_InqEquipmentGemStatus_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_InqEquipmentGemStatus_In = "ADMADS_InqEquipmentGemStatus_In";
