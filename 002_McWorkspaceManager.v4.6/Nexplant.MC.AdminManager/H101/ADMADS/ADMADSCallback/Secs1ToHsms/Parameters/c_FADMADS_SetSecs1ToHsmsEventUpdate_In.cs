...
--
--  Program Id      : c_FADMADS_SetSecs1ToHsmsEventUpdate_In.cs
...
{
    internal static class FADMADS_SetSecs1ToHsmsEventUpdate_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_SetSecs1ToHsmsEventUpdate_In = "ADMADS_SetSecs1ToHsmsEventUpdate_In";
        ...
        public static class FSecs1ToHsmsEvent
        {
            public const string E_Secs1ToHsmsEvent = "Secs1ToHsmsEvent";
