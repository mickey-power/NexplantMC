...
--
--  Program Id      : c_FADMADS_TolSecs1ToHsmsConverterBackupLogDownload_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.05.12
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.05.12
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TolSecs1ToHsmsConverterBackupLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolSecs1ToHsmsConverterBackupLogDownload_In = "ADMADS_TolSecs1ToHsmsConverterBackupLogDownload_In";
