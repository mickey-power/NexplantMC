...
{
    internal static class FADMADS_DlgEapWizardEapSchemaSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_DlgEapWizardEapSchemaSearch_Out = "ADMADS_DlgEapWizardEapSchemaSearch_Out";
        ...
        public static class FSchema
        {
            ...
            public static class FSecsDriver
            {
                ...
                public static class FSecsDevice
                {
                    ...
                    public const string A_OpcProgId = "ProgId";
                    ...
                    public const string D_OpcProgId = "";
