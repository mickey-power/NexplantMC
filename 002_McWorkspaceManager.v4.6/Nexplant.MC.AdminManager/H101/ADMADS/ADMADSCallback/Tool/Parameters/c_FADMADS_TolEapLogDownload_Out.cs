...
--
--  Program Id      : c_FADMADS_TolEapLogDownload_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolEapLogDownload_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapLogDownload_Out = "ADMADS_TolEapLogDownload_Out";
