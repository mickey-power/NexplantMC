...
--
--  Program Id      : c_FADMADS_TolPackageDataPush_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_TolPackageDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolPackageDataPush_In = "ADMADS_TolPackageDataPush_In";
