...
--
--  Program Id      : c_FADMADS_TolModelDataPush_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_TolModelDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolModelDataPush_In = "ADMADS_TolModelDataPush_In";
