...
--
--  Program Id      : c_FADMADS_TolAlertServiceBackupLogList_In.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceBackupLogList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceBackupLogList_In = "ADMADS_TolAlertServiceBackupLogList_In";
