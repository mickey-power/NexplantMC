...
--
--  Program Id      : c_FADMADS_TolAdminAgentBackupLogList_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolAdminAgentBackupLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentBackupLogList_Out = "ADMADS_TolAdminAgentBackupLogList_Out";
