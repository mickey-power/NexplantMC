...
--
--  Program Id      : c_FADMADS_TolEapBackupLogDownload_In.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolEapBackupLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapBackupLogDownload_In = "ADMADS_TolEapBackupLogDownload_In";
