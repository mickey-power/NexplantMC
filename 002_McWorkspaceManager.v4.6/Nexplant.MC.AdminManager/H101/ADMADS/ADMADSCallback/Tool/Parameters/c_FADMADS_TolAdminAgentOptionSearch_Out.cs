...
--
--  Program Id      : c_FADMADS_TolAdminAgentOptionSearch_Out.cs
...
{
    internal static class FADMADS_TolAdminAgentOptionSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentOptionSearch_Out = "ADMADS_TolAdminAgentOptionSearch_Out";
