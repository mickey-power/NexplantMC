...
--
--  Program Id      : c_FADMADS_TolAdminAgentBackupLogDownload_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolAdminAgentBackupLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentBackupLogDownload_In = "ADMADS_TolAdminAgentBackupLogDownload_In";
