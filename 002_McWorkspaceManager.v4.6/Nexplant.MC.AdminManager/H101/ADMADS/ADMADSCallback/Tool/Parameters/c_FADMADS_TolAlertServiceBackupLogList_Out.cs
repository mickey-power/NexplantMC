...
--
--  Program Id      : c_FADMADS_TolAlertServiceBackupLogList_Out.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceBackupLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceBackupLogList_Out = "ADMADS_TolAlertServiceBackupLogList_Out";
