...
--
--  Program Id      : c_FADMADS_TolEapBackupLogSearch_In.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolEapBackupLogSearch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapBackupLogSearch_In = "ADMADS_TolEapBackupLogSearch_In";
