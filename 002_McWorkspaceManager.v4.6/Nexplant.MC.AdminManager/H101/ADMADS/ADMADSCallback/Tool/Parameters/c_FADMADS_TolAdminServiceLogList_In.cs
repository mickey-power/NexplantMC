...
--
--  Program Id      : c_FADMADS_TolAdminServiceLogList_In.cs
--  Creator         : baehyun seo
...
{
    internal static class FADMADS_TolAdminServiceLogList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceLogList_In = "ADMADS_TolAdminServiceLogList_In";
