...
--
--  Program Id      : c_FADMADS_TolEapModelDownload_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolEapModelDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapModelDownload_In = "ADMADS_TolEapModelDownload_In";
