...
--
--  Program Id      : c_FADMADS_TolAdminServiceLogList_Out.cs
--  Creator         : baehyun seo
...
{
    internal static class FADMADS_TolAdminServiceLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceLogList_Out = "ADMADS_TolAdminServiceLogList_Out";
