...
--
--  Program Id      : c_FADMADS_TolEquipmentIssueEventRefresh_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.07.14
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.07.14
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TolEquipmentIssueEventRefresh_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEquipmentIssueEventRefresh_In = "ADMADS_TolEquipmentIssueEventRefresh_In";
