...
--
--  Program Id      : c_FADMADS_TolPackageVerDataPush_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_TolPackageVerDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolPackageVerDataPush_In = "ADMADS_TolPackageVerDataPush_In";
        ...
        public static class FPackageVer
        {
            public const string E_PackageVer = "PackageVer";
