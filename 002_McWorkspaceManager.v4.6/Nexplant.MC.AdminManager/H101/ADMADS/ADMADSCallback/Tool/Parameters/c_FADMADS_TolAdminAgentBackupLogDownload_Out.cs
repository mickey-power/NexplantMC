...
--
--  Program Id      : c_FADMADS_TolAdminAgentBackupLogDownload_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolAdminAgentBackupLogDownload_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentBackupLogDownload_Out = "ADMADS_TolAdminAgentBackupLogDownload_Out";
