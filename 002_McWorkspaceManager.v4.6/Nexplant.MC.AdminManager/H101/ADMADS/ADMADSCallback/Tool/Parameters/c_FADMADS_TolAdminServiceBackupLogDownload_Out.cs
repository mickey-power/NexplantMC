...
--
--  Program Id      : c_FADMADS_TolAdminServiceBackupLogDownload_Out.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolAdminServiceBackupLogDownload_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceBackupLogDownload_Out = "ADMADS_TolAdminServiceBackupLogDownload_Out";
