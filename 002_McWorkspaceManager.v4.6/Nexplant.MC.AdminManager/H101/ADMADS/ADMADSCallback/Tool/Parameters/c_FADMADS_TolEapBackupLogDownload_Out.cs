...
--
--  Program Id      : c_FADMADS_TolEapBackupLogDownload_Out.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolEapBackupLogDownload_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapBackupLogDownload_Out = "ADMADS_TolEapBackupLogDownload_Out";
