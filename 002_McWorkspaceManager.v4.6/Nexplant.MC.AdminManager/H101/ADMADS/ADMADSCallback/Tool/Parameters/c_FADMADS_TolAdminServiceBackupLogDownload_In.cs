...
--
--  Program Id      : c_FADMADS_TolAdminServiceBackupLogDownload_In.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolAdminServiceBackupLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceBackupLogDownload_In = "ADMADS_TolAdminServiceBackupLogDownload_In";
