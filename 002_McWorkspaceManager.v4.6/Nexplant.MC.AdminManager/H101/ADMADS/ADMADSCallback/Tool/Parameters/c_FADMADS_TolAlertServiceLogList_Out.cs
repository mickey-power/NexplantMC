...
--
--  Program Id      : c_FADMADS_TolAlertServiceLogList_Out.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceLogList_Out = "ADMADS_TolAlertServiceLogList_Out";
