...
--
--  Program Id      : c_FADMADS_TolAdminServiceBackupLogSearch_Out.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolAdminServiceBackupLogSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceBackupLogSearch_Out = "ADMADS_TolAdminServiceBackupLogSearch_Out";
