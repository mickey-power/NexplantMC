...
--
--  Program Id      : c_FADMADS_TolModelVerDataPush_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_TolModelVerDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolModelVerDataPush_In = "ADMADS_TolModelVerDataPush_In";
        ...
        public static class FModelVer
        {
            public const string E_ModelVer = "ModelVer";
