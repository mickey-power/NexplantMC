...
--
--  Program Id      : c_FADMADS_TolAdminAgentBackupLogList_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolAdminAgentBackupLogList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentBackupLogList_In = "ADMADS_TolAdminAgentBackupLogList_In";
