...
--
--  Program Id      : c_FADMADS_TolEapLogDownload_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolEapLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapLogDownload_In = "ADMADS_TolEapLogDownload_In";
