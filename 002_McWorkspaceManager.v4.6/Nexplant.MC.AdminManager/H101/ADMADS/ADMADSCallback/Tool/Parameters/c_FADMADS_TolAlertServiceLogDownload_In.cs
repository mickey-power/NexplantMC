...
--
--  Program Id      : c_FADMADS_TolAlertServiceLogDownload_In.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceLogDownload_In = "ADMADS_TolAlertServiceLogDownload_In";
