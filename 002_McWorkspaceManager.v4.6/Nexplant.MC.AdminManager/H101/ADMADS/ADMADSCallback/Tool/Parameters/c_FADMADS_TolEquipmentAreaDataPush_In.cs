...
--
--  Program Id      : c_FADMADS_TolEquipmentAreaDataPush_In.cs
...
{
    internal static class FADMADS_TolEquipmentAreaDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEquipmentAreaDataPush_In = "ADMADS_TolEquipmentAreaDataPush_In";
        ...
        public static class FEquipmentArea
        {
            public const string E_EquipmentArea = "EquipmentArea";
