...
--
--  Program Id      : c_FADMADS_TolAdminAgentBackupLogSearch_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolAdminAgentBackupLogSearch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentBackupLogSearch_In = "ADMADS_TolAdminAgentBackupLogSearch_In";
