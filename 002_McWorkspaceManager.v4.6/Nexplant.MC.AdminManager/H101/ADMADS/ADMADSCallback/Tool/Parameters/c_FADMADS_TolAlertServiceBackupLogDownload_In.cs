...
--
--  Program Id      : c_FADMADS_TolAlertServiceBackupLogDownload_In.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceBackupLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceBackupLogDownload_In = "ADMADS_TolAlertServiceBackupLogDownload_In";
