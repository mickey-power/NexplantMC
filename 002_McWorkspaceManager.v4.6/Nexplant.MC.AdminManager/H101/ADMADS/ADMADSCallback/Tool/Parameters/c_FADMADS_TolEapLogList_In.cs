...
--
--  Program Id      : c_FADMADS_TolEapLogList_In.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolEapLogList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapLogList_In = "ADMADS_TolEapLogList_In";
