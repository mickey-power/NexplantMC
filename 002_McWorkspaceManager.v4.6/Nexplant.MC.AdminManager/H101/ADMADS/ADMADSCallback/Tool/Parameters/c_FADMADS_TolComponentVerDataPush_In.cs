...
--
--  Program Id      : c_FADMADS_TolComponentVerDataPush_In.cs
--  Creator         : spike.lee
...
{
    internal static class FADMADS_TolComponentVerDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolComponentVerDataPush_In = "ADMADS_TolComponentVerDataPush_In";
        ...
        public static class FComponentVer
        {
            public const string E_ComponentVer = "ComponentVer";
