...
--
--  Program Id      : c_FADMADS_TolAdminAgentLogDownload_In.cs
--  Creator         : baehyun seo
...
{
    internal static class FADMADS_TolAdminAgentLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentLogDownload_In = "ADMADS_TolAdminAgentLogDownload_In";
