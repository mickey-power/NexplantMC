...
--
--  Program Id      : c_FADMADS_TolEapBackupLogList_Out.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolEapBackupLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapBackupLogList_Out = "ADMADS_TolEapBackupLogList_Out";
