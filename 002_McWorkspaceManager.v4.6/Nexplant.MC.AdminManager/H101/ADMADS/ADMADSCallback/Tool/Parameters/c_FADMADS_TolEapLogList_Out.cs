...
--
--  Program Id      : c_FADMADS_TolEapLogList_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolEapLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapLogList_Out = "ADMADS_TolEapLogList_Out";
