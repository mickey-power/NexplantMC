...
--
--  Program Id      : c_FADMADS_TolAlertServiceBackupLogSearch_In.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceBackupLogSearch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceBackupLogSearch_In = "ADMADS_TolAlertServiceBackupLogSearch_In";
