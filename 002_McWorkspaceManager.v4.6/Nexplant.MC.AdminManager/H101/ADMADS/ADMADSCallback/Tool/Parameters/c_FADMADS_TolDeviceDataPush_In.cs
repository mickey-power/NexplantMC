...
--
--  Program Id      : c_FADMADS_TolDeviceDataPush_In.cs
...
{
    internal static class FADMADS_TolDeviceDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolDeviceDataPush_In = "ADMADS_TolDeviceDataPush_In";
        ...
        {
            public const string E_Device = "Device";
            ...
            public const string A_DeviceType = "DeviceType";
            ...
            public const string D_DeviceType = "";
        }
