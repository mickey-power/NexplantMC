...
--
--  Program Id      : c_FADMADS_TolAdminServiceLogDownload_In.cs
--  Creator         : baehyun seo
...
{
    internal static class FADMADS_TolAdminServiceLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceLogDownload_In = "ADMADS_TolAdminServiceLogDownload_In";
