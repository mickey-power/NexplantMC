...
--
--  Program Id      : c_FADMADS_TolAdminAgentLogList_Out.cs
--  Creator         : baehyun seo
...
{
    internal static class FADMADS_TolAdminAgentLogList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentLogList_Out = "ADMADS_TolAdminAgentLogList_Out";
