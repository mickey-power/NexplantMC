...
--
--  Program Id      : c_FADMADS_TolAdminServiceBackupLogContinue_In.cs
--  Creator         : <Generated Class File Creator>
--  Create Date     : 2017.05.23
--  Description     : <Generated Class File Description>
--  History         : Created by <Generated Class File Creator> at 2017.05.23
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TolAdminServiceBackupLogContinue_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminServiceBackupLogContinue_In = "ADMADS_TolAdminServiceBackupLogContinue_In";
