...
--
--  Program Id      : c_FADMADS_TolAlertServiceLogList_In.cs
--  Creator         : iskim
...
{
    internal static class FADMADS_TolAlertServiceLogList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAlertServiceLogList_In = "ADMADS_TolAlertServiceLogList_In";
