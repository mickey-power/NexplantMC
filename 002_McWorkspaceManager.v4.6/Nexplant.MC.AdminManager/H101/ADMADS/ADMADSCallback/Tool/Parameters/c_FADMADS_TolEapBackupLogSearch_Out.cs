...
--
--  Program Id      : c_FADMADS_TolEapBackupLogSearch_Out.cs
--  Creator         : baehyun.seo
...
{
    internal static class FADMADS_TolEapBackupLogSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolEapBackupLogSearch_Out = "ADMADS_TolEapBackupLogSearch_Out";
