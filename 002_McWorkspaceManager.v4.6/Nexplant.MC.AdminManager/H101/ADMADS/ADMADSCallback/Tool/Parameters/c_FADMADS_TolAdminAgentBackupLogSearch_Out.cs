...
--
--  Program Id      : c_FADMADS_TolAdminAgentBackupLogSearch_Out.cs
--  Creator         : mjkim
...
{
    internal static class FADMADS_TolAdminAgentBackupLogSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolAdminAgentBackupLogSearch_Out = "ADMADS_TolAdminAgentBackupLogSearch_Out";
