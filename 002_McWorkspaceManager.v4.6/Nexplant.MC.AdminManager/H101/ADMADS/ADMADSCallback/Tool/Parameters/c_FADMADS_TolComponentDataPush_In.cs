...
--
--  Program Id      : c_FADMADS_TolComponentDataPush_In.cs
--  Creator         : spike.lee
--  Create Date     : 2017.08.17
--  Description     : <Generated Class File Description>
--  History         : Created by spike.lee at 2017.08.17
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FADMADS_TolComponentDataPush_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_ADMADS_TolComponentDataPush_In = "ADMADS_TolComponentDataPush_In";
        ...
        public static class FComponent
        {
            public const string E_Component = "Component";
