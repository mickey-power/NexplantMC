...
{
    public partial class FEapStart : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FITransaction
    {
            ...
            )
        {
            ...
            try
            {
                fEapSelector = new FEapClassSelector(m_fAdmCore, FEapAttrCategory.Released, FEapType.Process.ToString());
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TrnEapStart_In.E_ADMADS_TrnEapStart_In);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStart_In.A_hLanguage, FADMADS_TrnEapStart_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStart_In.A_hStep, FADMADS_TrnEapStart_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStart_In.A_hFactory, FADMADS_TrnEapStart_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStart_In.A_hUserId, FADMADS_TrnEapStart_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStart_In.A_hHostIp, FADMADS_TrnEapStart_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStart_In.A_hHostName, FADMADS_TrnEapStart_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_TrnEapStart_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_TrnEapStart_In.FEap.A_Name, 
                            FADMADS_TrnEapStart_In.FEap.D_Name, 
                            eap
                            );
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_TrnEapStart_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );
                            // --
                            if (fXmlNodeOut.get_elemVal(FADMADS_TrnEapStart_Out.A_hStatus, FADMADS_TrnEapStart_Out.D_hStatus) != "0")
                            {
                                grdList.Rows[r.Index].Cells["EAP"].Appearance.Image = getImageOfEap("Fail");
                                result = this.fUIWizard.searchCaption("Fail");
                                msg = fXmlNodeOut.get_elemVal(FADMADS_TrnEapStart_Out.A_hStatusMessage, FADMADS_TrnEapStart_Out.D_hStatusMessage);
                                fCnt++;
                            }
                            else
                            {
        ...
        #region FEapStart Form Event Handler

        private void FEapStart_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.EapStart);
        ...
        private void FEapStart_FormClosing(
            object sender, 
