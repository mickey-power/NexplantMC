...
--
--  Program Id      : f_FEapRestart.cs
--  Creator         : mjkim
--  Create Date     : 2012.05.04
--  Description     : FAMate Admin Manager Transaction - EAP Restart Form Class 
...
{
    public partial class FEapRestart : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FITransaction
    {
            ...
            )
        {
            ...
            try
            {
                ...
                btnRestart.Enabled = m_tranEnabled;
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TrnEapRestart_In.E_ADMADS_TrnEapRestart_In);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRestart_In.A_hLanguage, FADMADS_TrnEapRestart_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRestart_In.A_hStep, FADMADS_TrnEapRestart_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRestart_In.A_hFactory, FADMADS_TrnEapRestart_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRestart_In.A_hUserId, FADMADS_TrnEapRestart_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRestart_In.A_hHostIp, FADMADS_TrnEapRestart_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRestart_In.A_hHostName, FADMADS_TrnEapRestart_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_TrnEapRestart_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_TrnEapRestart_In.FEap.A_Name, 
                            FADMADS_TrnEapRestart_In.FEap.D_Name, 
                            eap
                            );
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_TrnEapRestart_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );

                            if (fXmlNodeOut.get_elemVal(FADMADS_TrnEapRestart_Out.A_hStatus, FADMADS_TrnEapRestart_Out.D_hStatus) != "0")
                            {
                                grdList.Rows[r.Index].Cells["EAP"].Appearance.Image = getImageOfEap("Fail");
                                result = this.fUIWizard.searchCaption("Fail");
                                msg = fXmlNodeOut.get_elemVal(FADMADS_TrnEapRestart_Out.A_hStatusMessage, FADMADS_TrnEapRestart_Out.D_hStatusMessage);
                                fCnt++;
                            }
                            else
                            {
        ...
        #region FEapRestart Form Event Handler

        private void FEapRestart_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.EapRestart);
        ...
        private void FEapRestart_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FEapRestart_FormClosing(
            object sender, 
        ...
        #region btnRestart Control Event Handler
            ...
            )
        {
            ...
            try
            {
                ...
                fPrgDialog = new FTransactionProgress(
                    m_fAdmCore,
                    this,
                    this.fUIWizard.generateMessage("M0010", new object[] { "Restart" })
                    );
