...
--
--  Program Id      : f_FEapStop.cs
--  Creator         : mjkim
--  Create Date     : 2012.05.04
--  Description     : FAMate Admin Manager Transaction - EAP Stop Form Class 
...
{
    public partial class FEapStop : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FITransaction
    {
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TrnEapStop_In.E_ADMADS_TrnEapStop_In);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStop_In.A_hLanguage, FADMADS_TrnEapStop_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStop_In.A_hStep, FADMADS_TrnEapStop_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStop_In.A_hFactory, FADMADS_TrnEapStop_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStop_In.A_hUserId, FADMADS_TrnEapStop_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStop_In.A_hHostIp, FADMADS_TrnEapStop_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapStop_In.A_hHostName, FADMADS_TrnEapStop_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_TrnEapStop_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_TrnEapStop_In.FEap.A_Name, 
                            FADMADS_TrnEapStop_In.FEap.D_Name, 
                            eap
                            );
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_TrnEapStop_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );
                            // --
                            if (fXmlNodeOut.get_elemVal(FADMADS_TrnEapStop_Out.A_hStatus, FADMADS_TrnEapStop_Out.D_hStatus) != "0")
                            {
                                grdList.Rows[r.Index].Cells["EAP"].Appearance.Image = getImageOfEap("Fail");
                                result = this.fUIWizard.searchCaption("Fail");
                                msg = fXmlNodeOut.get_elemVal(FADMADS_TrnEapStop_Out.A_hStatusMessage, FADMADS_TrnEapStop_Out.D_hStatusMessage);
                                fCnt++;
                            }
                            else
                            {
        ...
        #region FEapStop Form Event Handler

        private void FEapStop_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.EapStop);
        ...
        private void FEapStop_FormClosing(
            object sender, 
            ...
            )
        {
            ...
            try
            {
                ...
                fPrgDialog = new FTransactionProgress(
                    m_fAdmCore,
                    this,
                    this.fUIWizard.generateMessage("M0010", new object[] { "Stop" })
                    );
