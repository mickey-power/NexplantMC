...
--
--  Program Id      : f_FEapReload.cs
--  Creator         : mjkim
--  Create Date     : 2013.06.13
--  Description     : FAMate Admin Manager Transaction - EAP Reload Form Class 
--  History         : Created by mjkim at 2013.06.13
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FEapReload : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FITransaction
    {
            ...
            )
        {
            ...
            try
            {
                ...
                btnReload.Enabled = m_tranEnabled;
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TrnEapReload_In.E_ADMADS_TrnEapReload_In);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapReload_In.A_hLanguage, FADMADS_TrnEapReload_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapReload_In.A_hStep, FADMADS_TrnEapReload_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapReload_In.A_hFactory, FADMADS_TrnEapReload_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapReload_In.A_hUserId, FADMADS_TrnEapReload_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapReload_In.A_hHostIp, FADMADS_TrnEapReload_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapReload_In.A_hHostName, FADMADS_TrnEapReload_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_TrnEapReload_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_TrnEapReload_In.FEap.A_Name, 
                            FADMADS_TrnEapReload_In.FEap.D_Name, 
                            eap
                            );
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_TrnEapReload_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );

                            if (fXmlNodeOut.get_elemVal(FADMADS_TrnEapReload_Out.A_hStatus, FADMADS_TrnEapReload_Out.D_hStatus) != "0")
                            {
                                grdList.Rows[r.Index].Cells["EAP"].Appearance.Image = getImageOfEap("Fail");
                                result = this.fUIWizard.searchCaption("Fail");
                                msg = fXmlNodeOut.get_elemVal(FADMADS_TrnEapReload_Out.A_hStatusMessage, FADMADS_TrnEapReload_Out.D_hStatusMessage);
                                fCnt++;
                            }
                            else
                            {
        ...
        #region FEapReload Form Event Handler

        private void FEapReload_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.EapReload);
        ...
        private void FEapReload_FormClosing(
            object sender, 
        ...
        #region btnReload Control Event Handler
            ...
            )
        {
            ...
            try
            {
                ...
                fPrgDialog = new FTransactionProgress(
                    m_fAdmCore,
                    this,
                    this.fUIWizard.generateMessage("M0010", new object[] { "Reload" })
                    );
