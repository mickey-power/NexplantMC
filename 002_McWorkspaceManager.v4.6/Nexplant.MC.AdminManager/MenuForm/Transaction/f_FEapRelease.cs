...
--
--  Program Id      : f_FEapRelease.cs
--  Creator         : mjkim
--  Create Date     : 2012.05.03
--  Description     : FAMate Admin Manager Transaction - EAP Release Form Class 
--  History         : Created by mjkim at 2012.05.03
...
{
    public partial class FEapRelease : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FITransaction
    {
            ...
            )
        {
            ...
            try
            {
                ...
                btnRelease.Enabled = m_tranEnabled;
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TrnEapRelease_In.E_ADMADS_TrnEapRelease_In);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRelease_In.A_hLanguage, FADMADS_TrnEapRelease_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRelease_In.A_hStep, FADMADS_TrnEapRelease_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRelease_In.A_hFactory, FADMADS_TrnEapRelease_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRelease_In.A_hUserId, FADMADS_TrnEapRelease_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRelease_In.A_hHostIp, FADMADS_TrnEapRelease_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_TrnEapRelease_In.A_hHostName, FADMADS_TrnEapRelease_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_TrnEapRelease_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_TrnEapRelease_In.FEap.A_Name, 
                            FADMADS_TrnEapRelease_In.FEap.D_Name, 
                            eap
                            );
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_TrnEapRelease_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );

                            if (fXmlNodeOut.get_elemVal(FADMADS_TrnEapRelease_Out.A_hStatus, FADMADS_TrnEapRelease_Out.D_hStatus) != "0")
                            {
                                grdList.Rows[r.Index].Cells["EAP"].Appearance.Image = getImageOfEap("Fail");
                                result = this.fUIWizard.searchCaption("Fail");
                                msg = fXmlNodeOut.get_elemVal(FADMADS_TrnEapRelease_Out.A_hStatusMessage, FADMADS_TrnEapRelease_Out.D_hStatusMessage);
                                // --
                                fCnt++;
                            }
                            else
            ...
            )
        {
            ...
            try
            {
                fEapSelector = new FEapClassSelector(m_fAdmCore, FEapAttrCategory.Setup, FEapType.Process.ToString());                
        ...
        #region FEapRelease Form Event Handler

        private void FEapRelease_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.EapRelease);
        ...
        private void FEapRelease_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FEapRelease_FormClosing(
            object sender, 
            ...
            )
        {
            try
            {
                ...
                else if (e.Tool.Key == FMenuKey.MenuTrnEapAbort)
                {
                    procMenuEapAbort();
                }
            }
        ...
        #region btnRelease Control Event Handler
            ...
            )
        {
            ...
            try
            {
                ...
                fPrgDialog = new FTransactionProgress(
                    m_fAdmCore, 
                    this, 
                    this.fUIWizard.generateMessage("M0010", new object[] { "Release" })
                    );
            ...
            )
        {
            ...
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuTrnEapAbort].SharedProps.Enabled = FCommon.hasFunctionAuthority(m_fAdmCore, FUserFunction.EapAbort);
