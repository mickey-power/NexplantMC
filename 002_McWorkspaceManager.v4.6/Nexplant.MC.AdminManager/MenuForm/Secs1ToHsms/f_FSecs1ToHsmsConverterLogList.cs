...
--
--  Program Id      : f_FSecs1ToHsmsConverterLogList.cs
--  Creator         : spike.lee
--  Create Date     : 2017.05.12
--  Description     : FAMate Admin Manager SECS1 To HSMS Convereter Log List Form Class 
--  History         : Created by spike.lee at 2017.05.12
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FSecs1ToHsmsConverterLogList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        public FSecs1ToHsmsConverterLogList()
        {
            InitializeComponent();
        }
            ...
            )
        {
            try
            {
                ...
                if (m_cleared)
                {
                    mnuMenu.Tools[FMenuKey.MenuS2HCvtLogListExport].SharedProps.Enabled = false;
                    mnuMenu.Tools[FMenuKey.MenuS2HCvtLogListDownload].SharedProps.Enabled = false;
                    mnuMenu.Tools[FMenuKey.MenuS2HCvtLogListView].SharedProps.Enabled = false;
                }
                else
                {
                    mnuMenu.Tools[FMenuKey.MenuS2HCvtLogListExport].SharedProps.Enabled = true;
                    mnuMenu.Tools[FMenuKey.MenuS2HCvtLogListDownload].SharedProps.Enabled = grdLog.activeDataRowKey == string.Empty ? false : true;
                    mnuMenu.Tools[FMenuKey.MenuS2HCvtLogListView].SharedProps.Enabled = grdLog.activeDataRowKey == string.Empty ? false : true;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TolSecs1ToHsmsConverterLogList_In.E_ADMADS_TolSecs1ToHsmsConverterLogList_In);
                fXmlNodeIn.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.A_hLanguage, FADMADS_TolSecs1ToHsmsConverterLogList_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.A_hFactory, FADMADS_TolSecs1ToHsmsConverterLogList_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.A_hUserId, FADMADS_TolSecs1ToHsmsConverterLogList_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.A_hStep, FADMADS_TolSecs1ToHsmsConverterLogList_In.D_hStep, "1");
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.A_Converter, FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.D_Converter, txtConverter.Text);
                fXmlNodeInLog.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.A_Type, FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.D_Type, ucbLogType.Text);

                // --

                do
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.A_NextRowNumber, FADMADS_TolSecs1ToHsmsConverterLogList_In.FLog.D_NextRowNumber, nextRowNumber.ToString());

                    // --

                    FADMADSCaster.ADMADS_TolSecs1ToHsmsConverterLogList_Req(
                        m_fAdmCore.fH101,
                        fXmlNodeIn,
                        ref fXmlNodeOut
                        );
                    // --
                    if (fXmlNodeOut.get_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_Out.A_hStatus, FADMADS_TolSecs1ToHsmsConverterLogList_Out.D_hStatus) != "0")
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_Out.A_hStatusMessage, FADMADS_TolSecs1ToHsmsConverterLogList_Out.D_hStatusMessage)
                            );
                    }

                    // --

                    fXmlNodeOutTbl = fXmlNodeOut.get_elem(FADMADS_TolSecs1ToHsmsConverterLogList_Out.FTable.E_Table);
                    // --
                    dt = FDbWizard.stringToDataTable(fXmlNodeOutTbl.get_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_Out.FTable.A_Rows, FADMADS_TolSecs1ToHsmsConverterLogList_Out.FTable.D_Rows));
                    //--
                    ...
                    nextRowNumber = int.Parse(
                        fXmlNodeOutTbl.get_elemVal(FADMADS_TolSecs1ToHsmsConverterLogList_Out.FTable.A_NextRowNumber, FADMADS_TolSecs1ToHsmsConverterLogList_Out.FTable.D_NextRowNumber)
                        );
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_Secs1ToHsmsConverterLogList.xlsx";

                // --

                sfd = new SaveFileDialog();
                // --
                sfd.Title = "Export SECS1 To HSMS Converter Log List to Excel";
                ...
                fExcelSht = fExcelExp.addExcelSheet("Converter Log List");
                ...
                // --
                rowIndex += 1;
                fExcelSht.writeCondition(lblConverter.Text, txtConverter.Text, rowIndex, 0);
                fExcelSht.writeCondition(lblLogType.Text, ucbLogType.Text, rowIndex, 2);

                // --

                // ***
                // SECS1 To HSMS Converter Log List Grid Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("SECS1 To HSMS Converter Log List") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeInLog.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogDownload_In.FLog.A_Converter, FADMADS_TolSecs1ToHsmsConverterLogDownload_In.FLog.D_Converter, txtConverter.Text);

                // --

                foreach (string key in grdLog.selectedDataRowKeys)
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolSecs1ToHsmsConverterLogDownload_In.FLog.A_File, FADMADS_TolSecs1ToHsmsConverterLogDownload_In.FLog.D_File, key);
                    ...
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolSecs1ToHsmsConverterLogDownload_Out.A_hStatusMessage, FADMADS_TolSecs1ToHsmsConverterLogDownload_Out.D_hStatusMessage)
                            );
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                if (extension == FExtensionType.log.ToString())
                {
                    ...
                    fSecs1ToHsmsConverterLogViewer = new FSecs1ToHsmsConverterLogViewer(
                        m_fAdmCore, 
                        txtConverter.Text,          // converter 
                        string.Empty,               // backup file name
                        grdLog.activeDataRowKey     // file name
                        );
        ...
        #region FSecs1ToHsmsConverterLogList Form Event Handler

        private void FSecs1ToHsmsConverterLogList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FSecs1ToHsmsConverterLogList_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FSecs1ToHsmsConverterLogList_FormClosing(
            object sender,
        ...
        private void FSecs1ToHsmsConverterLogList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuS2HCvtLogListRefresh)
                {
                    refreshGridOfLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuS2HCvtLogListExport)
                {
                    exportOfLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuS2HCvtLogListDownload)
                {
                    downloadOfLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuS2HCvtLogListView)
                {
                    viewOfLog();
                }
            }
        ...
        #region txtCvtName Control Event Handler

        private void txtCvtName_EditorButtonClick(
            object sender,
        ...
        private void txtCvtName_ValueChanged(
            object sender,
            EventArgs e
            )
        {
            ...
            )
        {
            ...
            try
            {
                ...
                mnuMenu.ShowPopup(FMenuKey.MenuS2HCvtLogListPopupMenu);
            }
            catch (Exception ex)
            {
                FMessageBox.showError(FConstants.ApplicationName, ex, m_fAdmCore.fWsmCore.fWsmContainer);
