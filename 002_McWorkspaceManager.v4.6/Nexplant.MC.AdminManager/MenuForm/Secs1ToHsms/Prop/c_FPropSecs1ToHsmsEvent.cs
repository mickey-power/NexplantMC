...
--
--  Program Id      : c_FPropSecs1ToHsmsEvent.cs
--  Creator         : spike.lee
--  Create Date     : 2017.04.21
--  Description     : FAMate Admin Manager SECS1 To HSMS Event Property Source Object Class 
...
{
    public class FPropSecs1ToHsmsEvent : FDynPropCusBase<FAdmCore>
    {

        //------------------------------------------------------------------------------------------------------------------------

        private const string CategoryGeneral = "[01] General";
        private const string CategorySystemEvent = "[02] System Event";
            ...
            )
        {
            try
            {
                ...
                if (dt != null)
                {
                    ...
                    m_comments = dt.Rows[0][3].ToString();
                    for (int i = 0; i < m_dataList.Length; i++)
                    {
