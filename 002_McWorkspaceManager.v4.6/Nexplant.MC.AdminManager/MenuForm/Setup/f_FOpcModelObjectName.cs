...
--
--  Program Id      : f_FOpcModelObjectName.cs
--  Creator         : mjkim
--  Create Date     : 2015.07.13
--  Description     : FAMate Admin Manager Setup OPC Model Object Name Form Class 
...
{
    public partial class FOpcModelObjectName : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdObjectType.DisplayLayout.Bands[0].Columns["Object Type"].CellAppearance.Image = Properties.Resources.OmdObjectNameList;
            ...
            )
        {
            ...
            try
            {
                ...
                grdObjectName.DisplayLayout.Bands[0].Columns["Object Name"].CellAppearance.Image = Properties.Resources.OmdObjectName;
            ...
            try
            {
                ...
                foreach (FObjectType objType in Enum.GetValues(typeof(FObjectType)))
                {
                    cellValues = new object[] {
                        objType.ToString(),                                          // Type (ex:OpcDriver)
                        Regex.Replace(objType.ToString(), "([a-z])([A-Z])", "$1 $2") // Description (ex:Opc Driver)
                        };
                    // --
            ...
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.OpcModelObjectName);
        ...
        private void FOpcModelObjectName_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
