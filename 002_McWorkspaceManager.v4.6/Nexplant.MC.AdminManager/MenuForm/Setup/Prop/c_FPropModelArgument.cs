...
--
--  Program Id      : c_FPropModelArgument.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2012.06.03
--  Description     : FAMate Admin Manager Model Argument Property Source Object Class 
...
{
    public class FPropModelArgument : FDynPropCusBase<FAdmCore>
    {
        ...
        private string m_argument = string.Empty;
        ...
        public FPropModelArgument(
            ...
            : this(fAdmCore, fPropGrid, null, functionNameList, functionName, parameterName, tranEnabled)
        {
            ...
            )
        {
            try
            {
                if (dt != null)
                {
                    m_argument = dt.Rows[0][0].ToString();
                ...
                base.fTypeDescriptor.properties["ParameterName"].attributes.replace(new DisplayNameAttribute("Parameter Name"));
                base.fTypeDescriptor.properties["Argument"].attributes.replace(new DisplayNameAttribute("Argument"));
                ...
                base.fTypeDescriptor.properties["ParameterName"].attributes.replace(new ParenthesizePropertyNameAttribute(true));
                base.fTypeDescriptor.properties["Argument"].attributes.replace(new ParenthesizePropertyNameAttribute(true));
                ...
                base.fTypeDescriptor.properties["ParameterName"].attributes.replace(new DefaultValueAttribute(m_parameterName));
                base.fTypeDescriptor.properties["Argument"].attributes.replace(new DefaultValueAttribute(m_argument));
                ...
                if (!m_tranEnabled)
                {
                    base.fTypeDescriptor.properties["Argument"].attributes.replace(new ReadOnlyAttribute(true));
