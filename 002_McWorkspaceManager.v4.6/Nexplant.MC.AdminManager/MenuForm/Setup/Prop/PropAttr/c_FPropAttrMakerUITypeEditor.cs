...
{
    public class FPropAttrMakerUITypeEditor : UITypeEditor
    {
        ...
        {
            FPropModel fProp = null;
            FMakerSelector dialog = null;

            try
            {
                fProp = (FPropModel)((FDynPropGridTypeDescriptor)context.Instance).GetPropertyOwner(null);
