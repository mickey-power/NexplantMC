...
--
--  Program Id      : c_FPropModelParameter.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2012.06.03
--  Description     : FAMate Admin Manager Model Parameter Property Source Object Class 
...
{
    public class FPropModelParameterName : FDynPropCusBase<FAdmCore>
    {
        ...
        public FPropModelParameterName(
            FAdmCore fAdmCore,
        ...
        public FPropModelParameterName(
            ...
            : this(fAdmCore, fPropGrid, null, functionNameList, functionName, tranEnabled)
        {
            ...
            )
        {
            try
            {
                if (dt != null)
                {
                    m_parameterName = dt.Rows[0][0].ToString();
                ...
                if (!m_tranEnabled)
                {
                    base.fTypeDescriptor.properties["ParameterName"].attributes.replace(new ReadOnlyAttribute(true));
