...
--
--  Program Id      : f_FTcpModelUserTagName.cs
--  Creator         : mjkim
--  Create Date     : 2015.07.13
--  Description     : FAMate Admin Manager Setup TCP Model User Tag Name Form Class 
...
{
    public partial class FTcpModelUserTagName : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdObjectType.DisplayLayout.Bands[0].Columns["Object Type"].CellAppearance.Image = Properties.Resources.TmdUserTagNameList;
            ...
            )
        {
            ...
            try
            {
                ...
                grdUserTagName.DisplayLayout.Bands[0].Columns["Tag No"].CellAppearance.Image = Properties.Resources.TmdUserTagName;
            ...
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.TcpModelUserTagName);
        ...
        private void FTcpModelUserTagName_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
