...
--
--  Program Id      : f_FOpcModelFunctionName.cs
--  Creator         : mjkim
--  Create Date     : 2015.07.13
--  Description     : FAMate Admin Manager Setup OPC Model Function Name Form Class 
...
{
    public partial class FOpcModelFunctionName : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdFunList.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.OmdFunctionNameList;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdFun.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.OmdFunctionName;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdPara.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.OmdParameterName;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdArg.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.OmdArgument;
                // --
            ...
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.OpcModelFunctionName);
        ...
        private void FOpcModelFunctionName_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
