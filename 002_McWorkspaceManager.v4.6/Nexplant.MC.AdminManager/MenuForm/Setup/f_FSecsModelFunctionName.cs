...
--
--  Program Id      : f_FSecsModelFunctionName.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.06.03
--  Description     : FAMate Admin Manager Setup SECS Model Function Name Form Class 
--  History         : Created by jungyoul.moon at 2013.06.03
----------------------------------------------------------------------------------------------------------*/
using System;
using System.Data;
...
{
    public partial class FSecsModelFunctionName : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams.add("mdl_type", FEapType.SECS.ToString());
            ...
            )
        {
            ...
            try
            {
                ...
                grdFunList.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.SmdFunctionNameList;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdFun.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.SmdFunctionName;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdPara.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.SmdParameterName;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdArg.DisplayLayout.Bands[0].Columns["Function Name List"].CellAppearance.Image = Properties.Resources.SmdArgument;
                // --
        ...
        private void refreshGridOfFunctionList(
            string beforeKey
            )
        {
            FSqlParams fSqlParams = null;
        ...
        private void updateGridOfFunctionList(
            )
        {
            ...
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.SecsModelFunctionName);
            ...
            )
        {
            try
            {
                ...
                refreshGridOfFunctionList(string.Empty);
        ...
        private void FSecsModelFunctionName_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            try
            {
                if (e.KeyCode == Keys.F5)
                {
                    ...
                    if (tabMain.ActiveTab.Key == "Function Name List")
                    {
                        refreshGridOfFunctionList(grdFunList.activeDataRowKey);
                    }
