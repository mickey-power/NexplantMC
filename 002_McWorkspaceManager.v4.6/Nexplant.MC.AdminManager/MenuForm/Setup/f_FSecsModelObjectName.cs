...
--
--  Program Id      : f_FSecsModelObjectName.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.05.31
--  Description     : FAMate Admin Manager Setup SECS Model Object Name Form Class 
--  History         : Created by jungyoul.moon at 2013.05.31
----------------------------------------------------------------------------------------------------------*/
using System;
using System.Data;
...
{
    public partial class FSecsModelObjectName : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdObjectType.DisplayLayout.Bands[0].Columns["Object Type"].CellAppearance.Image = Properties.Resources.SmdObjectNameList;
            ...
            )
        {
            ...
            try
            {
                ...
                grdObjectName.DisplayLayout.Bands[0].Columns["Object Name"].CellAppearance.Image = Properties.Resources.SmdObjectName;
            ...
            try
            {
                ...
                foreach (FObjectType objType in Enum.GetValues(typeof(FObjectType)))
                {
                    cellValues = new object[] {
                        objType.ToString(),                                             // Type (ex:SecsDriver)
                        Regex.Replace(objType.ToString(), "([a-z])([A-Z])", "$1 $2")    // Description (ex:Secs Driver)
                        };
                    // --
            ...
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.SecsModelObjectName);
        ...
        private void FSecsModelObjectName_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
