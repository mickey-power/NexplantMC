...
--
--  Program Id      : f_FSecsModelUserTagName.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.06.04
--  Description     : FAMate Admin Manager Setup SECS Model User Tag Name Form Class 
...
{
    public partial class FSecsModelUserTagName : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdObjectType.DisplayLayout.Bands[0].Columns["Object Type"].CellAppearance.Image = Properties.Resources.SmdUserTagNameList;
            ...
            )
        {
            ...
            try
            {
                ...
                grdUserTagName.DisplayLayout.Bands[0].Columns["Tag No"].CellAppearance.Image = Properties.Resources.SmdUserTagName;
            ...
            )
        {
            try
            {
                ...
                m_tranEnabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.SecsModelUserTagName);
        ...
        private void FSecsModelUserTagName_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
