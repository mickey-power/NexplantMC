...
--
--  Program Id      : f_FEapList.cs
--  Creator         : baehyun seo
--  Create Date     : 2012.06.05
--  Description     : FAMate Admin Manager EAP List Form Class 
--  History         : Created by baehyun seo at 2012.06.05
----------------------------------------------------------------------------------------------------------*/
using System;
using System.Data;
...
{
    public partial class FEapList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                grdEap.DisplayLayout.Bands[0].Columns["Reload Count"].Width = 90;
            ...
            )
        {
            ...
            try
            {
                ...
                grdEapConfig.addColumns(3, columns);
                grdEapConfig.setColumnHeaderWidth(120);

                // --

                grdEapConfig.DisplayLayout.Override.TipStyleCell = TipStyle.Show;

                // --

                grdEapConfig.Rows[3].Cells[4].Value = string.Empty;

                // --

                grdEapConfig.Rows[3].Cells[3].Appearance.TextHAlign = HAlign.Right;
                // --
                grdEapConfig.Rows[4].Cells[5].Appearance.TextHAlign = HAlign.Right;
                // --
                grdEapConfig.Rows[5].Cells[2].Value = "Max File Size (MB)";
                grdEapConfig.Rows[5].Cells[3].Appearance.TextHAlign = HAlign.Right;
                grdEapConfig.Rows[5].Cells[4].Value = "Max File Size (Byte)";
                grdEapConfig.Rows[5].Cells[5].Appearance.TextHAlign = HAlign.Right;
                // --
                grdEapConfig.Rows[6].Cells[2].Value = "Max File Size (MB)";
                grdEapConfig.Rows[6].Cells[3].Appearance.TextHAlign = HAlign.Right;
                grdEapConfig.Rows[6].Cells[4].Value = "Max File Size (Byte)";
                grdEapConfig.Rows[6].Cells[5].Appearance.TextHAlign = HAlign.Right;
                // --
                grdEapConfig.Rows[7].Cells[2].Value = "Max File Size (MB)";
                grdEapConfig.Rows[7].Cells[3].Appearance.TextHAlign = HAlign.Right;
                grdEapConfig.Rows[7].Cells[4].Value = "Max File Size (Byte)";
                grdEapConfig.Rows[7].Cells[5].Appearance.TextHAlign = HAlign.Right;
                // --
                grdEapConfig.Rows[8].Cells[2].Value = "Max File Size (MB)";
                grdEapConfig.Rows[8].Cells[3].Appearance.TextHAlign = HAlign.Right;
                grdEapConfig.Rows[8].Cells[4].Value = "Max File Size (Byte)";
                grdEapConfig.Rows[8].Cells[5].Appearance.TextHAlign = HAlign.Right;

                // --

                foreach (UltraGridRow r in grdEapConfig.Rows)
                {
                    r.Hidden = true;
                }
            }
            ...
            )
        {
            ...
            try
            {
                ...
                grdLogLevel.DisplayLayout.Override.TipStyleCell = TipStyle.Show;
            ...
            )
        {
            try
            {
                ...
                // EAP Config Clear
                // ***
                grdEapConfig.beginUpdate();
                grdEapConfig.clearColumnValue();
                foreach (UltraGridRow r in grdEapConfig.Rows)
                {
                    r.Hidden = true;
                }
                grdEapConfig.endUpdate();
             ...
             )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapList", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
            ...
            )
        {
            ...
            try
            {
                ...
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapList", "SearchEap", fSqlParams, true);
                row = dt.Rows[0];
            ...
            )
        {
            ...
            try
            {
                ...
                grdEapConfig.setColumnValues(cellValues);

                // --

                if (fileBackupPath.Trim() == string.Empty)
                {
                    grdEapConfig.Rows[1].Hidden = true;
                }
                // --
                if (fileErrorPath.Trim() == string.Empty)
                {
                    grdEapConfig.Rows[2].Hidden = true;
                }
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_McList.xlsx";

                // --

                sfd = new SaveFileDialog();
                // --
                sfd.Title = "Export MC List to Excel";
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_McList_" + tabMain.ActiveTab.Text + ".xlsx";
                ...
                // --
                rowIndex += 1;
                rowIndex = fExcelSht.writeDetailViewGrid(grdEapConfig, rowIndex, 0);
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapList", "SearchFactory", fSqlParams, true);
        ...
        #region FEapList Form Event Handler

        private void FEapList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FEapList_FormClosing(
            object sender, 
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuEplRefresh)
                {
                    refresh();
                }
                else if (e.Tool.Key == FMenuKey.MenuEplExport)
                {
                    export();
                }
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    grdEapConfig.Rows[5].Cells[0].Value = "SECS Log";
                    grdEapConfig.Rows[8].Cells[0].Value = "SML Log";
                    // --
                    grdEapConfig.Rows[4].Hidden = false;
                    grdEapConfig.Rows[5].Hidden = false;
                    grdEapConfig.Rows[6].Hidden = false;
                    grdEapConfig.Rows[7].Hidden = false;
                    grdEapConfig.Rows[8].Hidden = false;
                }
                //else if (this.activeType == FEapType.PLC.ToString())
                //{
                //    grdEapConfig.Rows[3].Cells[0].Value = "PLC Log";
                //    // --
                //    grdEapConfig.Rows[2].Hidden = false;
                //    grdEapConfig.Rows[3].Hidden = false;
                //    grdEapConfig.Rows[4].Hidden = false;
                //    grdEapConfig.Rows[5].Hidden = false;
                //}
                else if (this.activeType == FEapType.OPC.ToString())
                {
                    grdEapConfig.Rows[5].Cells[0].Value = "OPC Log";
                    // --
                    grdEapConfig.Rows[4].Hidden = false;
                    grdEapConfig.Rows[5].Hidden = false;
                    grdEapConfig.Rows[7].Hidden = false;
                ...
                {
                    grdEapConfig.Rows[5].Cells[0].Value = "TCP Log";
                    grdEapConfig.Rows[8].Cells[0].Value = "XLG Log";
                    // --
                    grdEapConfig.Rows[4].Hidden = false;
                    grdEapConfig.Rows[5].Hidden = false;
                    grdEapConfig.Rows[6].Hidden = false;
                ...
                {
                    grdEapConfig.Rows[5].Cells[0].Value = "File Log";
                    // --
                    grdEapConfig.Rows[0].Hidden = false;
                    grdEapConfig.Rows[1].Hidden = false;
                    grdEapConfig.Rows[2].Hidden = false;
                    grdEapConfig.Rows[3].Hidden = false;
                    grdEapConfig.Rows[4].Hidden = false;
                    grdEapConfig.Rows[5].Hidden = false;
