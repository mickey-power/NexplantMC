...
--
--  Program Id      : f_FServerList.cs
--  Creator         : baehyun seo
--  Create Date     : 2012.04.19
--  Description     : FAMate Admin Manager Server List Form Class 
--  History         : Created by baehyun seo at 2012.04.19
----------------------------------------------------------------------------------------------------------*/
using System;
using System.Data;
...
{
    public partial class FServerList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                uds.Band.Columns.Add("EAP Count");
                ...
                // --
                grdServer.DisplayLayout.Bands[0].Columns["EAP Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                ...
                grdServer.DisplayLayout.Bands[0].Columns["EAP Count"].Width = 80;
             ...
             )
        {
            ...
            try
            {
                ...
                {
                    index = ucbCategory.appendDataRow(s, new object[] { s }).Index;
                }
             ...
             )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerList", "ListServer", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        svrUpDown = r[5].ToString();
                        svrStatus = r[6].ToString();
                        lastEventTime = FDataConvert.defaultDataTimeFormating(r[16].ToString());
                        createTime = FDataConvert.defaultDataTimeFormating(r[19].ToString());
                        updateTime = FDataConvert.defaultDataTimeFormating(r[21].ToString());
                        ...
                        cellValues = new object[] {
                            ...
                            r[4].ToString(),    // EAP Count
                            svrUpDown,          // Up/Down
                            svrStatus,          // Status
                            r[7].ToString(),    // Agent
                            r[8].ToString(),    // Used Backup 
                            r[9].ToString(),    // Backup Mode
                            r[10].ToString(),   // Backup Server
                            r[11].ToString(),   // B.Server Up/Down
                            r[12].ToString(),   // B.Server Status  
                            r[13].ToString(),   // B.Server Agent                             
                            r[14].ToString(),   // OPC Server Monitoring
                            r[15].ToString(),   // OPC Server Up/Down                      
                            lastEventTime,      // Last Event Time
                            r[17].ToString(),   // Last Event ID
                            r[18].ToString(),   // Create User ID
                            createTime,         // Create Time
                            r[20].ToString(),   // Update User ID
             ...
             )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                fSqlParams.add("server", grdServer.activeDataRowKey);
                // --
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerList", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ServerList.xlsx";

                // --

                sfd = new SaveFileDialog();
                // --
                sfd.Title = "Export Server List to Excel";
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ServerList_" + tabMain.ActiveTab.Text + ".xlsx";
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerList", "SearchFactory", fSqlParams, true);
        ...
        public void procMenuRemotePingTest(
            )
        {
        ...
        public void procMenuEqEventDefineRequest(
            )
        {
        ...
        public void procMenuEqVersionRequest(
            )
        {
            FEquipmentVersionRequest fEqVerRequest = null;

            try
            {
                fEqVerRequest = (FEquipmentVersionRequest)m_fAdmCore.fAdmContainer.getChild(typeof(FEquipmentVersionRequest));
                if (fEqVerRequest == null)
                {
                    fEqVerRequest = new FEquipmentVersionRequest(m_fAdmCore);
                    m_fAdmCore.fAdmContainer.showChild(fEqVerRequest);
                }
                fEqVerRequest.activate();
                fEqVerRequest.attach(this.selectedEqs, this.activeEap);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public void procMenuEqControlModeRequest(
            )
        {
        ...
        #region FServerList Form Event Handler

        private void FServerList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FServerList_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FServerList_FormClosing(
            object sender, 
        ...
        private void FServerList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuSvlRefresh)
                {
                    refresh();
                }
                else if (e.Tool.Key == FMenuKey.MenuSvlExport)
                {
                    export();
                }
        ...
        private void grdServer_DoubleClickRow(
            object sender, 
