...
--
--  Program Id      : f_FModelList.cs
--  Creator         : baehyun seo
--  Create Date     : 2012.05.09
--  Description     : FAMate Admin Manager Model List Form Class 
...
{
    public partial class FModelList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            get
            {
                ...
                try
                {
                    if (tabMain.ActiveTab.Key == "Model")
                    {
                        ...
                        version = (string)grdModel.activeDataRow["Release Ver."];
                    }
                    else
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                grdModel.DisplayLayout.Bands[0].Columns["(Set) MC Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                grdModel.DisplayLayout.Bands[0].Columns["(Rel) MC Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                grdModel.DisplayLayout.Bands[0].Columns["(Apl) MC Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                ...
                grdModel.DisplayLayout.Bands[0].Columns["Create Time"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center;
                grdModel.DisplayLayout.Bands[0].Columns["Update Time"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center;
                ...
                grdModel.DisplayLayout.Bands[0].Columns["(Set) MC Count"].Width = 80;
                grdModel.DisplayLayout.Bands[0].Columns["(Rel) MC Count"].Width = 80;
                grdModel.DisplayLayout.Bands[0].Columns["(Apl) MC Count"].Width = 80;
                grdModel.DisplayLayout.Bands[0].Columns["Release Ver."].Width = 80;
                grdModel.DisplayLayout.Bands[0].Columns["Last Ver."].Width = 80;
                grdModel.DisplayLayout.Bands[0].Columns["Create User ID"].Width = 100;
                grdModel.DisplayLayout.Bands[0].Columns["Create Time"].Width = 165;
                grdModel.DisplayLayout.Bands[0].Columns["Update User ID"].Width = 100;
                grdModel.DisplayLayout.Bands[0].Columns["Update Time"].Width = 165;

                // --

                grdModel.DisplayLayout.Override.AllowRowFiltering = Infragistics.Win.DefaultableBoolean.True;
                grdModel.DisplayLayout.Override.FilterUIProvider = this.grdFilter;
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                grdVersion.DisplayLayout.Bands[0].Columns["Version"].CellAppearance.Image = Properties.Resources.ModelVersion;
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                grdEap.DisplayLayout.Bands[0].Columns["Type"].Width = 180;
                ...
                grdEap.DisplayLayout.Override.AllowRowFiltering = DefaultableBoolean.True;
            ...
            )
        {
            ...
            try
            {
                ...
                grdConfig.Rows[1].Cells[4].Value = string.Empty;

                // --

                grdConfig.Rows[1].Cells[3].Appearance.TextHAlign = HAlign.Right;
                // --
                grdConfig.Rows[2].Cells[5].Appearance.TextHAlign = HAlign.Right;
                // --
                grdConfig.Rows[3].Cells[2].Value = "Max File Size (MB)";
                grdConfig.Rows[3].Cells[3].Appearance.TextHAlign = HAlign.Right;
                grdConfig.Rows[3].Cells[4].Value = "Max File Size (Byte)";
                grdConfig.Rows[3].Cells[5].Appearance.TextHAlign = HAlign.Right;
                // --
                grdConfig.Rows[4].Cells[2].Value = "Max File Size (MB)";
                grdConfig.Rows[4].Cells[3].Appearance.TextHAlign = HAlign.Right;
                grdConfig.Rows[4].Cells[4].Value = "Max File Size (Byte)";
             ...
             )
        {
            ...
            try
            {
                ...
                beforeKey = grdModel.activeDataRowKey;
                // --
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ModelList", "ListModel", fSqlParams, false, ref nextRowNumber);
                    // --
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ModelList", "ListModelVer", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        createTime = FDataConvert.defaultDataTimeFormating(r[9].ToString());
                        ...
                        cellValues = new object[] {
                            ...
                            r[1].ToString(),    // Description
                            r[2].ToString(),    // Setup EAP Count
                            r[3].ToString(),    // Released EAP Count
                            r[4].ToString(),    // Applied EAP Count
                            r[5].ToString(),    // File
             ...
             )
        {
            ...
            try
            {
                ...
                grdEap.DisplayLayout.Bands[0].SortedColumns.Clear();
                // --
                if (grdModel.activeDataRow == null || grdVersion.activeDataRow == null)
                {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ModelList", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ModelList", "SearchModelSheet", fSqlParams, false);
                // --
                if (dt.Rows.Count == 0)
                {
                    return;
            ...
            )
        {
            try
            {
                ...
                else if (tabMain.ActiveTab.Key == "EapDetail")
                {
                    refreshGridOfEapDetail();
                    refreshEapSchema();
                    grdEapDetail.Focus();
                }
                else if (tabMain.ActiveTab.Key == "ModelSheet")
                {
                    refreshModelSheet();
                    ftxSheet.Focus();
                }
            ...
            )
        {
            try
            {
                lblModelTotal.Text = grdModel.Rows.VisibleRowCount.ToString("#,##0") + " / " + grdModel.Rows.Count.ToString("#,##0");
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private void exportGridOfModel(
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ModelList.xlsx";

                // --

                sfd = new SaveFileDialog();
                sfd.InitialDirectory = m_fAdmCore.fOption.recentExportPath;
                sfd.Title = "Export Model List to Excel";
                ...
                fExcelSht = FExcelExp.addExcelSheet("Model List");
                ...
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("Model List") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
                rowIndex = fExcelSht.writeGrid(grdModel, rowIndex, 0);
                // --
                rowIndex += 1;
                fExcelSht.writeText("Total Count: " + grdModel.Rows.Count.ToString(), rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ModelList_"+ tabMain.ActiveTab.Text+".xlsx";
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ModelList", "SearchFactory", fSqlParams, true);
            ...
            )
        {
            ...
            try
            {
                ...
                fEquipmentHistory.attach(this.activeEq);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        #region FModelList Form Event Handler

        private void FModelList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FModelList_FormClosing(
            object sender, 
        ...
        private void FModelList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuMdlRefresh)
                {
                    refresh();
                }
                else if (e.Tool.Key == FMenuKey.MenuMdlExport)
                {
                    export();
                }
                ...
                else if (e.Tool.Key == FMenuKey.MenuInqModelStatus)
                {
                    procMenuModelStatus();
                }
            ...
            )
        {
            ...
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuInqModelStatus].SharedProps.Enabled = FCommon.hasFunctionAuthority(m_fAdmCore, FUserFunction.ModelStatus);
                
                // --
                
                mnuMenu.ShowPopup(FMenuKey.MenuInqMdlPopupMenu);
            }
            catch (Exception ex)
            {
                FMessageBox.showError(FConstants.ApplicationName, ex, m_fAdmCore.fWsmCore.fWsmContainer);
        ...
        private void grdModel_AfterRowFilterChanged(
            object sender,
            ...
            )
        {
            ...
            try
            {
                ...
                grdModel.ActiveRow = e.Rows.GetRowAtVisibleIndex(activateIndex);
                grdModel.DisplayLayout.RowScrollRegions[0].ScrollRowIntoView(grdModel.ActiveRow);
            ...
            )
        {
            ...
            try
            {
               if (grdVersion.ActiveCell.Column.Key.ToString() == "Comment")
                {
            ...
            )
        {
            try
            {
                ...
                {
                    grdConfig.Rows[3].Cells[0].Value = "SECS Log";
                    grdConfig.Rows[6].Cells[0].Value = "SML Log";
                    // --
                ...
                {
                    grdConfig.Rows[3].Cells[0].Value = "OPC Log";
                    // --
                    grdConfig.Rows[2].Hidden = false;
                    grdConfig.Rows[3].Hidden = false;
                    grdConfig.Rows[5].Hidden = false;
                ...
                {
                    grdConfig.Rows[3].Cells[0].Value = "TCP Log";
                    grdConfig.Rows[6].Cells[0].Value = "XLG Log";
                    // --
                    grdConfig.Rows[2].Hidden = false;
                    grdConfig.Rows[3].Hidden = false;
                    grdConfig.Rows[4].Hidden = false;
                ...
                {
                    grdConfig.Rows[3].Cells[0].Value = "File Log";
                    // --
        ...
        #region rstMdlToolbar Control Event Handler

        private void rstMdlToolbar_SearchRequested(
            object sender,
            ...
            )
        {
            try
            {
                ...
                if (e.Tab.Key == "Model Sheet")
                {
                    mnuMenu.Tools[FMenuKey.MenuMdlExport].SharedProps.Enabled = false;
                }
