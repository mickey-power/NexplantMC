...
--
--  Program Id      : f_FServerStatus.cs
--  Creator         : mjkim
--  Create Date     : 2012.05.09
--  Description     : FAMate Admin Manager Server Status Form Class 
--  History         : Created by mjkim at 2012.04.09
----------------------------------------------------------------------------------------------------------*/
using System;
using System.Data;
...
{
    public partial class FServerStatus : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        private void designGridOfServerDetail(
            )
        {
            string[] columns = null;
            ...
            try
            {
                ...
                grdDetail.Rows[6].Cells[4].Value = string.Empty;
            ...
            )
        {
            ...
            {
                // ***
                // Server Detail Information Clear
                // ***
        ...
        private void refreshGridOfServerDetail(
             )
        {
            ...
            try
            {
                ...
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerStatus", "HasServer", fSqlParams, false);
                // --
                if (dt.Rows.Count == 0)
                {
                    grdDetail.endUpdate();
                ...
                fSqlParams.add("server", txtSvrName.Text);
                // --
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerStatus", "SearchServer", fSqlParams, true);
                ...
                creator = row[15].ToString() + " [" + FDataConvert.defaultDataTimeFormating(row[16].ToString()) + "]";
                updater = row[17].ToString() + " [" + FDataConvert.defaultDataTimeFormating(row[18].ToString()) + "]";
                lastEventTime = FDataConvert.defaultDataTimeFormating(row[19].ToString());

                // --

                cellValues = new object[] {
                    row[0].ToString(),    // Server
                    row[1].ToString(),    // Description
                    row[13].ToString(),   // OPC Server Monitoring
                    // --
                    row[2].ToString(),    // Server Type
                    row[3].ToString(),    // Server IP
                    row[14].ToString(),   // OPC Server Up/Down
                    // --
                    row[4].ToString(),    // Up/Down
                    row[5].ToString(),    // Status
                    row[6].ToString(),    // Agent
                    // --
                    row[7].ToString(),    // Used Backup
                    row[8].ToString(),    // Backup Mode
                    row[9].ToString(),    // Backup Server
                    // --
                    row[10].ToString(),   // B.Server Up/Down
                    row[11].ToString(),   // B.Server Status
                    row[12].ToString(),   // B.Server Agent
                    // --
                    creator,              // Creator
                    updater,              // Updater
                    string.Empty,       
                ...
                if (grdDetail.getColumn("Up/Down").Text == FUpDown.Down.ToString())
                {
                    cell = grdDetail.getColumn("Server");
                    cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                    cell.Appearance.ForeColor = Color.Red;

                    // --

                    cell = grdDetail.getColumn("Up/Down");
                    cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                    cell.Appearance.ForeColor = Color.Red;
                }
                ...
                if (
                    grdDetail.getColumn("OPC Server Monitoring").Text == FYesNo.Yes.ToString() &&
                    grdDetail.getColumn("OPC Server").Text == FUpDown.Down.ToString()
                    )
                {
                    cell = grdDetail.getColumn("OPC Server");
                    cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                    cell.Appearance.ForeColor = Color.Red;
                }
                ...
                if (grdDetail.getColumn("Status").Text == FServerStatusEnum.Backup.ToString())
                {
                    cell = grdDetail.getColumn("Status");
                    cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                    cell.Appearance.ForeColor = Color.Red;
                }
                ...
                if (grdDetail.getColumn("Agent").Text == FUpDown.Down.ToString())
                {
                    cell = grdDetail.getColumn("Agent");
                    cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                    cell.Appearance.ForeColor = Color.Red;
                }
                ...
                if (grdDetail.getColumn("Used Backup").Text == FYesNo.Yes.ToString())
                {
                    if (grdDetail.getColumn("B.Server Up/Down").Text == FUpDown.Down.ToString())
                    {
                        cell = grdDetail.getColumn("Backup Server");
                        cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                        cell.Appearance.ForeColor = Color.Red;

                        cell = grdDetail.getColumn("B.Server Up/Down");
                        cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                        cell.Appearance.ForeColor = Color.Red;
                    }
                    ...
                    if (grdDetail.getColumn("B.Server Status").Text == FServerStatusEnum.Backup.ToString())
                    {
                        cell = grdDetail.getColumn("B.Server Status");
                        cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                        cell.Appearance.ForeColor = Color.Red;
                    }
                    ...
                    if (grdDetail.getColumn("B.Server Agent").Text == FUpDown.Down.ToString())
                    {
                        cell = grdDetail.getColumn("B.Server Agent");
                        cell.Appearance.FontData.Bold = Infragistics.Win.DefaultableBoolean.True;
                        cell.Appearance.ForeColor = Color.Red;
                    }
                }
             ...
             )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerStatus", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
            ...
            )
        {
            ...
            try
            {
                ...
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerStatus", "SearchEap", fSqlParams, true);
                row = dt.Rows[0];
        ...
        private void exportGridOfServer(
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ServerStatus_" + txtSvrName.Text + ".xlsx";

                // --

                sfd = new SaveFileDialog();
                // --
                sfd.Title = "Export Server Status to Excel";
                ...
                fExcelSht = fExcelExp.addExcelSheet("Server Status");
                ...
                // ***
                // Server Detail Grid Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("Server Detail") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
        ...
        // 불필요하고 정리되지 않은 코드로 인해 Excel Export 재 구성합니다. 
        // Core 부분도 확장성이 없어 다시 구현합니다.
        // ***
        private void export(            
            )
        {
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ServerStatus", "SearchFactory", fSqlParams, true);
            ...
            )
        {
            ...
            try
            {
                ...
                fServerHistory.attach(txtSvrName.Text);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                fServerMainSwitch.attach(txtSvrName.Text);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                fServerBackupSwitch.attach(txtSvrName.Text);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        #region FServerStatus Form Event Handler

        private void FServerStatus_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FServerStatus_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FServerStatus_FormClosing(
            object sender, 
        ...
        private void FServerStatus_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuSvsRefresh)
                {
                    refresh();
                }
                else if (e.Tool.Key == FMenuKey.MenuSvsExport)
                {
                    export();
                }
            ...
            try
            {
                ...
                if (grdEap.ActiveRow != null)
                {
                    ...
                    if (eapType == FEapType.Process.ToString())
                    {
                        ...
                        mnuMenu.Tools[FMenuKey.MenuInqEapMove].SharedProps.Enabled = false;
