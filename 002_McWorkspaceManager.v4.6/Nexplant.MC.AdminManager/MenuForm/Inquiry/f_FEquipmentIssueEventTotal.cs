...
--
--  Program Id      : f_FEquipmentIssueEventTotal.cs
--  Creator         : spike.lee
--  Create Date     : 2017.07.31
--  Description     : FAmate Admin Manager Equipment Issue Event Total Form Class 
...
{
    public partial class FEquipmentIssueEventTotal : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        //------------------------------------------------------------------------------------------------------------------------
        ...
        public FEquipmentIssueEventTotal(
            )
        {
            InitializeComponent();
        }
            ...
            )
        {
            try
            {
                ...
                foreach (FChart fChart in new FChart[] { chartEvent, chartEqp })
                {
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EquipmentIssueEventTotal", "ListEquipmentEvent", fSqlParams, false, ref nextRowNumber);
                    // --
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EquipmentIssueEventTotal", "ListEquipment", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        eqp = r[0].ToString();
        ...
        private void refreahChartOfEquipmentIssueEventTotal(
            )
        {
            FSqlParams fSqlParams = null;
            DataTable dt = null;
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EquipmentIssueEventTotal", "SearchEquipmentIssueEventTotal", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        evt = r[0].ToString();
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EquipmentIssueEventTotal", "SearchEquipmentIssueEventSummary", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        eqp = r[0].ToString();
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    using (DataTable dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EquipmentIssueEventTotal", "SearchEquipmentIeh", fSqlParams, false, ref nextRowNumber))
                    {
            ...
            )
        {
            try
            {
                ...
                refreahChartOfEquipmentIssueEventTotal();
                // --
                m_cleared = false;
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_EquipmentIssueEventTotal" + ".xlsx";

                // --

                sfd = new SaveFileDialog();
                // --                
                sfd.Title = "Export Equipment Issue Event Total to Excel";
                ...
                fExcelSht = fExcelExp.addExcelSheet("Equipment Issue Event Total");
                ...
                // ***
                // Equipment Issue Event Total Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("Equipment Issue Event Total") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
        ...
        #region FEquipmentIssueEventTotal Form Event Handler

        private void FEquipmentIssueEventTotal_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FEquipmentIssueEventTotal_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FEquipmentIssueEventTotal_FormClosing(
            object sender, 
        ...
        private void FEquipmentIssueEventTotal_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            ...
            try
            {
                ...
                if (ret.ChartElementType == ChartElementType.DataPoint)
                {
                    ...
                    refreahChartOfEquipmentIssueEventSummary(evt);
            ...
            )
        {
            ...
            try
            {
                ...
                if (ret.ChartElementType == ChartElementType.DataPoint)
                {
                    ...
                    refreshGridOfEquipmentHistory(eqp, m_event);
                }
            }
            catch (Exception ex)
            {
