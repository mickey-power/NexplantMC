...
--
--  Program Id      : f_FComponentStatus.cs
--  Creator         : baehyun.seo
--  Create Date     : 2012.05.14
--  Description     : FAMate Admin Manager Component Status Form Class 
...
{
    public partial class FComponentStatus : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        private void designGridOfComponentDetail(
            )
        {
            string[] columns = null;
            ...
            )
        {
            ...
            {
                // ***
                // Component Detail Information Clear
                // ***
        ...
        private void refreshGridOfComponentDetail(
             )
        {
            ...
            try
            {
                ...
                if (txtComponent.Text == string.Empty || txtVersion.Text == string.Empty)
                {
                    grdDetail.endUpdate();
                    txtVersion.Focus();
                    FDebug.throwFException(fUIWizard.generateMessage("E0004", new object[] { "Component" }));
                }
                ...
                fSqlParams.add("component", txtComponent.Text);
                fSqlParams.add("com_ver", txtVersion.Text);

                // --

                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentStatus", "SearchComponent", fSqlParams, true);
                row = dt.Rows[0];
             ...
             )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentStatus", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ComponentStatus_" + txtComponent.Text + "_" + txtVersion.Text + ".xlsx";

                // --

                sfd = new SaveFileDialog();
                // --
                sfd.Title = "Export Component Status to Excel";
                ...
                fExcelSht = fExcelExp.addExcelSheet("Component Status");
                ...
                // ***
                // Component Detail Grid Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("Component Detail") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Component Status EAP Detail Grid Write
                // ***
                rowIndex += 2;
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentStatus", "SearchFactory", fSqlParams, true);
            ...
            )
        {
            try
            {
                txtComponent.Text = componentName;
                txtComponent.Tag = componentType;
                txtVersion.Text = componentVersion;
        ...
        #region FComponentStatus Form Event Handler

        private void FComponentStatus_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FComponentStatus_Enter(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FComponentStatus_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FComponentStatus_FormClosing(
            object sender, 
        ...
        private void FComponentStatus_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuCpsRefresh)
                {
                    refresh();
                }
                else if (e.Tool.Key == FMenuKey.MenuCpsExport)
                {
                    export();
                }
            ...
            )
        {
            ...
            try
            {
                ...
                fDialog = new FComponentVersionSelector(m_fAdmCore, txtComponent.Text, txtVersion.Text);
                ...
                txtComponent.Tag = fDialog.selectedType;
                txtVersion.Text = fDialog.selectedComponentVer;
            }
            catch (Exception ex)
            {
                FMessageBox.showError(FConstants.ApplicationName, ex, m_fAdmCore.fWsmCore.fWsmContainer);
