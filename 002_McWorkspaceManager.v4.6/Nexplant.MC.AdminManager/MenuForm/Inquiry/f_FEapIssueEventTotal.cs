...
--
--  Program Id      : f_FEapIssueEventTotal.cs
--  Creator         : spike.lee
--  Create Date     : 2017.07.31
--  Description     : FAmate Admin Manager EAP Issue Event Total Form Class 
...
{
    public partial class FEapIssueEventTotal : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        //------------------------------------------------------------------------------------------------------------------------
            ...
            )
        {
            try
            {
                ...
                foreach (FChart fChart in new FChart[] { chartEvent, chartEap })
                {
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapIssueEventTotal", "ListEapEvent", fSqlParams, false, ref nextRowNumber);
                    // --
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapIssueEventTotal", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        eap = r[0].ToString();
        ...
        private void refreahChartOfEapIssueEventTotal(
            )
        {
            FSqlParams fSqlParams = null;
            DataTable dt = null;
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapIssueEventTotal", "SearchEapIssueEventTotal", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        evt = r[0].ToString();
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapIssueEventTotal", "SearchEapIssueEventSummary", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        eap = r[0].ToString();
            ...
            )
        {
            ...
            try
            {
                ...
                do
                {
                    using (DataTable dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "EapIssueEventTotal", "SearchEapIeh", fSqlParams, false, ref nextRowNumber))
                    {
            ...
            )
        {
            try
            {
                ...
                refreahChartOfEapIssueEventTotal();
                // --
                m_cleared = false;
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_McIssueEventTotal" + ".xlsx";

                // --

                sfd = new SaveFileDialog();
                // --                
                sfd.Title = "Export MC Issue Event Total to Excel";
                ...
                fExcelSht = fExcelExp.addExcelSheet("EAP Issue Event Total");
                ...
                // ***
                // EAP Issue Event Total Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("EAP Issue Event Total") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
        ...
        #region FEapIssueEventTotal Form Event Handler

        private void FEapIssueEventTotal_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FEapIssueEventTotal_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FEapIssueEventTotal_FormClosing(
            object sender, 
        ...
        private void FEapIssueEventTotal_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            ...
            try
            {
                ...
                if (ret.ChartElementType == ChartElementType.DataPoint)
                {
                    ...
                    refreahChartOfEapIssueEventSummary(evt);
            ...
            )
        {
            ...
            try
            {
                ...
                if (ret.ChartElementType == ChartElementType.DataPoint)
                {
                    ...
                    refreshGridOfEapHistory(eap, m_event);
                }
            }
            catch (Exception ex)
            {
