...
--
--  Program Id      : f_FComponentList.cs
--  Creator         : baehyun seo
--  Create Date     : 2012.05.09
--  Description     : FAMate Admin Manager Component List Form Class 
...
{
    public partial class FComponentList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            get
            {
                ...
                try
                {
                    if (tabMain.ActiveTab.Key == "Component")
                    {
                        ...
                        version = (string)grdComponent.activeDataRow["Release Ver."];
                    }
                    else
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                grdComponent.DisplayLayout.Bands[0].Columns["(Set) MC Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                grdComponent.DisplayLayout.Bands[0].Columns["(Rel) MC Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                grdComponent.DisplayLayout.Bands[0].Columns["(Apl) MC Count"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right;
                ...
                grdComponent.DisplayLayout.Bands[0].Columns["Create Time"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center;
                grdComponent.DisplayLayout.Bands[0].Columns["Update Time"].CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center;
                // --
                grdComponent.DisplayLayout.Bands[0].Columns["Component"].Header.Fixed = true;
                // --
                grdComponent.DisplayLayout.Bands[0].Columns["Component"].Width = 120;
                grdComponent.DisplayLayout.Bands[0].Columns["Description"].Width = 180;
                grdComponent.DisplayLayout.Bands[0].Columns["Type"].Width = 80;
                grdComponent.DisplayLayout.Bands[0].Columns["(Set) MC Count"].Width = 80;
                grdComponent.DisplayLayout.Bands[0].Columns["(Rel) MC Count"].Width = 80;
                grdComponent.DisplayLayout.Bands[0].Columns["(Apl) MC Count"].Width = 80;
                ...
                grdComponent.DisplayLayout.Bands[0].Columns["Create User ID"].Width = 100;
                grdComponent.DisplayLayout.Bands[0].Columns["Create Time"].Width = 165;
                grdComponent.DisplayLayout.Bands[0].Columns["Update User ID"].Width = 100;
                grdComponent.DisplayLayout.Bands[0].Columns["Update Time"].Width = 165;
                // --
                grdComponent.DisplayLayout.Override.AllowRowFiltering = Infragistics.Win.DefaultableBoolean.True;
                grdComponent.DisplayLayout.Override.FilterUIProvider = this.grdFilter;
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                grdVersion.DisplayLayout.Bands[0].Columns["Version"].CellAppearance.Image = Properties.Resources.ComponentVersion;
                ...
                // --
                grdVersion.DisplayLayout.Bands[0].Columns["Comment"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.FormattedText;
                // --
             ...
             )
        {
            ...
            try
            {
                ...
                beforeKey = grdComponent.activeDataRowKey;
                // --
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentList", "ListComponent", fSqlParams, false, ref nextRowNumber);
                    // --
             ...
             )
        {
            ...
            try
            {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentList", "ListComponentVer", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        createTime = FDataConvert.defaultDataTimeFormating(r[9].ToString());
             ...
             )
        {
            ...
            try
            {
                ...
                grdEap.DisplayLayout.Bands[0].SortedColumns.Clear();
                // --
                if (grdComponent.activeDataRow == null || grdVersion.activeDataRow == null)
                {
                ...
                do
                {
                    dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentList", "ListEap", fSqlParams, false, ref nextRowNumber);
                    // --
                    foreach (DataRow r in dt.Rows)
                    {
                        ...
                        cellValues = new object[] {
                            r[0].ToString(),             // EAP
                            r[1].ToString(),             // Description
                            r[38].ToString(),            // RPM Count (2017.06.07 by spike.lee)
                            eapType,                     // Type
            ...
            )
        {
            try
            {
                lblComponentTotal.Text = grdComponent.Rows.VisibleRowCount.ToString("#,##0") + " / " + grdComponent.Rows.Count.ToString("#,##0");
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private void exportGridOfComponent(
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ComponentList.xlsx";

                // --

                sfd = new SaveFileDialog();
                sfd.InitialDirectory = m_fAdmCore.fOption.recentExportPath;
                sfd.Title = "Export Component List to Excel";
                ...
                fExcelSht = FExcelExp.addExcelSheet("Component List");
                ...
                // ***
                // Component List Grid Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("Component List") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
                rowIndex = fExcelSht.writeGrid(grdComponent, rowIndex, 0);
                // --
                rowIndex += 1;
                fExcelSht.writeText("Total Count: " + grdComponent.Rows.Count.ToString(), rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_ComponentList_" + tabMain.ActiveTab.Text + ".xlsx";
                ...
                // ***
                // Component Version List Grid Write
                // ***
                rowIndex += 2;
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Component MC Detail Grid Write
                // ***
                rowIndex += 2;
            ...
            )
        {
            ...
            try
            {
                ...
                fSqlParams = new FSqlParams();
                fSqlParams.add("factory", m_fAdmCore.fOption.factory);
                dt = FCommon.requestCommonSqlQuery(m_fAdmCore, "Inquiry", "ComponentList", "SearchFactory", fSqlParams, true);
        ...
        #region FComponentList Form Event Handler

        private void FComponentList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FComponentList_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FComponentList_FormClosing(
            object sender,
        ...
        private void FComponentList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuCplRefresh)
                {
                    refresh();
                }
                else if (e.Tool.Key == FMenuKey.MenuCplExport)
                {
                    export();
                }
                ...
                else if (e.Tool.Key == FMenuKey.MenuInqComponentStatus)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuInqComponentStatus].SharedProps.Enabled = FCommon.hasFunctionAuthority(m_fAdmCore, FUserFunction.ComponentStatus);
                mnuMenu.ShowPopup(FMenuKey.MenuInqComPopupMenu);
            }
            catch (Exception ex)
            {
                FMessageBox.showError(FConstants.ApplicationName, ex, m_fAdmCore.fWsmCore.fWsmContainer);
        ...
        private void grdComponent_AfterRowFilterChanged(
            object sender,
            ...
            )
        {
            ...
            try
            {
                ...
                grdComponent.ActiveRow = e.Rows.GetRowAtVisibleIndex(activateIndex);
                grdComponent.DisplayLayout.RowScrollRegions[0].ScrollRowIntoView(grdComponent.ActiveRow);
            ...
            )
        {
            ...
            try
            {
                ...
                r = (Infragistics.Win.UltraWinGrid.UltraGridRow)grdEap.DisplayLayout.UIElement.ElementFromPoint(new Point(e.X, e.Y)).
                    GetContext(typeof(Infragistics.Win.UltraWinGrid.UltraGridRow));
                if (r != null)
                {
        ...
        #region rstComToolbar Control Event Handler

        private void rstComToolbar_SearchRequested(
            object sender,
