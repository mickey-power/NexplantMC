...
--  Description     : FAMate SECS Modeler SECS Item Log Value Transformer UI Type Editor Property Class 
...
{
    public class FPropAttrSitlValueTransformerUITypeEditor : UITypeEditor
    {
            ...
            )
        {
            ...
            try
            {
                ...
                dialog = new FValueTransformationViewer(m_fPropSitl.mainObject, m_fPropSitl.fSecsItemLog.fFormat, m_fPropSitl.fSecsItemLog.fValueTransformer);
                dialog.ShowDialog();
