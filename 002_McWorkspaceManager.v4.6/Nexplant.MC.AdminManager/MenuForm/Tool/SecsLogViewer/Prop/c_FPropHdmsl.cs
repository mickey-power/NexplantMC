...
--  Description     : FAMate SECS Modeler HOST Device Data Message Received Log Property Source Object Class 
...
{
    public class FPropHdmsl : FDynPropCusBase<FAdmCore>
    {
            ...
            )
        {
            try
            {
                ...
                // --
                base.fTypeDescriptor.properties["MultiCast"].attributes.replace(new DefaultValueAttribute(m_fHdmsl.multiCastMessage));
                base.fTypeDescriptor.properties["Guaranteed"].attributes.replace(new DefaultValueAttribute(m_fHdmsl.guaranteedMessage));
                base.fTypeDescriptor.properties["CastChannel"].attributes.replace(new DefaultValueAttribute(m_fHdmsl.castChannel));
                // --
