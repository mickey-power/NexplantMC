...
{
    public class FPropHdmrl : FDynPropCusBase<FAdmCore>
    {
            ...
            )
        {
            try
            {
                ...
                // --
                base.fTypeDescriptor.properties["MultiCast"].attributes.replace(new DefaultValueAttribute(m_fHdmrl.multiCastMessage));
                base.fTypeDescriptor.properties["Guaranteed"].attributes.replace(new DefaultValueAttribute(m_fHdmrl.guaranteedMessage));
                // --
