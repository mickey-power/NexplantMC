...
--  Description     : FAMate SECS Modeler Host Item Log Property Source Object Class 
...
{
    public class FPropHitl : FDynPropCusBase<FAdmCore>
    {
        ...
        public string OriginalValue
        {
            get
            {
                try
                {
                    return m_fHitl.originalStringValue;
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
        ...
        public string OriginalEncodingValue
        {
            get
            {
                try
                {
                    return m_fHitl.originalEncodingValue;
                }
                catch (Exception ex)
                {
            ...
            )
        {
            try
            {
                ...
                // --
                base.fTypeDescriptor.properties["OriginalValue"].attributes.replace(new DefaultValueAttribute(m_fHitl.originalStringValue));
                base.fTypeDescriptor.properties["OriginalEncodingValue"].attributes.replace(new DefaultValueAttribute(m_fHitl.originalEncodingValue));
                ...
                base.fTypeDescriptor.properties["Value"].attributes.replace(new DefaultValueAttribute(m_fHitl.stringValue));
                base.fTypeDescriptor.properties["EncodingValue"].attributes.replace(new DefaultValueAttribute(m_fHitl.encodingValue));
