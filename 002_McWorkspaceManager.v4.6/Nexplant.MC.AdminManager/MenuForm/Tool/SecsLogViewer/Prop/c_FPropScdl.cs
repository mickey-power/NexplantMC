...
{
    public class FPropScdl : FDynPropCusBase<FAdmCore>
    {
            ...
            )
        {
            try
            {
                ...
                base.fTypeDescriptor.properties["Type"].attributes.replace(new DefaultValueAttribute(m_fScdl.fSecsDriverLog.ToString()));
