...
{
    public class FPropOdcl : FDynPropCusBase<FAdmCore>
    {
        //------------------------------------------------------------------------------------------------------------------------
            ...
            )
        {
            try
            {
                ...
                base.fTypeDescriptor.properties["Namespace"].attributes.replace(new DisplayNameAttribute("Default Name Space"));
            ...
            )
        {
            try
            {
                ...
                if (m_fOdcl.fProtocol == FProtocol.KEPWARE)
                {
