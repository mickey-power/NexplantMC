...
{
    public partial class FAlertServiceLogList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                grdLog.DisplayLayout.Bands[0].Columns["File Name"].Width = 300;
                grdLog.DisplayLayout.Bands[0].Columns["Start Time"].Width = 170;
                grdLog.DisplayLayout.Bands[0].Columns["Creation Time"].Width = 170;
                grdLog.DisplayLayout.Bands[0].Columns["Last Write Time"].Width = 170;
                grdLog.DisplayLayout.Bands[0].Columns["Last Access Time"].Width = 170;
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TolAlertServiceLogList_In.E_ADMADS_TolAlertServiceLogList_In);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceLogList_In.A_hLanguage, FADMADS_TolAlertServiceLogList_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceLogList_In.A_hFactory, FADMADS_TolAlertServiceLogList_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceLogList_In.A_hUserId, FADMADS_TolAlertServiceLogList_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceLogList_In.A_hStep, FADMADS_TolAlertServiceLogList_In.D_hStep, "1");
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAlertServiceLogList_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceLogList_In.FLog.A_Type, FADMADS_TolAlertServiceLogList_In.FLog.D_Type, ucbLogType.Text);

                // --

                do
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceLogList_In.FLog.A_NextRowNumber, FADMADS_TolAlertServiceLogList_In.FLog.D_NextRowNumber, nextRowNumber.ToString());

                    // --

                    FADMADSCaster.ADMADS_TolAlertServiceLogList_Req(
                        m_fAdmCore.fH101,
                        fXmlNodeIn,
                        ref fXmlNodeOut
                        );
                    // --
                    if (fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceLogList_Out.A_hStatus, FADMADS_TolAlertServiceLogList_Out.D_hStatus) != "0")
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceLogList_Out.A_hStatusMessage, FADMADS_TolAlertServiceLogList_Out.D_hStatusMessage)
                            );
                    }

                    // --

                    fXmlNodeOutTbl = fXmlNodeOut.get_elem(FADMADS_TolAlertServiceLogList_Out.FTable.E_Table);
                    // --
                    dt = FDbWizard.stringToDataTable(fXmlNodeOutTbl.get_elemVal(FADMADS_TolAlertServiceLogList_Out.FTable.A_Rows, FADMADS_TolAlertServiceLogList_Out.FTable.D_Rows));
                    //--
                    ...
                    nextRowNumber = int.Parse(
                        fXmlNodeOutTbl.get_elemVal(FADMADS_TolAlertServiceLogList_Out.FTable.A_NextRowNumber, FADMADS_TolAlertServiceLogList_Out.FTable.D_NextRowNumber)
                        );
            ...
            )
        {
            ...
            try
            {
                fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "_AlertServiceLogList.xlsx";

                // --

                sfd = new SaveFileDialog();
                // --
                sfd.Title = "Export Alert Service Log List to Excel";
                ...
                fExcelSht = fExcelExp.addExcelSheet("Alert Service Log List");
                ...
                // ***
                // Alert Service Log List Grid Write
                // ***
                rowIndex += 2;
                fExcelSht.writeText("[" + m_fAdmCore.fUIWizard.searchCaption("Alert Service Log List") + "]", rowIndex, 0, m_fAdmCore.fUIWizard.fontName, 9, true);
                // --
                rowIndex += 1;
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceLogDownload_In.FLog.A_File, FADMADS_TolAlertServiceLogDownload_In.FLog.D_File, key);
                    ...
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceLogDownload_Out.A_hStatusMessage, FADMADS_TolAlertServiceLogDownload_Out.D_hStatusMessage)
                            );
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                if (extension == FExtensionType.log.ToString())
                {
                    ...
                    fApplicationLogViewer = new FApplicationLogViewer(m_fAdmCore, grdLog.activeDataRowKey ,FLogFileType.AlertServiceLogFile);
                ...
                else if (extension == FExtensionType.dlg.ToString())
                {
                    ...
                    fDebugLogViewer = new FDebugLogViewer(m_fAdmCore, grdLog.activeDataRowKey, FLogFileType.AlertServiceLogFile);
        ...
        #region FAlertServiceLogList Form Event Handler

        private void FAlertServiceLogList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FAlertServiceLogList_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FAlertServiceLogList_FormClosing(
            object sender,
        ...
        private void FAlertServiceLogList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
