...
--
--  Program Id      : f_FAdminServiceBackupLogList.cs
--  Creator         : baehyun.seo
...
{
    public partial class FAdminServiceBackupLogList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        public FAdminServiceBackupLogList()
        {
            InitializeComponent();
        }
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TolAdminServiceBackupLogList_In.E_ADMADS_TolAdminServiceBackupLogList_In);
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogList_In.A_hLanguage, FADMADS_TolAdminServiceBackupLogList_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogList_In.A_hFactory, FADMADS_TolAdminServiceBackupLogList_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogList_In.A_hUserId, FADMADS_TolAdminServiceBackupLogList_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogList_In.A_hStep, FADMADS_TolAdminServiceBackupLogList_In.D_hStep, "1");
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAdminServiceBackupLogList_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAdminServiceBackupLogList_In.FLog.A_Type, FADMADS_TolAdminServiceBackupLogList_In.FLog.D_Type, ucbLogType.Text);


                do
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAdminServiceBackupLogList_In.FLog.A_NextRowNumber, FADMADS_TolAdminServiceBackupLogList_In.FLog.D_NextRowNumber, nextRowNumber.ToString());

                    // --

                    FADMADSCaster.ADMADS_TolAdminServiceBackupLogList_Req(
                        m_fAdmCore.fH101,
                        fXmlNodeIn,
                        ref fXmlNodeOut
                        );
                    // --
                    if (fXmlNodeOut.get_elemVal(FADMADS_TolAdminServiceBackupLogList_Out.A_hStatus, FADMADS_TolAdminServiceBackupLogList_Out.D_hStatus) != "0")
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAdminServiceBackupLogList_Out.A_hStatusMessage, FADMADS_TolAdminServiceBackupLogList_Out.D_hStatusMessage)
                            );
                    }

                    // --

                    fXmlNodeOutTbl = fXmlNodeOut.get_elem(FADMADS_TolAdminServiceBackupLogList_Out.FTable.E_Table);
                    // --
                    dt = FDbWizard.stringToDataTable(fXmlNodeOutTbl.get_elemVal(FADMADS_TolAdminServiceBackupLogList_Out.FTable.A_Rows, FADMADS_TolAdminServiceBackupLogList_Out.FTable.D_Rows));
                    //--
                    ...
                    nextRowNumber = int.Parse(
                        fXmlNodeOutTbl.get_elemVal(FADMADS_TolAdminServiceBackupLogList_Out.FTable.A_NextRowNumber, FADMADS_TolAdminServiceBackupLogList_Out.FTable.D_NextRowNumber)
                        );
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TolAdminServiceBackupLogSearch_In.E_ADMADS_TolAdminServiceBackupLogSearch_In);
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogSearch_In.A_hLanguage, FADMADS_TolAdminServiceBackupLogSearch_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogSearch_In.A_hFactory, FADMADS_TolAdminServiceBackupLogSearch_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogSearch_In.A_hUserId, FADMADS_TolAdminServiceBackupLogSearch_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TolAdminServiceBackupLogSearch_In.A_hStep, FADMADS_TolAdminServiceBackupLogSearch_In.D_hStep, "1");
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAdminServiceBackupLogSearch_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAdminServiceBackupLogSearch_In.FLog.A_BackupLog, FADMADS_TolAdminServiceBackupLogSearch_In.FLog.D_BackupLog, grdBackup.activeDataRowKey);

                // --

                do
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAdminServiceBackupLogSearch_In.FLog.A_NextRowNumber, FADMADS_TolAdminServiceBackupLogSearch_In.FLog.D_NextRowNumber, nextRowNumber.ToString());

                    // --

                    FADMADSCaster.ADMADS_TolAdminServiceBackupLogSearch_Req(
                        m_fAdmCore.fH101,
                        fXmlNodeIn,
                        ref fXmlNodeOut
                        );
                    // --
                    if (fXmlNodeOut.get_elemVal(FADMADS_TolAdminServiceBackupLogSearch_Out.A_hStatus, FADMADS_TolAdminServiceBackupLogSearch_Out.D_hStatus) != "0")
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAdminServiceBackupLogSearch_Out.A_hStatusMessage, FADMADS_TolAdminServiceBackupLogSearch_Out.D_hStatusMessage)
                            );
                    }

                    // --

                    fXmlNodeOutTbl = fXmlNodeOut.get_elem(FADMADS_TolAdminServiceBackupLogSearch_Out.FTable.E_Table);
                    // --
                    dt = FDbWizard.stringToDataTable(fXmlNodeOutTbl.get_elemVal(FADMADS_TolAdminServiceBackupLogSearch_Out.FTable.A_Rows, FADMADS_TolAdminServiceBackupLogSearch_Out.FTable.D_Rows));
                    //--
                    foreach (DataRow r in dt.Rows)
                    {
                        cellValues = new object[] {
                    ...
                    nextRowNumber = int.Parse(
                        fXmlNodeOutTbl.get_elemVal(FADMADS_TolAdminServiceBackupLogSearch_Out.FTable.A_NextRowNumber, FADMADS_TolAdminServiceBackupLogSearch_Out.FTable.D_NextRowNumber)
                        );
                } while (nextRowNumber >= 0);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAdminServiceBackupLogDownload_In.FLog.A_File, FADMADS_TolAdminServiceBackupLogDownload_In.FLog.D_File, key);
                    ...
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAdminServiceBackupLogDownload_Out.A_hStatusMessage, FADMADS_TolAdminServiceBackupLogDownload_Out.D_hStatusMessage)
                            );
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAdminServiceBackupLogDownload_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAdminServiceBackupLogDownload_In.FLog.A_File, FADMADS_TolAdminServiceBackupLogDownload_In.FLog.D_File, grdBackup.activeDataRowKey);
            ...
            )
        {
            ...
            try
            {
                ...
                if (extension == FExtensionType.log.ToString())
                {
                    ...
                    fAppLogViewer = new FApplicationLogViewer(m_fAdmCore, string.Empty, string.Empty, grdBackup.activeDataRowKey, grdLog.activeDataRowKey, FLogFileType.AdminServiceLogFile);
                ...
                else if (extension == FExtensionType.dlg.ToString())
                {
                    ...
                    fDbgLogViewer = new FDebugLogViewer(
                        ...
                        FLogFileType.AdminServiceLogFile
                        );
        ...
        #region FAdminServiceBackupLogList Form Event Handler

        private void FAdminServiceBackupLogList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FAdminServiceBackupLogList_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FAdminServiceBackupLogList_FormClosing(
            object sender,
        ...
        private void FAdminServiceBackupLogList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
