...
--
--  Program Id      : f_FEapLogViewer.cs
--  Creator         : mjkim
--  Create Date     : 2015.09.02
--  Description     : FAMate Admin Manager EAP Log Viewer Form Class 
--  History         : Created by mjkim at 2015.09.02
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FEapLogViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuElvRefresh].SharedProps.Enabled = m_fileName == string.Empty ? false : true;
                // --
                mnuMenu.Tools[FMenuKey.MenuElvFind].SharedProps.Enabled = true;
            ...
            )
        {
            ...
            try
            {
                preFontName = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuElvFontName]).Value.ToString();
                // -- 
        ...
        #region FEapLogViewer Form Event Handler

        private void FEapLogViewer_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                ((FontListTool)mnuMenu.Tools[FMenuKey.MenuElvFontName]).Text = m_fAdmCore.fOption.fontName;
                numFontSize.Value = m_fAdmCore.fOption.fontSize;

                // --

                txtLog.Appearance.FontData.Name = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuElvFontName]).Value.ToString();
                txtLog.Appearance.FontData.SizeInPoints = float.Parse(numFontSize.Value.ToString());
        ...
        private void FEapLogViewer_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FEapLogViewer_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuElvRefresh)
                {
                    refreshLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuElvFind)
                {
                    txtLog.showSearcher();
                }
                else if (e.Tool.Key == FMenuKey.MenuElvPrevious)
                {
                    procMenuPrevious();
                }
                else if (e.Tool.Key == FMenuKey.MenuElvNext)
                {
                    procMenuNext();
                }
            }
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuAlvFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuElvFontName]).Value = m_fAdmCore.fOption.fontName;
