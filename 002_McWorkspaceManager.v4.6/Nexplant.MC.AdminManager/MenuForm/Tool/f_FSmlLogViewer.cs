...
--
--  Program Id      : f_FSmlLogViewer.cs
--  Creator         : mjkim
--  Create Date     : 2013.01.11
--  Description     : FAMate Admin Manager SML Log Viewer Form Class 
...
{
    public partial class FSmlLogViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuMlvRefresh].SharedProps.Enabled = false;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuMlvPrevious].SharedProps.Enabled = false;
                    mnuMenu.Tools[FMenuKey.MenuMlvNext].SharedProps.Enabled = false;
                }
                else
                {
                    mnuMenu.Tools[FMenuKey.MenuMlvRefresh].SharedProps.Enabled = true;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuMlvPrevious].SharedProps.Enabled = true;
                    mnuMenu.Tools[FMenuKey.MenuMlvNext].SharedProps.Enabled = true;
                }
                // --
                mnuMenu.Tools[FMenuKey.MenuMlvFind].SharedProps.Enabled = true;
            ...
            )
        {
            ...
            try
            {
                preFontName = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuMlvFontName]).Value.ToString();
                // -- 
            ...
            )
        {
            try
            {
                ...
                txtFileName.Text = "Convert To SML";
                controlMenu();
            }
            catch (Exception ex)
            {
        ...
        #region FSmlLogViewer Form Event Handler

        private void FSmlLogViewer_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                ((FontListTool)mnuMenu.Tools[FMenuKey.MenuMlvFontName]).Text = m_fAdmCore.fOption.fontName;
                numFontSize.Value = m_fAdmCore.fOption.fontSize;

                // --

                txtLog.Appearance.FontData.Name = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuMlvFontName]).Value.ToString();
                txtLog.Appearance.FontData.SizeInPoints = float.Parse(numFontSize.Value.ToString());
        ...
        private void FSmlLogViewer_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FSmlLogViewer_FormClosing(
            object sender, 
        ...
        private void FSmlLogViewer_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuMlvRefresh)
                {
                    refreshLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuMlvFind)
                {
                    txtLog.showSearcher();
                }
                else if (e.Tool.Key == FMenuKey.MenuMlvPrevious)
                {
                    continueLogFile(FLogContinuity.Previous);
                }
                else if (e.Tool.Key == FMenuKey.MenuMlvNext)
                {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuAlvFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuMlvFontName]).Value = m_fAdmCore.fOption.fontName;
