...
--  Description     : FAMate TCP Modeler Data Log Value Transformer UI Type Editor Property Class 
--  History         : Created by spike.lee at 2011.12.12
----------------------------------------------------------------------------------------------------------*/
using System;
    ...
    public class FPropAttrDatlValueTransformerUITypeEditor : UITypeEditor
    {
            ...
            )
        {
            ...
            try
            {
                ...
                dialog = new FValueTransformationViewer(m_fPropDatl.mainObject, m_fPropDatl.fDataLog.fFormat, m_fPropDatl.fDataLog.fValueTransformer);
                dialog.ShowDialog();
