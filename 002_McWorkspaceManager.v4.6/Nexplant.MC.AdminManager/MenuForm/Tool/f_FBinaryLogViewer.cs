...
--  Description     : FAMate Admin Manager Binary Log Viewer Form Class 
    ...
    public partial class FBinaryLogViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuBlvRefresh].SharedProps.Enabled = m_fileName == string.Empty ? false : true;
                // --
                mnuMenu.Tools[FMenuKey.MenuBlvFind].SharedProps.Enabled = true;
            ...
            )
        {
            ...
            try
            {
                preFontName = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuBlvFontName]).Value.ToString();
                // -- 
            ...
            )
        {
            try
            {
                ...
                ((FontListTool)mnuMenu.Tools[FMenuKey.MenuBlvFontName]).Text = m_fAdmCore.fOption.fontName;
                numFontSize.Value = m_fAdmCore.fOption.fontSize;

                // --

                txtLog.Appearance.FontData.Name = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuBlvFontName]).Value.ToString();
                txtLog.Appearance.FontData.SizeInPoints = float.Parse(numFontSize.Value.ToString());
        ...
        private void FBinaryLogViewer_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuBlvRefresh)
                {
                    refreshLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuBlvFind)
                {
                    txtLog.showSearcher();
                }
                else if (e.Tool.Key == FMenuKey.MenuBlvPrevious)
                {
                    continueLogFile(FLogContinuity.Previous);
                }
                else if (e.Tool.Key == FMenuKey.MenuBlvNext)
                {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuBlvFontName)
                {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuAlvFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuBlvFontName]).Value = m_fAdmCore.fOption.fontName;
