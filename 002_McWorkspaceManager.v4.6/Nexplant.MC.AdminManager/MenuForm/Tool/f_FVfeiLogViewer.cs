...
--
--  Program Id      : f_FVfeiLogViewer.cs
--  Creator         : baehyun.seo
--  Create Date     : 2013.01.15
--  Description     : FAMate Admin Manager VFEI Log Viewer Form Class 
--  History         : Created by baehyun.seo at 2013.01.15
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FVfeiLogViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuVlvRefresh].SharedProps.Enabled = false;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuVlvPrevious].SharedProps.Enabled = false;
                    mnuMenu.Tools[FMenuKey.MenuVlvNext].SharedProps.Enabled = false;
                }
                else
                {
                    mnuMenu.Tools[FMenuKey.MenuVlvRefresh].SharedProps.Enabled = true;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuVlvPrevious].SharedProps.Enabled = true;
                    mnuMenu.Tools[FMenuKey.MenuVlvNext].SharedProps.Enabled = true;
                }
                // --
                mnuMenu.Tools[FMenuKey.MenuVlvFind].SharedProps.Enabled = true;
            ...
            )
        {
            ...
            try
            {
                preFontName = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuVlvFontName]).Value.ToString();
                // -- 
            ...
            )
        {
            try
            {
                ...
                txtFileName.Text = "Convert To VFEI";
                controlMenu();
            }
            catch (Exception ex)
            {
        ...
        #region FVfeiLogViewer Form Event Handler

        private void FVfeiLogViewer_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                ((FontListTool)mnuMenu.Tools[FMenuKey.MenuVlvFontName]).Text = m_fAdmCore.fOption.fontName;
                numFontSize.Value = m_fAdmCore.fOption.fontSize;

                // --

                txtLog.Appearance.FontData.Name = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuVlvFontName]).Value.ToString();
                txtLog.Appearance.FontData.SizeInPoints = float.Parse(numFontSize.Value.ToString());
        ...
        private void FVfeiLogViewer_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FVfeiLogViewer_FormClosing(
            object sender, 
        ...
        private void FVfeiLogViewer_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuVlvRefresh)
                {
                    refreshLog();
                }
                else if (e.Tool.Key == FMenuKey.MenuVlvFind)
                {
                    txtLog.showSearcher();
                }
                else if (e.Tool.Key == FMenuKey.MenuVlvPrevious)
                {
                    continueLogFile(FLogContinuity.Previous);
                }
                else if (e.Tool.Key == FMenuKey.MenuVlvNext)
                {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuVlvFontName)
                {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuAlvFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuVlvFontName]).Value = m_fAdmCore.fOption.fontName;
