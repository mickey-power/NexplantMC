...
--
--  Program Id      : f_FAlertServiceBackupLogList.cs
--  Creator         : iskim
--  Create Date     : 2013.06.03
--  Description     : FAMate Alert Service Backup Log List Form Class 
--  History         : Created by iskim at 2013.06.03
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FAlertServiceBackupLogList : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        public FAlertServiceBackupLogList()
        {
            InitializeComponent();
        }
            ...
            )
        {
            try
            {
                ...
                if (m_cleared)
                {
                    mnuMenu.Tools[FMenuKey.MenuSblDownload].SharedProps.Enabled = false;
                    mnuMenu.Tools[FMenuKey.MenuSblView].SharedProps.Enabled = false;
                }
                else
                {
                    mnuMenu.Tools[FMenuKey.MenuSblDownload].SharedProps.Enabled = grdBackup.activeDataRowKey == string.Empty && grdLog.activeDataRowKey == string.Empty ? false : true;
                    mnuMenu.Tools[FMenuKey.MenuSblView].SharedProps.Enabled = grdLog.activeDataRowKey == string.Empty ? false : true;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                grdBackup.ImageList = new ImageList();
                // --
                grdBackup.ImageList.Images.Add("File_Zip", Properties.Resources.File_Zip);
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                ...
                // ***
                // Admin Service Backup Log List Clear
                // ***
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TolAlertServiceBackupLogList_In.E_ADMADS_TolAlertServiceBackupLogList_In);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogList_In.A_hLanguage, FADMADS_TolAlertServiceBackupLogList_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogList_In.A_hFactory, FADMADS_TolAlertServiceBackupLogList_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogList_In.A_hUserId, FADMADS_TolAlertServiceBackupLogList_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogList_In.A_hStep, FADMADS_TolAlertServiceBackupLogList_In.D_hStep, "1");
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAlertServiceBackupLogList_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceBackupLogList_In.FLog.A_Type, FADMADS_TolAlertServiceBackupLogList_In.FLog.D_Type, ucbLogType.Text);


                do
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceBackupLogList_In.FLog.A_NextRowNumber, FADMADS_TolAlertServiceBackupLogList_In.FLog.D_NextRowNumber, nextRowNumber.ToString());

                    // --

                    FADMADSCaster.ADMADS_TolAlertServiceBackupLogList_Req(
                        m_fAdmCore.fH101,
                        fXmlNodeIn,
                        ref fXmlNodeOut
                        );
                    // --
                    if (fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceBackupLogList_Out.A_hStatus, FADMADS_TolAlertServiceBackupLogList_Out.D_hStatus) != "0")
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceBackupLogList_Out.A_hStatusMessage, FADMADS_TolAlertServiceBackupLogList_Out.D_hStatusMessage)
                            );
                    }

                    // --

                    fXmlNodeOutTbl = fXmlNodeOut.get_elem(FADMADS_TolAlertServiceBackupLogList_Out.FTable.E_Table);
                    // --
                    dt = FDbWizard.stringToDataTable(fXmlNodeOutTbl.get_elemVal(FADMADS_TolAlertServiceBackupLogList_Out.FTable.A_Rows, FADMADS_TolAlertServiceBackupLogList_Out.FTable.D_Rows));
                    //--
                    foreach (DataRow r in dt.Rows)
                    {
                        ...
                        grdBackup.Rows[index].Cells[0].Appearance.Image = getImageOfLog(r[0].ToString());
                    }

                    // --

                    nextRowNumber = int.Parse(
                        fXmlNodeOutTbl.get_elemVal(FADMADS_TolAlertServiceBackupLogList_Out.FTable.A_NextRowNumber, FADMADS_TolAlertServiceBackupLogList_Out.FTable.D_NextRowNumber)
                        );
                ...
                grdBackup.DisplayLayout.Bands[0].SortedColumns.Add("File Name", true);
                ...
                if (grdBackup.Rows.Count > 0)
                {
                    ...
                    {
                        grdBackup.ActiveRow = grdBackup.Rows[0];
                    }
                }
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_TolAlertServiceBackupLogSearch_In.E_ADMADS_TolAlertServiceBackupLogSearch_In);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogSearch_In.A_hLanguage, FADMADS_TolAlertServiceBackupLogSearch_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogSearch_In.A_hFactory, FADMADS_TolAlertServiceBackupLogSearch_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogSearch_In.A_hUserId, FADMADS_TolAlertServiceBackupLogSearch_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_TolAlertServiceBackupLogSearch_In.A_hStep, FADMADS_TolAlertServiceBackupLogSearch_In.D_hStep, "1");
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAlertServiceBackupLogSearch_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceBackupLogSearch_In.FLog.A_BackupLog, FADMADS_TolAlertServiceBackupLogSearch_In.FLog.D_BackupLog, grdBackup.activeDataRowKey);

                // --

                do
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceBackupLogSearch_In.FLog.A_NextRowNumber, FADMADS_TolAlertServiceBackupLogSearch_In.FLog.D_NextRowNumber, nextRowNumber.ToString());

                    // --

                    FADMADSCaster.ADMADS_TolAlertServiceBackupLogSearch_Req(
                        m_fAdmCore.fH101,
                        fXmlNodeIn,
                        ref fXmlNodeOut
                        );
                    // --
                    if (fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceBackupLogSearch_Out.A_hStatus, FADMADS_TolAlertServiceBackupLogSearch_Out.D_hStatus) != "0")
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceBackupLogSearch_Out.A_hStatusMessage, FADMADS_TolAlertServiceBackupLogSearch_Out.D_hStatusMessage)
                            );
                    }

                    // --

                    fXmlNodeOutTbl = fXmlNodeOut.get_elem(FADMADS_TolAlertServiceBackupLogSearch_Out.FTable.E_Table);
                    // --
                    dt = FDbWizard.stringToDataTable(fXmlNodeOutTbl.get_elemVal(FADMADS_TolAlertServiceBackupLogSearch_Out.FTable.A_Rows, FADMADS_TolAlertServiceBackupLogSearch_Out.FTable.D_Rows));
                    //--
                    foreach (DataRow r in dt.Rows)
                    {
                        cellValues = new object[] {
                    ...
                    nextRowNumber = int.Parse(
                        fXmlNodeOutTbl.get_elemVal(FADMADS_TolAlertServiceBackupLogSearch_Out.FTable.A_NextRowNumber, FADMADS_TolAlertServiceBackupLogSearch_Out.FTable.D_NextRowNumber)
                        );
                } while (nextRowNumber >= 0);
                ...
                grdLog.DisplayLayout.Bands[0].SortedColumns.Add("File Name", true);
                ...
                if (grdLog.Rows.Count > 0)
                {
                    ...
                    {
                        grdLog.ActiveRow = grdLog.Rows[0];
                    }
                }
            ...
            )
        {
            ...
            try
            {
                ...
                downloadFilePath = Path.Combine(fbd.SelectedPath, string.Format("{0}_AlertService_Log", m_fAdmCore.fOption.factory));
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceBackupLogDownload_In.FLog.A_File, FADMADS_TolAlertServiceBackupLogDownload_In.FLog.D_File, key);
                    ...
                    {
                        FDebug.throwFException(
                            fXmlNodeOut.get_elemVal(FADMADS_TolAlertServiceBackupLogDownload_Out.A_hStatusMessage, FADMADS_TolAlertServiceBackupLogDownload_Out.D_hStatusMessage)
                            );
                    }
                    ...
                    F7Zip.unpack(Path.Combine(tempFilePath, zipFileName), downloadFilePath);
                }
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                fXmlNodeInLog = fXmlNodeIn.set_elem(FADMADS_TolAlertServiceBackupLogDownload_In.FLog.E_Log);
                fXmlNodeInLog.set_elemVal(FADMADS_TolAlertServiceBackupLogDownload_In.FLog.A_File, FADMADS_TolAlertServiceBackupLogDownload_In.FLog.D_File, grdBackup.activeDataRowKey);
                ...
                F7Zip.unpack(Path.Combine(tempFilePath, grdBackup.activeDataRowKey), tempFilePath);
            ...
            )
        {
            ...
            try
            {
                ...
                if (extension == FExtensionType.log.ToString())
                {
                    foreach (FBaseTabChildForm fChildForm in m_fAdmCore.fAdmContainer.fChilds)
                    {
                        if (fChildForm is FApplicationLogViewer &&
                            ((FApplicationLogViewer)fChildForm).fileName == grdLog.activeDataRowKey
                            )
                        {   
                    ...
                    fAppLogViewer = new FApplicationLogViewer(m_fAdmCore, string.Empty, string.Empty, grdBackup.activeDataRowKey, grdLog.activeDataRowKey, FLogFileType.AlertServiceLogFile);
                    m_fAdmCore.fAdmContainer.showChild(fAppLogViewer);
                    fAppLogViewer.activate();
                }
                else if (extension == FExtensionType.dlg.ToString())
                {
                    ...
                    fDbgLogViewer = new FDebugLogViewer(
                        m_fAdmCore, 
                        string.Empty, 
                        string.Empty, 
                        string.Empty,
                        ...
                        FLogFileType.AlertServiceLogFile
                        );
                    m_fAdmCore.fAdmContainer.showChild(fDbgLogViewer);
                    fDbgLogViewer.activate();
                }
            }
            catch (Exception ex)
        ...
        #region FAlertServiceBackupLogList Form Event Handler

        private void FAlertServiceBackupLogList_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FAlertServiceBackupLogList_Shown(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FAlertServiceBackupLogList_FormClosing(
            object sender,
        ...
        private void FAlertServiceBackupLogList_KeyDown(
            object sender, 
            KeyEventArgs e
            )
        {
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuSblRefresh)
                {
                    refreshGridOfBackupLogList();
                }
                else if (e.Tool.Key == FMenuKey.MenuSblDownload)
                {
                    download();
                }
                else if (e.Tool.Key == FMenuKey.MenuSblView)
                {
                    viewOfLog();
                }
            }
            ...
            )
        {
            ...
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuSblView].SharedProps.Visible = false;

                // --

                mnuMenu.ShowPopup(FMenuKey.MenuSblPopupMenu);
            }
            catch (Exception ex)
            {
                FMessageBox.showError(FConstants.ApplicationName, ex, m_fAdmCore.fWsmCore.fWsmContainer);
            ...
            )
        {
            ...
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuSblView].SharedProps.Visible = true;
