...
--
--  Program Id      : f_FEquipmentEventDefineRequest.cs
--  Creator         : hsshim
--  Create Date     : 2013.02.14
--  Description     : FAMate Admin Manager Remote Command - Equipment Event Define Form Class 
--  History         : Created by hsshim at 2013.02.14
                    : Modify by hsshim at 2013.06.11
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public partial class FEquipmentEventDefineRequest : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FIRemoteCommand
    {
        ...
        public FEquipmentEventDefineRequest(
            )
        {
            InitializeComponent();
        }
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_RcmEquipmentEventDefineRequest_In.E_ADMADS_RcmEquipmentEventDefineRequest_In);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentEventDefineRequest_In.A_hLanguage, FADMADS_RcmEquipmentEventDefineRequest_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentEventDefineRequest_In.A_hStep, FADMADS_RcmEquipmentEventDefineRequest_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentEventDefineRequest_In.A_hFactory, FADMADS_RcmEquipmentEventDefineRequest_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentEventDefineRequest_In.A_hUserId, FADMADS_RcmEquipmentEventDefineRequest_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentEventDefineRequest_In.A_hHostIp, FADMADS_RcmEquipmentEventDefineRequest_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentEventDefineRequest_In.A_hHostName, FADMADS_RcmEquipmentEventDefineRequest_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_RcmEquipmentEventDefineRequest_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_RcmEquipmentEventDefineRequest_In.FEap.A_EapId,
                            FADMADS_RcmEquipmentEventDefineRequest_In.FEap.D_EapId,
                            r["EAP"].ToString()
                            );
                        // --
                        fXmlNodeInEqp = fXmlNodeInEap.set_elem(FADMADS_RcmEquipmentEventDefineRequest_In.FEap.FEquipment.E_Equipment);
                        fXmlNodeInEqp.set_elemVal(
                            FADMADS_RcmEquipmentEventDefineRequest_In.FEap.FEquipment.A_EquipmentId,
                            FADMADS_RcmEquipmentEventDefineRequest_In.FEap.FEquipment.D_EquipmentId,
                            r["Equipment"].ToString()
                            );
                        // --
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_RcmEquipmentEventDefineRequest_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );

                            if (fXmlNodeOut.get_elemVal(FADMADS_RcmEquipmentEventDefineRequest_Out.A_hStatus, FADMADS_RcmEquipmentEventDefineRequest_Out.D_hStatus) != "0")
                            {
                                ...
                                msg = fXmlNodeOut.get_elemVal(FADMADS_RcmEquipmentEventDefineRequest_Out.A_hStatusMessage, FADMADS_RcmEquipmentEventDefineRequest_Out.D_hStatusMessage);
                                // --
                                fCnt++;
                            }
                            else
        ...
        #region FEquipmentEventDefineRequest Form Event Handler

        private void FEquipmentEventDefineRequest_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FEquipmentEventDefineRequest_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FEquipmentEventDefineRequest_FormClosing(
            object sender, 
