...
--
--  Program Id      : f_FEquipmentControlModeRequest.cs
--  Creator         : hsshim
--  Create Date     : 2013.02.20
--  Description     : FAMate Admin Manager Remote Command - Equipment Control Mode Request Form Class 
...
{
    public partial class FEquipmentControlModeRequest : Nexplant.MC.Core.FaUIs.FBaseTabChildDialogForm, FIRemoteCommand
    {
        ...
        public FEquipmentControlModeRequest(
            )
        {
            InitializeComponent();
        }
            ...
            )
        {
            ...
            try
            {
                ...
                btnRequest.Enabled = FCommon.hasTransactionAuthority(m_fAdmCore, FUserFunction.EquipmentControlModeRequest);
            }
            catch (Exception ex)
            {
                grdList.endUpdate();
            ...
            )
        {
            ...
            try
            {
                ...
                fXmlNodeIn = FCommon.createXmlNode(FADMADS_RcmEquipmentControlModeRequest_In.E_ADMADS_RcmEquipmentControlModeRequest_In);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentControlModeRequest_In.A_hLanguage, FADMADS_RcmEquipmentControlModeRequest_In.D_hLanguage, m_fAdmCore.fWsmOption.language.ToString());
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentControlModeRequest_In.A_hStep, FADMADS_RcmEquipmentControlModeRequest_In.D_hStep, "1");
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentControlModeRequest_In.A_hFactory, FADMADS_RcmEquipmentControlModeRequest_In.D_hFactory, m_fAdmCore.fOption.factory);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentControlModeRequest_In.A_hUserId, FADMADS_RcmEquipmentControlModeRequest_In.D_hUserId, m_fAdmCore.fOption.user);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentControlModeRequest_In.A_hHostIp, FADMADS_RcmEquipmentControlModeRequest_In.D_hHostIp, m_fAdmCore.fOption.hostIPAddrress);
                fXmlNodeIn.set_elemVal(FADMADS_RcmEquipmentControlModeRequest_In.A_hHostName, FADMADS_RcmEquipmentControlModeRequest_In.D_hHostName, m_fAdmCore.fOption.hostName);
                // --
                fXmlNodeInEap = fXmlNodeIn.set_elem(FADMADS_RcmEquipmentControlModeRequest_In.FEap.E_Eap);
                ...
                foreach (UltraDataRow r in grdList.dataSource.Rows)
                {
                    ...
                    else
                    {
                        fXmlNodeInEap.set_elemVal(
                            FADMADS_RcmEquipmentControlModeRequest_In.FEap.A_EapId,
                            FADMADS_RcmEquipmentControlModeRequest_In.FEap.D_EapId,
                            r["EAP"].ToString()
                            );
                        // --
                        fXmlNodeInEqp = fXmlNodeInEap.set_elem(FADMADS_RcmEquipmentControlModeRequest_In.FEap.FEquipment.E_Equipment);
                        fXmlNodeInEqp.set_elemVal(
                            FADMADS_RcmEquipmentControlModeRequest_In.FEap.FEquipment.A_EquipmentId,
                            FADMADS_RcmEquipmentControlModeRequest_In.FEap.FEquipment.D_EquipmentId,
                             r["Equipment"].ToString()
                            );
                        // --
                        ...
                        try
                        {
                            FADMADSCaster.ADMADS_RcmEquipmentControlModeRequest_Req(
                                m_fAdmCore.fH101,
                                fXmlNodeIn,
                                ref fXmlNodeOut
                                );

                            if (fXmlNodeOut.get_elemVal(FADMADS_RcmEquipmentControlModeRequest_Out.A_hStatus, FADMADS_RcmEquipmentControlModeRequest_Out.D_hStatus) != "0")
                            {
                                ...
                                msg = fXmlNodeOut.get_elemVal(FADMADS_RcmEquipmentControlModeRequest_Out.A_hStatusMessage, FADMADS_RcmEquipmentControlModeRequest_Out.D_hStatusMessage);
                                // --
                                fCnt++;
                            }
                            else
        ...
        #region FEquipmentControlModeRequest Form Event Handler

        private void FEquipmentControlModeRequest_Load(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FEquipmentControlModeRequest_Shown(
            object sender, 
            EventArgs e
            )
        {
        ...
        private void FEquipmentControlModeRequest_FormClosing(
            object sender, 
