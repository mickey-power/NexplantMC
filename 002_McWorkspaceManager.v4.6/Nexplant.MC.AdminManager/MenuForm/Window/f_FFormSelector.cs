...
{
    public partial class FFormSelector : FBaseStandardDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                for (int i = 0; i < m_fAdmCore.fOption.fChildFormList.count; i++)
                {
                    cellValues = new object[] {fUIWizard.searchCaption(m_fAdmCore.fOption.fChildFormList.getTextOfIndex(i)) };
                    grdList.appendDataRow(m_fAdmCore.fOption.fChildFormList.getKeyOfIndex(i), cellValues);
                }
            ...
            )
        {
            ...
            try
            {
                fChildForm = (FBaseTabChildForm)m_fAdmCore.fOption.fChildFormList.getFormOfKey(grdList.activeDataRowKey);
                fChildForm.activate();
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (UltraDataRow row in grdList.selectedDataRows)
                {
                    ...
                    ((FBaseTabChildForm)m_fAdmCore.fOption.fChildFormList.getFormOfKey(key)).Close();
                    // --
