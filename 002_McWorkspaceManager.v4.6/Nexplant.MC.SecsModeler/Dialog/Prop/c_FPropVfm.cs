...
{
    public class FPropVfm : FDynPropCusBase<FSsmCore>
    {
        ...
        public string Type
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    else if (type == FValueFormulaType.DateTimeTicks)
                    {
                        m_fValueFormula = new FDateTimeTicks();
                    }
                    ...
                    else if (type == FValueFormulaType.RemoveNonPrintable)
                    {
                        m_fValueFormula = new FRemoveNonPrintable();
                    }
