...
--  Description     : FAMate SECS Modeler Value Formula Type String Conveter Attribute Class 
            ...
            try
            {
                    ...
                    )
                {
                    values = new string[]{
                        ...
                        FValueFormulaType.DateTimeTicks.ToString(),
                        ...
                        FValueFormulaType.RemoveNonPrintable.ToString(),
