...
--  Description     : FAMate SECS Modeler Column Log Property Source Object Class  
...
{
    public class FPropColl : FDynPropCusBase<FSsmCore>
    {
        ...
        public string OriginalValue
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fColl.originalStringValue);
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
        ...
        public string OriginalEncodingValue
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fColl.originalEncodingValue);
                }
                catch (Exception ex)
                {
        ...
        public string Value
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fColl.stringValue);
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
        ...
        public string EncodingValue
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fColl.encodingValue);
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                base.fTypeDescriptor.properties["OriginalValue"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fColl.originalStringValue)));
                base.fTypeDescriptor.properties["OriginalEncodingValue"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fColl.originalEncodingValue)));
                ...
                base.fTypeDescriptor.properties["Value"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fColl.stringValue)));
                base.fTypeDescriptor.properties["EncodingValue"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fColl.encodingValue)));
