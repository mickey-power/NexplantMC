    ...
    public partial class FVfeiTracer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                logBuilder.AppendLine(
                    ...
                    "DataSent    , " +
                    "SecsDevice=<" + e.fHostDeviceVfeiSentLog.name + ">, " +
            ...
            )
        {
            ...
            try
            {
                ...
                logBuilder.AppendLine(
                    ...
                    "DataReceived, " +
                    "SecsDevice=<" + e.fHostDeviceVfeiReceivedLog.name + ">, " +
            ...
            )
        {
            try
            {
                ...
                mnbMaxTraceCount.Value = m_fSsmCore.fOption.vfeiTracerMaxTraceCount;
            ...
            )
        {
            try
            {
                ...
                m_fSsmCore.fOption.vfeiTracerMaxTraceCount = int.Parse(mnbMaxTraceCount.Value.ToString());
