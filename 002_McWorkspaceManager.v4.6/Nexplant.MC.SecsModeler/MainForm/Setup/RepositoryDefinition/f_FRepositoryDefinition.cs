...
--  Description     : FAMate Repository Definition Form Class 
--  History         : Created by kitae at 2011.10.12
----------------------------------------------------------------------------------------------------------*/
using System;
    ...
    public partial class FRepositoryDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuRpdAppendRepositoryList].SharedProps.Visible = ((FSecsDriver)fObject).canAppendChildRepositoryList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuRpdPasteChild].SharedProps.Enabled = ((FSecsDriver)fObject).canPasteChildRepositoryList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FRepositoryList fRpl in fScd.fChildRepositoryListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FRepositoryList fRpl in ((FSecsDriver)fParent).fChildRepositoryListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).appendChildRepositoryList(new FRepositoryList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
                    fNewChild = ((FRepositoryList)fParent).appendChildRepository(new FRepository(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.Repository)
                {
                    fNewChild = ((FRepository)fParent).appendChildColumn(new FColumn(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.Column)
                {
                    fNewChild = new FColumn(this.m_fSsmCore.fSsmFileInfo.fSecsDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).insertBeforeChildRepositoryList(
                        new FRepositoryList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
                    fNewChild = ((FRepositoryList)fParent).insertBeforeChildRepository(
                        new FRepository(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.Repository)
                {
                    fNewChild = ((FRepository)fParent).insertBeforeChildColumn(
                        new FColumn(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                        (FColumn)fRefChild
                        );
                }
                else if (fParent.fObjectType == FObjectType.Column)
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).insertAfterChildRepositoryList(
                        new FRepositoryList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                        (FRepositoryList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    ...
                    // --
                    ((FSecsDriver)fParent).removeChildRepositoryList((FRepositoryList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fChild = ((FSecsDriver)fParent).pasteChildRepositoryList();
                }
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fSsmCore.fSsmFileInfo.fSecsDriver.searchRepositorySeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropRpl(m_fSsmCore, pgdProp, (FRepositoryList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Repository)
                {
                    pgdProp.selectedObject = new FPropRps(m_fSsmCore, pgdProp, (FRepository)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Column)
                {
                    pgdProp.selectedObject = new FPropCol(m_fSsmCore, pgdProp, (FColumn)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.SecsDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.RepositoryList)
                        {
                            ...
                            {
                                cnt = ((FSecsDriver)fRefObject).fChildRepositoryListCollection.count;
                                fRefObject = ((FSecsDriver)fRefObject).fChildRepositoryListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.SecsDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.RepositoryList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FSecsDriver)fRefObject).pasteChildRepositoryList();
