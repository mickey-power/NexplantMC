...
--  Description     : FAMate SECS Modeler Function Name Definition Form Class 
    ...
    public partial class FFunctionNameDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuFndAppendFunctionNameList].SharedProps.Visible = ((FSecsDriver)fObject).canAppendChildFunctionNameList;
                    // -- 
                    mnuMenu.Tools[FMenuKey.MenuFndPasteChild].SharedProps.Enabled = ((FSecsDriver)fObject).canPasteChildFunctionNameList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                //***
                foreach (FFunctionNameList fFnl in fScd.fChildFunctionNameListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FFunctionNameList fFnl in ((FSecsDriver)fParent).fChildFunctionNameListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).appendChildFuntionNameList(new FFunctionNameList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.FunctionNameList)
                {
                    fNewChild = ((FFunctionNameList)fParent).appendChildFuncionName(new FFunctionName(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.FunctionName)
                {
                    fNewChild = ((FFunctionName)fParent).appendChildParameterName(new FParameterName(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.ParameterName)
                {
                    fNewChild = ((FParameterName)fParent).appendChildArgument(new FArgument(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).insertBeforeChildFunctionNameList(
                        new FFunctionNameList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.FunctionNameList)
                {
                    fNewChild = ((FFunctionNameList)fParent).insertBeforeChildFunctionName(
                        new FFunctionName(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.FunctionName)
                {
                    fNewChild = ((FFunctionName)fParent).insertBeforeChildParameterName(
                        new FParameterName(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.ParameterName)
                {
                    fNewChild = ((FParameterName)fParent).insertBeforeChildArgument(
                        new FArgument(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                        (FArgument)fRefChild
                        );
                }
                // --
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).insertAfterChildFunctionNameList(
                        new FFunctionNameList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                        (FFunctionNameList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // Remove SECS Object 가 1개 이상일경우 사용자에게 Confirm를 받는다.
                // ***
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    ...
                    // --
                    ((FSecsDriver)fParent).removeChildFunctionNameList((FFunctionNameList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.FunctionNameList)
                {
        ...
        {            
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fChild = ((FSecsDriver)fParent).pasteChildFunctionNameList();
                }
                else if (fParent.fObjectType == FObjectType.FunctionNameList)
                {
             ...
             )
        {
            ...
            try
            {
                ...
                fResult = m_fSsmCore.fSsmFileInfo.fSecsDriver.searchFunctionNameSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropFnl(m_fSsmCore, pgdProp, (FFunctionNameList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.FunctionName)
                {
                    pgdProp.selectedObject = new FPropFna(m_fSsmCore, pgdProp, (FFunctionName)fObject);
                }
                else if (fObject.fObjectType == FObjectType.ParameterName)
                {
                    pgdProp.selectedObject = new FPropPna(m_fSsmCore, pgdProp, (FParameterName)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Argument)
                {
                    pgdProp.selectedObject = new FPropArg(m_fSsmCore, pgdProp, (FArgument)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.SecsDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.FunctionNameList)
                        {
                            ...
                            {
                                cnt = ((FSecsDriver)fRefObject).fChildFunctionNameListCollection.count;
                                fRefObject = ((FSecsDriver)fRefObject).fChildFunctionNameListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.SecsDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.FunctionNameList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FSecsDriver)fRefObject).pasteChildFunctionNameList();
