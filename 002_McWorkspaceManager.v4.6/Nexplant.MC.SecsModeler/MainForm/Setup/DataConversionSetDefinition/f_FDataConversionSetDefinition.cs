...
--  Description     : FAMate SECS Modeler Data Conversion Set Definition Form Class 
    ...
    public partial class FDataConversionSetDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuDcdAppendDataConversionSetList].SharedProps.Visible = ((FSecsDriver)fObject).canAppendChildDataConversionSetList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuDcdPasteChild].SharedProps.Enabled = ((FSecsDriver)fObject).canPasteChildDataConversionSetList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FDataConversionSetList fDcl in fScd.fChildDataConversionSetListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FDataConversionSetList fDcl in ((FSecsDriver)fParent).fChildDataConversionSetListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fNewChild.fObjectType == FObjectType.DataConversionSetList)
                {
                    ...
                    if (
                        tNodeParent == null ||
                        tNodeParent.Nodes.Count != ((FSecsDriver)fParent).fChildDataConversionSetListCollection.count - 1
                        )
                    {
                        return;
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).appendChildDataConversionSetList(new FDataConversionSetList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
                    fNewChild = ((FDataConversionSetList)fParent).appendChildDataConversionSet(new FDataConversionSet(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSet)
                {
                    fNewChild = ((FDataConversionSet)fParent).appendChildDataConversion(new FDataConversion(this.m_fSsmCore.fSsmFileInfo.fSecsDriver));
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).insertBeforeChildDataConversionSetList(
                        new FDataConversionSetList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
                    fNewChild = ((FDataConversionSetList)fParent).insertBeforeChildDataConversionSet(
                        new FDataConversionSet(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                ...
                else if (fParent.fObjectType == FObjectType.DataConversionSet)
                {
                    fNewChild = ((FDataConversionSet)fParent).insertBeforeChildDataConversion(
                        new FDataConversion(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fNewChild = ((FSecsDriver)fParent).insertAfterChildDataConversionSetList(
                        new FDataConversionSetList(this.m_fSsmCore.fSsmFileInfo.fSecsDriver),
                        (FDataConversionSetList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    ...
                    // --
                    ((FSecsDriver)fParent).removeChildDataConversionSetList((FDataConversionSetList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.SecsDriver)
                {
                    fChild = ((FSecsDriver)fParent).pasteChildDataConversionSetList();
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
             ...
             )
        {
            ...
            try
            {
                ...
                fResult = m_fSsmCore.fSsmFileInfo.fSecsDriver.searchDataConversionSetSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropDcl(m_fSsmCore, pgdProp, (FDataConversionSetList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.DataConversionSet)
                {
                    pgdProp.selectedObject = new FPropDcs(m_fSsmCore, pgdProp, (FDataConversionSet)fObject);
                }
                else if (fObject.fObjectType == FObjectType.DataConversion)
                {
                    pgdProp.selectedObject = new FPropDcv(m_fSsmCore, pgdProp, (FDataConversion)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.SecsDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.DataConversionSetList)
                        {
                            ...
                            {
                                cnt = ((FSecsDriver)fRefObject).fChildDataConversionSetListCollection.count;
                                fRefObject = ((FSecsDriver)fRefObject).fChildDataConversionSetListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.SecsDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.DataConversionSetList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FSecsDriver)fRefObject).pasteChildDataConversionSetList();
