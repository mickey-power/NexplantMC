...
--  Description     : FAMate SECS Modeler Enviroment Property Source Object Class 
...
{
    public class FPropEnv : FDynPropCusBase<FSsmCore>
    {
            ...
            )
        {
            try
            {
                ...
                base.fTypeDescriptor.properties["Type"].attributes.replace(new DefaultValueAttribute(m_fEnv.fObjectType.ToString()));
