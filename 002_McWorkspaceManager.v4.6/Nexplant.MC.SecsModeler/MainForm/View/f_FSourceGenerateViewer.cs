...
{
    public partial class FSourceGenerateViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
        ...
        public void appendSourceGenerate(
            string vfeiText
            )
        {          
            try
            {
                txtSourceGen.AppendText(vfeiText);
                txtSourceGen.Select(txtSourceGen.TextLength, 0);
                txtSourceGen.Focus();
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    txtSourceGen.Text = sr.ReadToEnd();
                    txtSourceGen.Select(0, 0);
                    txtSourceGen.ScrollToCaret();
                    txtSourceGen.Focus();
                    // --
                    sr.Close();
                }
            ...
            )
        {
            ...
            try
            {
                ...
                dialog.Title = fUIWizard.searchCaption("Open Source Generate File");
                dialog.Filter = "Source Generate Files (*.gen)| *.gen";
            ...
            )
        {
            ...
            try
            {
                ...
                dialog.Title = fUIWizard.searchCaption("Save Source Generate File");
                dialog.Filter = "Source Generate File (*.gen) |*.gen";
                dialog.DefaultExt = "gen";
                // --
                if (m_isNewFile)
                {
                ...
                saveGenerateFile(dialog.FileName);
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                txtSourceGen.Appearance.FontData.Name = (new System.Drawing.FontFamily(preFontName)).Name;
            ...
            )
        {
            try
            {
                txtSourceGen.Appearance.FontData.SizeInPoints = float.Parse(mnbFontSize.Value.ToString());
            ...
            )
        {
            try
            {
                ...
                txtSourceGen.Appearance.FontData.Name = ((FontListTool)mnuMenu.Tools[FMenuKey.MenuFontName]).Value.ToString();
                txtSourceGen.Appearance.FontData.SizeInPoints = float.Parse(mnbFontSize.Value.ToString());

                // --
                
                m_fileName = "FAmate" + m_libraryName + ".gen";
                // --
                m_isNewFile = true;
                m_isModifiedFile = false;
                m_isCleared = true;
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuFontName]).Value = m_fSsmCore.fOption.commonFontName;
                        txtSourceGen.Appearance.FontData.Name = m_fSsmCore.fOption.commonFontName;
                    }
                }
            }
            catch (Exception ex)
