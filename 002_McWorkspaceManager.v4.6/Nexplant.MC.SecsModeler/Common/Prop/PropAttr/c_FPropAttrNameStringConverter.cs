...
--  Description     : FAMate SECS Modeler Object Name String Conveter Attribute Class 
    ...
    public class FPropAttrNameStringConverter : StringConverter
    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fProp is FPropScd)
                {
                    fObnCollection = ((FPropScd)fProp).fSecsDriver.fObjectNameCollection;
                }
                // --
                ...
                // --
                else if (fProp is FPropSlg)
                {
                    fObnCollection = ((FPropSlg)fProp).fSecsLibraryGroup.fObjectNameCollection;
                }
                else if (fProp is FPropSlb)
                {
                    fObnCollection = ((FPropSlb)fProp).fSecsLibrary.fObjectNameCollection;
                }
                else if (fProp is FPropSml)
                {
                    fObnCollection = ((FPropSml)fProp).fSecsMessageList.fObjectNameCollection;
                }
                else if (fProp is FPropSms)
                {
                    fObnCollection = ((FPropSms)fProp).fSecsMessages.fObjectNameCollection;
                }
                else if (fProp is FPropSmg)
                {
                    fObnCollection = ((FPropSmg)fProp).fSecsMessage.fObjectNameCollection;
                }
                else if (fProp is FPropSit)
                {
                    fObnCollection = ((FPropSit)fProp).fSecsItem.fObjectNameCollection;
                }
                // --
                else if (fProp is FPropSdv)
                {
                    fObnCollection = ((FPropSdv)fProp).fSecsDevice.fObjectNameCollection;
                }
                else if (fProp is FPropSsn)
                {
                    fObnCollection = ((FPropSsn)fProp).fSecsSession.fObjectNameCollection;
                }
                // --
                ...
                else if (fProp is FPropStr)
                {
                    fObnCollection = ((FPropStr)fProp).fSecsTrigger.fObjectNameCollection;
                }
                else if (fProp is FPropScn)
                {
                    fObnCollection = ((FPropScn)fProp).fSecsCondition.fObjectNameCollection;
                }
                else if (fProp is FPropSep)
                {
                    fObnCollection = ((FPropSep)fProp).fSecsExpression.fObjectNameCollection;
                }
                else if (fProp is FPropStn)
                {
                    fObnCollection = ((FPropStn)fProp).fSecsTransmitter.fObjectNameCollection;
                }
                else if (fProp is FPropStf)
                {
                    fObnCollection = ((FPropStf)fProp).fSecsTransfer.fObjectNameCollection;
                }
