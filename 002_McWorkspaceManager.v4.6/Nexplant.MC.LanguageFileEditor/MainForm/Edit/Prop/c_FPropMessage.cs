...
--
--  Program Id      : c_FPropMessage.cs
--  Creator         : spike.lee
--  Create Date     : 2011.01.06
--  Description     : FAMate Language Editor Message Property Source Object Class 
...
{
    public class FPropMessage : FDynPropCusBase<FLfeCore>
    {
            ...
            )
        {
            try
            {
                if (m_fXmlNodeMsg != null)
                {
                    m_messageId = m_fXmlNodeMsg.get_attrVal(FXmlTagMessage.A_MessageId, FXmlTagMessage.D_MessageId);
                    m_default = m_fXmlNodeMsg.get_attrVal(FLanguage.Default.ToString(), FXmlTagMessage.D_Language);
                    m_english = m_fXmlNodeMsg.get_attrVal(FLanguage.English.ToString(), FXmlTagMessage.D_Language);
                    m_korean = m_fXmlNodeMsg.get_attrVal(FLanguage.Korean.ToString(), FXmlTagMessage.D_Language);
                    m_chinese = m_fXmlNodeMsg.get_attrVal(FLanguage.Chinese.ToString(), FXmlTagMessage.D_Language);
                    m_description = m_fXmlNodeMsg.get_attrVal(FXmlTagMessage.A_Description, FXmlTagMessage.D_Description);
                }

                // --

                base.fTypeDescriptor.properties["MessageId"].attributes.replace(new DisplayNameAttribute("Message ID"));
                ...
                base.fTypeDescriptor.properties["MessageId"].attributes.replace(new DefaultValueAttribute(m_messageId));
