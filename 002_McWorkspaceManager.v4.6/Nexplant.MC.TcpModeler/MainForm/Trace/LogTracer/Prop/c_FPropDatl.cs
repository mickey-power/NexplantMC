...
--  Description     : FAMate TCP Modeler Data Log Property Source Object Class 
...
{
    public class FPropDatl : FDynPropCusBase<FTcmCore>
    {
        ...
        public string OriginalValue
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fDatl.originalStringValue);
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
        ...
        public string OriginalEncodingValue
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fDatl.originalEncodingValue);
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
        ...
        public string Value
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fDatl.stringValue);
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
        ...
        public string EncodingValue
        {
            get
            {
                try
                {
                    ...
                    return getDisplayValue(m_fDatl.encodingValue);
                }
                catch (Exception ex)
                {
                    FMessageBox.showError(FConstants.ApplicationName, ex, this.mainObject.fWsmCore.fWsmContainer);
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                base.fTypeDescriptor.properties["OriginalValue"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fDatl.originalStringValue)));
                base.fTypeDescriptor.properties["OriginalEncodingValue"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fDatl.originalEncodingValue)));
                ...
                base.fTypeDescriptor.properties["Value"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fDatl.stringValue)));
                base.fTypeDescriptor.properties["EncodingValue"].attributes.replace(new DefaultValueAttribute(getDisplayValue(m_fDatl.encodingValue)));
