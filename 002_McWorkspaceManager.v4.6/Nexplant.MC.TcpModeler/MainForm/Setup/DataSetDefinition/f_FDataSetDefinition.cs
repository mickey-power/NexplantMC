...
--  Description     : FAMate TCP Modeler DataSet Definition Form Class 
    ...
    public partial class FDataSetDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuDsdAppendDataSetList].SharedProps.Visible = ((FTcpDriver)fObject).canAppendChildDataSetList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuDsdPasteChild].SharedProps.Enabled = ((FTcpDriver)fObject).canPasteChildDataSetList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // Data Set List Load
                // ***
                foreach (FDataSetList fDsl in fTcd.fChildDataSetListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FDataSetList fDsl in ((FTcpDriver)fParent).fChildDataSetListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).appendChildDataSetList(new FDataSetList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.DataSetList)
                {
                    fNewChild = ((FDataSetList)fParent).appendChildDataSet(new FDataSet(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.DataSet)
                {
                    fNewChild = ((FDataSet)fParent).appendChildData(new FData(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.Data)
                {
                    fNewChild = new FData(this.m_fTcmCore.fTcmFileInfo.fTcpDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertBeforeChildDataSetList(
                        new FDataSetList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.DataSetList)
                {
                    fNewChild = ((FDataSetList)fParent).insertBeforeChildDataSet(
                        new FDataSet(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FDataSet)fRefChild
                        );
                }
                else if (fParent.fObjectType == FObjectType.DataSet)
                {
                    fNewChild = ((FDataSet)fParent).insertBeforeChildData(
                        new FData(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FData)fRefChild
                        );
                }
                else if (fParent.fObjectType == FObjectType.Data)
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertAfterChildDataSetList(
                        new FDataSetList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FDataSetList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    ...
                    // --
                    ((FTcpDriver)fParent).removeChildDataSetList((FDataSetList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.DataSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fChild = ((FTcpDriver)fParent).pasteChildDataSetList();
                }
                else if (fParent.fObjectType == FObjectType.DataSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fTcmCore.fTcmFileInfo.fTcpDriver.searchDataSetSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropDsl(m_fTcmCore, pgdProp, (FDataSetList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.DataSet)
                {
                    pgdProp.selectedObject = new FPropDts(m_fTcmCore, pgdProp, (FDataSet)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Data)
                {
                    pgdProp.selectedObject = new FPropDat(m_fTcmCore, pgdProp, (FData)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.DataSetList)
                        {
                            ...
                            {
                                cnt = ((FTcpDriver)fRefObject).fChildDataSetListCollection.count;
                                fRefObject = ((FTcpDriver)fRefObject).fChildDataSetListCollection[cnt - 1];
                    ...
                    else if (fRefObject.fObjectType == FObjectType.Data)
                    {
                        ...
                        else if (fDragDropData.fObject.fObjectType == FObjectType.TcpItem)
                        {
                            ...
                            if (((FData)fRefObject).equalsModelingFile(fDragDropData.fObject))
                            {
                                if (((FTcpItem)fDragDropData.fObject).fPattern == FPattern.Fixed)
                                {
                                    if (
                                        ((FData)fRefObject).fPattern == FPattern.Fixed ||
                                        ((FData)fRefObject).fPreviousSibling == null ||
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.DataSetList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FTcpDriver)fRefObject).pasteChildDataSetList();
                    ...
                    else if (fRefObject.fObjectType == FObjectType.Data)
                    {
                            ...
                            )
                        {
                            ...
                            if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                // --
                                if (fDragDropData.fObject.fObjectType == FObjectType.TcpDriver)
                                {
                                ...
                                {
                                    ((FData)fRefObject).sourceResource = FResourceSourceType.TcpDeviceName;
                                }
                                else if (fDragDropData.fObject.fObjectType == FObjectType.TcpSession)
                                {
                                    ((FData)fRefObject).sourceResource = FResourceSourceType.TcpSessionName;
                                }
                        ...
                        else if (fDragDropData.fObject.fObjectType == FObjectType.TcpItem)
                        {
                            ...
                            if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                {
                                    ((FData)fRefObject).fPattern = FPattern.Fixed;
                                    ((FData)fRefObject).fixedLength = ((FTcpItem)fDragDropData.fObject).fixedLength;
                                }
                                else
                                {
                                    ((FData)fRefObject).fPattern = FPattern.Variable;
                                ...
                                if (!((FData)fRefObject).hasChild)
                                {
                                    ((FData)fRefObject).fFormat = ((FTcpItem)fDragDropData.fObject).fFormat;
                                }
                                fAction = FDragDropAction.Set;
                            }
                            else
