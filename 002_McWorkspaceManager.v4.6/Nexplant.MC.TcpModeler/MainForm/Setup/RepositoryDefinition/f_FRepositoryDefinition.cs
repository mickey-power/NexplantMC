...
--  Description     : FAMate TCP Modeler Repository Definition Form Class 
    ...
    public partial class FRepositoryDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuRpdAppendRepositoryList].SharedProps.Visible = ((FTcpDriver)fObject).canAppendChildRepositoryList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuRpdPasteChild].SharedProps.Enabled = ((FTcpDriver)fObject).canPasteChildRepositoryList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FRepositoryList fRpl in fTcd.fChildRepositoryListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FRepositoryList fRpl in ((FTcpDriver)fParent).fChildRepositoryListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).appendChildRepositoryList(new FRepositoryList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
                    fNewChild = ((FRepositoryList)fParent).appendChildRepository(new FRepository(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.Repository)
                {
                    fNewChild = ((FRepository)fParent).appendChildColumn(new FColumn(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.Column)
                {
                    fNewChild = new FColumn(this.m_fTcmCore.fTcmFileInfo.fTcpDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertBeforeChildRepositoryList(
                        new FRepositoryList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
                    fNewChild = ((FRepositoryList)fParent).insertBeforeChildRepository(
                        new FRepository(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.Repository)
                {
                    fNewChild = ((FRepository)fParent).insertBeforeChildColumn(
                        new FColumn(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FColumn)fRefChild
                        );
                }
                else if (fParent.fObjectType == FObjectType.Column)
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertAfterChildRepositoryList(
                        new FRepositoryList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FRepositoryList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    ...
                    // --
                    ((FTcpDriver)fParent).removeChildRepositoryList((FRepositoryList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fChild = ((FTcpDriver)fParent).pasteChildRepositoryList();
                }
                else if (fParent.fObjectType == FObjectType.RepositoryList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fTcmCore.fTcmFileInfo.fTcpDriver.searchRepositorySeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropRpl(m_fTcmCore, pgdProp, (FRepositoryList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Repository)
                {
                    pgdProp.selectedObject = new FPropRps(m_fTcmCore, pgdProp, (FRepository)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Column)
                {
                    pgdProp.selectedObject = new FPropCol(m_fTcmCore, pgdProp, (FColumn)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.RepositoryList)
                        {
                            ...
                            {
                                cnt = ((FTcpDriver)fRefObject).fChildRepositoryListCollection.count;
                                fRefObject = ((FTcpDriver)fRefObject).fChildRepositoryListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.RepositoryList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FTcpDriver)fRefObject).pasteChildRepositoryList();
