...
--  Description     : FAMate TCP Modeler Equipment State Set Definition Form Class 
    ...
    public partial class FEquipmentStateSetDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuEsdAppendEquipmentStateSetList].SharedProps.Visible = ((FTcpDriver)fObject).canAppendChildEquipmentStateSetList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuEsdPasteChild].SharedProps.Enabled = ((FTcpDriver)fObject).canPasteChildEquipmentStateSetList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FEquipmentStateSetList fEsl in fTcd.fChildEquipmentStateSetListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FEquipmentStateSetList fEsl in ((FTcpDriver)fParent).fChildEquipmentStateSetListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).appendChildEquipmentStateSetList(new FEquipmentStateSetList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
                    fNewChild = ((FEquipmentStateSetList)fParent).appendChildEquipmentStateSet(new FEquipmentStateSet(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSet)
                {
                    fNewChild = ((FEquipmentStateSet)fParent).appendChildEquipmentState(new FEquipmentState(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.EquipmentState)
                {
                    fNewChild = ((FEquipmentState)fParent).appendChildStateValue(new FStateValue(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertBeforeChildEquipmentStateSetList(
                        new FEquipmentStateSetList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
                    fNewChild = ((FEquipmentStateSetList)fParent).insertBeforeChildEquipmentStateSet(
                        new FEquipmentStateSet(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EquipmentStateSet)
                {
                    fNewChild = ((FEquipmentStateSet)fParent).insertBeforeChildEquipmentState(
                        new FEquipmentState(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EquipmentState)
                {
                    fNewChild = ((FEquipmentState)fParent).insertBeforeChildStateValue(
                        new FStateValue(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertAfterChildEquipmentStateSetList(
                        new FEquipmentStateSetList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FEquipmentStateSetList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    ...
                    // --
                    ((FTcpDriver)fParent).removeChildEquipmentStateSetList((FEquipmentStateSetList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fChild = ((FTcpDriver)fParent).pasteChildEquipmentStateSetList();
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fTcmCore.fTcmFileInfo.fTcpDriver.searchEquipmentStateSetSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropEsl(m_fTcmCore, pgdProp, (FEquipmentStateSetList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.EquipmentStateSet)
                {
                    pgdProp.selectedObject = new FPropEss(m_fTcmCore, pgdProp, (FEquipmentStateSet)fObject);
                }
                else if (fObject.fObjectType == FObjectType.EquipmentState)
                {
                    pgdProp.selectedObject = new FPropEst(m_fTcmCore, pgdProp, (FEquipmentState)fObject);
                }
                else if (fObject.fObjectType == FObjectType.StateValue)
                {
                    pgdProp.selectedObject = new FPropStv(m_fTcmCore, pgdProp, (FStateValue)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EquipmentStateSetList)
                        {
                            ...
                            {
                                cnt = ((FTcpDriver)fRefObject).fChildEquipmentStateSetListCollection.count;
                                fRefObject = ((FTcpDriver)fRefObject).fChildEquipmentStateSetListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EquipmentStateSetList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FTcpDriver)fRefObject).pasteChildEquipmentStateSetList();
