...
--  Description     : FAMate TCP Modeler Enviroment Definition Form Class 
    ...
    public partial class FEnvironmentDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuEndAppendEnvironmentList].SharedProps.Visible = ((FTcpDriver)fObject).canAppendChildEnvironmentList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuEndPasteChild].SharedProps.Enabled = ((FTcpDriver)fObject).canPasteChildEnvironmentList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FEnvironmentList fEnl in fTcd.fChildEnvironmentListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FEnvironmentList fEnl in ((FTcpDriver)fParent).fChildEnvironmentListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).appendChildEnvironmentList(new FEnvironmentList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
                    fNewChild = ((FEnvironmentList)fParent).appendChildEnvironment(new FEnvironment(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                }
                else if (fParent.fObjectType == FObjectType.Environment)
                {
                    fNewChild = new FEnvironment(this.m_fTcmCore.fTcmFileInfo.fTcpDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertBeforeChildEnvironmentList(
                        new FEnvironmentList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
                    fNewChild = ((FEnvironmentList)fParent).insertBeforeChildEnvironment(
                        new FEnvironment(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertAfterChildEnvironmentList(
                        new FEnvironmentList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FEnvironmentList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    ...
                    // --
                    ((FTcpDriver)fParent).removeChildEnvironmentList((FEnvironmentList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fChild = ((FTcpDriver)fParent).pasteChildEnvironmentList();
                }
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
             ...
             )
        {
            ...
            try
            {
                ...
                fResult = m_fTcmCore.fTcmFileInfo.fTcpDriver.searchEnvironmentSeries(fBase, searchWord);
                if (fResult == null)
                {
        ...
        #region FEnvironmentDefinition form Event Handler
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropEnl(m_fTcmCore, pgdProp, (FEnvironmentList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Environment)
                {
                    pgdProp.selectedObject = new FPropEnv(m_fTcmCore, pgdProp, (FEnvironment)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EnvironmentList)
                        {
                            ...
                            {
                                cnt = ((FTcpDriver)fRefObject).fChildEnvironmentListCollection.count;
                                fRefObject = ((FTcpDriver)fRefObject).fChildEnvironmentListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EnvironmentList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FTcpDriver)fRefObject).pasteChildEnvironmentList();
