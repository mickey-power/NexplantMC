...
--  Description     : FAMate TCP Modeler VFEI Viewer Form Class
    ...
    public partial class FVfeiViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                m_fileName = fileName;
                m_fTcmCore.fOption.vfeiViewerRecentOpenPath = Path.GetDirectoryName(m_fileName);
            ...
            )
        {
            ...
            try
            {
                ...
                // --
                m_fileName = fileName;
                m_fTcmCore.fOption.vfeiViewerRecentSavePath = Path.GetDirectoryName(m_fileName);
            ...
            )
        {
            ...
            try
            {
                ...
                dialog.InitialDirectory = m_fTcmCore.fOption.vfeiViewerRecentOpenPath;
            ...
            )
        {
            ...
            try
            {
                ...
                if (m_isNewFile)
                {
                    dialog.InitialDirectory = m_fTcmCore.fOption.vfeiViewerRecentSavePath;
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuFontName]).Value = m_fTcmCore.fOption.commonFontName;
                        txtVfei.Appearance.FontData.Name = m_fTcmCore.fOption.commonFontName;
                    }
                }
            }
            catch (Exception ex)
