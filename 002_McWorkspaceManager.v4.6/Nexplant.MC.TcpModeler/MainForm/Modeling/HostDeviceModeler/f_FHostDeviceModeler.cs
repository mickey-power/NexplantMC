...
--  Description     : FAMate TCP Modeler Host Device Modeler Form Class 
    ...
    public partial class FHostDeviceModeler : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuHdmAppendHostDevice].SharedProps.Visible = ((FTcpDriver)fObject).canAppendChildHostDevice;
                    //--
                    mnuMenu.Tools[FMenuKey.MenuHdmPasteChild].SharedProps.Enabled = ((FTcpDriver)fObject).canPasteChildHostDevice; 
                }
                ...
                else if (fObject.fObjectType == FObjectType.HostMessages)
                {
                    ...
                    // mnuMenu.Tools[FMenuKey.MenuHdmConvertToTrs].SharedProps.Enabled = true;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                tNodeHcd = new UltraTreeNode(fTcd.uniqueIdToString);
                tNodeHcd.Tag = fTcd;
                FCommon.refreshTreeNodeOfObject(fTcd, tvwTree, tNodeHcd);
                ...
                // Host Device Load
                // ***
                foreach (FHostDevice fHdv in fTcd.fChildHostDeviceCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FHostDevice fHdv in ((FTcpDriver)fParent).fChildHostDeviceCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FHostDevice fHdv in this.m_fTcmCore.fTcmFileInfo.fTcpDriver.fChildHostDeviceCollection)
                {
                    foreach (FHostSession fHsn in fHdv.fChildHostSessionCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).appendChildHostDevice(new FHostDevice(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                    uniqueId = fNewChild.uniqueIdToString;
                }
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
                    fNewChild = ((FHostDevice)fParent).appendChildHostSession(new FHostSession(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                    uniqueId = fNewChild.uniqueIdToString;
                }
                else if (fParent.fObjectType == FObjectType.HostSession)
                {
                    fNewChild = ((FHostSession)fParent).fLibrary.appendChildHostMessageList(new FHostMessageList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                    uniqueId = createTreeId(tNodeParent.Key, fNewChild.uniqueIdToString);
                }
                else if (fParent.fObjectType == FObjectType.HostMessageList)
                {
                    fNewChild = ((FHostMessageList)fParent).appendChildHostMessages(new FHostMessages(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                ...
                else if (fParent.fObjectType == FObjectType.HostMessages)
                {
                    ...
                    {
                        fNewChild = ((FHostMessages)fParent).appendChildPrimaryHostMessage(new FHostMessage(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                    }
                    else
                    {
                        fNewChild = ((FHostMessages)fParent).appendChildSecondaryHostMessage(new FHostMessage(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                    }
                    uniqueId = createTreeId(getHostSessionId(tNodeParent.Key), fNewChild.uniqueIdToString);
                }
                else if (fParent.fObjectType == FObjectType.HostMessage)
                {
                    fNewChild = ((FHostMessage)fParent).appendChildHostItem(new FHostItem(this.m_fTcmCore.fTcmFileInfo.fTcpDriver));
                    uniqueId = createTreeId(getHostSessionId(tNodeParent.Key), fNewChild.uniqueIdToString);
                }
                else if (fParent.fObjectType == FObjectType.HostItem)
                {
                    fNewChild = new FHostItem(this.m_fTcmCore.fTcmFileInfo.fTcpDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertBeforeChildHostDevice(
                        new FHostDevice(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
                    fNewChild = ((FHostDevice)fParent).insertBeforeChildHostSession(
                        new FHostSession(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.HostSession)
                {
                    fNewChild = ((FHostSession)fParent).fLibrary.insertBeforeChildHostMessageList(
                        new FHostMessageList(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.HostMessageList)
                {
                    fNewChild = ((FHostMessageList)fParent).insertBeforeChildHostMessages(
                        new FHostMessages(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                ...
                else if (fParent.fObjectType == FObjectType.HostMessage)
                {
                    fNewChild = ((FHostMessage)fParent).insertBeforeChildHostItem(
                        new FHostItem(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FHostItem)fRefChild
                        );
                    uniqueId = createTreeId(getHostSessionId(tNodeParent.Key), fNewChild.uniqueIdToString);
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).insertAfterChildHostDevice(
                        new FHostDevice(this.m_fTcmCore.fTcmFileInfo.fTcpDriver),
                        (FHostDevice)fRefChild
                        );
                    uniqueId = fNewChild.uniqueIdToString;
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    ...
                    // --
                    ((FTcpDriver)fParent).removeChildHostDevice((FHostDevice[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.TcpDriver)
                {
                    fNewChild = ((FTcpDriver)fParent).pasteChildHostDevice();
                    uniqueId = fNewChild.uniqueIdToString;
                }
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fTcmCore.fTcmFileInfo.fTcpDriver.searchHostDeviceSeries(fBase, ref fHsn, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropHdv(m_fTcmCore, pgdProp, (FHostDevice)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostSession)
                {
                    pgdProp.selectedObject = new FPropHsn(m_fTcmCore, pgdProp, (FHostSession)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostMessageList)
                {
                    pgdProp.selectedObject = new FPropHml(m_fTcmCore, pgdProp, (FHostMessageList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostMessages)
                {
                    pgdProp.selectedObject = new FPropHms(m_fTcmCore, pgdProp, (FHostMessages)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostMessage)
                {
                    pgdProp.selectedObject = new FPropHmg(m_fTcmCore, pgdProp, (FHostMessage)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostItem)
                {
                    ...
                    pgdProp.selectedObject = new FPropHit(m_fTcmCore, pgdProp, (FHostItem)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.HostDevice)
                        {
                            ...
                            {
                                cnt = ((FTcpDriver)fRefObject).fChildHostDeviceCollection.count;
                                fRefObject = ((FTcpDriver)fRefObject).fChildHostDeviceCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.TcpDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.HostDevice)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FTcpDriver)fRefObject).pasteChildHostDevice();
                ...
                else if (fDragDropData.fObjectLog != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.HostMessageList)
                    {
                            ...
                            )
                        {
                            ...
                            if (e.Effect == DragDropEffects.Copy)
                            {
                                fHms = new FHostMessages(m_fTcmCore.fTcmFileInfo.fTcpDriver);
