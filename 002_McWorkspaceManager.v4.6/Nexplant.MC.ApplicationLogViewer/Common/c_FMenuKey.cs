...
--  Description     : FAMate Application Log Viewer Menu Key Class 
...
namespace Nexplant.MC.ApplicationLogViewer
{
    public static class FMenuKey
    {
        ...
        // --
        public const string MenuLogList = "Log List";
        ...
        public const string MenuVieLvrRefresh = "Refresh";
        // --
        public const string MenuVieLvrFind = "Find";
