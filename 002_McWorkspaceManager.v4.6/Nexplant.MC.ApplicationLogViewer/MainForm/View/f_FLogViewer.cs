    ...
    public partial class FLogViewer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                m_fAlvCore.fOption.fontName = preFontName;
            }
            catch (Exception)
            {
            ...
            )
        {
            try
            {
                ...
                m_fAlvCore.fOption.fontSize = float.Parse(numFontSize.Value.ToString());
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                fProgress.show(m_fAlvCore.fWsmCore.fWsmContainer);
            ...
            )
        {
            try
            {
                ...
                ((FontListTool)mnuMenu.Tools[FMenuKey.MenuFontName]).Text = m_fAlvCore.fOption.fontName;
                numFontSize.Value = m_fAlvCore.fOption.fontSize;
                ...
                m_fAlvCore.fOption.fChildFormList.add(this, this.Text + " - [" + Path.GetFileName(m_fileName) + "]");
            }
            catch (Exception ex)
            {
            ...
            )
        {
            try
            {
                ...
                m_fAlvCore.fOption.fChildFormList.remove(this);
            }
            catch (Exception ex)
            {
                FMessageBox.showError(FConstants.ApplicationName, ex, m_fAlvCore.fWsmCore.fWsmContainer);
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuVieLvrFind)
                {
                    txtLog.showSearcher();
                }
            }
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuFontName]).Value = m_fAlvCore.fOption.fontName;
                        txtLog.Appearance.FontData.Name = m_fAlvCore.fOption.fontName;
                    }
                }
            }
            catch (Exception ex)
            ...
            )
        {
            try
            {
                ...
                {
                    FMessageBox.showInformation("Search", m_fAlvCore.fWsmCore.fUIWizard.generateMessage("M0004", new object[] { e.searchWord }), this);
                }
            }
            catch (Exception ex)
            {
