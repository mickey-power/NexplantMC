...
--
--  Program Id      : c_FWSMADS_SysPasswordChange_In.cs
...
{
    internal static class FWSMADS_SysPasswordChange_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_WSMADS_SysPasswordChange_In = "WSMADS_SysPasswordChange_In";
        ...
        {
            public const string E_Password = "Password";

            // --

            public const string A_OldPassword = "OldPassword";
            public const string A_NewPassword = "NewPassword";

            // --

            public const string D_OldPassword = "";
            public const string D_NewPassword = "";
        }
