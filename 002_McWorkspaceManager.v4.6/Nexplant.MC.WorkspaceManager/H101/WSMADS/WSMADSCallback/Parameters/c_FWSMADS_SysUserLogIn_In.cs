...
{
    internal static class FWSMADS_SysUserLogIn_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_WSMADS_SysUserLogIn_In = "WSMADS_SysUserLogIn_In";
        ...
        {
            public const string E_LogIn = "LogIn";
