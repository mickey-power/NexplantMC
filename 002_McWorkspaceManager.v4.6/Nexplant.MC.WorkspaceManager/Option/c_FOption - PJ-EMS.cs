    ...
    public class FOption : FIWsmOption, IDisposable
    {
            ...
            )
        {
            ...
            try
            {
                ...
                m_site = "PJ-EMS";
                m_factory = "100";
                m_description = "PJ EMS Smart FAB";
                // --
                m_stationConnectString = "117.52.82.196:10101";
                ...
                // --
                m_adsStationConnectString = "117.52.82.196:10101";
                ...
                m_adsFtpIp = @"200.2.1.10\NexplantMC";
                m_adsFtpUsedAnonymous = Boolean.Parse("False");
                m_adsFtpUser = "fa";
                m_adsFtpPassword = "pjeap";
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // PJ EMS Site Option Element Create
                // ***
                fXmlNodeSop = fXmlNodeSol.appendChild(m_fXmlDocOpt.createNode(FXmlTagWSMOption.E_SiteOption));
                // --
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_Site, FXmlTagWSMOption.D_Site, "PJ-EMS");
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_Factory, FXmlTagWSMOption.D_Factory, "100");
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_Description, FXmlTagWSMOption.D_Description, "PJ EMS Smart FAB");

                // ***
                // Development Site IP Setting
                // ***
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_StationConnectString, FXmlTagWSMOption.D_StationConnectString, "117.52.82.196:10101");
                // --
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_AdsStationConnectString, FXmlTagWSMOption.D_AdsStationConnectString, "117.52.82.196:10101");
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_AdsFtpIp, FXmlTagWSMOption.D_AdsFtpIp, @"200.2.1.10\NexplantMC");
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_AdsFtpUsedAnonymous, FXmlTagWSMOption.D_AdsFtpUsedAnonymous, "False");
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_AdsFtpUser, FXmlTagWSMOption.D_AdsFtpUser, "fa");
                fXmlNodeSop.set_attrVal(FXmlTagWSMOption.A_AdsFtpPassword, FXmlTagWSMOption.D_AdsFtpPassword, fCrypt.encrypt2("pjeap"));
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                // PJ-EMS Site Option Add
                // ***
                fXmlNodeSol = fXmlNodeWso.selectSingleNode(FXmlTagWSMOption.E_SiteOptionList);
                fXmlNode = fXmlNodeSol.get_elem(FXmlTagWSMOption.E_SiteOption + "[@" + FXmlTagWSMOption.A_Site + "='PJ-EMS']");
                // --
                if (fXmlNode != null)
                {
                    fXmlNodeSol.removeChild(fXmlNode);
                }
