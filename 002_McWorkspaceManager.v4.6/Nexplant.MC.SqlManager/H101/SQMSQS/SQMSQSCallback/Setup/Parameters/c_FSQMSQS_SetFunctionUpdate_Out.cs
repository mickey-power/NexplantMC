...
--
--  Program Id      : c_FSQMSQS_SetFunctionUpdate_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.28
--  Description     : FAMate SQL Service Setup Function Insert / Update / Delete Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetFunctionUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Function Insert / Update / Delete Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetFunctionUpdate_Out = "SQMSQS_FunctionUpdate_Out";
        // --
