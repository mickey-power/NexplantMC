...
--
--  Program Id      : c_FSQMSQS_SetModuleList_In.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.25
--  Description     : FAMate SQL Service Setup Module List In XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetModuleList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Module List In Element and Attribute
        // ***
        public const string E_SQMSQS_SetModuleList_In = "SQMSQS_SetModuleList_In";
        // --
