...
--
--  Program Id      : c_FSQMSQS_SetModuleUpdate_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.25
--  Description     : FAMate SQL Service Setup Module Insert / Update / Delete Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetModuleUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Module Insert / Update / Delete Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetModuleUpdate_Out = "SQMSQS_SetModuleUpdate_Out";
        // --
