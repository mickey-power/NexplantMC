...
--
--  Program Id      : c_FSQMSQS_SetSqlCodeList_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.31
--  Description     : FAMate SQL Service Setup Sql Code List Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSqlCodeList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Sql Code List Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetSqlCodeList_Out = "SQMSQS_SetSqlCodeList_Out";
        // --
