...
--
--  Program Id      : c_FSQMSQS_SystemSearch_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.24
--  Description     : FAMate SQL Service System Inforamtion Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSystemSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service System Code Information Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetSystemSearch_Out = "SQMSQS_SetSystemSearch_Out";
        // --
