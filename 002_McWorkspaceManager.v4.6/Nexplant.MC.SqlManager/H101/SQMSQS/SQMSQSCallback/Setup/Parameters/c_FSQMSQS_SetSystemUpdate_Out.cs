...
--
--  Program Id      : c_FSQMSQS_SystemUpdate_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.24
--  Description     : FAMate SQL Service System Insert / Update / Delete Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSystemUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service System Insert / Update / Delete Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetSystemUpdate_Out = "SQMSQS_SetSystemUpdate_Out";
        // --
