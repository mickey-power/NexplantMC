...
--
--  Program Id      : c_FSQMSQS_SetSystemDownload_In.cs
--  Creator         : iskim
--  Create Date     : 2013.10.29
--  Description     : <Generated Class File Description>
--  History         : Created by iskim at 2013.10.29
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FSQMSQS_SetSystemDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_SQMSQS_SetSystemDownload_In = "SQMSQS_SetSystemDownload_In";
        ...
        {
            public const string E_Database = "Database";
