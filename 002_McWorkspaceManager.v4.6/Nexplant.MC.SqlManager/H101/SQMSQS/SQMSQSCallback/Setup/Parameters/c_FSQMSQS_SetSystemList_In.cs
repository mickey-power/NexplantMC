...
--
--  Program Id      : c_FSQMSQS_SystemList_In.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.24
--  Description     : FAMate SQL Service System List In XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSystemList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service System List In Element and Attribute
        // ***
        public const string E_SQMSQS_SetSystemList_In = "SQMSQS_SetSystemList_In";
        // --
