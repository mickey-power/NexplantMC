...
--
--  Program Id      : c_FSQMSQS_SystemList_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.24
--  Description     : FAMate SQL Service System List Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSystemList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service System List Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetSystemList_Out = "SQMSQS_SetSystemList_Out";
        // --
