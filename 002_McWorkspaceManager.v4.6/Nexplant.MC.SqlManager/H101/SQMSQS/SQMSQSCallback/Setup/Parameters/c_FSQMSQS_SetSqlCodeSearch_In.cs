...
--
--  Program Id      : c_FSQMSQS_SqlCodeSearch_In.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.31
--  Description     : FAMate SQL Service Setup Sql Code Inforamtion In XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSqlCodeSearch_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Sql Code Information In Element and Attribute
        // ***
        public const string E_SQMSQS_SetSqlCodeSearch_In = "SQMSQS_SetSqlCodeSearch_In";
        // --
