...
--
--  Program Id      : c_FSQMSQS_SetSystemMigration_In.cs
--  Creator         : iskim
--  Create Date     : 2013.10.30
--  Description     : <Generated Class File Description>
--  History         : Created by iskim at 2013.10.30
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    internal static class FSQMSQS_SetSystemMigration_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_SQMSQS_SetSystemMigration_In = "SQMSQS_SetSystemMigration_In";
