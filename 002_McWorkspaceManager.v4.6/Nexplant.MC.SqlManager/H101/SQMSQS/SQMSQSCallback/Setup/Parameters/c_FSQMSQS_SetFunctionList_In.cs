...
--
--  Program Id      : c_FSQMSQS_SetFunctionList_In.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.28
--  Description     : FAMate SQL Service Function List In XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetFunctionList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Function  List In Element and Attribute
        // ***
        public const string E_SQMSQS_SetFunctioneList_In = "SQMSQS_SetFunctionList_In";
        // --
