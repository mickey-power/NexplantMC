...
--
--  Program Id      : c_FSQMSQS_SetFunctionList_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.28
--  Description     : FAMate SQL Service Setup Function List Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetupFunctionList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Function List Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetFunctionList_Out = "SQMSQS_SetFunctionList_Out";
        // --
