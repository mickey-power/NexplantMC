...
--
--  Program Id      : c_FSQMSQS_SetSqlCodeSearch_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.31
--  Description     : FAMate SQL Service Setup Sql Code Inforamtion Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSqlCodeSearch_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Sql Code Information Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetSqlCodeSearch_Out = "SQMSQS_SetSqlCodeSearch_Out";
        // --
