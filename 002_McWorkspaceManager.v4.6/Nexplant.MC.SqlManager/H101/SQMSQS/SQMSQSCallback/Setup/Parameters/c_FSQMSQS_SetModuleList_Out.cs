...
--
--  Program Id      : c_FSQMSQS_ModuleList_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.25
--  Description     : FAMate SQL Service Setup Module List Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetModuleList_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Module List Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetModuleList_Out = "SQMSQS_SetModuleList_Out";
        // --
