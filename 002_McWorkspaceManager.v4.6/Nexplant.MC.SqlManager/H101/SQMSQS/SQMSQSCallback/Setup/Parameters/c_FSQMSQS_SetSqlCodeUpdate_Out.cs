...
--
--  Program Id      : c_FSQMSQS_SetSqlCodeUpdate_Out.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.31
--  Description     : FAMate SQL Service Setup Sql Code Insert / Update / Delete Out XML Tag Definition Class 
...
{
    public static class FSQMSQS_SetSqlCodeUpdate_Out
    {

        //------------------------------------------------------------------------------------------------------------------------

        // ***
        // FAMate SQL Service Setup Sql Code Insert / Update / Delete Out Element and Attribute
        // ***
        public const string E_SQMSQS_SetSqlCodeUpdate_Out = "SQMSQS_SetSqlCodeUpdate_Out";
        // --
