...
--
--  Program Id      : c_FSQMSQS_ViwSqlServiceLogList_In.cs
--  Creator         : baehyun seo
...
{
    public static class FSQMSQS_ViwSqlServiceLogList_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_FSQMSQS_ViwSqlServiceLogList_In = "FSQMSQS_ViwSqlServiceLogList_In";
