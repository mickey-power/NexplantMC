...
--
--  Program Id      : c_FSQMSQS_ViwSqlServiceLogDownload_In.cs
--  Creator         : baehyun seo
...
{
    public static class FSQMSQS_ViwSqlServiceLogDownload_In
    {

        //------------------------------------------------------------------------------------------------------------------------

        public const string E_FSQMSQS_ViwSqlServiceLogDownload_In = "FSQMSQS_ViwSqlServiceLogDownload_In";
