...
--
--  Program Id      : c_FPropSystem.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.12
--  Description     : FAMate SQL Manager System Property Source Object Class 
...
{
    public class FPropSystem : FDynPropCusBase<FSqmCore>
    {

        //------------------------------------------------------------------------------------------------------------------------

        private const string CategoryGeneral = "[01] General"; 
        private const string CategoryMigration = "[02] Migration";
        ...
        private FDbProvider m_standardDb = FDbProvider.MsSqlServer;
        ...
        public string Description
        {
            ...
            set
            {
                try
                {
                    FCommon.validateName(this.System, true, this.mainObject.fUIWizard);
            ...
            )
        {
            try
            {
                if (dt != null)
                {
                    ...
                    m_system = (string)dt.Rows[0][1];
                    m_description = (string)dt.Rows[0][2];
                    m_standardDb = (FDbProvider)Enum.Parse(typeof(FDbProvider), (string)dt.Rows[0][3]);
                }
                ...
                base.fTypeDescriptor.properties["System"].attributes.replace(new DisplayNameAttribute("Name"));
                base.fTypeDescriptor.properties["Description"].attributes.replace(new DisplayNameAttribute("Description"));
                base.fTypeDescriptor.properties["StandardDb"].attributes.replace(new DisplayNameAttribute("Standard Database"));
                ...
                base.fTypeDescriptor.properties["StandardDb"].attributes.replace(new DefaultValueAttribute(m_standardDb));  
            }
            catch (Exception ex)
            {
