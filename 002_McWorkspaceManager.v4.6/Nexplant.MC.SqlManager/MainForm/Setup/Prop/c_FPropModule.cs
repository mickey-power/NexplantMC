...
--
--  Program Id      : c_FPropModule.cs
--  Creator         : mj.kim
--  Create Date     : 2011.10.12
--  Description     : FAMate SQL Manager Module Property Source Object Class 
...
{
    public class FPropModule : FDynPropCusBase<FSqmCore>
    {
        ...
        public FPropModule(
            ...
            : this(fSqmCore, fPropGrid, system, null)
        {
        ...
        public string Description
        {
            ...
            set
            {
                try
                {
                    FCommon.validateName(this.Module, true, this.mainObject.fUIWizard);
            ...
            )
        {
            try
            {
                ...
                base.fTypeDescriptor.properties["Module"].attributes.replace(new DisplayNameAttribute("Name"));
