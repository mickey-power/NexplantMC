    ...
    public partial class FValueEditor : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm
    {
            ...
            )
        {
            try
            {
                ...
                // --
                if (m_fObject.fObjectType == FObjectType.OpcEventItem)
                {
                    rtxValue.Text = ((FOpcEventItem)m_fObject).originalStringValue;
                }
                else if (m_fObject.fObjectType == FObjectType.OpcItem)
                {
                    rtxValue.Text = ((FOpcItem)m_fObject).originalStringValue;
                }
            ...
            )
        {
            try
            {
                ...
                if (m_fObject.fObjectType == FObjectType.OpcEventItem)
                {
                    ((FOpcEventItem)m_fObject).originalStringValue = rtxValue.Text;
                }
                else if (m_fObject.fObjectType == FObjectType.OpcItem)
                {
                    ((FOpcItem)m_fObject).originalStringValue = rtxValue.Text;
                }
                else if (m_fObject.fObjectType == FObjectType.HostItem)
                {
