...
--  Description     : FAMate OPC Modeler Host Message Property Source Object Class 
...
{
    public class FPropHmg : FDynPropCusBase<FOpmCore>
    {
        ...
        private const string CategoryOpenProtocol = "[04] Open Protocol";
        private const string CategoryDelivery = "[05] Delivery";
        private const string CategoryReply = "[06] Reply";
        ...
        #region Open Protocol

        [Category(CategoryOpenProtocol)]
            ...
            )
        {
            try
            {
                ...
                // --
                base.fTypeDescriptor.properties["NoAckFlag"].attributes.replace(new DisplayNameAttribute("No Ack Flag"));
                base.fTypeDescriptor.properties["StationId"].attributes.replace(new DisplayNameAttribute("Station Id"));
                base.fTypeDescriptor.properties["SpindleId"].attributes.replace(new DisplayNameAttribute("Spindle Id"));
                // --
                ...
                // --
                base.fTypeDescriptor.properties["NoAckFlag"].attributes.replace(new DefaultValueAttribute(m_fHmg.noAckFlag));
                base.fTypeDescriptor.properties["StationId"].attributes.replace(new DefaultValueAttribute(m_fHmg.stationId));
                base.fTypeDescriptor.properties["SpindleId"].attributes.replace(new DefaultValueAttribute(m_fHmg.spindleId));
