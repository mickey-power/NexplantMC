...
--  Description     : FAMate OPC Modeler Host Device Modeler Form Class 
    ...
    public partial class FHostDeviceModeler : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuHdmAppendHostDevice].SharedProps.Visible = ((FOpcDriver)fObject).canAppendChildHostDevice;
                    //--
                    mnuMenu.Tools[FMenuKey.MenuHdmPasteChild].SharedProps.Enabled = ((FOpcDriver)fObject).canPasteChildHostDevice; 
                }
                ...
                {
                    // mnuMenu.Tools[FMenuKey.MenuHdmApplyOsmFiles].SharedProps.Visible = true;
            ...
            )
        {
            ...
            try
            {
                ...
                tNodeHcd = new UltraTreeNode(fOcd.uniqueIdToString);
                tNodeHcd.Tag = fOcd;
                FCommon.refreshTreeNodeOfObject(fOcd, tvwTree, tNodeHcd);
                ...
                // Host Device Load
                // ***
                foreach (FHostDevice fHdv in fOcd.fChildHostDeviceCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FHostDevice fHdv in ((FOpcDriver)fParent).fChildHostDeviceCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                foreach (FHostDevice fHdv in this.m_fOpmCore.fOpmFileInfo.fOpcDriver.fChildHostDeviceCollection)
                {
                    foreach (FHostSession fHsn in fHdv.fChildHostSessionCollection)
                    {
            ...
            try
            {
                ...
                foreach (FHostDevice fHdv in this.m_fOpmCore.fOpmFileInfo.fOpcDriver.fChildHostDeviceCollection)
                {
                    foreach (FHostSession fHsn in fHdv.fChildHostSessionCollection)
                    {
                        ...
                        if (fRefObject.fObjectType == FObjectType.HostLibrary)
                        {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).appendChildHostDevice(new FHostDevice(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                    uniqueId = fNewChild.uniqueIdToString;
                }
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
                    fNewChild = ((FHostDevice)fParent).appendChildHostSession(new FHostSession(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                    uniqueId = fNewChild.uniqueIdToString;
                }
                else if (fParent.fObjectType == FObjectType.HostSession)
                {
                    fNewChild = ((FHostSession)fParent).fLibrary.appendChildHostMessageList(new FHostMessageList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertBeforeChildHostDevice(
                        new FHostDevice(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
                    fNewChild = ((FHostDevice)fParent).insertBeforeChildHostSession(
                        new FHostSession(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertAfterChildHostDevice(
                        new FHostDevice(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                        (FHostDevice)fRefChild
                        );
                    uniqueId = fNewChild.uniqueIdToString;
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    ...
                    // --
                    ((FOpcDriver)fParent).removeChildHostDevice((FHostDevice[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
            ...
            )
        {
            ...
            //    fVfeiViewer = (FTrsViewer)fView.getChild(typeof(FTrsViewer));
            //    if (fVfeiViewer == null)
            //    {
            //        fVfeiViewer = new FTrsViewer(m_fOpmCore);
            //        fView.showChild(fVfeiViewer);
            //    }
            ...
            //    if (fObject.fObjectType == FObjectType.HostMessageList)
            //    {
            //        fVfeiViewer.appendTrs(((FHostMessageList)fObject).convertToTrs());
            //    }
            //    else if (fObject.fObjectType == FObjectType.HostMessages)
            //    {
            //        fVfeiViewer.appendTrs(((FHostMessages)fObject).convertToTrs());
            //    }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).pasteChildHostDevice();
                    uniqueId = fNewChild.uniqueIdToString;
                }
                else if (fParent.fObjectType == FObjectType.HostDevice)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fOpmCore.fOpmFileInfo.fOpcDriver.searchHostDeviceSeries(fBase, ref fHsn, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropHdv(m_fOpmCore, pgdProp, (FHostDevice)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostSession)
                {
                    pgdProp.selectedObject = new FPropHsn(m_fOpmCore, pgdProp, (FHostSession)fObject);
                }
                else if (fObject.fObjectType == FObjectType.HostMessageList)
                {
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.HostDevice)
                        {
                            ...
                            {
                                cnt = ((FOpcDriver)fRefObject).fChildHostDeviceCollection.count;
                                fRefObject = ((FOpcDriver)fRefObject).fChildHostDeviceCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.HostDevice)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FOpcDriver)fRefObject).pasteChildHostDevice();
            ...
            )
        {
            try
            {
                ...
                //else if (e.Tool.Key == FMenuKey.MenuHdmApplyOsmFiles)
                //{
