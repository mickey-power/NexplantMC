...
--  Description     : FAMate OPC Modeler Equipment State Set Definition Form Class 
    ...
    public partial class FEquipmentStateSetDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuEsdAppendEquipmentStateSetList].SharedProps.Visible = ((FOpcDriver)fObject).canAppendChildEquipmentStateSetList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuEsdPasteChild].SharedProps.Enabled = ((FOpcDriver)fObject).canPasteChildEquipmentStateSetList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FEquipmentStateSetList fEsl in fOcd.fChildEquipmentStateSetListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FEquipmentStateSetList fEsl in ((FOpcDriver)fParent).fChildEquipmentStateSetListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).appendChildEquipmentStateSetList(new FEquipmentStateSetList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
                    fNewChild = ((FEquipmentStateSetList)fParent).appendChildEquipmentStateSet(new FEquipmentStateSet(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSet)
                {
                    fNewChild = ((FEquipmentStateSet)fParent).appendChildEquipmentState(new FEquipmentState(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.EquipmentState)
                {
                    fNewChild = ((FEquipmentState)fParent).appendChildStateValue(new FStateValue(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertBeforeChildEquipmentStateSetList(
                        new FEquipmentStateSetList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
                    fNewChild = ((FEquipmentStateSetList)fParent).insertBeforeChildEquipmentStateSet(
                        new FEquipmentStateSet(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EquipmentStateSet)
                {
                    fNewChild = ((FEquipmentStateSet)fParent).insertBeforeChildEquipmentState(
                        new FEquipmentState(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EquipmentState)
                {
                    fNewChild = ((FEquipmentState)fParent).insertBeforeChildStateValue(
                        new FStateValue(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertAfterChildEquipmentStateSetList(
                        new FEquipmentStateSetList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                        (FEquipmentStateSetList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    ...
                    // --
                    ((FOpcDriver)fParent).removeChildEquipmentStateSetList((FEquipmentStateSetList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fChild = ((FOpcDriver)fParent).pasteChildEquipmentStateSetList();
                }
                else if (fParent.fObjectType == FObjectType.EquipmentStateSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                fResult = m_fOpmCore.fOpmFileInfo.fOpcDriver.searchEquipmentStateSetSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropEsl(m_fOpmCore, pgdProp, (FEquipmentStateSetList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.EquipmentStateSet)
                {
                    pgdProp.selectedObject = new FPropEss(m_fOpmCore, pgdProp, (FEquipmentStateSet)fObject);
                }
                else if (fObject.fObjectType == FObjectType.EquipmentState)
                {
                    pgdProp.selectedObject = new FPropEst(m_fOpmCore, pgdProp, (FEquipmentState)fObject);
                }
                else if (fObject.fObjectType == FObjectType.StateValue)
                {
                    pgdProp.selectedObject = new FPropStv(m_fOpmCore, pgdProp, (FStateValue)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EquipmentStateSetList)
                        {
                            ...
                            {
                                cnt = ((FOpcDriver)fRefObject).fChildEquipmentStateSetListCollection.count;
                                fRefObject = ((FOpcDriver)fRefObject).fChildEquipmentStateSetListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EquipmentStateSetList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FOpcDriver)fRefObject).pasteChildEquipmentStateSetList();
