...
--  Description     : FAMate OPC Modeler Enviroment Definition Form Class 
    ...
    public partial class FEnvironmentDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuEndAppendEnvironmentList].SharedProps.Visible = ((FOpcDriver)fObject).canAppendChildEnvironmentList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuEndPasteChild].SharedProps.Enabled = ((FOpcDriver)fObject).canPasteChildEnvironmentList;
                }
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FEnvironmentList fEnl in fOcd.fChildEnvironmentListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FEnvironmentList fEnl in ((FOpcDriver)fParent).fChildEnvironmentListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).appendChildEnvironmentList(new FEnvironmentList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
                    fNewChild = ((FEnvironmentList)fParent).appendChildEnvironment(new FEnvironment(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.Environment)
                {
                    fNewChild = new FEnvironment(this.m_fOpmCore.fOpmFileInfo.fOpcDriver);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertBeforeChildEnvironmentList(
                        new FEnvironmentList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
                    fNewChild = ((FEnvironmentList)fParent).insertBeforeChildEnvironment(
                        new FEnvironment(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertAfterChildEnvironmentList(
                        new FEnvironmentList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                        (FEnvironmentList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    ...
                    // --
                    ((FOpcDriver)fParent).removeChildEnvironmentList((FEnvironmentList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fChild = ((FOpcDriver)fParent).pasteChildEnvironmentList();
                }
                else if (fParent.fObjectType == FObjectType.EnvironmentList)
                {
             ...
             )
        {
            ...
            try
            {
                ...
                fResult = m_fOpmCore.fOpmFileInfo.fOpcDriver.searchEnvironmentSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropEnl(m_fOpmCore, pgdProp, (FEnvironmentList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.Environment)
                {
                    pgdProp.selectedObject = new FPropEnv(m_fOpmCore, pgdProp, (FEnvironment)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EnvironmentList)
                        {
                            ...
                            {
                                cnt = ((FOpcDriver)fRefObject).fChildEnvironmentListCollection.count;
                                fRefObject = ((FOpcDriver)fRefObject).fChildEnvironmentListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.EnvironmentList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FOpcDriver)fRefObject).pasteChildEnvironmentList();
