...
--  Description     : FAMate OPC Modeler Data Conversion Set Definition Form Class 
    ...
    public partial class FDataConversionSetDefinition : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuDcdAppendDataConversionSetList].SharedProps.Visible = ((FOpcDriver)fObject).canAppendChildDataConversionSetList;
                    // --
                    mnuMenu.Tools[FMenuKey.MenuDcdPasteChild].SharedProps.Enabled = ((FOpcDriver)fObject).canPasteChildDataConversionSetList;
                }
                ...
                {
                    mnuMenu.Tools[FMenuKey.MenuDcdApplyOsmFiles].SharedProps.Visible = true;
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                foreach (FDataConversionSetList fDcl in fOcd.fChildDataConversionSetListCollection)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    foreach (FDataConversionSetList fDcl in ((FOpcDriver)fParent).fChildDataConversionSetListCollection)
                    {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fNewChild.fObjectType == FObjectType.DataConversionSetList)
                {
                    ...
                    if (
                        tNodeParent == null ||
                        tNodeParent.Nodes.Count != ((FOpcDriver)fParent).fChildDataConversionSetListCollection.count - 1
                        )
                    {
                        return;
                    }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fObject.fObjectType == FObjectType.DataConversionSet)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).appendChildDataConversionSetList(new FDataConversionSetList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
                    fNewChild = ((FDataConversionSetList)fParent).appendChildDataConversionSet(new FDataConversionSet(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSet)
                {
                    fNewChild = ((FDataConversionSet)fParent).appendChildDataConversion(new FDataConversion(this.m_fOpmCore.fOpmFileInfo.fOpcDriver));
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertBeforeChildDataConversionSetList(
                        new FDataConversionSetList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
                    fNewChild = ((FDataConversionSetList)fParent).insertBeforeChildDataConversionSet(
                        new FDataConversionSet(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                ...
                else if (fParent.fObjectType == FObjectType.DataConversionSet)
                {
                    fNewChild = ((FDataConversionSet)fParent).insertBeforeChildDataConversion(
                        new FDataConversion(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fNewChild = ((FOpcDriver)fParent).insertAfterChildDataConversionSetList(
                        new FDataConversionSetList(this.m_fOpmCore.fOpmFileInfo.fOpcDriver),
                        (FDataConversionSetList)fRefChild
                        );
                }
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    ...
                    // --
                    ((FOpcDriver)fParent).removeChildDataConversionSetList((FDataConversionSetList[])fChilds);
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                if (fParent.fObjectType == FObjectType.OpcDriver)
                {
                    fChild = ((FOpcDriver)fParent).pasteChildDataConversionSetList();
                }
                else if (fParent.fObjectType == FObjectType.DataConversionSetList)
                {
             ...
             )
        {
            ...
            try
            {
                ...
                fResult = m_fOpmCore.fOpmFileInfo.fOpcDriver.searchDataConversionSetSeries(fBase, searchWord);
                if (fResult == null)
                {
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    pgdProp.selectedObject = new FPropDcl(m_fOpmCore, pgdProp, (FDataConversionSetList)fObject);
                }
                else if (fObject.fObjectType == FObjectType.DataConversionSet)
                {
                    pgdProp.selectedObject = new FPropDcs(m_fOpmCore, pgdProp, (FDataConversionSet)fObject);
                }
                else if (fObject.fObjectType == FObjectType.DataConversion)
                {
                    pgdProp.selectedObject = new FPropDcv(m_fOpmCore, pgdProp, (FDataConversion)fObject);
                }
                ...
                if (fDragDropData.fObject != null)
                {
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.DataConversionSetList)
                        {
                            ...
                            {
                                cnt = ((FOpcDriver)fRefObject).fChildDataConversionSetListCollection.count;
                                fRefObject = ((FOpcDriver)fRefObject).fChildDataConversionSetListCollection[cnt - 1];
                    ...
                    if (fRefObject.fObjectType == FObjectType.OpcDriver)
                    {
                        if (fDragDropData.fObject.fObjectType == FObjectType.DataConversionSetList)
                        {
                            ...
                            else if (e.Effect == DragDropEffects.Copy)
                            {
                                ...
                                fDragDropData.fObject = ((FOpcDriver)fRefObject).pasteChildDataConversionSetList();
            ...
            )
        {
            try
            {
                ...
                else if (e.Tool.Key == FMenuKey.MenuDcdApplyOsmFiles)
                {
