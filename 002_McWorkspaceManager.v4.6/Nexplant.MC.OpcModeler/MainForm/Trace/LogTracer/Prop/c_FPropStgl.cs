...
--
--  Program Id      : c_FPropStgl.cs
--  Creator         : jungyoul.moon
--  Create Date     : 2013.11.07
--  Description     : FAMate OPC Modeler Storage Performed Log Property Source Object Class 
--  History         : Created by jungyoul.moon at 2012.11.07
----------------------------------------------------------------------------------------------------------*/
using System;
...
{
    public class FPropStgl : FDynPropCusBase<FOpmCore>
    {
            ...
            )
        {
            try
            {
                ...
                base.fTypeDescriptor.properties["Mode"].attributes.replace(new DefaultValueAttribute(m_fStgl.fMode));
                // --
                ...
                if (m_fStgl.fAction == FStorageAction.Create)
                {
