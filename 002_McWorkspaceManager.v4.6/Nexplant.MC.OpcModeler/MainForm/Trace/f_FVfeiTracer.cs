...
--  Description     : FAMate OPC Modeler Sml Tracer  Class
    ...
    public partial class FVfeiTracer : Nexplant.MC.Core.FaUIs.FBaseTabChildForm
    {
            ...
            )
        {
            ...
            try
            {
                ...
                logBuilder.AppendLine(
                    ...
                    "DataSent    , " +
                    "OpcDevice=<" + e.fHostDeviceVfeiSentLog.name + ">, " +
            ...
            )
        {
            ...
            try
            {
                ...
                logBuilder.AppendLine(
                    ...
                    "DataReceived, " +
                    "OpcDevice=<" + e.fHostDeviceVfeiReceivedLog.name + ">, " +
            ...
            )
        {
            try
            {
                ...
                m_fEventHandler = new FEventHandler(m_fOpmCore.fOpmFileInfo.fOpcDriver, txtMonitor);
                // --
                ...
                mnbMaxTraceCount.Value = m_fOpmCore.fOption.vfeiTracerMaxTraceCount;
            ...
            )
        {
            try
            {
                ...
                m_fOpmCore.fOption.vfeiTracerMaxTraceCount = int.Parse(mnbMaxTraceCount.Value.ToString());
            ...
            )
        {
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuFontName)
                {
                    ...
                    {
                        ((FontListTool)mnuMenu.Tools[FMenuKey.MenuFontName]).Value = m_fOpmCore.fOption.commonFontName;
                        txtMonitor.Appearance.FontData.Name = m_fOpmCore.fOption.commonFontName;
                    }
                }
            }
            catch (Exception ex)
