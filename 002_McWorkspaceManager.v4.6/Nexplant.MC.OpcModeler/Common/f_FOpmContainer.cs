...
--
--  Program Id      : f_FPlmContainer.cs
--  Creator         : Jeff.kim
--  Create Date     : 2013.07.10
--  Description     : FAMate OPC Modeler Container Form Class 
...
{
    public partial class FOpmContainer : Nexplant.MC.Core.FaUIs.FBaseTabMdiChildForm
    {
        //------------------------------------------------------------------------------------------------------------------------
        ...
        private FValidationViewer m_fValidationViewer = null;
        
        //------------------------------------------------------------------------------------------------------------------------

        #region Class Construction and Destruction

        public FOpmContainer(
            )
        {
            InitializeComponent();
        }
            ...
            : this()
        {
            ...
            m_fOpmCore = new FOpmCore(fWsmCore, this);
        }
        ...
        {
            base.fUIWizard = fWsmCore.fUIWizard;
            m_fOpmCore = new FOpmCore(fWsmCore, this, fOpcDriver);
        }
           ...
           )
        {
            ...
            try
            {
                appName = m_fOpmCore.fWsmCore.fUIWizard.searchCaption(FConstants.ApplicationName);
                // --
                if (m_fOpmCore.fOpmFileInfo.isClosedFile)
                {
                    this.Text = appName;
                }
                else
                {
                    this.Text = appName + " - [" + m_fOpmCore.fOpmFileInfo.fileName + (m_fOpmCore.fOpmFileInfo.isModifiedFile ? "*" : "") + "]";
                }
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                caption = m_fOpmCore.fUIWizard.searchCaption(FConstants.ApplicationName);
                if (!m_fOpmCore.fOpmFileInfo.isClosedFile)
                {
                    caption += " - [" + m_fOpmCore.fOpmFileInfo.fileFullName + (m_fOpmCore.fOpmFileInfo.isModifiedFile ? "*" : "") + "]";
                }
                // --
                ...
                m_fOpmCore.fWsmCore.onMainStatusBarChanged(
                    true,
                    caption,
                    string.Empty,
                    string.Empty,
            ...
            )
        {
            try
            {
                ...
                mnuMenu.Tools[FMenuKey.MenuClose].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                // --
                mnuMenu.Tools[FMenuKey.MenuClone].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                // --
                mnuMenu.Tools[FMenuKey.MenuSave].SharedProps.Enabled = m_fOpmCore.fOpmFileInfo.isNewFile | m_fOpmCore.fOpmFileInfo.isModifiedFile;
                mnuMenu.Tools[FMenuKey.MenuSaveAs].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                // --
                mnuMenu.Tools[FMenuKey.MenuRecentLibrary].SharedProps.Enabled = true;
                mnuMenu.Tools[FMenuKey.MenuRecentLog].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                // --
                mnuMenu.Tools[FMenuKey.MenuExport].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                // --
                ...
                // Setup Menu
                // ***
                mnuMenu.Tools[FMenuKey.MenuObjectNameDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuFunctionNameDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuUserTagNameDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuDataConversionSetDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuEquipmentStateSetDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuRepositoryDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuEnvironmentDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuDataSetDefinition].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                ...
                // Modeling Menu
                // ***
                mnuMenu.Tools[FMenuKey.MenuOpcLibraryModeler].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuOpcDeviceModeler].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuHostLibraryModeler].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuHostDeviceModeler].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuEquipmentModeler].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;

                // ***
                // Tool
                // ***
                mnuMenu.Tools[FMenuKey.MenuOpenAllDevice].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuCloseAllDevice].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                // mnuMenu.Tools[FMenuKey.MenuItemNameOfOpcSession].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile; 
                mnuMenu.Tools[FMenuKey.MenuVfeiLogCut].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile && m_fOpmCore.fOption.enabledLogOfVfei;
                mnuMenu.Tools[FMenuKey.MenuOpcLogCut].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile && m_fOpmCore.fOption.enabledLogOfOpc;


                // ***
                // Tracer Menu
                // ***
                mnuMenu.Tools[FMenuKey.MenuVfeiTracer].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuLogTracer].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                //mnuMenu.Tools[FMenuKey.MenuInterfaceTracer].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuInterfaceTracer].SharedProps.Visible = false;

                // ***
                // View Menu
                // ***                
                mnuMenu.Tools[FMenuKey.MenuVfeiViewer].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
                mnuMenu.Tools[FMenuKey.MenuRelationViewer].SharedProps.Enabled = !m_fOpmCore.fOpmFileInfo.isClosedFile;
            ...
            )
        {
            try
            {
                if (m_fOpmCore.fOption.libRecentFileList.Contains(fileName))
                {
                    m_fOpmCore.fOption.libRecentFileList.Remove(fileName);
                }
                else if (m_fOpmCore.fOption.libRecentFileList.Count == FConstants.RecentMaxCount)
                {
                    m_fOpmCore.fOption.libRecentFileList.RemoveAt(m_fOpmCore.fOption.libRecentFileList.Count - 1);
                }
                m_fOpmCore.fOption.libRecentFileList.Insert(0, fileName);
            ...
            )
        {
            ...
            try
            {
                ...
                // ***
                if (m_fOpmCore.fOpmFileInfo.isModifiedFile)
                {
                    dialogResult = FMessageBox.showQuestion(
                        FConstants.ApplicationName,
                        m_fOpmCore.fWsmCore.fUIWizard.generateMessage("Q0002", new object[] { m_fOpmCore.fOpmFileInfo.fileName }),
            ...
            )
        {
            try
            {
                ...
                m_fOpmCore.fOpmFileInfo.openFile(fileName);
                // showDefaultModeler();

                // --

                m_fOpmCore.fOption.libRecentOpenPath = Path.GetDirectoryName(fileName);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fLogTracer == null)
                {
                    fLogTracer = new FTotalLogTracer(m_fOpmCore);
            ...
            )
        {
            try
            {
                m_fOpmCore.fOpmFileInfo.saveFile(fileName);

                // --

                m_fOpmCore.fOption.libRecentSavePath = Path.GetDirectoryName(fileName);
                changeRecentLibFile(fileName);
            ...
            )
        {
            try
            {
                ...
                m_fOpmCore.fOpmFileInfo.closeFile();
            ...
            )
        {
            try
            {
                m_fOpmCore.fWsmCore.fWsmContainer.showTabMdiChild(
                    new FOpmContainer(m_fOpmCore.fWsmCore, this.m_fOpmCore.fOpmFileInfo.fOpcDriver.cloneOpcDriver())
                    );
            }
            catch (Exception ex)
            {
            ...
            )
        {
            try
            {
                if (m_fOpmCore.fOpmFileInfo.isNewFile)
                {
                ...
                saveLibFile(m_fOpmCore.fOpmFileInfo.fileFullName);
            ...
            )
        {
            ...
            try
            {
                ...
                dialog.Title = fUIWizard.searchCaption("Save As OPC Modeling File");
                dialog.Filter = "OPC Modeling Files | *.osm";
                dialog.DefaultExt = "osm";
                ...
                if (m_fOpmCore.fOpmFileInfo.isNewFile)
                {
                    dialog.InitialDirectory = m_fOpmCore.fOption.libRecentSavePath;
                }
                else
                {
                    dialog.InitialDirectory = Path.GetDirectoryName(m_fOpmCore.fOpmFileInfo.fileFullName);
                }
                dialog.FileName = m_fOpmCore.fOpmFileInfo.fileName;
                // --
                if (dialog.ShowDialog(m_fOpmCore.fWsmCore.fWsmContainer) == DialogResult.Cancel)
                {
                    return false;
            ...
            try
            {
                ...
                if (!File.Exists(fileName))
                {
                    FMessageBox.showError(
                        FConstants.ApplicationName,
                        m_fOpmCore.fWsmCore.fUIWizard.generateMessage("E0010", new object[] { fileName }),
                        m_fOpmCore.fWsmCore.fWsmContainer
                        );
                    // --
                    if (m_fOpmCore.fOption.libRecentFileList.Contains(fileName))
            ...
            )
        {
            ...
            try
            {
                dialog = new FOptionDialog(this.m_fOpmCore);
            ...
            )
        {
            ...
            try
            {
                dialog = new FExportDialog(this.m_fOpmCore);
                if (dialog.ShowDialog(this) == DialogResult.OK)
                {
                    controlMainMenu();
                }
        ...
        {            
            ...
            try
            {
                ...
                {
                    fObjectNameDefinition = new FObjectNameDefinition(m_fOpmCore);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fFunctionNameDefinition = new FFunctionNameDefinition(m_fOpmCore);
            ...
            )
        {
            ...
            {   
                ...
                {
                    fUserTagNameDefinition = new FUserTagNameDefinition(m_fOpmCore);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fDataConversionSetDefinition = new FDataConversionSetDefinition(m_fOpmCore);
            ...
            )
        {
            ...
            {   
                ...
                {
                    fEquipmentStateSetDefinition = new FEquipmentStateSetDefinition(m_fOpmCore);
            ...
            )
        {
            ...
            {   
                ...
                {
                    fRepositoryDefinition = new FRepositoryDefinition(m_fOpmCore);
        ...
        private void procMenuEnvironmentDefinition(
            )
        {
            ...
            {   
                ...
                {
                    fEnvironmentDefinition = new FEnvironmentDefinition(m_fOpmCore);
            ...
            )
        {
            ...
            {   
                ...
                {
                    fDataSetDefinition = new FDataSetDefinition(m_fOpmCore);
        ...
        private void procMenuOpcLibraryModeler(
            )
        {
            FOpcLibraryModeler fOpcLibraryModeler = null;

            try
            {   
                fOpcLibraryModeler = (FOpcLibraryModeler)this.getChild(typeof(FOpcLibraryModeler));
                if (fOpcLibraryModeler == null)
                {
                    fOpcLibraryModeler = new FOpcLibraryModeler(m_fOpmCore);
                    this.showChild(fOpcLibraryModeler);
                }
                fOpcLibraryModeler.activate();   
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            {
                fOpcLibraryModeler = null;
            }
        }

        //------------------------------------------------------------------------------------------------------------------------

        private void procMenuOpcDeviceModeler(
            )
        {
            FOpcDeviceModeler fOpcDeviceModeler = null;

            try
            {   
                fOpcDeviceModeler = (FOpcDeviceModeler)this.getChild(typeof(FOpcDeviceModeler));
                if (fOpcDeviceModeler == null)
                {
                    fOpcDeviceModeler = new FOpcDeviceModeler(m_fOpmCore);
                    this.showChild(fOpcDeviceModeler);
                }
                fOpcDeviceModeler.activate();   
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    fHostLibraryModeler = new FHostLibraryModeler(m_fOpmCore);
            ...
            )
        {
            ...
            {   
                ...
                {
                    fHostDeviceModeler = new FHostDeviceModeler(m_fOpmCore);
            ...
            )
        {
            ...
            {  
                ...
                {
                    fEquipmentModeler = new FEquipmentModeler(m_fOpmCore);
            ...
            )
        {
            try
            {
                m_fOpmCore.fOpmFileInfo.fOpcDriver.openAllDevice();
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            try
            {
                m_fOpmCore.fOpmFileInfo.fOpcDriver.closeAllDevice();
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        public void procMenuApplyOSMFiles(
            )
        {
            //FApplyOsmFiles fApplyOsmFiles = null;

            //try
            //{
            //    fApplyOsmFiles = (FApplyOsmFiles)this.getChild(typeof(FApplyOsmFiles));
            //    if (fApplyOsmFiles == null)
            //    {
            //        fApplyOsmFiles = new FApplyOsmFiles(m_fOpmCore);
            //        this.showChild(fApplyOsmFiles);                     
            //    }
            //    fApplyOsmFiles.activate();
            //}
            //catch (Exception ex)
            //{
            //    FDebug.throwException(ex);
        ...
        private void procMenuItemNameOfOpcSession(
            )
        {
            //FItemNameOfOpcSession fItemNameOfOpcSession = null;

            //try
            //{                
            //    fItemNameOfOpcSession = (FItemNameOfOpcSession)fTool.getChild(typeof(FItemNameOfOpcSession));
            //    if (fItemNameOfOpcSession == null)
            //    {
            //        fItemNameOfOpcSession = new FItemNameOfOpcSession(m_fOpmCore);
            //        fTool.showChild(fItemNameOfOpcSession);
            //    }
            //    fItemNameOfOpcSession.activate();
            //}
            //catch (Exception ex)
            //{
            //    FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                dialogResult = FMessageBox.showQuestion(
                    FConstants.ApplicationName,
                    m_fOpmCore.fUIWizard.generateMessage("Q0013", new object[] { "VFEI Log" }),
                ...
                m_fOpmCore.fOpmFileInfo.fOpcDriver.cutVfeiLogFile();
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        private void procMenuOpcLogCut(
            )
        {
            DialogResult dialogResult;
            ...
            try
            {
                ...
                dialogResult = FMessageBox.showQuestion(
                    FConstants.ApplicationName,
                    m_fOpmCore.fUIWizard.generateMessage("Q0013", new object[] { "OPC Log" }),
                    MessageBoxButtons.YesNo,
                    MessageBoxDefaultButton.Button2,
                    this
                    );
                ...
                m_fOpmCore.fOpmFileInfo.fOpcDriver.cutOpcLogFile();
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
            ...
            )
        {
            ...
            try
            {
                ...
                if (fVfeiTracer == null)
                {
                    fVfeiTracer = new FVfeiTracer(m_fOpmCore);
        ...
        //    )
        //{
        //    FInterfaceTracer fIftTracer = null;

        //    try
        //    {
        //        fIftTracer = (FInterfaceTracer)this.getChild(typeof(FInterfaceTracer));
        //        if (fIftTracer == null)
        //        {
        //            fIftTracer = new FInterfaceTracer(m_fOpmCore);
        //            this.showChild(fIftTracer);
        //        }
        //        fIftTracer.activate();
        //    }
        //    catch (Exception ex)
            ...
            )
        {
            ...
            try
            {
                fChildForm = (FBaseTabChildForm)m_fOpmCore.fOption.fChildFormList.getFormOfKey(key);                
                fChildForm.activate();
            }
            catch (Exception ex)
            {
            ...
            )
        {
            ...
            try
            {
                dialog = new FFormSelector(m_fOpmCore);
                dialog.ShowDialog();
            }
            catch (Exception ex)
            {
            ...
            )
        {
            try
            {
                ...
                {
                    m_fRelationViewer = new FRelationViewer(m_fOpmCore);
        ...
        public void showValidationViewer(
            )
        {
            try
            {
                if (m_fValidationViewer == null)
                {
                    m_fValidationViewer = new FValidationViewer(m_fOpmCore);
                    m_fValidationViewer.FormClosed += new FormClosedEventHandler(m_fValidationViewer_FormClosed);
                    // --
                    m_fValidationViewer.Show(this);
                }

                // --

                m_fValidationViewer.refresh();
            }
            catch (Exception ex)
            {
                FDebug.throwException(ex);
        ...
        {   
            ...
            try
            {
                if (!this.m_fOpmCore.fOpmFileInfo.fOpcDriver.containsObject(fObject))
                {
                    return;
                }
                    ...
                    )
                {
                    ...
                    fOpcDeviceModeler.Invoke(new MethodInvoker(delegate()
                    {
                        fOpcDeviceModeler.searchObject(fObject);
                    }));
                }
                else if (
                    ...
                    )
                {
                    ...
                    fOpcLibraryModeler.Invoke(new MethodInvoker(delegate()
                    {
                        fOpcLibraryModeler.searchObject(fObject);
                    }));
                }
                else if (
        ...
        #region FOpmContainer Form Event Handler

        private void FOpmContainer_Load(
            object sender,
            EventArgs e
            )
        {
            try
            {
                ...
                m_fOpmCore.ModelingFileModified += new FModelingFileModifiedEventHandler(m_fOpmCore_ModelingFileModified);
            }
            catch (Exception ex)
            {
        ...
        private void FOpmContainer_Shown(
           object sender,
           EventArgs e
           )
        {
            ...
            try
            {
                ...
                {
                    // ***
                    // OPC Modeler 기본 실행과 Modeling File Clone 처리
                    // ***
                    if (!m_fOpmCore.fOpmFileInfo.isClosedFile)
                    {
                        // showDefaultModeler();
        ...
        private void FOpmContainer_Enter(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FOpmContainer_Activated(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FOpmContainer_Leave(
            object sender,
            EventArgs e
            )
        {
        ...
        private void FOpmContainer_FormCloseConfirm(
            object sender,
        ...
        private void FOpmContainer_FormClosing(
            object sender,
            ...
            )
        {
            try
            {
                ...
                m_fOpmCore.fWsmCore.onMainStatusBarChanged(true);
                // --
                if (m_fOpmCore != null)
                {
                    m_fOpmCore.ModelingFileModified -= new FModelingFileModifiedEventHandler(m_fOpmCore_ModelingFileModified);
            ...
            )
        {
            ...
            try
            {
                ...
                if (e.Tool.Key == FMenuKey.MenuFile)
                {
                    ...
                    // --
                    foreach (string s in m_fOpmCore.fOption.libRecentFileList)
                    {
                        ...
                        mnuTool.SharedProps.AppearancesSmall.Appearance.Image = mnuMenu.ImageListSmall.Images["File_Osm"];
                    ...
                    popMenuTool.Tools.Clear();
                    // --
                    foreach (string s in m_fOpmCore.fOption.logRecentFileList)
                    {
                        if (!mnuMenu.Tools.Exists(s))
                        {
                            mnuMenu.Tools.Add(new ButtonTool(s));
                ...
                else if (e.Tool.Key == FMenuKey.MenuWindow)
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        if (i >= m_fOpmCore.fOption.fChildFormList.count)
                        {
                            break;
                        }
                        ...
                        mnuTool.SharedProps.Tag = m_fOpmCore.fOption.fChildFormList.getKeyOfIndex(i);
                        mnuTool.SharedProps.Caption = "&" + (i + 1).ToString() + " " + fUIWizard.searchCaption(m_fOpmCore.fOption.fChildFormList.getTextOfIndex(i));
                        mnuTool.SharedProps.Visible = true;
                    }

                    // --

                    if (m_fOpmCore.fOption.fChildFormList.count > 10)
                    {
            ...
            )
        {
            try
            {
                ...
                // --
                else if (e.Tool.Key == FMenuKey.MenuOpcLibraryModeler)
                {
                    procMenuOpcLibraryModeler();
                }
                else if (e.Tool.Key == FMenuKey.MenuOpcDeviceModeler)
                {
                    procMenuOpcDeviceModeler();
                }
                // --
                ...
                //else if (e.Tool.Key == FMenuKey.MenuItemNameOfOpcSession)
                //{
                //    procMenuItemNameOfOpcSession();
                //}
                else if (e.Tool.Key == FMenuKey.MenuVfeiLogCut)
                {
                    procMenuVfeiLogCut();
                }
                else if (e.Tool.Key == FMenuKey.MenuOpcLogCut)
                {
                    procMenuOpcLogCut();
                }
                // --
                ...
                // Recent File
                // ***
                else if (Path.GetExtension(e.Tool.Key) == ".osm")
                {
        ...
        #region m_fOpmCore Object Event Handler

        private void m_fOpmCore_ModelingFileModified(
            object sender,
        ...
        #region m_fValidationViewer Form Event Handler

        private void m_fValidationViewer_FormClosed(
            object sender,
            FormClosedEventArgs e
            )
        {
