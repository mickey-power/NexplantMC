...
{
    public class FLvwCore : IDisposable
    {
        ...
        private FLvwContainer m_fLvwContainer = null;
        ...
        public FLvwCore(
            FIWsmCore fWsmCore,
            FLvwContainer fLvwContainer
            )
        {
            m_fWsmCore = fWsmCore;
            m_fLvwContainer = fLvwContainer;
            // --
            init();
        }
        ...
        public FLvwContainer fLvwContainer
        {
            get
            {
                try
                {
                    return m_fLvwContainer;
                }
                catch (Exception ex)
                {
                    FDebug.throwException(ex);
