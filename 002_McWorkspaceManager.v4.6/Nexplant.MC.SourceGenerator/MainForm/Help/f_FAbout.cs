...
--  Description     : FAMate Source Generator About Form Class 
--  History         : Created by baehyun.seo at 2013.02.04
----------------------------------------------------------------------------------------------------------*/
using System;
using System.Net;
...
namespace Nexplant.MC.SourceGenerator
{
    public partial class FAbout : Nexplant.MC.Core.FaUIs.FBaseStandardDialogForm
    {
            ...
            )
        {
            ...
            try
            {
                caption = m_fScgCore.fWsmCore.fUIWizard.searchCaption(this.Text);
                this.Text = caption;
            }
            catch (Exception ex)
            {
